...
//		$result['total_fee']=$this->fetch_total_fee_paid($result['stud_id']);
	...
	//	$result=$query->result_array();
    	...
    	function searchStudentsajax($data){
		    $DB1 = $this->load->database('umsdb', TRUE);
		$DB1->select("sm.*,stm.stream_name,cm.course_name,cdn.remark as provisnal_cancle");
		$DB1->from('student_master as sm');
...
ad.`transport_required`,ad.`transport_boarding_point`,ad.`remark`,ad.`cancelled_admission`,ad.`fess_update_bybala`");
		$DB1->from('student_master as sm');
	//	$DB1->join('couse_master as scm','d.emp_id = e.emp_id','left');
		$DB1->join('stream_master as stm','sm.admission_stream = stm.stream_id','left');
			$DB1->join('course_master as cm','cm.course_id = stm.course_id','left');
   ...
   $sid=array_map('intval', explode(',', $sid1));
	...
	function student_registration($data){
	  ...
	  //  $temp['student_id']=stripcslashes($stid);
		//Admission for
		$temp['admission-course']=stripslashes(mysql_real_escape_string($data['admission-course'])); 	
		//course
		$temp['admission-branch']=stripslashes(mysql_real_escape_string($data['admission-branch'])); 	
		//student name
		$temp['fname']= strtoupper(stripslashes(mysql_real_escape_string($data['sfname']))); 		
		$temp['mname']=strtoupper(stripslashes(mysql_real_escape_string($data['smname']))); 		
		$temp['lname']=strtoupper(stripslashes(mysql_real_escape_string($data['slname']))); 
        
		$temp['gender']=stripslashes(mysql_real_escape_string($data['gender'])); 
		$temp['dob']=stripslashes(mysql_real_escape_string($data['dob'])); 
		$temp['mobile']=stripslashes(mysql_real_escape_string($data['mobile'])); 
		$temp['email_id']=stripslashes(mysql_real_escape_string($data['email_id'])); 
		$temp['nationality']=stripslashes(mysql_real_escape_string($data['nationality'])); 
		$temp['caste']=stripslashes(mysql_real_escape_string($data['category']));  
		//$temp['sub_caste']=stripslashes(mysql_real_escape_string($data['sub_caste']));  
		$temp['religion']=stripslashes(mysql_real_escape_string($data['religion'])); 
		$temp['aadhar_no']=stripslashes(mysql_real_escape_string($data['saadhar'])); 
		$temp['res_state']=stripslashes(mysql_real_escape_string($data['res_state'])); 
		$temp['hostelfacility']=stripslashes(mysql_real_escape_string($data['hostel'])); 
		$temp['transportfacility']=stripslashes(mysql_real_escape_string($data['transport'])); 
		$temp['bording_point']=stripslashes(mysql_real_escape_string($data['bording_point'])); 
		//student Husband/father name
        $address['student_id']=stripcslashes($stid);		
		$address['pfname']=strtoupper(stripslashes(mysql_real_escape_string($data['sfname1']))); 		
		$address['pmname']=strtoupper(stripslashes(mysql_real_escape_string($data['smname1']))); 		
		$address['plname']=strtoupper(stripslashes(mysql_real_escape_string($data['slname1']))); 
         // student mother name		
		$address['mothernm']=strtoupper(stripslashes(mysql_real_escape_string($data['sfname2']))); 
		/***Address details***/
		//local address bill_A
		$address['lhouseno']=stripslashes(mysql_real_escape_string($data['laddress'])); 
//		$address['lstreet']=stripslashes(mysql_real_escape_string($data['bill_B'])); 
		
		$address['lstate']=stripslashes(mysql_real_escape_string($data['lstate_id'])); 
		$address['lcity']=stripslashes(mysql_real_escape_string($data['lcity'])); 
		$address['ldistrict']=stripslashes(mysql_real_escape_string($data['ldistrict_id'])); 	
		//$address['lcountry']=stripslashes(mysql_real_escape_string($data['bill_country'])); 
		$address['lpostal']=stripslashes(mysql_real_escape_string($data['bill_pc']));
         // permenant	address	
         
         
		$address['phouseno']=stripslashes(mysql_real_escape_string($data['paddress'])); 
		//$address['pstreet']=stripslashes(mysql_real_escape_string($data['shipping_B'])); 
			$address['pdistrict']=stripslashes(mysql_real_escape_string($data['ldistrict_id'])); 
		$address['pcity']=stripslashes(mysql_real_escape_string($data['shipping_C'])); 
		$address['pstate']=stripslashes(mysql_real_escape_string($data['shipping_D'])); 
	//	$address['pcountry']=stripslashes(mysql_real_escape_string($data['shipping_country'])); 
		$address['ppostal']=stripslashes(mysql_real_escape_string($data['shipping_pc'])); 
		$address['same']=stripslashes(mysql_real_escape_string($data['same'])); 
		
		//Guardians details  parent_details
		  $guardian['student_id']=stripcslashes($stid);
		$guardian['gfname']=strtoupper(stripslashes(mysql_real_escape_string($data['fname']))); 
		$guardian['gmname']=strtoupper(stripslashes(mysql_real_escape_string($data['mname']))); 
		$guardian['glname']=strtoupper(stripslashes(mysql_real_escape_string($data['lname']))); 
		$guardian['grelationship']=stripslashes(mysql_real_escape_string($data['relationship'])); 
		$guardian['goccupation']=stripslashes(mysql_real_escape_string($data['occupation'])); 
		$guardian['gannual_income']=stripslashes(mysql_real_escape_string($data['annual_income'])); 
		$guardian['gparent_email']=stripslashes(mysql_real_escape_string($data['parent_email'])); 
		$guardian['gparent_mobile']=stripslashes(mysql_real_escape_string($data['parent_mobile'])); 
		$guardian['gparent_phone']=stripslashes(mysql_real_escape_string($data['parent_phone'])); 
		$guardian['gparent_address']=stripslashes(mysql_real_escape_string($data['parent_address']));
	...
	$prnj =	$temp['enrollment_no_new']=$this->Ums_admission_model->generateprn_new($data['admission-branch'],$data['acyear'],$data['admission_type']); 
		...
		//($stream_id)
		//course
		$temp['admission_stream']=stripslashes(mysql_real_escape_string($data['admission-branch'])); 	
		//student name
		$temp['first_name']=strtoupper(stripslashes(mysql_real_escape_string($data['sfname']))); 		
		$temp['middle_name']=strtoupper(stripslashes(mysql_real_escape_string($data['smname']))); 		
		$temp['last_name']=strtoupper(stripslashes(mysql_real_escape_string($data['slname']))); 
        
		$temp['gender']=stripslashes(mysql_real_escape_string($data['gender'])); 
		$temp['blood_group']=stripslashes(mysql_real_escape_string($data['blood_gr'])); 
		$temp['dob']=stripslashes(mysql_real_escape_string($data['dob']));
		
		$temp['sub_caste']=stripslashes(mysql_real_escape_string($data['subcaste']));
		$temp['admission_date']=stripslashes(mysql_real_escape_string($data['doadd']));
		
		
		
		$temp['birth_place']=stripslashes(mysql_real_escape_string($data['pob']));  
		$temp['mobile']=stripslashes(mysql_real_escape_string($data['mobile'])); 
		$temp['email']=stripslashes(mysql_real_escape_string($data['email_id'])); 
		$temp['nationality']=stripslashes(mysql_real_escape_string($data['nationality'])); 
		$temp['category']=stripslashes(mysql_real_escape_string($data['category']));  
		//$temp['sub_caste']=stripslashes(mysql_real_escape_string($data['sub_caste']));  
		$temp['religion']=stripslashes(mysql_real_escape_string($data['religion'])); 
		$temp['adhar_card_no']=stripslashes(mysql_real_escape_string($data['saadhar'])); 
		$temp['domicile_status']=stripslashes(mysql_real_escape_string($data['res_state'])); 
		
		
								$temp['is_defence']=isset($data['defperson']) ? Y : 'N'; 		
		$temp['is_JKMigrant']= isset($data['jk']) ? Y : 'N'; //strtoupper(stripslashes(mysql_real_escape_string($data['slname1']))); 
		
			$temp['physically_handicap']= isset($data['pwd']) ? Y : 'N';
		
			$temp['general_reg_no']=strtoupper(stripslashes(mysql_real_escape_string($data['sgrn']))); 		
		$temp['last_institute']=strtoupper(stripslashes(mysql_real_escape_string($data['linst']))); 
	...
	//	$temp['bording_point']=stripslashes(mysql_real_escape_string($data['bording_point'])); 
      ...
      //	$temp['academic_year']= date('Y');
       $temp['academic_year']= stripslashes(mysql_real_escape_string($data['acyear']));
        $temp['admission_session']= stripslashes(mysql_real_escape_string($data['acyear']));
        
       	$admission_type=stripslashes(mysql_real_escape_string($data['admission_type']));
      ...
      $temp['created_by']= $_SESSION['uid'];
		$temp['father_fname']=strtoupper(stripslashes(mysql_real_escape_string($data['sfname1']))); 		
		$temp['father_mname']=strtoupper(stripslashes(mysql_real_escape_string($data['smname1']))); 		
		$temp['father_lname']=strtoupper(stripslashes(mysql_real_escape_string($data['slname1']))); 
         // student mother name		
		$temp['mother_name']=strtoupper(stripslashes(mysql_real_escape_string($data['sfname2']))); 
		...
		$address['address']=stripslashes(mysql_real_escape_string($data['laddress'])); 
	//	$address['street']=stripslashes(mysql_real_escape_string($data['bill_B'])); 
		$address['city']=stripslashes(mysql_real_escape_string($data['lcity'])); 
		$address['state_id']=stripslashes(mysql_real_escape_string($data['lstate_id'])); 
		$address['district_id']=stripslashes(mysql_real_escape_string($data['ldistrict_id'])); 
		$address['pincode']=stripslashes(mysql_real_escape_string($data['lpincode']));
	...
	//	$insert_id1 = $this->db->insert_id();
		...
		$paddress['address']=stripslashes(mysql_real_escape_string($data['paddress'])); 
	//	$paddress['street']=stripslashes(mysql_real_escape_string($data['bshipping_B'])); 
		$paddress['city']=stripslashes(mysql_real_escape_string($data['pcity'])); 
		$paddress['state_id']=stripslashes(mysql_real_escape_string($data['pstate_id'])); 
		$paddress['district_id']=stripslashes(mysql_real_escape_string($data['pdistrict_id'])); 
		$paddress['pincode']=stripslashes(mysql_real_escape_string($data['ppincode']));
	    ...
	    $gpaddress['student_id']=$insert_id1;
	 		$gpaddress['address']=stripslashes(mysql_real_escape_string($data['gparent_address'])); 
	//	$paddress['street']=stripslashes(mysql_real_escape_string($data['bshipping_B'])); 
		$gpaddress['city']=stripslashes(mysql_real_escape_string($data['gcity'])); 
		$gpaddress['state_id']=stripslashes(mysql_real_escape_string($data['gstate_id'])); 
		$gpaddress['district_id']=stripslashes(mysql_real_escape_string($data['gdistrict_id'])); 
		$gpaddress['pincode']=stripslashes(mysql_real_escape_string($data['gpincode']));
	 ...
	 $guardian['student_id']=stripcslashes($insert_id1);
		...
		$guardian['gfirst_name']=strtoupper(stripslashes(mysql_real_escape_string($data['fname']))); 
		$guardian['gmiddle_name']=strtoupper(stripslashes(mysql_real_escape_string($data['mname']))); 
		$guardian['glast_name']=strtoupper(stripslashes(mysql_real_escape_string($data['lname']))); 
		$guardian['relation']=stripslashes(mysql_real_escape_string($data['relationship'])); 
		$guardian['occupation']=stripslashes(mysql_real_escape_string($data['occupation'])); 
		$guardian['income']=stripslashes(mysql_real_escape_string($data['annual_income'])); 
		$guardian['parent_email']=stripslashes(mysql_real_escape_string($data['parent_email'])); 
		$guardian['parent_mobile2']=stripslashes(mysql_real_escape_string($data['parent_mobile'])); 
		$guardian['parent_mobile1']=stripslashes(mysql_real_escape_string($data['parent_phone'])); 
	       	  ...
	       	  $feedet['student_id']=$insert_id1;
	    	          $feedet['amount']=$data['totalfeepaid'];
	    	            ...
	    	            $feedet['fees_paid_type']=$data['payment_type'];
	    	             $feedet['academic_year']= stripslashes(mysql_real_escape_string($data['acyear']));
	 			...
	 			$sbank['bank_city']=$data['bank_branch'];
	    	       	...
	    	       	if($data['exepmted_fee']>0)
	    	       	{
	    	       	 ...
	    	       	 $fcdetails['student_id']=$insert_id1;
	    	       	    $fcdetails['academic_year']=stripslashes(mysql_real_escape_string($data['acyear']));
      ...
      $fcdetails['created_by']= $_SESSION['uid'];
	    	         //   $fcdetails['fees_paid_type']=$data['payment_type'];
	    	       	 ...
	    	       	 $admdetails['student_id']=$insert_id1;
	    	       	    ...
	    	       	    $admdetails['stream_id']=stripslashes(mysql_real_escape_string($data['admission-branch']));
       ...
       else
       {
          	$admdetails['year']='2';     
	    	       	   ...
	    	       	   // $admdetails['year']=date('Y');
	    	       	    $admdetails['academic_year']= stripslashes(mysql_real_escape_string($data['acyear']));
...
/*
      ...
      $admdetails['created_by']= $_SESSION['uid'];
	    	       ...
	    	       //	echo $DB1->last_query();
	    	       	...
	    	       	$fidetails['fees_id']=$insert_feid1;
	    	       	  	 $fidetails['academic_year']= stripslashes(mysql_real_escape_string($data['acyear']));
	...
	/*	$res2=$this->db->insert('personal_details',$address);
		...
		/*	$stid=$data['reg_id'];
		$edu['student_id']=stripslashes(mysql_real_escape_string($data['reg_id']));
		$edu['qexam_name']=stripslashes(mysql_real_escape_string($data['qexam']));
		$edu['qexam_pyear']=stripslashes(mysql_real_escape_string($data['pyexam']));
		$edu['qexam_colleg']=stripslashes(mysql_real_escape_string($data['cexam']));
		$edu['adm_basis']=stripslashes(mysql_real_escape_string($data['admission_basis']));
		$edu['qexam_roll']=stripslashes(mysql_real_escape_string($data['roll_exam']));
		$edu['qexam_rank']=stripslashes(mysql_real_escape_string($data['exam_rank']));
		$edu['hscpass_date']=stripslashes(mysql_real_escape_string($data['hscpass_date']));
		$edu['htotal_phy']=stripslashes(mysql_real_escape_string($data['thsc_phy']));
		$edu['htotal_chem']=stripslashes(mysql_real_escape_string($data['thsc_chem']));
		$edu['htotal_bio']=stripslashes(mysql_real_escape_string($data['thsc_bio']));
		$edu['htotal_eng']=stripslashes(mysql_real_escape_string($data['thsc_eng']));
		$edu['hobt_phy']=stripslashes(mysql_real_escape_string($data['ohsc_phy']));
		$edu['hobt_chem']=stripslashes(mysql_real_escape_string($data['ohsc_chem']));
		$edu['hobt_bio']=stripslashes(mysql_real_escape_string($data['ohsc_bio']));
		$edu['hobt_eng']=stripslashes(mysql_real_escape_string($data['ohsc_eng']));
		$edu['ssc_passing_dt']=stripslashes(mysql_real_escape_string($data['sscpass_date']));
		$edu['stotal_eng']=stripslashes(mysql_real_escape_string($data['tssc_eng']));
		$edu['sobt_eng']=stripslashes(mysql_real_escape_string($data['ossc_eng']));
		*/
		//academic History
	/*	$len=sizeof($data['exam_id'],1);
	
		for($i=0;$i<$len;$i++){
		$academic['student_id']=stripslashes(mysql_real_escape_string($data['reg_id']));
		$academic['exam_id']=stripslashes(mysql_real_escape_string($data['exam_id'][$i]));
		$academic['college_name']=stripslashes(mysql_real_escape_string($data['college_name'][$i]));
		$academic['pass_year']=stripslashes(mysql_real_escape_string($data['pass_year'][$i]));
		$academic['pass_month']=stripslashes(mysql_real_escape_string($data['pass_month'][$i]));
		$academic['seat_no']=stripslashes(mysql_real_escape_string($data['seat_no'][$i]));
		$academic['institute_name']=stripslashes(mysql_real_escape_string($data['institute_name'][$i]));
		$academic['marks_obtained']=stripslashes(mysql_real_escape_string($data['marks_obtained'][$i]));
		$academic['marks_outof']=stripslashes(mysql_real_escape_string($data['marks_outof'][$i]));
		$academic['percentage']=($academic['marks_obtained']/$academic['marks_outof'])*100;// % calulation
		//$academic['percentage']=stripslashes(mysql_real_escape_string($data['percentage'][$i]));
...
/*	exit(0);
	...
	//	echo $DB1->last_query();
		...
		//end
			...
			$temp1['doc_id']=stripslashes(mysql_real_escape_string($temp2['doc_id'][$key]));
			$temp1['doc_applicable']=stripslashes(mysql_real_escape_string($temp2['doc_applicable'][$key]));
			$temp1['ox']=stripslashes(mysql_real_escape_string($temp2['ox'][$key]));
			$temp1['remark']=stripslashes(mysql_real_escape_string($temp2['remark'][$key]));
			$temp1['created_on']=stripslashes(mysql_real_escape_string($temp2['sub_dt'][$key]));
			$temp1['doc_path']=stripslashes(mysql_real_escape_string($temp2['doc_path'][$key]));
...
//	 $stid=$data['reg_id'];	
		...
		$tempx['person_name']=stripslashes(mysql_real_escape_string($data['fref1']));
		$tempx['contact_no']=stripslashes(mysql_real_escape_string($data['frefcont1']));
...
//		echo $DB1->last_query();
		...
		$tempy['person_name']=stripslashes(mysql_real_escape_string($data['fref2']));
		$tempy['contact_no']=stripslashes(mysql_real_escape_string($data['frefcont2']));
		...
		$temp3['person_name']=stripslashes(mysql_real_escape_string($data['relatedname']));
		$temp3['designation']=stripslashes(mysql_real_escape_string($data['relateddesig']));
		$temp3['relation']=stripslashes(mysql_real_escape_string($data['relatedrelation']));
		...
		$temp4['person_name']=stripslashes(mysql_real_escape_string($data['alumininame']));
			$temp4['passing_year']=stripslashes(mysql_real_escape_string($data['aluminiyear']));
		$temp4['relation']=stripslashes(mysql_real_escape_string($data['aluminirelation']));
		...
		$temp49['institute']=stripslashes(mysql_real_escape_string($data['cin']));
		...
		$temp5['person_name']=stripslashes(mysql_real_escape_string($data['relativename']));
		$temp5['course']=stripslashes(mysql_real_escape_string($data['relativecoursenm']));
		$temp5['relation']=stripslashes(mysql_real_escape_string($data['relativerelation']));
	...
	//	$temp['publicity_media']=implode(",",$temp1);//$temp=implode("/ ",$mstatus); 
		...
		$temp6['person_name']=stripslashes(mysql_real_escape_string($data['refcandidatenm']));
		$temp6['contact_no']=stripslashes(mysql_real_escape_string($data['refcandidatecont']));
		$temp6['email']=stripslashes(mysql_real_escape_string($data['refcandidateemail']));
		$temp6['relation']=stripslashes(mysql_real_escape_string($data['refcandidaterelt']));
		$temp6['area_of_interest']=stripslashes(mysql_real_escape_string($data['refcandidateinterest']));
...
//	echo "jugal";
		//total of every
	/*	$temp['totalfeeappli']=stripslashes(mysql_real_escape_string($data['totalfeeappli']));
		$temp['totalfeepaid']=stripslashes(mysql_real_escape_string($data['totalfeepaid']));
		$temp['totalfeebal']=stripslashes(mysql_real_escape_string($data['totalfeebal']));
		//fee paid dd details
		//$temp['paidfee']=stripslashes(mysql_real_escape_string($data['paidfee']));
		$temp['dd_no']=stripslashes(mysql_real_escape_string($data['dd_no']));
		$temp['dd_drawn_date']=stripslashes(mysql_real_escape_string($data['dd_date']));
		$temp['dd_drawn_bank_branch']=stripslashes(mysql_real_escape_string($data['dd_bank']));
		
		//bank details
		$temp['bank_name']=stripslashes(mysql_real_escape_string($data['bank_name']));
		$temp['account_no']=stripslashes(mysql_real_escape_string($data['account_no']));
		$temp['ifsc']=stripslashes(mysql_real_escape_string($data['ifsc']));
		//profile image
		//$temp['profile_img']=$temp['student_id'].'-'.stripslashes(mysql_real_escape_string($data['profile_img']));
...
*/
  ...
  echo"am in step 2 model";
	...
	function registration_step3($data,$arr){
		...
		$stid=$data['reg_id'];
		$temp['student_id']=stripslashes(mysql_real_escape_string($data['reg_id']));
		$temp['doc_id']= $this->rearrange1($data['dapplicable']);//without changing key value sequence
		$temp['doc_applicable']	= $this->rearrange1($data['dapplicable']);
		$temp['ox']	= $this->rearrange1($data['ox']);
		$temp['sub_dt']	= $this->rearrange1($data['docsubdate']);
		...
		for($i=0;$i<$len;$i++){
		$a['student_id']=stripslashes(mysql_real_escape_string($data['reg_id']));
		$a['certificate_name']=	$cert['certificate_name'][$i];
		$a['certificate_no']=	$cert['certificate_no'][$i];
		...
		//end
			...
			foreach($temp2['doc_id'] as $key=>$val){
			$temp1['student_id']=stripslashes(mysql_real_escape_string($data['reg_id']));
			$temp1['doc_id']=stripslashes(mysql_real_escape_string($temp2['doc_id'][$key]));
			$temp1['doc_applicable']=stripslashes(mysql_real_escape_string($temp2['doc_applicable'][$key]));
			$temp1['ox']=stripslashes(mysql_real_escape_string($temp2['ox'][$key]));
			$temp1['remark']=stripslashes(mysql_real_escape_string($temp2['remark'][$key]));
			$temp1['sub_dt']=stripslashes(mysql_real_escape_string($temp2['sub_dt'][$key]));
			$temp1['doc_path']=stripslashes(mysql_real_escape_string($temp2['doc_path'][$key]));
...
if($data['fref1']!='')
{
	$temp['student_id']=$student_id;
		...
		$temp['person_name']=stripslashes(mysql_real_escape_string($data['fref1']));
		$temp['contact_no']=stripslashes(mysql_real_escape_string($data['frefcont1']));
...
if($data['fref2']!='')
{
		...
		$temp2['person_name']=stripslashes(mysql_real_escape_string($data['fref2']));
		$temp2['contact_no']=stripslashes(mysql_real_escape_string($data['frefcont2']));
...
{	
	...
	//	exit();
		...
		$temp5['is_uni_student']='Y';
		$temp5['person_name']=stripslashes(mysql_real_escape_string($data['relativename']));
		$temp5['course_name']=stripslashes(mysql_real_escape_string($data['relativecoursenm']));
		$temp5['relation']=stripslashes(mysql_real_escape_string($data['relativerelation']));
		$DB1->insert('student_references',$temp5);	
	//	echo $DB1->last_query();
}
...
/*if (!mkdir($structure, 0777, true)) {
  //  die('Failed to create folders...');
	...
	//	$temp['admission_stream']=stripslashes(mysql_real_escape_string($data['admission-branch'])); 	
		...
		$temp['religion']=stripslashes(mysql_real_escape_string($data['religion'])); 
		$temp['adhar_card_no']=stripslashes(mysql_real_escape_string($data['saadhar'])); 
		$temp['passport_no']=stripslashes(mysql_real_escape_string($data['passport_no']));
		$temp['visa_no']=stripslashes(mysql_real_escape_string($data['visa_no']));
		$temp['domicile_status']=stripslashes(mysql_real_escape_string($data['res_state'])); 
		...
		$temp['last_institute']=strtoupper(stripslashes(mysql_real_escape_string($data['linst']))); 
		   	...
		   	$temp['academic_year']= strtoupper(stripslashes(mysql_real_escape_string($data['acyear'])));;
	...
	function reregistration_details($data){
		...
		if($data['isdetained']=='Y') 
	    {
			...
			//	$temp['about_uni_know']=implode(",",$data['publicitysandip']);//$temp=implode("/ ",$mstatus); 
			   	...
			   	$temp['academic_year']= stripslashes(mysql_real_escape_string($data['hacyear'])) + 1;

				$temp['current_year']=stripslashes(mysql_real_escape_string($data['hcyear']));

				$temp['current_semester']=stripslashes(mysql_real_escape_string($data['hcsem']));
			...
			$admdetails['hostel_required']=$data['hostel'];
			   ...
			   $neacyearj =	$admdetails['academic_year']=stripslashes(mysql_real_escape_string($data['hacyear'])) + 1;

				$admdetails['year']=stripslashes(mysql_real_escape_string($data['hcyear']));
				/*$admdetails['actual_fee']=stripslashes(mysql_real_escape_string($data['acd_totalfee'])) ;
				 	$admdetails['applicable_fee']=stripslashes(mysql_real_escape_string($data['acd_totalfee'])) ;*/
				 	$admdetails['actual_fee']='0' ;
				 	$admdetails['applicable_fee']='0' ;
				 		$admdetails['opening_balance']=stripslashes(mysql_real_escape_string($data['open_bal'])) ;
				 	
			//	$temp['current_semester']=strtoupper(stripslashes(mysql_real_escape_string($data['hcsem']))) + 2;
				       	    //  $admdetails['entry_from_ip']=$_SERVER['REMOTE_ADDR'];
				       	      //	  $admdetails['allowed_by']='Admin';
				            $admdetails['created_on']= date('Y-m-d H:i:s');
			$admdetails['created_by']= $_SESSION['uid'];
			$admdetails['form_number']= stripslashes(mysql_real_escape_string($data['sfnumber']));
			$admdetails['enrollment_no']= stripslashes(mysql_real_escape_string($data['henroll']));
			$admdetails['school_code']= stripslashes(mysql_real_escape_string($data['hschool']));
			$admdetails['stream_id']= stripslashes(mysql_real_escape_string($data['hstream']));
			$admdetails['entry_from_ip']= $_SERVER['REMOTE_ADDR'];
			...
			$sem=mysql_real_escape_string($data['hcsem']);
			$isactic['is_active']='N';
	    ...
	    else
	    {
			...
			//	$temp['admission_school']=$this->Ums_admission_model->getschool_bycourse($data['admission-course']); 	
			//course
			//	$temp['form_number']=stripslashes(mysql_real_escape_string($data['sfnumber']));
			//	$temp['admission_stream']=stripslashes(mysql_real_escape_string($data['admission-branch'])); 	
			//student name
			$temp['first_name']=strtoupper(stripslashes(mysql_real_escape_string($data['sfname']))); 		
			$temp['middle_name']=strtoupper(stripslashes(mysql_real_escape_string($data['smname']))); 		
			...
			//	$temp['about_uni_know']=implode(",",$data['publicitysandip']);//$temp=implode("/ ",$mstatus); 
	       	...
	       	$temp['current_year']=stripslashes(mysql_real_escape_string($data['hcyear'])) + 1;
	     
	        	$temp['current_semester']=stripslashes(mysql_real_escape_string($data['hcsem'])) + 1;
	  ...
	  //    $temp['entry_from_ip']= $_SERVER['REMOTE_ADDR'];
		...
		$admdetails['transport_boarding_point']=$data['bording_point'];
	       	...
	       	$admdetails['year']=stripslashes(mysql_real_escape_string($data['hcyear'])) + 1;
	      	$admdetails['actual_fee']=stripslashes(mysql_real_escape_string($data['acd_totalfee'])) ;
		/////////////////////////////////////////////////////////////////////////////////////////////////////	
			 $DB1->select("concession_type,student_id,enrollement_no,actual_fees,exepmted_fees,duration,concession_remark");
			 $DB1->from("fees_consession_details");
			 $DB1->where("student_id",$student_id);
			 $DB1->where("academic_year",$data['hacyear']);
			...
			$admdetails['applicable_fee']=stripslashes(mysql_real_escape_string($fees_paid_required));
			$admdetails['fees_consession_allowed']='Y';
   ...
   $DB1->delete('student_document_details');
	...
	function update_stepfourthdata($id,$data){
		echo"in 4th update";
		 ...
		 $stid=$data['reg_id'];		
		$temp['student_id']=stripslashes(mysql_real_escape_string($data['reg_id']));
		$temp['for_stud_refer_name1']=stripslashes(mysql_real_escape_string($data['fref1']));
		$temp['for_stud_refer_cont1']=stripslashes(mysql_real_escape_string($data['frefcont1']));
		$temp['for_stud_refer_name2']=stripslashes(mysql_real_escape_string($data['fref2']));
		$temp['for_stud_refer_cont2']=stripslashes(mysql_real_escape_string($data['frefcont2']));
		$temp['ex_emp_rel']=stripslashes(mysql_real_escape_string($data['reletedsandip']));
		$temp['ex_emp_rname']=stripslashes(mysql_real_escape_string($data['relatedname']));
		$temp['ex_emp_rdesig']=stripslashes(mysql_real_escape_string($data['relateddesig']));
		$temp['ex_emp_relat']=stripslashes(mysql_real_escape_string($data['relatedrelation']));
		$temp['alumini_rel']=stripslashes(mysql_real_escape_string($data['aluminisandip']));
		$temp['alumini_rel_name']=stripslashes(mysql_real_escape_string($data['alumininame']));
		$temp['alumini_rel_passyear']=stripslashes(mysql_real_escape_string($data['aluminiyear']));
		$temp['alumini_relat']=stripslashes(mysql_real_escape_string($data['aluminirelation']));
		$temp['rel_stud_san']=stripslashes(mysql_real_escape_string($data['relativesandip']));
		$temp['rel_stud_san_name']=stripslashes(mysql_real_escape_string($data['relativename']));
		$temp['rel_stud_san_course']=stripslashes(mysql_real_escape_string($data['relativecoursenm']));
		$temp['rel_stud_san_relat']=stripslashes(mysql_real_escape_string($data['relativerelation']));
		//publicity_media
		$temp1=array();
		$temp1=$data['publicitysandip'];
		$temp['publicity_media']=implode(",",$temp1);//$temp=implode("/ ",$mstatus); 
		$temp['ref_bystud_name']=stripslashes(mysql_real_escape_string($data['refcandidatenm']));
		$temp['ref_bystud_cont']=stripslashes(mysql_real_escape_string($data['refcandidatecont']));
		$temp['ref_bystud_email']=stripslashes(mysql_real_escape_string($data['refcandidateemail']));
		$temp['ref_bystud_relat']=stripslashes(mysql_real_escape_string($data['refcandidaterelt']));
		$temp['ref_bystud_area']=stripslashes(mysql_real_escape_string($data['refcandidateinterest']));
	...
	function update_stepfifthdata($id,$data,$prof_img){
		...
		$temp['student_id']=stripslashes(mysql_real_escape_string($data['reg_id']));
		//applicable fee
		$temp['formfeeappli']=stripslashes(mysql_real_escape_string($data['formfeeappli']));
		$temp['formfeepaid']=stripslashes(mysql_real_escape_string($data['formfeepaid']));
		$temp['formfeebal']=stripslashes(mysql_real_escape_string($data['formfeebal']));
		//tution fee
		$temp['tutionfeeappli']=stripslashes(mysql_real_escape_string($data['tutionfeeappli']));
		$temp['tutionfeepaid']=stripslashes(mysql_real_escape_string($data['tutionfeepaid']));
		$temp['tutionfeebal']=stripslashes(mysql_real_escape_string($data['tutionfeebal']));
		//other fee
		$temp['otherfeeappli']=stripslashes(mysql_real_escape_string($data['otherfeeappli']));
		$temp['otherfeepaid']=stripslashes(mysql_real_escape_string($data['otherfeepaid']));
		$temp['otherfeebal']=stripslashes(mysql_real_escape_string($data['otherfeebal']));
		//total of every
		$temp['totalfeeappli']=stripslashes(mysql_real_escape_string($data['totalfeeappli']));
		$temp['totalfeepaid']=stripslashes(mysql_real_escape_string($data['totalfeepaid']));
		$temp['totalfeebal']=stripslashes(mysql_real_escape_string($data['totalfeebal']));
    ...
    function fetch_personal_details($stud_id){
		...
		$DB1->select("sm.*,u.username,u.password,stm.stream_name, stm.course_name,stm.course_id,stm.stream_code,stm.course_short_name,sc.docuemnt_confirm,stm.stream_id");
		$DB1->from('student_master as sm');
