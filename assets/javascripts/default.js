...
function getstaffdept_using_school(school_id,department){
//alert(department);
 var post_data=schoolid='';
	var schoolid=school_id;
           if(school_id!=null){

				post_data+="&school_id="+schoolid+"&department="+department;
...
//
function getEmp_using_dept_forbasic_salary_allocation(dept_id){
	//alert('hooooo');
var e = document.getElementById("reporting_school");
var school_id = e.options[e.selectedIndex].value;
var post_data='';
...
jQuery.ajax({
				type: "POST",
				url: base_url+"staff_payment/getEmpListDepartmentSchoolForBasicSalary",
				data: encodeURI(post_data),
				success: function(data){
					//alert(data);
				$('#reporting_person').html(data);
...
///
//for mareked manual attendance
function getMarked_Emp_Manual_Attendance(dept_id){
	//alert('hooooo');
var e = document.getElementById("reporting_school");
var school_id = e.options[e.selectedIndex].value;
var post_data='';
...
jQuery.ajax({
				type: "POST",
				url: base_url+"admin/getEmpListMarked_Emp_Manual",
				data: encodeURI(post_data),
				success: function(data){
					//alert(data);
				$('#reporting_person').html(data);
...
jQuery.ajax({
				...
				success: function(data){
					//alert(data);
					$('#oddiv').css('display','block');
				$('#emp-table-od').html(data);
         		}	
			});

}
function getEmp_using_deptforwfh(dept_id){
var e = document.getElementById("reporting_school_od");
var lfrmdt= $("#dob-datepicker4").val();
var ltodt= $("#dob-datepicker5").val();
var school_id = e.options[e.selectedIndex].value;
var post_data='';
if(school_id!=null && dept_id!=null){
...
jQuery.ajax({
				...
				success: function(data){
					//alert(data);
					$('#wfhdiv').css('display','block');
				$('#emp-table-wfh').html(data);
         		}	
			});
