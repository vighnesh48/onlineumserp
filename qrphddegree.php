<?php
if(isset($_GET['wo']) || isset($_GET['id'])){
...
//'qrcode_'.$prn.'.png'
	// $file = 'chpdf/output1.pdf';
	 $filename ="https://sandipuniversity.com/erp/uploads/degree/".$exam_month."/".$exam_year."/".$prn."_degree_certificate.pdf";
	  ...
	  header("Location: https://erp.sandipuniversity.com/login/phd_view_degree_certificate/$prn");
	 }else{
		 //header('http://sandipuniversity.com/erp/certificate/160106071002');
		 header("Location: https://sandipuniversity.com/erp/login/view/160106061002");
	 }
}
else
echo "Invalid link";	
