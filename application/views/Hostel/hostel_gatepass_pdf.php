...
.details td {border:1px solid #CCC;}
.border{border:1px solid #ccc;}

.table td th {padding:10px!important;}
</style>
</head>
<body>
<?php
...
?>
  <br><br>  
<div style="width:85%;xheight:842px;margin:0 auto;border:1px solid #000;padding:7px 10px;">
 
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-size:12px;xheight:415px">
    <tr>
      <td style="border-bottom:1px solid #000;padding-bottom:10px"><strong>App. No :</strong><?=$std_gatepass_details['hgp_id']?><br />
        <img style="padding-top:5px;" src="<?=base_url()?>uploads/gatepass/<?=$form_no?>.jpg" alt="Sandip Foundation" /></td>
      <td valign="top" align="center" style="border-bottom:1px solid #000" width="60%"><img src="<?=base_url()?>header-logo.png" style="width:200px">
        <p><strong>Phone:</strong>(02594) 222 541, 42, 43, 44, 45 | <strong>Fax:</strong>(02594) 222 555</p></td>
      <td align="center" style="border-bottom:1px solid #000;padding-bottom:10px"><strong>Student Copy</strong></td>
    </tr>
    
<tr >
<td colspan="3" align="left" width="100%">
<table width="40%"  cellspacing="2" cellpadding="30" align="center" class="details table" style="margin-top:10px" >
<tr>
      <td><span style="border:1px solid #000;padding:5px 15px!important;"><?=$std_gatepass_details['hostel_code']?>/<?=$std_gatepass_details['floor_no']?>/<?=$std_gatepass_details['room_no']?></span></td>
      <td align="center" width="300"><h2><strong>Gate Pass</strong></h2></td>
      <td align="right"><?=date("d/m/Y", strtotime($std_gatepass_details['added_on']))?></td>
    </tr>
    <tr>
...
<tr>  <td width="250"><strong>Going To:</strong> <?=$std_gatepass_details['type']?></td>
  ...
  vertical-align: bottom;"><strong>Signature of Student</strong></td>
      <td align="center" style="height: 50px;
  vertical-align: bottom;"><strong>Signature of In-charge</strong></td>
      <td align="center" style="height: 50px;
  vertical-align: bottom;"><strong>Printed on:</strong> <?=date('d/m/Y')?></td>
    </tr>
</table>
  ...
  <hr style="border:dotted 1px #000" />
   <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-size:12px;xheight:415px">
    <tr>
      ...
      <td valign="top" align="center" style="border-bottom:1px solid #000" width="60%"><img src="<?=base_url()?>header-logo.png" style="width:200px">
        <p><strong>Phone:</strong>(02594) 222 541, 42, 43, 44, 45 | <strong>Fax:</strong>(02594) 222 555</p></td>
      <td align="center" style="border-bottom:1px solid #000;padding-bottom:10px"><strong>Hostel Copy</strong></td>
    </tr>
