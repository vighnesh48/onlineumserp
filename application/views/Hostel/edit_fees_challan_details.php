...
function challan_status_new(m){
	var challan_status=m.value;
	if(challan_status=='PD')
	{
		$("#display").show();
		$("#Cancelled").hide();
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-5 text-ctext-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;View challan </h1>            
        </div>
                   ...
                   <form id="form" name="form" action="<?=base_url($currentModule.'/edit_fees_challan_submit/'.$challan_details['fees_id'])?>" method="POST" >
                            ...
                            <div class="panel-body">
							  ...
							  <div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Course:</label>
									 ...
									 <span id="course" name="course">
									 
									 <?php 
									 if($challan_details['admission_stream'] !=0){
										echo $challan_details['course_name'];
									 }else{
										echo $challan_details['sfstream']; 
									 }	 
									 ?>
							  ...
							  <div class="form-group">
                                <label class="col-md-5" style="padding-left:0px;">Academic Year:</label>
							...
							for($i=1;$i<=4;$i++)
							{
							   if($yyyy==$challan_details['academic_year'])
								{
										?> 
										<input type="hidden" class="form-control numbersOnly" name="academic" id="academic" value="<?=$yyyy?>" />
										
										  <input type="text" class="form-control numbersOnly" readonly name="academicyear" id="academicyear" value="<?=$yyyy.'-'.$yy?>" />
										<?php 
								}						   
							   $yyyy--;$yy--;
							}
							?>
							  ...
							  <div class="form-group">
                                <label class="col-md-5" style="padding-left:0px;">Facility Type:</label>
                                <div class="col-md-5"  style="padding-left:0px;">
									...
									if(!empty($facility_details)){
										...
										{
										?> 
										  <input type="hidden" class="form-control numbersOnly" name="facilty" id="facilty" value="<?=$facility['faci_id']?>" />
										  
										  <input type="text" class="form-control numbersOnly" readonly name="facilty_type" id="facilty_type" value="<?=$facility['facility_name']?>" />
										<?php 
											}
						...
						<div class="panel" id="fee_details">
                            ...
                            <div class="panel-body">
                              ...
                              <?php } ?>
							  <div class="form-group">
                                <label class="col-md-5">Gym Fee:</label>
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly" value="<?=$challan_details['gym_fees']?>" name="gymfee" id="gymfee" readonly/>
                                </div>
                                
                              </div>
							  <div class="form-group">
                                <label class="col-md-5">Fine Fee:</label>
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly" value="<?=$challan_details['fine_fees']?>" name="finefee" id="finefee" readonly />
                                </div>
                                
                              </div>
                              <div class="form-group">
								<label class="col-md-5" >Other Fee:</label>
                                             <div class="col-md-6" >
											 <input type="text" class="form-control numbersOnly" name="other" id="other" readonly value="<?=$challan_details['other_fees']?>" />								   
										   </div>			 
									  </div>  
										<div class="form-group">
									  ...
									  <div id="non_cash" style="display:none;">
										...
										<label class="col-md-5" id="receipt"></label>
											<div class="col-md-6" >
											<input type="text" class="form-control"  name="receipt_number" readonly id="receipt_number" value="<?=$challan_details['receipt_no']?>" />
										</div>
										</div>
							...
							<div class="form-group">
                                ...
                                <div class="col-md-6">
                                <textarea name="Remark" id="Remark" ><?=$challan_details['remark']?></textarea>
							...
							<div class="form-group">
								...
								<div class="col-md-6" >
									<select name="challan_status" id="challan_status" class="form-control" onchange="challan_status_new(this)">
										<option value="">Select Action</option>
									<option value="VR" <?php if($challan_details['challan_status']=="VR"){?> selected<?php }?> >Deposited</option>
									<option value="CL" <?php if($challan_details['challan_status']=="CL"){?> selected<?php }?> >Cancelled</option>
									</select>	
								   </div>
                           ...
                           <div id="Cancelled" style="display:none">
							  <div class="form-group">
								<label class="col-md-5">Cancelled Charge:<?=$astrik?></label>
								<div class="col-md-6" >
									<input type="text" class="form-control numbersOnly"  name="canc_charges"  id="canc_charges" value="" />
								   </div>
								
							  </div> 

							   <div class="form-group">
								<label class="col-md-5">Remark:<?=$astrik?></label>
								<div class="col-md-6" >
							...
							<div class="form-group">
                                ...
                                <div class=" col-md-4">
                                  <button type="submit" id="display" class="btn btn-primary form-control" >Submit</button>
                                   ...
                                   <div class="col-sm-4"><button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url($currentModule)?>/fees_challan_list'">Cancel</button></div>
