								...
								<div class="form-group">
									...
									<label>Select Hostel Type: <?=$astrik?></label>
                                        <select id="hostel_ctype" name="hostel_ctype" class="form-control" >
                                            ...
                                            <option value="Type_I" <?php if($hostel_details['hostel_ctype']=="Type_I"){?> selected="selected"<?php }?>>Type I</option>
                                             <option value="Type_II" <?php if($hostel_details['hostel_ctype']=="Type_II"){?> selected="selected"<?php }?>>Type II</option>
                                             <option value="Type_III" <?php if($hostel_details['hostel_ctype']=="Type_III"){?> selected="selected"<?php }?>>Type III</option>
                                        </select>   
										<span style="color:red;"><?php echo form_error('hostel_type');?></span>										
                                    </div>
                                    <div class="col-sm-4">
									<label>Enter Hostel Name: <?=$astrik?></label>
									<input type="text" id="hostel_name" name="hostel_name" class="form-control" value="<?=$hostel_details['hostel_name']?>" placeholder="Enter Hostel Name"  />
									<span style="color:red;"><?php echo form_error('hostel_name');?></span>
									</div>                                    
                                   
                                    <div class="col-sm-4">
									<label>Enter Hostel Code: <?=$astrik?></label>
									<input type="text" id="hostel_code" onchange="check_exists()"  value="<?=$hostel_details['hostel_code']?>" name="hostel_code" class="form-control" placeholder="Enter Hostelcode"  readonly="readonly" />
