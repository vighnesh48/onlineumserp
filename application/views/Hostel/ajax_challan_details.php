...
<table class="table table-bordered" id="search-table" style="width:100%;max-width:100%;">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr>
                                ...
                                <td><?=$challan_details[$i]['gender'];?></td>
								 <td><?php if($challan_details[$i]['exam_session']!=''){ echo $challan_details[$i]['exam_session'];}else{ echo $challan_details[$i]['receipt_no'];}?></td>
                                <!--td><?php  echo date('d-m-Y',strtotime($challan_details[$i]['created_on'])); ?></td-->
                                <td><?php  echo $challan_details[$i]['created_on']; ?></td>
