   ...
   if($this->session->userdata('role_id')!='4')
    ...
    <td width="33%" valign="top">
        ...
        <tr>
          ...
          <td colspan=""><strong>Client Id :</strong><?=$std_challan_details['client_id']?></td>
		  ...
		  if($std_challan_details['admission_stream'] !=0){			  
			  if(!empty($std_challan_details['course_name']) && ($std_challan_details['course_name']=='12th' || $std_challan_details['course_name']=='11th')){
				echo $std_challan_details['course_name'];   
				  ...
				  else if($std_challan_details['current_year']==2)echo 'Second year'; else if($std_challan_details['current_year']==3) echo 'Third year';else echo $std_challan_details['current_year'];
			  }
		  }else{
        ...
        <tr>
		<td ><strong>Student ID :</strong> <?=$std_challan_details['enrollment_no']?></td><td> <?=$std_challan_details['enrollment_no_new']?></td>
		</tr>
      ...
      <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
		...
		<tr>
          ...
          <td>Deposit Fee</td>
          <td><?=$std_challan_details['deposit_fees']?></td>
        </tr>
		<tr>
          <td align="center">3</td>
          <td>Gym fee</td>
          <td><?=$std_challan_details['gym_fees']?></td>
        </tr>
		<tr>
      ...
      <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
        ...
        <tr>
          <td height="16" colspan="3"><strong>Remark :</strong><?=($std_challan_details['remark'])?></td>
        </tr>
      </table>
	  <?php
	  }
      ...
      <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
        ...
        <tr>
          <td colspan="2" height="80" valign="top">IMPORTANT INSTRUCTION TO <?=$std_challan_details['bank_name']?> BRANCH :</td>
        </tr>
        <tr>
