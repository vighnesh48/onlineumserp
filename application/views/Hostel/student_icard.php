...
<td valign="top">
    ...
    ?>
    <img src="<?=$imageData ?>" alt="" width="40"/>
</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
<td><font size="12">Floor</font></td>
<td><font size="12"><strong>: <?php if($ids[$i]['floor_no']==0)echo 'Ground';else echo $ids[$i]['floor_no'];?></strong></font></td>
</tr>
<tr>
<td><font size="12">Room</font></td>
<td><font size="12"><strong>: <?=$ids[$i]['room_no']?></strong></font></td>
</tr>
<tr>
<td><font size="12">Hostel </font></td>
<td><font size="12"><strong>: <?=$ids[$i]['hostel_code']?></strong></font></td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
<td valign="top" width="100%" align="center" style="border-right:1px dotted #000;border-bottom:1px dotted #000;">Parents/Guardian Contact No.<br>+91 <?=$ids[$i]['parent_mobile1']?></td>
