...
function check_beds(id,id_num)
{
	...
	else if(noof_beds>24)
	{$('#'+id).val(24);$('#err_msg').html('<span style="color:red;" > Maximum you can enter only 24 beds!!</span>');}
	else
