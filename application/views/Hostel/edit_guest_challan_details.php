    ...
    <div class="page-header">			
        ...
        <div class="row ">
            <div class="col-sm-12">
                   ...
                   <form id="form" name="form" action="<?=base_url($currentModule.'/edit_guest_challan_submit/'.$challan_details['fees_id'])?>" method="POST" >
                            ...
                            <div class="panel-body">
                              ...
                              <div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Challan No:</label>
									 ...
									 <input type="hidden"  id="online_payment_id" name="online_payment_id" value="<?=$challan_details['online_payment_id'];?>"/>
									 <span id="prnno" name="prnno"> <?=$challan_details['exam_session']?></span>								   
								   </div>			 
							  </div>
								<div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Name:</label>
									 <div class="col-md-8" style="padding-left:20px;" >
									  <span id="std_name" name="std_name"><?=$challan_details['guest_name']?> </span>								   
								   </div>			 
							  </div>
							  ...
							  <div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Mobile:</label>
									 <div class="col-md-7"  style="padding-left:20px;">
									 <span id="organisation" name="organisation"><?=$challan_details['mobile']?></span>								   
								   </div>			 
							  </div>
							  <div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Institute:</label>
									 <div class="col-md-7"  style="padding-left:20px;">
									 <span id="organisation" name="organisation"><?=$challan_details['organisation']?></span>								   
								   </div>			 
							  </div>
							  <div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Year:</label>
									 <div class="col-md-7"  style="padding-left:20px;">
									 
									 <span id="current_year" name="current_year"><?=$challan_details['academic_year']?></span>								   
								   </div>			 
							  </div>
							  <div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Mobile:</label>
						...
						<div class="panel" id="fee_details" ">
                            ...
                            <div class="panel-body">
								<div class="form-group">
                                <label class="col-md-5">Accomodation charges:</label>
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly" value="<?=$challan_details['accomodation_charges']?>" name="accomodation_charges" id="accomodation_charges" readonly />
                                </div>
                                
                              </div>
							  <div class="form-group">
                                <label class="col-md-5">Cricket ground charges:</label>
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly" value="<?=$challan_details['cricket_ground_charges']?>" name="cricket_ground_charges" id="cricket_ground_charges" readonly />
                                </div>
							...
							<div class="form-group">
                                ...
                                <div class=" col-md-4">
                                  <button type="submit" id="display" class="btn btn-primary form-control" >Submit</button>
                                   ...
                                   <div class="col-sm-4"><button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url($currentModule)?>/guest_challan_list'">Cancel</button></div>
