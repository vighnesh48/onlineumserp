                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/add_faci_submit')?>" method="POST" onsubmit="return validate_faci_category(event)">                                                               
								...
								<div class="form-group">
                                    <label class="col-sm-3">Hostel sub Type</label>                                    
                                    <div class="col-sm-4">
...
function check_facility_exists()
{
	...
	var hostel_ctype=$('#hostel_ctype').val();
	if(academic=="")
	{
	...
	else
	{
		...
		$.ajax({
				...
				data: {academic:academic,faci_id:faci_id,category:category,hostel_ctype:hostel_ctype},
