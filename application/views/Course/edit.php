                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                <input type="hidden" value="<?=isset($course_details['course_id'])?$course_details['course_id']:""?>" id="course_id" name="course_id" />
                                <div class="form-group">
                                    <label class="col-sm-3">Course Code <?=$astrik?></label>                                    
                                    <div class="col-sm-6"><input type="text" id="course_code" name="course_code" class="form-control" value="<?=isset($course_details['course_short_name'])?$course_details['course_short_name']:''?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="course_code" name="course_name" class="form-control" value="<?=isset($course_details['course_name'])?$course_details['course_name']:''?>" /></div>                                    
                             ...
                             <!--    <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select id="course_type" name="course_type" class="form-control">
                                            ...
                                            <option <?=$course_details['course_type']=="E"?"selected='selected'":""?> value="E">Engineering</option>
                                            <option <?=$course_details['course_type']=="M"?"selected='selected'":""?> value="M">Management</option>
                                            <option <?=$course_details['course_type']=="P"?"selected='selected'":""?> value="P">Polytechnic</option>
                                            <option <?=$course_details['course_type']=="PH"?"selected='selected'":""?> value="PH">Pharmacy</option>
                                        </select>
                                    </div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select id="duration" name="duration" class="form-control">
                                            <option value="">Select Type</option>
                                            <?php for($i=1;$i<=10;$i++) {?>
                                            <option <?=$course_details['duration']==$i?"selected='selected'":""?> value="<?=$i?>"><?=$i." Yrs "?></option>
                                            <?php } ?>
                                        </select>
                                    </div>                                    
                                    <div class="col-sm-3"><span style="color:red;"><?php echo form_error('course_type');?></span></div>
