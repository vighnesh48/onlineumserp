...
tr:nth-child(even) {
  ...
  <tr>
    ...
    <p style="margin-top:0"><strong>Mahiravani, Trimbak Road, Nashik – 422 213,</strong><br> 
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"  class="table time-table table-striped table-bordered" align="center" >
    	<tbody>
       <tr>
            <th align="center"><span style="">Day / Time</span></th>
			<?php
	   ...
	   <?php
			...
			?>
			<tr  style="font-size:10px !important;"<?=$slot[$i]["status"]=="N"?"style=''":""?>>
				<td align="center"  style="font-size:10px !important;"><strong><?=$wday[$l]?></strong></td>
				...
				//echo count($ttsub);
					...
					for($j=0;$j<count($ttsub);$j++){
						...
						?>
							...
							?>
							<td <?=$bkth_color?> style="font-size:10px !important;">
							...
							elseif($ttsub[$l][$j][$k]['subject_type']=='PR'){
								...
								?>
								<td colspan="<?=$colspan?>" style="font-size:10px !important;" <?=$bkpr_color?>>
							...
							?>	
							<td colspan="1" style="font-size:10px !important;" <?=$bk_color?>>
