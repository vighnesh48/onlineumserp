...
<?php
    ...
    //echo "<pre>";print_r($caste_details); echo "</pre>";
?>
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        <div class="breadcrumb-label text-light-gray">You are here: </div>
        <li><a href="#">Masters</a></li>
        <li class="active"><a href="#">Edit Caste</a></li>
    </ul>
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                <input type="hidden" value="<?=isset($caste_details['caste_id'])?$caste_details['caste_id']:""?>" id="caste_id" name="caste_id" />
                                <div class="form-group">
                                    <label class="col-sm-3">Caste Code <?=$astrik?></label>                                    
                                    <div class="col-sm-6"><input type="text" id="caste_code" name="caste_code" class="form-control" value="<?=isset($caste_details['caste_code'])?$caste_details['caste_code']:''?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="caste_code" name="caste_name" class="form-control" value="<?=isset($caste_details['caste_name'])?$caste_details['caste_name']:''?>" /></div>                                    
