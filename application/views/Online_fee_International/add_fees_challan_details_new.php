...
$(document).ready(function(){
    ...
    $('#sbutton').click(function()
	{
		...
		{  
			$.ajax({
				'url' : base_url + 'Online_fee_international/students_data',
				...
				'success' : function(data){ //probably this request will return anything, it'll be put in var "data"
					...
					if(data != "{\"std_details\":null}")
					{
						...
						$('#prnno').html(array.std_details.registration_no);
						$('#enroll').val(array.std_details.registration_no);
						$('#student_id').val(array.std_details.student_id);
						$('#curr_yr').val(array.std_details.academic_year);
						$('#admission_session').val(array.std_details.academic_year);
						$('#std_name').html(array.std_details.firstname);
						...
						$('#name').val(array.std_details.firstname);
						$('#institute').html('');
						$('#mobile1').html(array.std_details.phone);
						$('#mbl').val(array.std_details.phone);
						...
						$('#cyear').val(array.std_details.academic_year);
						$('#current_year').html('1');
						$('#academic_year').val(array.std_details.academic_year);
						$('#admission_year').val(array.std_details.academic_year);
...
function faci_type(){
	...
	if(academic!='' && facility!=''){
		...
		//$("#form").trigger("reset");
		type='POST',url='<?= base_url() ?>Online_fee_international/get_fee_details_new',datastring={academic:academic,facility:facility,enroll:enroll,stud:stud,curr_yr:curr_yr,admission_session:admission_session};
		html_content=ajaxcall(type,url,datastring);
	//	alert(html_content);
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-5 text-ctext-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;International Generate challan </h1>
							  ...
							  <div class="form-group">
                                ...
                                <div class="col-md-6" style="padding-left:0px;">
                                  <select class="form-control" name="academic" id="academic" >
                                       ...
                                       <option  value="2022" selected="selected">2022-23</option> 
                        ...
                        <div class="form-group">
                                  ...
                                  <div class="form-group">
										<label class="col-md-4" style="padding-left:0px;"> Amount:$<?=$astrik?></label>
													 <div class="col-md-6" >
	<input type="text" class="form-control numbersOnly" name="amt" id="amt" value="<?php echo $user_details[0]['amount_usd'];?>"/>
                               
									   </div>
                                         <div class="col-md-1"> <a href="javascript:void(0);" id="" class='Refresh'>Refresh</a></div>
								  </div>
                                  <div class="form-group">
										<label class="col-md-4" style="padding-left:0px;"> Indian Rs:<?=$astrik?></label>
													 <div class="col-md-6" >
	<input type="text" class="form-control numbersOnly" name="Indianamt" id="Indianamt" value="<?php echo $user_details[0]['amount'];?>"/>
