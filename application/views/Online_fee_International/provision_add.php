...
$(document).ready(function(){
   ...
   function autoload(){
	   ...
	   var admission_stream=$("#admission_stream").val();
	   var admission_year=$("#admission_year").val();
	 //  alert(admission_stream);
	 
	 
	  $.ajax({
		type:"POST",
		url:'<?php echo base_url();?>Online_fee/get_fee',
		data:{'curr_yr':curr_yr,'admission_stream':admission_stream,'admission_year':admission_year},
		
		success: function(result){
			if(result!=0){
				$("#Total_fee").html(result);
				$("#applicable_fee").val(result);
    ...
    $('#sbutton').click(function()
	{
		...
		{  
			$.ajax({
				'url' : base_url + 'Online_fee/students_data',
				...
				'success' : function(data){ //probably this request will return anything, it'll be put in var "data"
					...
					if(data != "{\"std_details\":null}")
					{
						...
						$('#admission_stream').val(array.std_details.admission_stream);
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-5 text-ctext-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Provision Add </h1>
		...
		<form id="form" name="form" action="<?=base_url($currentModule.'/save_slot')?>" method="POST" >
        ...
        <input type="hidden" id="admission_stream" name="admission_stream" value="" />
        <input type="hidden" id="applicable_fee" name="applicable_fee" value="" />
                            ...
                            <div class="panel-body">
							 ...
							 <!-- <div class="form-group">
                              ...
                              <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Applicable Fee:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									 
									 <span id="Total_fee" name="Total_fee"></span>								   
								   </div>			 
							  </div>
							  <!--<div class="form-group">
							  ...
							  <div class="form-group" id="">
                                <label class="col-md-5" style="padding-left:0px;">Apply Slot:<?=$astrik?></label>
                                <div class="col-md-6">
                              ...
                              <div class="form-group" id="">
                                <label class="col-md-5" style="padding-left:0px;">Approve Status:<?=$astrik?></label>
                                <div class="col-md-6">
                              ...
                              <div class="form-group" id="">
                                <label class="col-md-5" style="padding-left:0px;">Remark:<?=$astrik?></label>
                                <div class="col-md-6">
                                  <textarea name="remark" id="remark" ></textarea>
                                </div>
                                
                              </div>
                               <div class="form-group" id=""> <div class=" col-md-5"></div>
                              <div class=" col-md-5">
                                  <button type="submit" class="btn btn-primary form-control Generate" >Apply</button>
                                </div>
                                </div>
                               </form>
