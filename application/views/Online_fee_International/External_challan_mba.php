					...
					<form id="form" name="form" action="<?=base_url($currentModule.'/External_submit')?>" method="POST" >
                            ...
                            <div class="panel-body">
								...
								<label class="col-md-5" style="padding-left:0px;">Name:</label>
									 ...
									 <input type="text" class="form-control" id="guest_name" name="guest_name" value="<?php echo $user_details[0]['first_name'].' '.$user_details[0]['middle_name'].' '.$user_details[0]['last_name']; ?>" />								   
								   </div>			 
							  </div>
							  <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Mobile:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									  <input type="text" class="form-control" id="guest_mobile" name="guest_mobile" maxlength="10" value="<?php echo $user_details[0]['phone']; ?>"/>							   
								   </div>			 
							  </div>
							  ...
							  <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">School:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									 <input type="text" class="form-control" id="guest_organisation" name="guest_organisation" value="MBA<?php //echo $user_details[0]['school_name']; ?>" />
							   ...
							   <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Course/Stream:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									 <textarea class="form-control" id="guest_address" name="guest_address" /><?php echo $user_details[0]['productinfo']; ?></textarea>								   
								   </div>			 
							  </div>
                              <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Admission year:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									 <input type="text" class="form-control" id="guest_year" name="guest_year" value="<?php echo $user_details[0]['admission_type']; ?>" />							   
								   </div>			 
							  </div>
							  <div class="form-group">
						...
						<div class="col-md-12" >
									...
									<div class="form-group">
									  ...
									  <div id="non_cash" style="display:none;">
										...
										<label class="col-md-5" style="padding-left:0px;" id="receipt"></label>
											<div class="col-md-6" >
											<input type="text" class="form-control numbersOnly"  name="TransactionNo" id="TransactionNo" value="<?php echo $user_details[0]['txtid'];?>" />
										</div>
										</div>
								  ...
								  <div class="form-group">
										<label class="col-md-5" style="padding-left:0px;" id="paiddate"></label>
													 <div class="col-md-6" >
											 <input type="text" id="fees_date" name="fees_date" class="form-control" value="<?php //echo $user_details[0]['added_on'];?>"   readonly="true" />
								...
								<div class="col-md-6" >
								  ...
								  <div class="form-group">
										...
										<label class="col-md-5" style="padding-left:0px;" id="">Remark:</label>
											<div class="col-md-6" >
											<input type="text" name="Remark" id="Remark" class="form-control" readonly="readonly" value="<?php echo $user_details[0]['productinfo']; ?>" />
										</div>
										</div>
                                 <div class="form-group">
                                ...
                                <div class=" col-md-5">
                                  <button type="submit" class="btn btn-primary form-control" >Generate</button>
                                   ...
                                   <div class="col-sm-5"><button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='https://erp.sandipuniversity.com/Mba_online/Mba_online_view'">Cancel</button></div>
