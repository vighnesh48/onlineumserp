...
<div id="content-wrapper">
    ...
    <div class="page-header">
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;International Payment List</h1> <a href="<?=base_url()?>Online_fee/ic_adm_payment"></a>
...
$(document).ready(function() {
        ...
        "ajax": {
                "url": "<?php echo site_url('Online_fee_international/getOnlineFeeDetail')?>",
                "type": "POST",
                 "data": function ( data ) {
    ...
    /*$('#sbutton').click(function(){
      ...
      var pstatus = $("#pstatus").val();
        ...
        "bScrollCollapse": true,
          ...
          "ajax": {
                  "url": "<?php echo site_url('Online_fee/getOnlineFeeDetail')?>",
                  "type": "POST",
 ...
 function Type_status_change(m){
  ...
  oTable =  $('#table').DataTable( {
	...
	function add_passport(payment_id){
		var passport=$("#pass_"+payment_id).val();
		if(passport==''){
			alert("please enter passport");
		}
		else{
			 $.ajax({
   'url' : base_url + 'Online_fee_international/addpassport',
   'type' : 'POST', //the way you want to send data to your URL
   'data' : {'payment_id' : payment_id,'passport' : passport},
	...
	function change_productinfo(m){
		...
		var retVal = confirm("Do you want to continue ?");
               if( retVal == true ) {
				   ...
				   $.ajax({
   'url' : base_url + 'Online_fee/change_productinfo',
   'type' : 'POST', //the way you want to send data to your URL
   ...
   'success' : function(data){
	...
	var id=( $(this).closest(".upload").attr("id"));
  ...
  $.ajax({ 
    url: base_url + 'Online_fee_international/uploadimage', // Upload Script
    dataType: 'script',
    cache: false,
    contentType: false,
    processData: false,
