...
$( document ).ready(function() {
   ...
   if(ftype=='Examination'){
	  ...
	  if(admission_session==2021){
		  $("#PaymentType").html('<select name="Payment_type" id="Payment_type" class="form-control" onchange="onPayment_type()"><option value="">Select Payment Type</option><option value="1">35% Payment</option><option value="3">50% Payment</option><option value="2">Full Payment</option></select>');
	  }else{
		   $("#PaymentType").html('<select name="Payment_type" id="Payment_type" class="form-control" onchange="onPayment_type()"><option value="">Select Payment Type</option><option value="3">50% Payment</option><option value="2">Full Payment</option></select>');
	  }
               ...
               <div class="table-info panel-body">
                 <div class="form-group">
                    ...
                    <!-- <input type="hidden" name="productinfo" id="productinfo_ht" value="online_transporation_new"> -->
                     ...
                     <input type="hidden" name="ac_year" id="ac_year_ht" value="2021" required="required">
                     ...
                     <input type="hidden" name="surl" value="https://www.sandipuniversity.com/erp/Online_transport_fee/payu_success"/>
                     <input type="hidden" name="furl" value="https://www.sandipuniversity.com/erp/Online_transport_fee/payu_failure"/>
               ...
               <div class="table-info panel-body">
                 <div class="form-group">
                    ...
                    <!-- <input type="hidden" name="action" value="https://secure.payu.in/_payment" />-->
                     ...
                     <input type="hidden" name="surl" value="https://www.sandipuniversity.com/erp/Online_fee/success_gym"/>
                     <input type="hidden" name="furl" value="https://www.sandipuniversity.com/erp/Online_fee/failure_gym"/>
