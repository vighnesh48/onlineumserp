...
<body>
				...
				?>	
				<!--h6><?=$strm['school_name']?></h6-->
<table cellpadding="3" cellspacing="0" border="1" width="100%" class="cell-padding">
<tr>
<td align="left" width="15%"><strong>School :</strong></td>
<td colspan='4'><?=$strm['school_name']?></td>
</tr> 
<tr>
...
<?php 
	...
	$i++;
	?></table><br>
	<span style="font-size:12px">Note: Due to unavoidable circumstances, dates are subject to change.</span>
	<pagebreak>
	<?php
	//$mpdf->AddPage();
				}
