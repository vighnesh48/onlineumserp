         ...
         <tbody>
            <tr>
               <td valign="top" height="40">
                  <table cellpadding="0" cellspacing="0" border="0" align="center" width="800" style="margin-top:15px;">
                     <tr>
                     ...
                     <tr>
                        ...
                        <td align="center" style="text-align:center;margin:0;padding:0">
                           <h3 style="font-size:14px;">OFFICE OF THE CONTROLLER OF THE EXAMINATIONS<br>
            ...
            <tr>
               <td style="padding:10px;">
                  <table class="content-table" width="800" cellpadding="0" cellspacing="0" border="0" align="center" style="font-size:12px;height:150px;overflow: hidden;">
                     ...
                     <tr>
                        <td height="30"><strong>Date &amp; Session of Exam:</strong></td>
                        <td><?=date('d-m-Y', strtotime($emp_per[0]['date']))?>, <?=explode(':', $emp_per[0]['from_time'])[0]?>:<?=explode(':', $emp_per[0]['from_time'])[1]?>-<?=explode(':', $emp_per[0]['to_time'])[0]?>:<?=explode(':', $emp_per[0]['to_time'])[1]?></td>
                     </tr>
                  </table>
               </td>
            </tr>
