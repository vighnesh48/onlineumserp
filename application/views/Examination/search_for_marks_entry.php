 ...
 $('#btnView').click(function(){
                ...
                var report_type = $("#report_type").val();
                  ...
                  if(report_type=="" || prn==""){
                      ...
                      $.ajax({
                                'url' : base_url + 'Examination/student_marks_entry_list',
                                'type' : 'POST', //the way you want to send data to your URL
      ...
      <div class="page-header">	
		<div class="panel">
                <div class="panel-heading">
                        <span class="panel-title">  Search Marks Entry:</span>
				</div>						

        <div class="row panel-body">
                         <form method="post" action="<?=base_url()?>Examination/student_marks_entry_list">
