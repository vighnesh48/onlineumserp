...
<table cellpadding="0" cellspacing="0" border="0" align="center" width="800" style="margin-bottom:1px;">
 <tr> 
	<td align="center" colspan="3"><h3><?php if($exam_session[0]['exam_type']=='Regular'){ echo "End Semester Examination Time-Table";}else{ echo 'Special Supplementary Examination Time-Table';}?> <?=$exam_session[0]['exam_month']?>-<?=$exam_session[0]['exam_year']?>.</h3></td>
</tr>
</table>