...
<thead class="panel-primary">
	...
	<tr <?php if($summary_list[$i]['passed']=='N'){?> style="background-color:#f19b9b;"<?php }?>>
		...
		<td><input type='text' name="final_grade" value="<?=$summary_list[$i]['final_garde_marks']; ?>"></td>
		<td><input type='text' name="final_grade" value="<?=$summary_list[$i]['final_grade']; ?>"></td>		
