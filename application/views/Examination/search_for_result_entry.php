 ...
 $('#btnView').click(function(){
                ...
                var report_type = $("#report_type").val();
                  ...
                  if(report_type=="" || prn==""){
                      ...
                      $.ajax({
                                'url' : base_url + 'Examination/student_result_entry_list',
                                'type' : 'POST', //the way you want to send data to your URL
      ...
      <div class="page-header">	
		<div class="panel">
                <div class="panel-heading">
                        <span class="panel-title">  Search Results Entry:</span>
				</div>						

        <div class="row panel-body">
                         <form method="post" action="<?=base_url()?>Examination/student_result_entry_list">
							  ...
							  <div class="col-sm-2 hidden">
                                <select name="report_type" id="report_type" class="form-control" required>
                                  <option value="marks_entry">Marks Entry</option>
                                   <option value="fresh" <?php if($_REQUEST['report_type'] =='arrears'){ echo "selected";}else{}?>>Marks Entry</option>
