...
$(document).ready(function(){
      var acad_year=atob('<?echo $_GET['acad_year'];?>');
     ...
     var url='<?=base_url()?>dashboard/superadmin/'+acad_year;
      // window.location.href=url+'?acad_year='+acad_year;
       window.location.href=url+'?acad_year='+get;
	 });
   });
</script>
<?php
...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Super Admin</a></a></li>
        <li class="active"><a href="#">Dashboard</a></li>
         <!--li class="active"><a href="<?=base_url()?>dashboard/superadmin/2017">Academic Year:2017-18</a></li>
         <li class="active"><a href="<?=base_url()?>dashboard/superadmin/2018">Academic Year:2018-19</a></li>
		 <li class="active"><a href="<?=base_url()?>dashboard/superadmin/2019">Academic Year:2019-20</a></li>
		 <li class="active"><a href="<?=base_url()?>dashboard/superadmin/2020">Academic Year:2020-21</a></li>
		 <li class="active"><a href="<?=base_url()?>dashboard/superadmin/2021">Academic Year:2021-22</a></li>
		 <li class="active"><a href="<?=base_url()?>dashboard/superadmin/2022" style="color: #fd0b13;">Academic Year:2022-23</a></li-->
		 <li class="active">
		<select  name="acad_year" id="acad_year" class="form-control col-sm-3">
    ...
    <div class="ant-col-md-6">
     <div class="isoWidgetsWrapper">
			...
			<div class="isoContentWrapper isoContentWrapper1">
			
			<div class="col-md-9">
			<h3 class="isoStatNumber"><?php echo $getTotalAdmNew['newadd']-$getTotalAdmNew['ing']; //$getTotalAdmNew['newadd'].'+'.($getTotalAdmAll['totstud']).'='.($getTotalAdmNew['newadd'] + $getTotalAdmAll['totstud']); //-$getTotalAdmNew['newadd']?> + IN <?php echo $getTotalAdmNew['ing'];?></h3>
			<span class="isoLabel">New Admissions 
			</div>
			<div class="col-md-3">
			<a href="<?php echo base_url(); ?>account/admission_fees_report/<?=$academic_year?>/N/2/All/both" style="float:right;float: right;
    color: #fff;
    font-weight: 600;" target="_blank"><i class="fa fa-eye fa-6 icomon" aria-hidden="true"></i> </a></span>
    ...
    <div class="ant-col-md-6">
     <div class="isoWidgetsWrapper">
			...
			<h3 class="isoStatNumber" data-toggle="tooltip" data-placement="top" data-html="true"  title="Applicable=<?php echo "".money_format('%!.0n',round($getTotalfee_new));?></br> +Opening=<?php echo "".money_format('%!.0n',round($opening_balance_new));?><br/>Other=<?php echo "".money_format('%!.0n',round($other_fees_new));?>"><?=money_format('%!.0n',$getTotalfee_new+ $opening_balance_new + $other_fees_new)?><?php //?></h3>
			<span class="isoLabel">Fees Applicable</span><!--<br />(Totappl+ost+othr)-->
			</div></div></div>   
    </div>
    ...
    <div class="ant-col-md-6">
     <div class="isoWidgetsWrapper">
			...
			<div class="isoContentWrapper">
			<h3 class="isoStatNumber"><?=money_format('%!.0n',$getExemfee_new)?></h3>
    ...
    <div class="ant-col-md-6">
     <div class="isoWidgetsWrapper">
			...
			<div class="isoContentWrapper">
			<h3 class="isoStatNumber" data-toggle="tooltip" data-placement="top" data-html="true"  title="
			Fees Recevied=<?=money_format('%!.0n',($getFeeReceived_new))?> - Refund=<?=money_format('%!.0n',($refunds_new))?>"><?=money_format('%!.0n',($getFeeReceived_new-$refunds_new))?></h3>
...
<div class="ant-col-md-6">
     <div class="isoWidgetsWrapper">
			...
			<div class="isoContentWrapper">
			<h3 class="isoStatNumber"><?php echo money_format('%!.0n',$getTotalfee_new + $opening_balance_new + $other_fees_new+$refunds_new-$getFeeReceived_new);?></h3>
 ...
 <div class="row" style="margin-bottom:20px;">
    <div class="ant-col-md-6"> 
     <div class="isoWidgetsWrapper">
			<div class="isoStickerWidget" style="background-color: rgb(114, 102, 186);"><a href="" style="float:right;"></a>
			<div class="isoContentWrapper isoContentWrapper1">
			 <div class="col-md-9"> 
			<h3 class="isoStatNumber"><?=($getTotalAdm_reg['rr_adm']); //-$getTotalAdmNew['newadd']?></h3>
			<span class="isoLabel">Re-registration</span>
			</div>
             <div class="col-md-3"> 
			<span class="isoLabel"><a href="<?php echo base_url(); ?>account/admission_fees_report/<?=$academic_year?>/R/2/All/both" style="float:right;" target="_blank"><i class="fa fa-eye fa-6 icomon" aria-hidden="true"></i></a></span> </div>  
    ...
    <div class="ant-col-md-6">
     <div class="isoWidgetsWrapper">
           ...
           <h3 class="isoStatNumber" data-toggle="tooltip" data-placement="top" data-html="true"  title="Applicable=<?php echo "".money_format('%!.0n',round($getTotalfee_reg));?></br> +Opening=<?php echo "".money_format('%!.0n',round($opening_balance_reg));?><br/>Other=<?php echo "".money_format('%!.0n',round($other_fees_reg));?>"><?=money_format('%!.0n',$getTotalfee_reg + $opening_balance_reg + $other_fees_reg)?></h3>
    ...
    <div class="ant-col-md-6">
     <div class="isoWidgetsWrapper">
			<div class="isoStickerWidget" style="background-color: rgb(126, 211, 32);">
			<div class="isoContentWrapper">
			<h3 class="isoStatNumber"><?=money_format('%!.0n',$getExemfee_reg)?></h3>
			<span class="isoLabel">Scholarship Given</span>
			</div></div></div>  
    </div>
    ...
    <div class="ant-col-md-6">
     <div class="isoWidgetsWrapper">
			...
			<div class="isoContentWrapper">
			<h3 class="isoStatNumber" data-toggle="tooltip" data-placement="top" data-html="true"  title="
			Fees Recevied=<?=money_format('%!.0n',($getFeeReceived_reg))?> - Refund=<?=money_format('%!.0n',($refunds_reg))?>"><?=money_format('%!.0n',($getFeeReceived_reg-$refunds_reg))?></h3>
			<span class="isoLabel">Fees Received</span>
			</div></div></div>    
    </div>
...
<div class="ant-col-md-6">
     <div class="isoWidgetsWrapper">
			<div class="isoStickerWidget" style="background-color: rgb(247, 93, 129);">
			<div class="isoContentWrapper">
			<h3 class="isoStatNumber"><?php echo money_format('%!.0n',$getTotalfee_reg + $opening_balance_reg + $other_fees_reg + $refunds_reg - $getFeeReceived_reg);?></h3>
			<span class="isoLabel">Fees Pending </span>
			</div></div></div>    
    </div>
        ...
        <div class="panel">
        					...
        					<!--table class="table table-bordered table-hover" >
        					    <tr class="themecolor">
									...
									<th width="20%">Fees Applicable&nbsp;(&nbsp;<i class="fa fa-inr"></i>&nbsp;)</th>
								...
								?>
									<tr>
										<td><?=$i?></td>
										<td><?=$stud['course']?></td>
										<td><i class="fa fa-inr">&nbsp;&nbsp;<?=money_format('%!.0n',(int)$stud['applicable_total'])?></i></td>
...
/*var base_url = "<?php echo base_url(); ?>";
         //
  $.ajax({
url: base_url+'dashboard/feesStatistics/2022',
type: "post",
data: "",
success: function(data) {
   $("#feesStatistics").html(data);
}
});*/
				</script>
				<!-- / Javascript -->
