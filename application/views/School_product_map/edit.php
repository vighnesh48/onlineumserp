...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Edit School Product Mapping</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit School Product Mapping</h1>
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title">School Product Mapping</span>
                    </div>
                    <div class="panel-body">
                        <div class="table-info">                            
                            <?php if(in_array("Edit", $my_privileges)) { ?>
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                <input type="hidden" value="<?=isset($schoolcolor_details['id'])?$schoolcolor_details['id']:""?>" id="school_color_id" name="school_color_id" />
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <option value=""> -- Select -- </option>
                                         <?php foreach($school as $schools) {
                                                if($schoolproduct_details['school_id'] == $schools['id']) {?>
                                    ...
                                    <div class="col-sm-6">
										...
										<option value=""> -- Select -- </option>
                                         <?php foreach($product as $products) {
                                                if($schoolproduct_details['product_id'] == $products['id']) {?>
