                   ...
                   <form id="form" name="form" action="<?=base_url($currentModule.'/edit_fees_challan_submit/'.$challan_details['fees_id'])?>" method="POST" >
						...
						<div class="panel" id="fee_details" ">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly" readonly name="finefee" id="finefee" value="<?=$challan_details['fine_fees']?>" />
                                </div>
                                
                              </div>
							  
							   <div class="form-group">
                                <label class="col-md-5">Facility Fee:</label>
                                <div class="col-md-6">
