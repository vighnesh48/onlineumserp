...
function calc_final_amount(){
		...
		//	var fine = $('#finefee').val();
			...
			var final_amount = parseInt(accomodation_charges)+parseInt(othr); 
        ...
        <div class="row ">
            <div class="col-sm-12">
                <div class="panel">
					...
					<form id="form" name="form" action="https://erp.sandipuniversity.com/Transport_Challan/add_guest_challan_submit" method="POST" >
						...
						<div class="panel" id="fee_details">
							...
							<div class="col-md-12" >
								...
								<div class="form-group">
                                <label class="col-md-5" style="padding-left:0px;">Transport Accomodation charges:</label>
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly" value="0"  name="accomodation_charges" id="accomodation_charges" onblur="calc_final_amount();"/>
                                </div>
