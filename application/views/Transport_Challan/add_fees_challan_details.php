...
function faci_type()
{
	...
	{
		type='POST',url='<?= base_url() ?>Transport_Challan/get_faci_fee_details',datastring={academic:academic,facility:facility,enroll:enroll};
		html_content=ajaxcall(type,url,datastring);
									...
									<div class="form-group">
									  ...
									  <div id="non_cash" style="display:none;">
										...
										<label class="col-md-5" style="padding-left:0px;" id="receipt"></label>
											<div class="col-md-6" >
											<input type="text" class="form-control numbersOnly"  name="receipt_number" id="receipt_number" /><a href="javascript:void(0);" id="Check_recepit" class="Check_recepit btn btn-primary">Check</a>
