                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                <input type="hidden" value="<?=isset($_REQUEST['ccb_id'])?$_REQUEST['ccb_id']:""?>" id="ccb_id" name="ccb_id" />
                                    ...
                                    <div class="col-sm-6">
                                        <select id="course_id" name="course_id" class="form-control">
                                            <option value="">Select Course</option>    
                                             <?php for($i=0;$i<count($course_details);$i++) { ?>
                                            <option value="<?=$course_details[$i]['course_id']?>"><?=$course_details[$i]['course_code']?></option>
                                            <?php } ?>                                        
                                        </select>
                                    </div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                    <?php //echo "<pre>"; print_r($branch_details); ?>
                                        <select id="branch_id" name="branch_id" class="form-control">
                                            <option value="">Select Branch</option>
                                            <?php for($i=0;$i<count($branch_details);$i++) { ?>
