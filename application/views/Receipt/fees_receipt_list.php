...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Fees Receipt</a></li>
         
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp; Fees Receipt List</h1>
			<span id="err_msg1" style="color:red;"></span>
			<div class="col-xs-12 col-sm-8">
                <div class="row"> 
					   <hr class="visible-xs no-grid-gutter-h">
                       <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" target="_blank" class="btn btn-primary btn-labeled" href="<?=base_url("Receipt/recepit_check")?>"><span class="btn-label icon fa fa-plus"></span>Check </a></div>
                       <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" target="_blank" class="btn btn-primary btn-labeled" href="<?=base_url("Challan/receipt_list")?>"><span class="btn-label icon fa fa-plus"></span>Report </a></div>
                  <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add_fees_receipt")?>"><span class="btn-label icon fa fa-plus"></span>Generate </a></div>
        ...
        <div class="row ">
            <div class="col-sm-12">
				...
				<div class="row">
                <label class="col-sm-1">Recepit&nbsp;No</label>
                <div class="col-sm-2">
						<input type="text" class="form-control" name="Recepitid" id="Recepitid" value="" />
						</div>
                
               
                <label class="col-sm-1">OR&nbsp;Mobile&nbsp;No</label>
                <div class="col-sm-2">
						<input type="text" class="form-control" name="Mobileid" id="Mobileid" value="" />
						</div>
                <div class="col-sm-1">
				...
				<!-- Modal -->
                    ...
                    <div class="table-info" id="getdata" >    
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr>
                                ...
                                <td><?=$list['student_name']?></td>
                                 ...
                                 <td><?php $datas=$CI->Receipt_model->get_enrollment_no_onthebasis_of_remark_formno($list['student_id']);
...
window.location.href = '<?= base_url() ?>Receipt'
	 ...
	 // alert(Recepit);
	  if((Recepit=='')&&(Mobile=='')){
		  alert("Please Eneter Recepit Or Mobile No");
		  return false;
	  }else{
	  
	  type='POST',url='<?= base_url() ?>Receipt/Search';
	  datastring={Recepit:Recepit,Mobile:Mobile};
	  //alert();
...
function common_call()
{
	...
	type='POST',url='<?= base_url() ?>Receipt/challan_list_by_creteria';
