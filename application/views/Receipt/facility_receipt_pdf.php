...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	  ...
	  //{
       ...
       <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
        ...
        <tr>
          ...
          <td colspan=""><strong>Client Id :</strong><?=$std_challan_details['clinet_id']?></td>
       <?php } ?>
        </tr>
		</table>
		 <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
        <tr>
          ...
          <td><strong>Class :</strong> <?php if($std_challan_details['curr_year']==1)echo 'First year';
		  else if($std_challan_details['curr_year']==2)
		  echo 'Second year'; 
		  else if($std_challan_details['curr_year']==3)
		   echo 'Third year';else echo '';?></td>
        </tr>
        <tr>
          
          <td width="40%"><strong>Receipt No:</strong><br><span style="font-size:13px"><?=$form_no?></span></td>
       ...
       <tr>
        ...
        <tr>
		  ...
		  <?php }else{ ?>
		  <?=$std_challan_details['student_name']?>
          <?php } ?>
          </td>
        </tr>
        <tr>
		  ...
		  <?php }else{ ?>
          <strong>Course/Branch :</strong><?=$std_challan_details['cousre_name']?>
		  <?php } ?>
          </td>
        </tr>
        <tr>
          <td colspan="2"><strong>Contact No.:</strong>
		   ...
		   <?=$std_challan_details['guest_mobile']?>
            <?php }else{ ?>
		   <?=$std_challan_details['mobile_no']?><?php } ?>
           </td>
      ...
      <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
        ...
        <tr>
		  ...
		  echo 'Academic Fees';}else if($std_challan_details['type_id']=="5"){
		   echo 'Exam Fees'; }else if($std_challan_details['type_id']=="10"){
	...
	<tr>
        ...
        <?php }elseif($std_challan_details['type_id']==5) {?>
         <tr>
          <td align="center">1</td>
      ...
      <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
        ...
        <tr>
          <td colspan="2" height="100" valign="top">IMPORTANT INSTRUCTION TO <?=$std_challan_details['bank_code']?> BRANCH :</td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" align="center"><div align="center">Note:-Cheque/DD are Subject to realisation</div></td>
    ...
    <td width="33%" valign="top">
       ...
       <?php } ?>
        ...
        <tr>
          ...
          <td><strong>Class :</strong> <?php if($std_challan_details['curr_year']==1)echo 'First year';
		  else if($std_challan_details['curr_year']==2)echo 'Second year'; else if($std_challan_details['curr_year']==3) echo 'Third year';else echo '';?></td>
        </tr>
        <tr>
	...
	<tr>
      ...
      <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
        ...
        <tr>
         ...
         <tr>
          <td colspan="2"><div align="center">Note:-Cheque/DD are Subject to realisation</div></td>
	  ...
	  <td width="33%" valign="top">
       ...
       <?php } ?>
        ...
        <tr>
		  ...
		  if($std_challan_details['curr_year']==1)
		  echo 'First year';
		  else if($std_challan_details['curr_year']==2)
		  echo 'Second year'; 
		  else if($std_challan_details['curr_year']==3) 
