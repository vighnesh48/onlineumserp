        ...
        <div class="row">
			...
			<div class="col-xs-12 col-sm-8">
                <div class="row"> 
                       ...
                       <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" target="_blank" class="btn btn-primary btn-labeled" href="<?=base_url("Receipt/receipt_checklist")?>"><span class="btn-label icon fa fa-plus"></span>Check Report </a></div>
...
window.location.href = '<?= base_url() ?>Receipt'
	 ...
	 // alert(Recepit);
	  ...
	  type='POST',url='<?= base_url() ?>Receipt/check_Search';
