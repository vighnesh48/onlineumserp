...
var stud = $('#student_id').val();
	...
	$('#facility').val(amt);
		...
		function check_provision(){
			//alert();
			var provisionalNo=$("#provisionalNo").val();
			if(provisionalNo==""){}else{
			$.ajax({
				'url' : base_url + 'Receipt/check_provision',
				'type' : 'POST', //the way you want to send data to your URL
				'data' : {provisionalNo:provisionalNo},
				'success' : function(data){
					var array=JSON.parse(data);
					$("#result_check").html(array.student_name);
					$("#stud_id").val(array.id);
					$("#challan_status").prop('disabled', false);
				}
			});
			}
		}
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-5 text-ctext-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;View Receipt </h1>            <span id="rrrr" style="color:red;"></span>
        </div>
            ...
            <div class="col-sm-12">
                   ...
                   <form id="form" name="form" action="<?=base_url($currentModule.'/edit_fees_challan_submit/'.$challan_details['fees_id'])?>" method="POST" >
                            ...
                            <div class="panel-body">
                              ...
                              <div class="form-group">
								<!--<label class="col-md-4" style="padding-left:0px;">ID/PRN:</label>-->
									 ...
									 <input type="hidden" id="fees_id" name="fees_id" value="<?=$challan_details['fees_id']?>" />
							  ...
							  <div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Course:</label>
									 ...
									 <span id="course" name="course"><?=$challan_details['cousre_name']?></span>								   
								   </div>			 
							  </div>
							  <!--<div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Institute:</label>
							  ...
							  <div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Current Year:</label>
									 ...
									 <span id="current_year" name="current_year"><?=$challan_details['curr_year']?></span>								   
								   </div>			 
							  </div>
							  <div class="form-group">
								<label class="col-md-4" style="padding-left:0px;">Mobile:</label>
									 ...
									 <span id="mobile1" name="mobile1"><?=$challan_details['mobile_no']?></span>								   
								   </div>			 
							  </div>
                       ...
                       <input type="text" class="form-control numbersOnly"  value="<? //$challan_details['amount']?>" readonly name="facility" id="facility" />                 
                             ...
                             <div class="col-md-6">                        
                             <input type="text" class="form-control numbersOnly"  value="<? //$challan_details['amount']?>" readonly name="apaid" id="apaid" readonly/>                                </div>                                                              </div>-->                                                                
                             
                               <!--<div class="form-group">     
                                                        <label class="col-md-5" style="padding-left:0px;">Amount Pending:</label>                                <div class="col-md-6">                                   <input type="text" class="form-control numbersOnly"  value="0" readonly name="apend" id="apend" readonly/>                               
                                             </div>                                                            
                                               </div>--> 
										<div class="form-group">
					...
					<div id="non_cash" style="display:none;">
                            ...
                            <div class="form-group">
									<label class="col-md-5">Receipt No:</label>
											 <div class="col-md-6" >
											 <input type="text" class="form-control alphaOnly" value="<?=$challan_details['exam_session']?>" readonly  name="Receiptno" id="Receiptno" />
                                       </div>
                               </div>
                            
                            <div class="form-group">
								<label class="col-md-5">provisional No:<?=$astrik?></label>
								<div class="col-md-6" >
						<input type="text" name="provisionalNo" id="provisionalNo" class="form-control" >
						<a href="javascript:void(0);" name="check" id="" onclick="check_provision();" >Check</a>				
								   </div>
								
							  </div>
                             <div class="form-group"><label class="col-md-3"></label>
                             <div class="col-md-6" ><label class="col-md-9" id="result_check"></label>
                             <input type="hidden" class="form-control alphaOnly" value="" readonly  name="stud_id" id="stud_id" />
                             </div>
							...
							<div class="form-group">
								...
								<input type="hidden" class="form-control" value="<?php echo $challan_details['challan_status'];?>"  name="last_status" id="last_status" />

							    <select name="challan_status" id="challan_status" class="form-control" <?php if($challan_details['challan_status']=="VR"){?><?php }else{?> disabled="disabled" <?php } ?>>
										<option value="">Select Action</option>
									<option value="VR" <?php if($challan_details['challan_status']=="VR"){?> selected="selected" <?php } ?> >Deposited<?php //echo $challan_details['challan_status']; ?></option>
									<option value="CL" <?php if($challan_details['challan_status']=="CL"){?> selected="selected" <?php } ?> >Cancelled</option>
									</select>	
								   </div>
