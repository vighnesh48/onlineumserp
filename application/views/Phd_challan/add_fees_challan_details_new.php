	...
	//	alert(html_content);
		...
		//}
			...
			$('#totf').html(array[0].applicable_fee);
						...
						if((array[1].fees_id)!=0){
							//alert("ddss");
						$('.Exam_fees_read').html(array[1].exam_fees);
						$('#Exam_fees_check').val(array[1].exam_fees);
...
<div class="modal fade" id="myModal_add">
    ...
    <tbody>
	<tr>
        <th width="5%">Opening Fees</th><td><input type="text" id="prev_balance_amount" name="prev_balance_amount" value="" /></td>
		</tr>
        	<tr>
		<tr>
        <th width="5%">Tuition Fees</th><td><input type="text" id="add_Tuition" name="add_Tuition" value="" /></td>
		</tr>
        	<tr>
...
$(document).ready(function(e) {
	$('.Refresh').on('click',function(){
		...
		var prev_balance_amount=$("#prev_balance_amount").val();
		...
		var formData = {prev_balance_amount:prev_balance_amount,add_Tuition:add_Tuition,add_Development:add_Development,add_Caution:add_Caution,add_Admission:add_Admission,add_Examfees:add_Examfees,add_University:add_University,enroll:enroll,student_id:student_id,academic:academic};
		if(student_id!=''){
