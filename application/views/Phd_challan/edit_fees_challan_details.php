...
var stud = $('#student_id').val();
	if(academic!='' && facility!='')	{	
		type='POST';		url='<?= base_url() ?>Phd_challan/get_fee_details';		datastring={academic:academic,facility:facility,enroll:enroll,stud:stud};	
            ...
            <div class="col-sm-12">
                   ...
                   <form id="form" name="form" action="<?=base_url($currentModule.'/edit_fees_challan_submit/'.$challan_details['fees_id'])?>" method="POST" >
                       ...
                       <input type="text" class="form-control numbersOnly"  value="<?=$challan_details['amount']?>" readonly name="facility" id="facility" />                 
                             ...
                             <div class="col-md-6">     -->                   
    <input type="hidden" class="form-control numbersOnly"  value="<?=$challan_details['amount']?>" name="apaid" id="apaid" readonly/>                              <!--  </div> </div> -->
                                                                      <div class="form-group">                             
