        ...
        <div class="row">
			...
			<div class="col-xs-12 col-sm-8">
                <div class="row"> 
					   ...
					   <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" target="_blank" class="btn btn-primary btn-labeled" href="<?=base_url("Phd_Challan/getchallanlist")?>"><span class="btn-label icon fa fa-plus"></span>Report </a></div>
<?php $roles_id =$this->session->userdata('role_id');if($roles_id==5 || $roles_id==40) { ?>			   
...
<?php }?>
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <label class="col-sm-1">OR&nbsp;Enrollment</label>
                <div class="col-sm-2">
						<input type="text" class="form-control" name="Mobileid" id="Mobileid" value="" />
						</div>
				<label class="col-sm-1">OR&nbsp;Transaction</label>
                <div class="col-sm-2">
               ...
               <div class="col-sm-1">
				...
				<!-- Modal -->
                    ...
                    <div class="table-info table-responsive" >    
                       <table id="search-table" class="table table-bordered" style="width:100%;max-width:100%;">
                        <thead>
                            <tr>
                                    <th>#</th>
									<th>Challan</th>
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr>
								...
								<td><?=$challan_details[$i]['fees_name']?></td>											   
								<td>
								...
								-->
								<?php if($challan_details[$i]['challan_status']!='VR' && ($roles_id==5 || $roles_id==40)) { 
...
$("#back").click(function(){
		//window.history.back();
window.location.href = '<?= base_url() ?>Phd_Challan'
...
$("#Search").click(function(){
	 ...
	 // alert(Recepit);
	  if((Recepit=='')&&(Mobile=='')&&(transactionno=='') ){
		  alert("Please Eneter Recepit Or Enrollment No");
		  return false;
	  }else{
	  
	  type='POST',url='<?= base_url() ?>Phd_Challan/Search';
	  datastring={Recepit:Recepit,Mobile:Mobile,transactionno:transactionno};
	  //alert();
...
function display_content(html_content)
{
	...
	else
	{
		...
		for(i=0;i<len;i++)
		{
			...
			content+='<td>'+array.std_challan_list[i].fees_paid_type+'</td>';
			content+='<td>'+array.std_challan_list[i].TransactionNo+'</td>';
