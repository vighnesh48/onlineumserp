							  ...
							  <div class="form-group">
                                ...
                                <div class="col-md-6" style="padding-left:0px;">
                                  <select class="form-control" name="facilty" id="facilty" onchange="faci_type()" >
                                      ...
                                      <option value="4" <?php if($productinfo=='Hostel_Gym_new'){ echo "selected";} ?>>Hostel GYM</option>
									   <?php 
						...
						<input type="hidden" value="" id="famt">
							...
							<div class="form-group">
							   ...
							   <div class="form-group">
                                ...
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly"  value="<?php echo $user_details[0]['amount']-$user_details[0]['deposit_fees']; ?>" name="facility" id="facility" onblur="calc_final_amount();"  />
                                </div>
