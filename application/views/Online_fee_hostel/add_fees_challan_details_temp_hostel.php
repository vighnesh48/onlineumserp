			...
			$.ajax({
				...
				'success' : function(data){ //probably this request will return anything, it'll be put in var "data"
					...
					if(data != "{\"std_details\":null}")
					{
						...
						alert(array);
						//$('#prnno').val(array.std_details.enrollment_no);
						...
						$('#std_name').val(array.std_details.first_name+' '+array.std_details.middle_name+' '+array.std_details.last_name);
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        ...
        <input type="hidden" id="enroll" name="enroll" value="<?php echo $user_details[0]['registration_no']; ?>" />
                            ...
                            <div class="panel-body">
                              ...
                              <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">ID/PRN:</label>
									 ...
									 <input type='text' class='form-control' id="prnno" name="prnno" value="<?=$user_details[0]['registration_no']?>"></span>								   
								   </div>			 
							  </div>
								<div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Name:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									  <input class='form-control' type='text' id="std_name" name="std_name" value="<?=$user_details[0]['firstname']?>">							   
								   </div>			 
							  </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
                                ...
                                <div class="col-md-6" style="padding-left:0px;">
                                  <select class="form-control" name="facilty" id="facilty"" >
                                      ...
                                      <option value="5" <?php if($productinfo=='Hostel_Temp_Room'){ echo "selected";} ?>>Hostel_Temp_Room</option>
