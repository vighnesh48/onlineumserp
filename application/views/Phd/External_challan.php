...
$(document).ready(function()
{
	...
	$('#fees_date').datepicker( {format: 'dd-mm-yyyy', "setDate": new Date(),autoclose: true}).datepicker("setDate",'now');;	
	 // Num check logic
        ...
        <div class="row ">
            <div class="col-sm-12">
                <div class="panel">
					...
					<form id="form" name="form" action="<?=base_url('Phd_Challan/External_submit')?>" method="POST" >
                            ...
                            <div class="panel-body">
								...
								<label class="col-md-5" style="padding-left:0px;">Name:</label>
									 ...
									 <input type="text" class="form-control" id="guest_name" name="guest_name" value="<?php echo $user_details[0]['firstname'].' '.$user_details[0]['middle_name'].' '.$user_details[0]['last_name']; ?>" />								   
								   </div>			 
							  </div>
							  <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Mobile:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									  <input type="text" class="form-control" id="guest_mobile" name="guest_mobile"  value="<?php echo $user_details[0]['phone']; ?>"/>							   
								   </div>			 
							  </div>
							 
							  <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">School:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									 <input type="text" class="form-control" id="guest_organisation" name="guest_organisation" value="<?php echo $user_details[0]['school_name']; ?>" />
									 							   
								   </div>			 
							  </div>
							   <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Course/Stream:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									 <textarea class="form-control" id="guest_address" name="guest_address" /><?php echo $user_details[0]['department']; ?></textarea>								   
								   </div>			 
							  </div>
                              <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Admission year:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									 <input type="text" class="form-control" id="guest_year" name="guest_year" value="2024<?php //echo $user_details[0]['admission_type']; ?>" />							   
								   </div>			 
							  </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
                                ...
                                <div class="col-md-7" style="padding-left:0px;">
								  <select class="form-control" name="depositto" id="depositto" required>
                    ...
                    <div class="col-md-1" ></div>
								...
								<div class="form-group">
					<label class="col-md-4" style="padding-left:0px;">Admission Form Fees</label> 
                    <label class="col-md-2"></label>
                    
					<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="guest_RegistrationFees" id="RegistrationFees" value="<?php echo $user_details[0]['amount']; ?>"  onblur="calc_final_amount();" /></div>
                    <div class="col-md-1" ></div>
					</div>
						...
						<div class="col-md-12" >
									...
									<div class="form-group">
										...
										<div class="col-md-6" >
											...
											<option value="CASH">Challan</option>
											 <option value="GATEWAY-ONLINE" selected>GATEWAY-ONLINE</option>
											</select>	
										   </div>
										
									  </div>  
									   <div id="Online_pay" style="display:block;">
									   <div class="form-group">
										
										<label class="col-md-5" style="padding-left:0px;" id="">Recepit No:<?=$astrik?> </label>
											<div class="col-md-6" >
											<input type="text" class="form-control"  name="receipt_number" id="receipt_number" value="<?php echo $user_details[0]['receipt_no'];?>"/>
										</div>
										</div>
										
										<div class="form-group">
										
										<label class="col-md-5" style="padding-left:0px;" id="">Transaction Date:<?=$astrik?> </label>
											<div class="col-md-6" >
									  ...
									  <div id="non_cash" style="display:none;">
										...
										<label class="col-md-5" style="padding-left:0px;" id="receipt"></label>
											<div class="col-md-6" >
											<input type="text" class="form-control numbersOnly"  name="TransactionNo" id="TransactionNo" value="<?php echo $user_details[0]['bank_ref_num'];?>" />
											<div class="col-md-1"><a href="javascript:void(0);" id="Check_recepit" class='Check_recepit'>Check</a></div>
										</div>
										</div>
										<div class="form-group">
								  ...
								  <div class="form-group">
										<label class="col-md-5" style="padding-left:0px;" id="paiddate"></label>
													 <div class="col-md-6" >
											 <input type="text" id="fees_date" name="fees_date" class="form-control" value="<?php echo date('d-m-Y') ?>"   readonly="true" />
								...
								<div class="col-md-6" >
								  ...
								  <div class="form-group">
										...
										<label class="col-md-5" style="padding-left:0px;" id="">Remark:</label>
											<div class="col-md-6" >
	<input type="text" name="Remark" id="Remark" class="form-control" readonly="readonly" value="<?php echo $user_details[0]['productinfo'].'-'.$user_details[0]['admission_category']; ?>" />
										</div>
										</div>
                                 <div class="form-group">
