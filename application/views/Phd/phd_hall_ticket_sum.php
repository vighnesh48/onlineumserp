         ...
         <div align="center" style="width:70%;margin:0px auto">
				  ...
				  <img class="act" src="https://erp.sandipuniversity.com/assets/su_logo.jpg" width=" 200px;" alt="sandip-university" style="margin-bottom:5px;">
                    <!-- <h1 style="text-align: center;">SANDIP UNIVERSITY</h1>-->
                     <p style="text-align: center;font-size:13px;margin-bottom:0px;">Neelam Vidya Vihar, Sijoul, P.O. Mailam, Madhubani, Bihar - 847235
<br/> https://sijoul.sandipuniversity.edu.in | <strong>Email:</strong> research.sijoul@sandipuniversity.edu.in 
					 
</p>
    <p style="text-align: center;font-size:13px;font-weight:bold;margin-bottom:0px;">
            SUM Ph.D. Entrance Test Hall Ticket – SUMPET  <?=strtoupper($students['admission_batch'])?> 
         </p>
         ...
         <table >
            <tbody>
               <tr >
				  ...
				  $path = 'https://sandipuniversity.com/phdsunpet/uploads/phd/'.$doc['doc_file'];
				 //echo '<pre>';
               ...
               <tr>
                  ...
                  <td colspan ="2">
                     SANDIP UNIVERSITY, Neelam Vidya Vihar, Sijoul, P.O.
Mailam, Madhubani, Bihar - 847235
                  </td>
               </tr>
               <tr>
                  <td>
                  ...
                  <td  colspan ="2">
                     <big><strong>0607<?= $students['phd_id']?></strong></big>
                  </td>
               </tr>
  ...
  <td height="80" valign="bottom" align="right">
    ...
    <td colspan="2"> 
     ...
     <p align="left" style="text-align: justify;"> <strong>Instruction: </strong><br>1. It is mandatory to carry a valid Government approved Identity proof during Examination (e.g:-
Adhar, Pan, Voter ID, Passport etc.)<br>  
													2. Candidate should report to the Examination Hall on said time, else He/She will not be Permitted.<br> 
													3.Please note that your permit to appear in the Entrance Exam is provisional and is subject to
cancellation if, for any reason you are subsequently found not eligible.</p>
    </td>
    </tr>
         </table>
      </div>
