                                                                ...
                                                                <li>
                                                                    ...
                                                                    <ul class="ul_<?=$cur_menu_id?>">
                                                                        ...
                                                                        for($k=0;$k<count($new_array['privileges_id']);$k++)                                                                       
                                                                        {
                                                                            ...
                                                                            echo "<li style='display:inline'>"."    "."<input type='checkbox' parent='".$cur_menu_id."' name='prev[".$cur_menu_id."][]' value='".$new_array['privileges_id'][$k]."' id='prev_".$cur_menu_id."_".$new_array['privileges_id'][$k]."' onclick='change_parents_value(this)' />        ".$new_array['privileges_name'][$k]."</li>";
                                                                        }
                                                                        ?>
