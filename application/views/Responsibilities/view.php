        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                    ...
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add")?>"><span class="btn-label icon fa fa-plus"></span>Upload Document</a></div>                        
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr >
                                <td><?=$j?></td>                                                                
                                <td><?=$staff_details[$i]['fname']." ".$staff_details[$i]['lname']?></td>
                                <td><a download href="<?php  echo base_url('uploads/staff_document/'.$staff_details[$i]['document_name']) ?>">Download</a>
								</td>                                
