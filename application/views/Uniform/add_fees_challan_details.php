...
$(document).ready(function(){
    ...
    $('#sbutton').click(function()
	{
		...
		{  
			$.ajax({
				'url' : base_url + 'Uniform/students_data',
...
function faci_type()
{
	...
	if(facility==6){
		...
		//alert(facility_type);
		type='POST',url='<?= base_url() ?>Uniform/get_depositedto',datastring={faci_type:facility_type};
		html_content=ajaxcall(type,url,datastring);
		//alert(html_content);
					...
					<form id="form" name="form" action="<?=base_url($currentModule.'/add_fees_challan_submit')?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="panel-body">
                              ...
                              <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">ID/PRN:</label>
									 ...
									 <input type="hidden" id="orgs" name="org_from" />
									   ...
									   <option value="">Academic Year</option>
										...
										if(!empty($academic_details)){
											foreach($academic_details as $academic){
												...
												$ac_year=$arr[0];
												if($academic['activ_for_uniform']=='Y')
												{
												?>
						...
						<input type="hidden" value="" id="famt">
							...
							<div class="form-group">
                                ...
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly" value="0"  name="uniform_fees" id="uniform_fees" onblur="calc_final_amount();" />
                                </div>
