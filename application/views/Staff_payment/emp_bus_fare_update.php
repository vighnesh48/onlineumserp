...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Bus Facility Update</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Bus Facility Update</h1>
            ...
            <div class="col-sm-12">
                        ...
                        <div class="table-info">                              
                             ...
                             <div id="dashboard-recent" class="panel-warning">   
                               <div class="panel">
                            	<div class="panel-heading"><strong>Bus Facility Update</strong></div>
                            ...
                            <div class="form-group">                              
							  ...
							  <form id="form" name="form" action="<?=base_url($currentModule.'/emp_bus_fare_update_submit')?>"  method="POST"  enctype="multipart/form-data">
							   <input type="hidden" name="bus_id" value="<?php echo $busfare_details[0]['bus_id'];?>"/>
                                ...
                                <div class="col-md-4">
                                  <input type="text" class="form-control" name="staffid" value="<?php echo $busfare_details[0]['emp_id']; ?>" id="staffid" />
                                </div>
								...
								<label class="col-md-4">Name</label>
                                             <div class="col-md-8" >
	 <input type="text" class="form-control" readonly name="ename" value="<?php if($busfare_details[0]['gender'] == 'male'){ $m = 'Mr.'; }elseif($busfare_details[0]['gender'] == 'female'){ $m='Mrs.'; }echo $m." ".$busfare_details[0]['fname']." ".$busfare_details[0]['lname']?>" id="nameid" />								   
                                       </div>			 
                                  </div>    
...
<div class="form-group">
								<label class="col-md-4">School </label>
                                             <div class="col-md-8" >
	 <input type="text" class="form-control" readonly name="school" value="<?php echo $busfare_details[0]['emp_id']; ?>" id="schoolid" />
                                       </div>
                                  </div>                      				  
								  
						  <div class="form-group">
								<label class="col-md-4">Boarding Point</label>
                                             <div class="col-md-8" >
	 <input type="text" class="form-control"   name="boarding_point" required value="<?php echo $busfare_details[0]['boarding_point']; ?>" id="boarding_point" />
                                       </div>
                                  </div> 	
 <div class="form-group">
								<label class="col-md-4">Active From</label>
                                             <div class="col-md-4" >
	 <input type="text" class="form-control"  name="active_form" required value="<?php echo date('Y-m',strtotime($busfare_details[0]['active_from'])); ?>" id="active_form" />
                                       </div>
                                  </div> 								  
								</div>
...
<?php $ci =&get_instance();
   $ci->load->model('admin_model'); 
    $department =  $ci->admin_model->getDepartmentById($busfare_details[0]['department']); 
		$school =  $ci->admin_model->getSchoolById($busfare_details[0]['emp_school']); 							 
   ?>
<div class="form-group">
 ...
 <div class="form-group">
								<label class="col-md-4">Amount </label>
                                             <div class="col-md-4" >
	 <input type="text" class="form-control" required maxlength="5"   name="amt" value="<?php echo $busfare_details[0]['bus_fare']; ?>" id="amt" />
                                       </div>
                                  </div>  								  
</div>									  
										</div>
...
<div class="form-group">
								   <div class="col-md-3" ></div>
                                      <div class=" col-md-2">  
                                        ...
                                        <div class="col-sm-2"><button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url($currentModule)?>/emp_bus_fare_list'">Cancel</button></div>
