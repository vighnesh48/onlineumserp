...
$ci =&get_instance();
  ...
  foreach($emp_sal as $val){
	...
	$total_diduction = $val['epf']+$val['ptax']+$val['TDS']+$val['bus_fare']+$val['mobile_bill']+$val['other_advance']+$val['Off_Adv']+$val['co_op_society'];
	?>
 <div style="width:90%;border:1px solid black;margin-bottom:5px;font-size:12px;align:center;margin-left:auto;margin-right:auto;"  >
    ...
    <table width="100%" border="1"  cellspacing="0" cellpadding="3" align="center" style="margin:10px 40px">
      ...
      <td><strong style="font-size:11px;">GROSS EARNING</strong></td>
        ...
        <td style="font-size:11px;text-align:right;"><?php echo $total_diduction;//$val['total_deduct'];?></td>
      </tr>
...
<div style="text-align:right;width:45%;float:right;">printed on: <?php echo date('Y-m-d h:i:s')?> </div>
