...
$this->load->library('excel'); 
	  ...
	  header('Content-Disposition: attachment;filename="mobile_bill.xls"');
	  $styleArray = array(
      'borders' => array(
          'allborders' => array(
...
$styleArray1 = array(
	...
	'alignment' => array(
      ...
      $object->getActiveSheet()->mergeCells('B7:k7');  
		...
		$object->getActiveSheet()->setCellValue('B7', 'Mobile Bill List');
...
$object->getActiveSheet()->setCellValue('H'.$j, $val['mobile']);
$object->getActiveSheet()->setCellValue('I'.$j, $val['mobile_limit']);
$object->getActiveSheet()->setCellValue('J'.$j, $val['bill_amount']);
$object->getActiveSheet()->setCellValue('K'.$j, $val['deduction_amount']);
