...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Bus Facility Add</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Bus Facility Add</h1>
            ...
            <div class="col-sm-12">
                        ...
                        <div class="table-info">                                        
                             ...
                             <div id="dashboard-recent" class="panel-warning">   
                               <div class="panel">
                            	<div class="panel-heading"><strong>Bus Facility Add</strong></div>
                            ...
                            <div class="form-group">
							  ...
							  <form id="form" name="form" action="<?=base_url($currentModule.'/emp_bus_fare_add_submit')?>"  method="POST"  enctype="multipart/form-data">
...
<div class="form-group">
	 ...
	 <label id="schoolid"></label>
                ...
                <label class="col-md-4"><b>Department</b></label>
                                             <div class="col-md-8" >
<lable id="departmentid"></lable>
                                       </div>
                                  </div>  
                  <div class="form-group">
                <label class="col-md-4"><b>Designation</b></label>
                                             <div class="col-md-8" >
   <lable id="designationid" ></lable>
                                       </div>
                                  </div> 
                                  <div class="form-group">
                <label class="col-md-4"><b>Boarding Point</b></label>
                                             <div class="col-md-6" >
   <input type="text" class="form-control"   name="boarding_point" required value="" id="boarding_point" />
                                       </div>
                                  </div>  
 <div class="form-group">
