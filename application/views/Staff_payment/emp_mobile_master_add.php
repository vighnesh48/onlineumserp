...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Employee Mobile Master Add</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Employee Mobile Master Add</h1>
            ...
            <div class="col-sm-12">
                        ...
                        <div class="table-info">                                          
                             ...
                             <div id="dashboard-recent" class="panel-warning">   
                               <div class="panel">
                            	<div class="panel-heading"><strong>Employee Mobile Master Add</strong></div>
                            ...
                            <div class="form-group">
							  ...
							  <form id="form" name="form" action="<?=base_url($currentModule.'/employee_mobile_master_add_submit')?>"  method="POST"  enctype="multipart/form-data">
...
<div class="form-group">
   ...
   <label  id="designationid"></label>
						  ...
						  <div class="form-group">
								<label class="col-md-4"><b>Mobile No</b></label>
                                             <div class="col-md-6" >
	 <input type="text" class="form-control" maxlength="10"  required pattern="[0-9]{10}" name="mobile_no" value="" id="mobile_no" />
                                       </div>
                                  </div> 	

 <div class="form-group">
                <label class="col-md-4"><b>Amount Limit</b></label><div class="col-md-6" >
   <input type="text" class="form-control" required maxlength="5"   name="amt_limt" value="" id="amt_limt" />
                                       </div>						 
								</div>
                <div class="form-group">
                <label class="col-md-4"><b>Deduction Required </b></label><div class="col-md-6" >
   <input type="radio"   name="dect_req" value="Y" /> Yes
   <input type="radio"  name="dect_req" value="N" /> No
                                       </div>            
                </div>
                <div class="form-group">
                <label class="col-md-4"><b>Remark</b></label><div class="col-md-6" >
   <textarea class="form-control" required name="remark" value="" id="remark" ></textarea>
                                       </div>            
                </div>
					</div>	
          </div>				
