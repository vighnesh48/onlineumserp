...
<body class="theme-default page-signin">
			...
			*/
			...
			<form action="" id="signin-form_id" method="post">
				...
				<div class="form-group w-icon">
					<input type="text" name="signin_username" id="username_id" class="form-control input-lg" value="" placeholder="Enrollment Number" required>
   ...
   <div class=" form-group date w-icon" id="otpid"> 
				...
				<div class="form-actions">
					<input type="button" name="button" value="Resend Password" id="signin-btn" class="signin-btn" style="background-color: #ed3237;color: white">
