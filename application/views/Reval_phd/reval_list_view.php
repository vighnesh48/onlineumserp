    ...
    <div class="page-header">
    	<div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="row"> 
					<a href="<?=base_url()?>Reval_phd/search_student_admin" target="_blank"><button class="btn btn-primary pull-right" style="margin-right:15px;">Add</button></a>				
            ...
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                        <span class="panel-title">
                            <form method="post" action ="<?=base_url()?>Reval_phd/list_applied">	
                           ...
                           // echo "<pre>";
                            ...
                            <tr>
                              ...
                              <td><?=$value['enrollment_no']?></td>
                                ...
                                <td width='150px'><a href="<?=base_url()?>Reval_phd/search_student_admin/<?=$value['enrollment_no']?>/<?=$exam_id?>/<?=$reval_type?>" target="_blank"><button class="btn btn-primary btn-xs" id="v_sd">View</button></a> | <a href="<?=base_url()?>Reval_phd/remove_reval/<?=$value['enrollment_no']?>/<?=$exam_id?>" target="_blank"><button class="btn btn-primary btn-xs" id="v_sd">Delete</button></a></td>
                            </tr>
                            <?php
                            $j++;
                            }
...
$(document).ready(function () {
    ...
    $('#ex_list').on('click', function () {	
    	var stream_id = '<?=$stream?>'
    	var exam_id= '<?=$exam_id?>';
    	window.location.href = '<?= base_url() ?>Reval_phd/excel_applied_list/'+stream_id+'/'+exam_id;
	}); 
});
