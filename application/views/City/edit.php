...
<?php
    ...
    //echo "<pre>";print_r($city_details); echo "</pre>";
?>
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                <input type="hidden" value="<?=isset($city_details['city_id'])?$city_details['city_id']:""?>" id="city_id" name="city_id" />                                
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">                                        
                                        <select name="state_id" id="state_id" class="form-control">
                                            ...
                                            <option value="<?=$state_details[$i]['state_id']?>" <?=$city_details['city_id']==$state_details[$i]['state_id']?"selected='selected'":""?> ><?=$state_details[$i]['state_name']?></option>
                                            <?php }?>
                                        </select>
                                    </div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="city_code" name="city_name" class="form-control" value="<?=isset($city_details['city_name'])?$city_details['city_name']:''?>" /></div>                                    
