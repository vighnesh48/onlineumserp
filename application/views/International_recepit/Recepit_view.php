...
<div id="content-wrapper">
   ...
   <div class="page-header">
      <div class="row">
         <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add International Recepit 2021-22</h1>
            ...
            <div id="dashboard-recent" class="panel panel-warning">
               <div class="tab-content">
                  ...
                  <div id="personal-details" class="widget-comments panel-body tab-pane fade active in">
                     <div class="panel">
                        <form id="Bonafide"   name="Bonafide" action="<?php echo base_url();?>International_recepit/insert_data" method="post"  enctype="multipart/form-data" >
                           ...
                           <fieldset class="scheduler-border">
                            ...
                            <div class="col-sm-3"><input type="text" id="Recepit_date" name="Recepit_date" class="form-control" value="<?php echo date('Y-m-d');?>" required="required"/></div>
                          ...
                          <?php } ?>
                           ...
                           <option value="2">2nd Year</option>
                                 ...
                                 <div><input type="hidden" id="ref_no" name="ref_no" class="form-control" placeholder="Ref No" required="required" /></div>
                              ...
                              <label class="col-sm-1">Passport&nbsp;No<?=$astrik?></label>
                                 <div class="col-sm-3"><input type="text" id="Passport_No" name="Passport_No" class="form-control" placeholder="" minlength="15"/></div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-3"><input type="file" id="file" name="file" class="form-control" placeholder=""  required="required"/></div>
...
function OpenDialouge(m){
	...
	$.ajax({
                   type: 'POST',
                   url: '<?= base_url() ?>International_recepit/fetch_Bonafide',
                   data: {'bcd_id' : m},
...
function OpenDialougeedit(m){
	...
	$.ajax({
                   type: 'POST',
                   url: '<?= base_url() ?>International_recepit/OpenDialougeedit',
                   data: {'bcd_id' : m},
                   success: function (resp) {
...
function OpenDialougedeleted(m){
  ...
  if (x){
	$.ajax({
                   type: 'POST',
                   url: '<?= base_url() ?>International_recepit/OpenDialougedeleted',
                   data: {'bcd_id' : m},
                   success: function (resp) {
...
//resetPaging: false,
        ...
        "ajax": {
            "url": "<?php echo site_url('International_recepit/ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
    ...
    $('#btn-reset').click(function(){ //button reset event click
	 ...
	 $("#save_status").on('click', function () {
		  ...
		  // window.location='<?= base_url() ?>Bonafide/Enquiry_list/'+value+'/';
		   ...
		   $.ajax({
                   type: 'POST',
                   url: '<?= base_url() ?>International_recepit/save_status',
