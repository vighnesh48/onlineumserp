...
<div id="content-wrapper">
   <ul class="breadcrumb breadcrumb-page">
      ...
      <li class="active"><a href="#">International Recepit 2021-22</a></li>
   ...
   <div class="page-header">
      <div class="row">
         <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp; International Recepit 2021-22</h1>
            ...
            <div id="dashboard-recent" class="panel panel-warning">
               <div class="tab-content">
                  ...
                  <div id="personal-details" class="widget-comments panel-body tab-pane fade active in">
                     <div class="panel">
                        <form id="Bonafide"   name="Bonafide" action="<?php echo base_url();?>Bonafide/insert_data" method="post"  enctype="multipart/form-data" >
                           ...
                           <fieldset class="scheduler-border">
                            ...
                            <div class="col-sm-3"><input type="text" id="Bonafide_date" name="date" class="form-control Bonafide_date" value="" required="required"/></div>
                             <label class="col-sm-1">Consultant<?=$astrik?></label>
                                 <div class="col-sm-3">
                                 <select name="consultant" id="Consultant" class="form-control">
                           <option value="">Select Consultant</option>
                           <?php foreach($consultants_list as $list){ ?>
                           <option value="<?php echo $list['id'];?>" ><?php echo $list['contact_person'];?></option>
                           ...
                           <option value="2021" selected="selected">2021-22</option>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-3">
                                    <select name="drcc_city" id="drcc_city" class="form-control">
                           <option value="">Select City</option>
                            <?php foreach($city_list as $clist){ ?>
                           <option value="<?php echo $clist['city_id'];?>"><?php echo $clist['city_name'];?></option>
                          <?php } ?>
                           </select>
                                 </div>
                                  <label class="col-sm-1">Ref No<?=$astrik?></label>
                                 <div class="col-sm-3"><input type="text" id="ref_no" name="ref_no" class="form-control" placeholder="Ref No" required="required" title="Ref No should only letters. e.g. john"/></div>
                                 
                                  <label class="col-sm-1">Full Ref No<?=$astrik?></label>
                                 <div class="col-sm-3">
                                    <input type="text" id="full_ref_no" name="full_ref_no" class="form-control" placeholder="Full Ref No" required="required" title="Full Ref No"/>
                                 </div>
                              </div>
                            ...
                            <?php foreach($streams_yearwise as $slist){ ?>
                          ...
                          <?php } ?>
                           ...
                           <option value="4">4th Year</option>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-3"><input type="text" id="student_name" name="student_name" class="form-control" placeholder="Student&nbsp;Name" required="required" pattern="^[A-Za-z][A-Za-z0-9!@#$%^&amp;* ]*$" title="Full Name should only letters. e.g. john"/></div>
                                 <label class="col-sm-1">Father&nbsp;Name&nbsp;<?=$astrik?></label>
                                 <div class="col-sm-3">
                                    <input type="text" id="father_name" name="father_name" class="form-control" placeholder="Father&nbsp;Name" required="required" pattern="^[A-Za-z][A-Za-z0-9!@#$%^&amp;* ]*$" title="Father Name should only letters. e.g. john"/>
                                 </div>
                                 <label class="col-sm-1">Mother&nbsp;Name&nbsp;<?=$astrik?></label>
                                 <div class="col-sm-3">
                                    <input type="text" id="mother_name" name="mother_name" class="form-control" placeholder="Mother&nbsp;Name" required="required" pattern="^[A-Za-z][A-Za-z0-9!@#$%^&amp;* ]*$" title="Mother Name should only letters. e.g. john"/>
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label class="col-sm-1">Email&nbsp;</label>
                                 <div class="col-sm-3"><input type="email" id="email_id" name="email" class="form-control" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" /></div>
                                 <label class="col-sm-1">Mobile1&nbsp;<?=$astrik?></label>
                                 <div class="col-sm-3">
                                    <input type="text" id="mobile1" name="mobile1" class="form-control" placeholder="mobile" required="required" maxlength="10"/>
                                 </div>
                                 <label class="col-sm-1">Mobile2&nbsp;</label>
                                 <div class="col-sm-3">
                                    <input type="text" id="mobile2" name="mobile2" class="form-control" placeholder="Mobile12&nbsp;No"/>
                                 </div>
                              </div>
                              <div class="form-group">
                          ...
                          <?php } ?></select>
                                 ...
                                 <div class="col-sm-3">
                                    <input type="text" id="village" name="village" class="form-control" placeholder="Village" required="required" />
                                 </div>
                                    <label class="col-sm-1">Pincode</label>
                                 <div class="col-sm-3"><input type="text" id="pincode" name="pincode" class="form-control" placeholder="Pincode"  /></div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-1">Gender<?=$astrik?></label>
                                 ...
                                 <label class="col-sm-1">Hostel&nbsp;Type<?=$astrik?></label>
                                 <div class="col-sm-3">
                                    <select name="hostel_type" id="hostel_type" class="form-control"  required="required">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-3"><input type="text" id="aadhar_card" name="aadhar_card" class="form-control" placeholder="" minlength="12"/></div>
                                 <label class="col-sm-1">Computer<?=$astrik?></label>
                                 <div class="col-sm-3">
                                    <select name="computer_status" id="computer_status" class="form-control"  required="required">
                                       <option value="">Select Type</option>
                                       <option value="Y">YES</option>
                                       <option value="N">NO</option>
                                    </select>
                                 ...
                                 <div class="col-sm-3"><input type="text" id="Amount" name="Amount" class="form-control" placeholder=""  required="required"/></div>
...
//resetPaging: false,
        ...
        "ajax": {
            "url": "<?php echo site_url('Bonafide/ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
