...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Scholarship & concession Upload</h1>
                    ...
                    <div id="dashboard-recent" class="panel panel-warning">        
                     <div class="panel-heading">
                       <span class="panel-title"><i class="panel-title-icon fa fa-fire text-danger"></i>Search Student</span>
						...
						<br>
						<form id="form1" name="form1" enctype="multipart/form-data" action="<?=base_url($currentModule.'/Excel_upload')?>" method="POST">
                                                <div class="row">
					   <div class="form-group">
	 
                      <div class="col-sm-2"><input type="file" class="form-control" name="Excel_upload" id="Excel_upload" placeholder="Excel upload."></div>
                      <div class="col-sm-2"><button class="btn btn-primary form-control" id="sbutton" type="submit" >Upload</button></div>    
