...
<div id="content-wrapper">
 <input type='hidden' id='date' value='<?php if (isset($date) && $date !=''){
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Provisional Admissions Report 2020-21</h1>
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="row" style="display:none">
                             <div class="col-sm-3">Total Provisional Admissions:<b> <?php
                             
						if(!empty($stud_data)){							
                            echo count($stud_data);
						}  
                            ?></b></div><div>
                           <div class="col-sm-1">Document&nbsp;status</div>
                           ...
                           <div class="col-sm-1">Admission&nbsp;status</div>
   ...
   <!-- <form method="post">
        ...
        <div class="row ">
            ...
            <thead>
                <tr>
                    <th width="5px">No</th>
                    <th width="10px" >School&nbsp;name</th>
                    <th width="10px" >Stream&nbsp;name</th>
                    <th width="5px">Year</th>
                    <th width="5px">Provisional&nbsp; </th>
                    <th width="5px">Confirm&nbsp;</th>
                    <th width="5px">Pending</th>
                    <th width="5px">MS&nbsp;</th>
                    <th width="5px">OMS&nbsp;</th>
                    <th width="5px">International&nbsp;</th>
                    <th >Cancel&nbsp;</th>
                     </tr>
            </thead>
            <tbody>
...
//resetPaging: false,
        ...
        "ajax": {
            "url": "<?php echo site_url('Provisional_admission/Admission_report_ajax')?>",
            "type": "POST",
            "data": function ( data ) {
