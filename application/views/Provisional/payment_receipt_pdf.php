...
table tr td{vertical-align:top;padding-left:4px;padding-right:4px;padding-top:2px;padding-bottom:2px;}
...
if($fee_det['admission_year']==1)
{
 $year="First Year";   
}
 if($fee_det['admission_year']==2)
{
 $year="Second Year";   
}
if($fee_det['admission_year']==3)
{
 $year="Third Year";   
}
if($fee_det['admission_year']==4)
{
 $year="Forth Year";   
}
    ?>
...
<table width="100%" border="1" cellspacing="0" cellpadding="3" style="border:1px solid  #333;">
  ...
  <tr>
    <td><strong>Receipt No. : </strong><?=$fee_det['college_receiptno']?> / <?=$fee_det['sys_fees_id']?></td>
    <td><strong>Date : </strong><?php if($fee_det['fees_date']==''){} else{ echo date('d-m-Y',strtotime(str_replace("/","-", $fee_det['fees_date'])));}?></td>
    <td><strong>Reg. No. : </strong><?=$fee_det['prov_reg_no']?> </td>
  </tr>
  <tr>
    <td><strong>Name : </strong><?=$fee_det['student_name']?></td>
    <td><strong>Year : </strong><?=$year?></td>
    <td><strong>Academic Year : </strong><?php 
     $var = substr($fee_det['year'], -2);

$var = ++$var;
   echo $fee_det['year']."-".$var;?></td>
    
    </tr>
    
  
      <tr>
    <td colspan="3"><strong>Course : </strong><?=$fee_det['sprogramm_acro']?></td>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border:1px solid  #333;">
  <tr>
    ...
    <td>Admission / Registration Fees</td>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border:1px solid #333;">
  ...
  <tr>
      <td  width="150"><strong>By <?=$fee_det['fees_paid_type']?> No. : </strong><?=$fee_det['receipt_no']?></td>
    <td><strong>Drawn on Bank : </strong><?=$fee_det['bank_name']." ".$fee_det['bank_city']?></td>
    <td width="120"><strong>Dt. : </strong><?php if($fee_det['fees_date']==''){} else{ echo date('d-m-Y',strtotime(str_replace("/","-", $fee_det['fees_date'])));}?></td>
    </tr>
  <tr>
