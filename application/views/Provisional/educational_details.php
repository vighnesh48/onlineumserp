               ...
               <div class="xtable-info">
                  <div id="dashboard-recent" class="panel panel-warning">
                     ...
                     <div class="tab-content">
                        <form method="post" action="<?=base_url()?>Ums_admission/updateEducation" enctype="multipart/form-data">
...
?>
                                    ...
                                    <td><input type="text" name="percentage[]" class="form-control" value="<?= isset($var['percentage']) ? $var['percentage'] : '' ?>" placeholder="" required/></td>
                                     <td><input type="file" name="sss_doc[]" id="sss_doc" style="width:80px" > <br><a href="<?= site_url() ?>uploads/student_document/<?=$var['file_path'];?>" target="_blank"> <?= isset($var['file_path']) ? $var['file_path'] : '' ?></a></td>
                                   <td></td>
                                  </tr>
								<?php $j++;}
									}
