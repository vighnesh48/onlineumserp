                        ...
                        <div id="personal-details" class="setup-content widget-comments panel-body tab-pane fade active in">
                         ...
                         <input type="text" id="sgrn" name="sgrn" class="form-control" value="<?= isset($emp_list[0]['general_reg_no']) ? $emp_list[0]['general_reg_no'] : ''; ?>" placeholder="Student GRN Number" />
                              ...
                              <div class="col-sm-3">
                                ...
                                <input id="sfnumber" name="sfnumber" class="form-control" value="<?= isset($emp_list[0]['form_number']) ? $emp_list[0]['form_number'] : ''; ?>" placeholder="Admission Form Number " type="text" required="">
                                    ...
                                    <tr>
                                       ...
                                       <td width="47%">
                                          <div class="form-group">
                                             ...
                                             <div class="col-sm-6">
                                                <textarea id="laddress" class="form-control" NAME="laddress" style="margin: 0px; width: 200px; height: 50px;" required><?= isset($local_address[0]['address']) ? $local_address[0]['address'] : ''; ?></textarea>
                                             </div>
                                          </div>
                                          <div id='ladd'>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-sm-6">
                                                <INPUT TYPE="TEXT" class="form-control numbersOnly" id="lpincode" NAME="lpincode" value="<?= isset($local_address[0]['pincode']) ? $local_address[0]['pincode'] : ''; ?>" required>
                                             </div>
                                          </div>
                                          </div>
                                       </td>
                           ...
                           <div class="panel">
                              ...
                              <div class="panel-body">
                                 <!--div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                       <input type="text" id="parent_lname" name="lname" class="form-control" value="<?= isset($parent_details[0]['glast_name']) ? $parent_details[0]['glast_name'] : ''; ?>" placeholder="Last Name" />
                                    </div>
                                    <div class="col-sm-3">
                                       <input type="text" id="parent_fname" name="fname" class="form-control" value="<?= isset($parent_details[0]['gfirst_name']) ? $parent_details[0]['gfirst_name'] : ''; ?>" placeholder="First Name" />
                                    </div>
                                    <div class="col-sm-3">
                                       <input type="text" id="parent_mname" name="mname" class="form-control" value="<?= isset($parent_details[0]['gmiddle_name']) ? $parent_details[0]['gmiddle_name'] : ''; ?>" placeholder="Middle Name" />
                                    </div>
                                 </div-->
                                 <div class="form-group">
                                 ...
                                 <!--div class="form-group">
                                    <label class="col-sm-3">Mobile</label>
                                    <div class="col-sm-3">
                                       <input type="text" id="parent_mobile" name="parent_mobile" class="form-control" value="<?= isset($parent_details[0]['parent_mobile2']) ? $parent_details[0]['parent_mobile1'] : ''; ?>" maxlength="10"/>
                                    </div>
                                    <label class="col-sm-3">Phone No</label>
                                    <div class="col-sm-3">
                                       <input type="text" id="parent_phone" name="parent_phone" class="form-control" value="<?= isset($parent_details[0]['parent_mobile1']) ? $parent_details[0]['parent_mobile2'] : ''; ?>" />
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="col-sm-3">Address</label>
                                    <div class="col-sm-3">
                                       <textarea id="gparent_address" name="gparent_address" class="form-control" rows="3" cols="50" style="resize: vertical;" ><?= isset($parent_address[0]['address']) ? $parent_address[0]['address'] : '' ?>
                                       </textarea>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                       ...
                                       <select class="form-control" name="gstate_id" id="gstate_id" required>
                                          ...
                                          <?php
                                             if(!empty($states)){
                                                 foreach($states as $stat){
                                                     ?>
                                          <option <?php if($parent_address[0]['state_id']==$stat['state_id']){echo 'selected';} ?> value="<?=$stat['state_id']?>"><?=$stat['state_name']?></option>
                                          <?php 
                                             }
                                             }
                                             ?>
                                       ...
                                       <select class="form-control" name="gdistrict_id" id="gdistrict_id" required>
                                                <?php
                                                      if(!empty($parentdistrict)){
                                                          foreach($parentdistrict as $stat){
                                                              ?>
                                                   <option value="<?=$stat['district_id']?>" <?php if($stat['district_id'] == $parent_address[0]['district_id']){echo "selected";} ?> ><?=$stat['district_name']?></option>
                                                   <?php 
                                                      }
                                                      }
                                                      ?>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                       <select class="form-control" name="gcity" id="gcity">
                                              <?php
                                                      if(!empty($parentcity)){
                                                          foreach($parentcity as $stat){
                                                              ?>
                                                   <option value="<?=$stat['taluka_id']?>" <?php if($stat['taluka_id'] == $parent_address[0]['city']){echo "selected";} ?> ><?=$stat['taluka_name']?></option>
                                                   <?php 
                                                      }
                                                      }
                                                      ?>
                                    ...
                                    <label  class="col-sm-3">Pin Code: <?=$astrik?></label>
                                    <div class="col-sm-3">
                                       <INPUT TYPE="TEXT" class="form-control numbersOnly" id="gpincode" NAME="gpincode" value="<?= isset($parent_address[0]['pincode']) ? $parent_address[0]['pincode'] : ''; ?>" required>
                                    </div>
                                 </div>
                              </div-->
                           </div>
