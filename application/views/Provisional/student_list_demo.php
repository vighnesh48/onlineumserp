...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Provisional Admissions 2019</h1>
                ...
                <div class="panel-body" style="overflow:scroll;height:800px;">
                    ...
                    <table  id="search-table" class="table table-bordered table-list-search">
						...
						if(!empty($stud_data)){	
                            ...
                            <tr  class="myHead">
                                <td><?=$j?></td>    
                                     <td><?=$stud_data[$i]['prov_reg_no']?></td> 
                                 <td><?=$stud_data[$i]['student_name']?></td>
                           
                                     
                        
                                <td><?=$stud_data[$i]['mobile1']?></td>
                                   <td><?=$stud_data[$i]['city_name']?></td>
                             ...
                             <!-- <td><?=$stud_data[$i]['state_name']?></td>
                                ...
                                <td><?=$stud_data[$i]['sprogramm_name']?></td>
                 ...
                 <p><?php  echo $new_links['navigation'];  ?></p>
                </div>
            </div>
            </div>    
        </div>
