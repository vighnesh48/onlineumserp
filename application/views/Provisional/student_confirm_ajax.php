...
<div id="content-wrapper">
 <input type='hidden' id='date' value='<?php if (isset($date) && $date !=''){
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Confirm Admissions</h1>
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                   ...
                   <div class="col-sm-6">
                           ...
                           <div class="col-sm-4"><select name="year" id="year" class="form-control" onchange="order_status_change(this)">
                            <option value="">Select Yeatr</option><option value="2020" >2020-21</option>
  ...
  <strong> <span id="flash-messages" style="color:Green;padding-left:50px;">
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="row ">
                             <div class="col-sm-4">Total&nbsp;Confirm&nbsp;Admissions:<b> <?php
						...
						if(!empty($stud_data)){							
                           ...
                           <div class="col-sm-2"><select name="Admission_status" id="Admission_status" class="form-control" onchange="Admission_status_change(this)">
                            ...
                            <div class="col-sm-2"> &nbsp;</div> <div class="col-sm-2"><b><a href="<?php echo base_url();?>Provisional_admission/list_admissions_l" target="_blank"><button name="">Provisional List</button></a></b></div>                        
...
//resetPaging: false,
        ...
        "ajax": {
            "url": "<?php echo site_url('Provisional_admission/list_confirm_ajax')?>",
            "type": "POST",
            "data": function ( data ) {
...
function admissiom_chnage(m){
		...
		var id = $(m).attr("lang");
	   if((docuemnt_confirm=="")||(docuemnt_confirm=="N")){alert("Document Not Verify");
		   return false;}else{
