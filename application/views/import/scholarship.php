  <div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            <li class="active"><i class="fa fa-list"></i> Import Scholarship</li>
        </ol>            
    </div>
</div><!-- /.row -->
						...
						<form action="<?=base_url()?>Import/add_exemption" enctype="multipart/form-data" method="post" accept-charset="utf-8">
