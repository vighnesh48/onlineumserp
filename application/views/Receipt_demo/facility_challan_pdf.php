...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="33%" valign="top">
       ...
       <?php } ?>
        ...
        <tr>
          ...
          <td><strong>Class :</strong> <?php if($std_challan_details['current_year']==1)echo 'First year';
		  else if($std_challan_details['current_year']==2)echo 'Second year'; else if($std_challan_details['current_year']==3) echo 'Third year';else echo 'Fourth year';?></td>
        </tr>
        <tr>
          
          <td width="50%"><strong>Challan No. :</strong><?=$form_no?></td>
		  <td>&nbsp;&nbsp;&nbsp;<img style="padding-top:5px;" src="<?=base_url()?>uploads/facility_challan/<?=$form_no?>.jpg" alt="Sandip University" /></td>
        </tr>
        <tr>
		<td colspan="2">
	...
	<tr>
	   ...
	   <?php 
	   if($std_challan_details['fees_paid_type']=='CASH')
	  {}else 
	   if($std_challan_details['fees_paid_type']=='CASH')
	  {
		  ?>
