...
$(document).ready(function(){
    ...
    $('#sbutton').click(function()
	{
		...
		/*if((mobileno=='')||(Formno==''))
		{
			$('#err_msg').html("Please enter mobile Number.");
			$('#std_details').hide();
			$('#fee_details').hide();
			    //    $("#form").trigger("reset");
		...
		{  
			$.ajax({
				'url' : base_url + 'Receipt/students_data',
				'type' : 'POST', //the way you want to send data to your URL
				'data' : {mobileno:mobileno,Formno:Formno},
				'success' : function(data){ //probably this request will return anything, it'll be put in var "data"
					...
					if(data != "{\"std_details\":null}")
					{
						...
						$('#Name').val(array.std_details.student_name);
						$('#mobile_no').val(array.std_details.mobile1);
						$('#course').val(array.std_details.sprogramm_name);
						$('#course_id').val(array.std_details.programme_id);
						$('#student_id').val(array.std_details.id);
						/*
...
function faci_type(){
	...
	if(academic!='' && facility!=''){
		...
		if(facility=="2"){
		//$("#form").trigger("reset");
		type='POST',url='<?= base_url() ?>Receipt/get_fee_details_new',datastring={academic:academic,facility:facility,enroll:enroll,stud:stud,curr_yr:curr_yr,admission_session:admission_session};
		html_content=ajaxcall(type,url,datastring);
	//	alert(html_content);
...
function calc_final_amount(){
			...
			+parseInt(exmf)+parseInt(unirf)+parseInt(Excess); 
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-5 text-ctext-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Generate Receipt </h1>
        ...
        <div class="row ">
            <div class="col-sm-12">
                <div class="panel">
					...
					<div class="row">
						<div class="col-sm-3">
							Mobile No.<input type="text" class="form-control numbersOnly" name="mobileno" id="mobileno" placeholder="mobile No."/>
						</div>
                        <div class="col-sm-1">OR</div>
                        <div class="col-sm-3">
						 Form No.<input type="text" class="form-control" name="Formno" id="Formno" placeholder="Form No."/>
						</div>
		...
		<form id="form" name="form" action="<?=base_url($currentModule.'/add_fees_receipt_submit')?>" method="POST" >
                            ...
                            <div class="panel-body">
							  ...
							  <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Current Year:</label>
									 <div class="col-md-7" style="padding-left:0px;">
<!--									 <input type="text" name="current_year" class="form-control" id="current_year" value=""  />
-->                                     <select name="current_year" id="current_year" class="form-control">
    ...
    more.
					...
					<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="tutf" id="tutf" value="0" onblur="calc_final_amount();" /></div>
			...
			<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="devf" id="devf" value="0"  onblur="calc_final_amount();" /></div>
		...
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="cauf" id="cauf" value="0" onblur="calc_final_amount();"  /></div>
			...
			<div class="form-group">
			 ...
			 <div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="admf" id="admf" value="0" onblur="calc_final_amount();"  /></div>
             <div class="col-md-1" ></div>
								  </div>
                                  
                                  
			<div class="form-group">
            <!--<input type="hidden" class="form-control numbersOnly" name="admf" id="admf" value="0" onblur="calc_final_amount();"  />-->
			...
			<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="exmf" id="exmf" value="0"  onblur="calc_final_amount();" /></div>
		...
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="unirf" id="unirf" value="0" onblur="calc_final_amount();" /></div>
        ...
        <label class="col-md-1"></label>
         <label class="col-md-1"></label>
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Excess" id="Excess" value="0" onblur="calc_final_amount();" /></div>
             <div class="col-md-1">
									   </div>
								  </div>
                                  ...
                                  <!--<div class="form-group">
								   <label class="col-md-4" style="padding-left:0px;"> Balance Amount:</label>
                                    <label class="col-md-1"></label>
         <label class="col-md-1"></label>
													 <div class="col-md-5" >
