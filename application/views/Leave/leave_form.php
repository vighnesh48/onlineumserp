...
<div class="panel" id="type">
              ...
              <label class="col-sm-3"><input type="radio"  value="leave" id="formtype_wfm" name="formtype">Work From Home</label>
...
<label ><input type="radio" value="N" id="gate_pass_no" checked name="gate_pass">No</label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                        ...
                        <div class="col-md-3">                            
                            <input class="form-control" id="dob-datepicker" name="leave_applied_from_date" value="" onchange="checkLeaveDuration()" placeholder="Leave From Date" type="text" required readonly="readonly">
                            </div>
...
<div class="col-md-3">  
 ...
 <div class="panel-heading"><strong> Application For OD</strong><?php $date = new DateTime('now', new DateTimeZone('Asia/Kolkata'));?>
  <span class="pull-right"><b>Current Date: <?=$date->format('d-m-Y H:i:s a')?></b>       
                                ...
                                <div class="panel-body">
                <form  id="form-forod"  name="form-forod" action="<?=base_url($currentModule.'/add_leave')?>" method="POST" enctype="multipart/form-data">
<input type="hidden" name="emp_id" value="<?php echo $this->session->userdata('name');?>">
   ...
   <input type="hidden" name="ltyp" id="ltyp" value="OD" />             
             ...
             <input class="form-control"  type="hidden" name="today_date" id="today_date" value="<?=$date->format('d-m-Y H:i:s a')?>">
                 ...
                 <div class="form-group">
                        ...
                        <option value="OD" selected >Official</option>
                        </select>
                        </div>
...
<label class="col-md-3 control-label">School</label>
                  ...
                  <label class="col-md-3 control-label">OD Document*</label>
                  <div class="col-md-3">
                  <input class="form-control"  type="file" name="od_cert" id="od_cert" required="required">
                  </div>
                  </div>
...
<div class="form-group">
                ...
                <div class="panel" id="wfmn" style="display:none;">
                              <div class="panel-heading"><strong> Application Work From Home</strong>
                                <?php $date = new DateTime('now', new DateTimeZone('Asia/Kolkata'));?>
  <span class="pull-right"><b>Current Date: <?=$date->format('d-m-Y H:i:s a')?>     </b>        
                         </span></div>
           ...
           <form id="form-for_wfh" name="form-wfh" action="<?=base_url($currentModule.'/add_leave')?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="emp_id" value="<?php echo $this->session->userdata('name');?>">
                <input type="hidden" name="in-leave" value="1">
                <input type="hidden" name="apply_leave_type" value="leave">
                <input type="hidden" name="vl_leave" id="vl_leave" value="">
                <input class="form-control"  type="hidden" name="today_date" id="today_date" value="<?=$date->format('d-m-Y H:i:s a')?>">
                  <input type="hidden" name="ltyp" id="ltyp" value="" />    
                        ...
                        <option value=""> Select Leave Type</option>
                        <option value='WFH' selected="selected">WFH</option>
                         <?php /*foreach($emp_leave_list as $val){
              $bal = $val['leaves_allocated']-$val['leave_used'];
              ...
              echo "<option value='".$val['id']."'>".$val['leave_type']."</option>";
					 ...
					 //echo "<option value='LWP'>LWP</option>"; 
                      ...
                      <!--  <option value='9'>LWP</option> -->
                        ...
                        <select id="leave_duration" name="leave_duration" onchange="display_duration(this.value);" class="form-control" required>
                        <option value=""> Select Duration</option>
                        <option value="full-day" selected="selected">Full-Day</option>
                     <!--   <option value="half-day">Half-Day</option>-->
                        </select>
                        </div>
...
<label ><input type="radio" value="N" id="gate_pass_no" checked name="gate_pass">No</label>
...
</div>-->     <input type="hidden" value="N" id="gate_pass_yes"  name="gate_pass">         
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                        ...
                        <div class="col-md-3">                            
                            <input class="form-control" id="dob-datepicker_10" name="leave_applied_from_date" value="" onchange="checkLeaveDuration()" placeholder="WFH From Date" type="text" required>
                            </div>
                      <label class="col-md-3 control-label">WFH To Date</label>
                        <div class="col-md-3">                          
                              <input class="form-control" id="dob-datepicker_11" name="leave_applied_to_date"  value="" placeholder="WFH To Date" type="text" >
                              <input class="form-control" id="dob-for-half-day" style="display:none" name="applied_to_date1"  value="" placeholder="Leave To Date" type="text">
                            </div>    
                          </div>
                                     <div class="form-group">
                   <label class="col-md-3 control-label">No Of Days.</label>
                   <div class="col-md-3">
                  <input class="form-control"  required type="text" readonly onclick="getTotalDays11();" name="no_days" id="no_days11" value="">
                  </div>
                   <label class="col-md-3 control-label">Designation</label>
                   <div class="col-md-3">
                  <input class="form-control" readonly type="text" name="designation" id="designation" value="<?=$emp_detail[0]['designation_name']?>">
                  ...
                  <input class="form-control" readonly type="text" name="school" id="school" value="<?=$emp_detail[0]['college_name']?>">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-9">
                        <textarea  class="form-control"  style="resize:none;overflow-y:scroll;height:50px" required name="reason" placeholder="Purpose For WFH" ></textarea>
                        </div>
                          </div>
...
//$('emp-table').tableCheckbox({ /* options */ });
 ...
 <div class="form-group">
  <label class="col-md-3 control-label">Contact Details During WFH Period</label>
  <div class="col-md-3">
  <textarea name="leave_contct_address" class="form-control" id="leave_contct_address" ><?=$emp_detail[0]['lflatno'].','.$emp_detail[0]['larea_name'].','.$emp_detail[0]['larea_name'].','.$emp_detail[0]['ltaluka'].','.$emp_detail[0]['ldist'].' - '.$emp_detail[0]['lpincode']?></textarea>
  </div>
  <label class="col-md-3 control-label">Mobile No.</label>
<div class="col-md-3">  
  <input type="text" name="leave_contct_no" id="leave_contct_no" value="<?=$emp_detail[0]['mobileNumber'];?>" class="form-control" placeholder="Mobile No">
                                    ...
                                    <?php if(($this->session->userdata('name')=="110096") || ($this->session->userdata('name')=="110461") || ($this->session->userdata('name')=="110563")){ //||||($this->session->userdata('name')=="210582")($this->session->userdata('name')=="210523")($this->session->userdata('name')=="210549")||||($this->session->userdata('name')=="210555")||($this->session->userdata('name')=="210588")||($this->session->userdata('name')=="210583")||($this->session->userdata('name')=="110412")||($this->session->userdata('name')=="110078")||($this->session->userdata('name')=="210534")($this->session->userdata('name')=="110368")||($this->session->userdata('name')=="210560")||||($this->session->userdata('name')=="210560")||($this->session->userdata('name')=="110330")?>
                                        <button class="btn btn-primary form-control" id="btn_submit" type="submit" >Submit  </button>      
                                        <?php }else{ ?> <?php }?>                                
                                    </div> 
                                    </div>                        
...
//alert("kk"+favorite[i]);  
  ...
  $("input[name='formtype']").click(function () {
        ...
        $("#leaveBal").hide();
		$("#wfmn").hide();
            }else if($("#formtype_wfm").is(":checked")){
	    $("#forod").hide();
        $("#forleave").hide();
        $("#leaveBal").hide();
		$("#wfmn").show();
  ...
  // startDate: '01-'+m+'-'+y     
	...
	// $('#dob-datepicker1').datepicker('setStartDate');
    ...
    format: 'dd-mm-yyyy',
     startDate: new Date()     
            ...
            var minDate = new Date(selected.date.valueOf());
            $('#dob-datepicker').datepicker('setEndDate', minDate);//$('#dob-datepicker').datepicker('setEndDate', minDate);
			//$('#dob-datepicker').datepicker('setEndDate');
            getTotalDays();
            var depid = $('#reporting_dept').val();
      getEmp_using_deptforLeave(depid);
  });
    ...
    startDate: new Date()
        ...
        var minDate = new Date(selected.date.valueOf());
        $('#dob-datepicker_11').datepicker('setStartDate', minDate);
	// $('#dob-datepicker1').datepicker('setStartDate');
      var depid = $('#reporting_dept').val();
      getEmp_using_deptforLeave(depid);
    //getTotalDays();
    $('#form-wfh').bootstrapValidator('revalidateField', 'leave_applied_from_date');
    $('#form-wfh').bootstrapValidator('revalidateField', 'no_days');
    });
    
    $("#dob-datepicker_11").datepicker({ 
    //endDate: '-'+day+'d', 
      todayBtn:  1,       
        autoclose: true,
    format: 'dd-mm-yyyy',
    startDate: new Date()    
            ...
            var minDate = new Date(selected.date.valueOf());
            $('#dob-datepicker_10').datepicker('setEndDate', minDate);//$('#dob-datepicker').datepicker('setEndDate', minDate);
			//$('#dob-datepicker').datepicker('setEndDate');
            getTotalDays11();
            var depid = $('#reporting_dept').val();
      getEmp_using_deptforLeave(depid);
  ...
  getTotalDays1();
    ...
    format: 'dd-mm-yyyy',
      startDate: new Date() 
		...
		//	 $('#dob-datepicker2').datepicker('setEndDate');
...
function getTotalDays11(){
  
  var date1=$("#dob-datepicker_10").val();
  var date2=$("#dob-datepicker_11").val();
  var firstValue = date1.split('-');
  var secondValue = date2.split('-');
...
//alert(timeDifferenceInDays);
if(timeDifferenceInDays>0){
$("#no_days11").val(timeDifferenceInDays);  
$("#no_days11").attr('readonly',true);
