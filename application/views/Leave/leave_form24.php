...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Apply ML Leave</a></li>
    </ul>
    <div class="page-header">     
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Application For ML Leave</h1>
...
<td><?=$val['leave_type']." (".$cnt[0]['vacation_type'].") - ".$cnt[0]['slot_type']?></td>
  ...
  <?php } ?>
    ...
    ?>
                              ...
                              <div class="panel-heading"><strong> Application For ML Leave</strong>
  ...
  <span class="pull-right"><b>Current Date: <?=$date->format('d-m-Y H:i:s a')?>     </b>        
           ...
           <form id="form-forleave" name="form-forleave" action="<?=base_url($currentModule.'/add_leave')?>" method="POST" enctype="multipart/form-data">
              ...
              echo "<option value='".$val['id']."' selected >".$val['leave_type']."</option>";
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                      ...
                      <label class="col-md-3 control-label">Leave To Date</label>
                        <div class="col-md-3">                          
                              <input class="form-control" id="dob-datepicker1" name="leave_applied_to_date"  value="" placeholder="Leave To Date" type="text" onclick="getTotalDays();" >
                  ...
                  <input class="form-control" readonly type="text" name="school" id="school" value="<?=$emp_detail[0]['college_name']?>">
                      ...
                      <div class="form-group" id="certify" >
...
$("#dob-datepicker").datepicker({
  ...
  autoclose: true,
    ...
    $('#dob-datepicker1').datepicker('setStartDate', startDate);
}).on('clearDate', function (selected) {
    $('#dob-datepicker1').datepicker('setStartDate', null);
});
...
$("#dob-datepicker1").datepicker({
   ...
   $('#dob-datepicker').datepicker('setEndDate', endDate);
}).on('clearDate', function (selected) {
   $('#dob-datepicker').datepicker('setEndDate', null);
});
