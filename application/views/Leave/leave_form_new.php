...
<div class="panel" id="type">
                              <div class="panel-heading"><strong>Select Type Of Application</strong></div>
                                <div class="panel-body">
            <div class="row">                
            <label class="col-sm-3"><input type="radio" value="leave" id="formtype_leave" checked name="formtype">Apply For Leave</label>        
            <label class="col-sm-3"><input type="radio"  value="od" id="formtype_od" name="formtype">Apply For OD</label>
            <label class="col-sm-3"><input type="radio"  value="whf" id="formtype_wfh" name="formtype">Apply For WHF</label>
            <label class="col-sm-3" id="mld">
            <?php  if($mlfs>'0'){ ?>
             <a href="<?php echo base_url()?>leave/apply_ml_leave" target="_blank"><span style="font-weight: bold;">Click here to apply ML</span></a>
            <?php } ?>
            </label>
...
<td><?=$val['leave_type']." (".$cnt[0]['vacation_type'].") - ".$cnt[0]['slot_type']?></td>
  ...
  <span class="pull-right"><b>Current Date: <?=$date->format('d-m-Y H:i:s a')?>     </b>        
           ...
           <form id="form-forleave" name="form-forleave" action="<?=base_url($currentModule.'/add_leave')?>" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="vl_leave" id="vl_leave" value="">
              ...
              $bal = $val['leaves_allocated']-$val['leave_used'];
            ...
            $cnt = $ci->leave_model->get_vacation_leave_list('',$val['vl_id']);
              ...
              if($val['leave_type']=='VL'){
                          echo "<option value='".$val['id']."'>".$val['leave_type']." (".$cnt[0]['vacation_type'].") - ".$cnt[0]['slot_type']." </option>";
              }else{
              echo "<option value='".$val['id']."'>".$val['leave_type']."</option>";
                      ...
                      <!--  <option value='9'>LWP</option> -->
                        ...
                        <div class="col-md-3" >
                        <select id="leave_duration" name="leave_duration" onchange="display_duration(this.value);" class="form-control" required>
...
<label ><input type="radio" value="N" id="gate_pass_no" checked name="gate_pass">No</label>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" readonly type="text" name="school" id="school" value="<?=$emp_detail[0]['college_name']?>">
                      ...
                      <div class="form-group" id="certify" style="display:none;">
                           ...
                           <span style="color:red;">"Note: ML will be approved subject to submission of original Medical Certificate to Establishment Section"</span>
                        </div>
                          </div>
                      <div class="form-group">
               ...
               <!-- <label class="col-md-9" style="color:red;">Note:Select Department Only if you want alternate arrangement from other Department</label>   -->     
                ...
                <label class="col-md-3 control-label">Select School</label>
                   <div class="col-md-3">
                  <select class="form-control" name="reporting_school"  id="reporting_school" onchange="getdept_using_school(this.value)" required>
               ...
               <label class="col-md-3 control-label">Select Department</label>
                   <div class="col-md-3">
                  <select name="reporting_dept" id="reporting_dept"  onchange="getEmp_using_deptforLeave(this.value)" class="form-control" required>
                 ...
                 <div  id="levdiv" style="display:none;height:300px;overflow-y:scroll;">
...
<div class="form-group">
                            <label class="col-md-3 control-label">Purpose For OD (Mention in Detail)</label>
                            <div class="col-md-9">
...
<div class="form-group">
                 ...
                 <!-- End Form For the Od-->   
                 <!--Form For the WFH-->                
                <div class="panel" style="display:none;" id="forwfh">
                
                
                <div class="panel" id="leaveBalwfh" style="">
                              <div class="panel-heading"><strong>Staff WFH Balance</strong></div>
                                <div class="panel-body">
                <div class="form-group">
                <table class="table table-bordered">
    <thead>
 ...
 <div class="panel-heading"><strong> Application For WFH</strong><?php $date = new DateTime('now', new DateTimeZone('Asia/Kolkata'));?>
  <span class="pull-right"><b>Current Date: <?=$date->format('d-m-Y H:i:s a')?></b>       
                         </span></div>
                                <div class="panel-body">
                <form  id="form-forwfh"  name="form-forwfh" action="<?=base_url($currentModule.'/add_leave')?>" method="POST" >
<input type="hidden" name="emp_id" value="<?php echo $this->session->userdata('name');?>">
<input type="hidden" name="in-od" value="1">
<input type="hidden" name="apply_leave_type" value="WFH">
   <input type="hidden" name="ltyp" id="ltyp" value="WFH" />             
                                        
             <input class="form-control"  type="hidden" name="today_date" id="today_date" value="<?=$date->format('d-m-Y H:i:s a')?>">
                      
                 <div class="form-group">
                            <label class="col-md-3 control-label">Select WFH Type</label>
                            <div class="col-md-3">
                        <select id="od_type" name="od_type" class="form-control" required>
                        <option value=""> Select WFH Type</option>
                        <option value="official" selected >Official</option>
                        </select>
                        </div>
                        <label class="col-md-3 control-label">Select WFH Duration</label>
                        <div class="col-md-3" >
                        <select id="od_duration" name="od_duration"  onchange="checkdh_divwfh(this.value)"  class="form-control" required>
                        <option value=""> Select Duration</option>
                        <option value="hrs">Hrs</option>
...
<div class="col-md-3">
<input type="hidden" value="N" id="gate_pass_no"  name="gate_pass">
</div>
...
<label class="col-md-3 control-label">School</label>
              ...
              <div class="form-group"  >
                            <label class="col-md-3 control-label">WFH From Date</label>
                        <div class="col-md-3">                            
                            <input class="form-control" required id="dob-datepicker4" name="applied_from_date" value="" onchange="checkOD_Duration()" placeholder="WFH From Date" type="text" >
                            </div>
                      <label class="col-md-3 control-label" id="od-for-day">WFH To Date</label>
                        <div class="col-md-3" id="od-for-day1">                            
                              <input class="form-control" id="dob-datepicker5" name="od_applied_to_date" value="" placeholder="WFH To Date" type="text" >
                           <input class="form-control" id="od-for-half-day" style="display:none" name="applied_to_date2"  value="" placeholder="WFH To Date" type="text" > 
                        </div>    
                          </div>
<div class="form-group" id="od-for-hrs" style="display:none">
                            <label class="col-md-3 control-label">Departure Time</label>
                        <div class="col-md-3">                          
                            <input class="form-control" id="timepicker3" name="od_departure_time" value="" placeholder="HH:MM" type="text" >
                            </div>
                      <label class="col-md-3 control-label">Arrival Time</label>
                        <div class="col-md-3">                            
                              <input class="form-control" id="timepicker4" name="od_arrival_time" value="" placeholder="HH:MM" type="text" >
                            </div>    
                          </div>                      
                                    <div class="form-group">
                  <div id="no_d" style="display:none">
                   <label class="col-md-3 control-label">No Of Days.</label>
                   <div class="col-md-3">
                  <input class="form-control" type="text" readonly onclick="getTotalDays1wfh();" name="no_days_forod" id="no_days_forwfh" value="">
                  </div>                      
                  </div>
                                    <div id="no_hr" style="display:none">
                   <label class="col-md-3 control-label">No Of Hrs.</label>
                   <div class="col-md-3">
                  <input class="form-control"   type="text" readonly onclick="getTotalhrswfh();" name="no_hrs_forod" id="no_hrs_forwfh" value="">
                  </div>                      
                  </div>                  
                  </div>
<div class="form-group">
                            <label class="col-md-3 control-label">Purpose For WFH (Mention in Detail)</label>
                            <div class="col-md-9">
                        <textarea  class="form-control"  style="resize:none;overflow-y:scroll;height:50px" required name="reason_od" placeholder="Purpose For WHF" ></textarea>
                        </div>
                          </div>    
 <div class="form-group">
                    <label class="col-md-3"><u>Details of Alternative Arrangement</u></label>
               <!-- <label class="col-md-9" style="color:red;">Note:Select Department Only if you want alternate arrangement from other Department</label>  -->      
                ...
                <label class="col-md-3 control-label">Select School</label>
                   <div class="col-md-3">
                  <select class="form-control" name="reporting_school_od" id="reporting_school_od" onchange="getdept_using_school_for(this.value)" required>
                  <option value=" "> Select School</option>
                  <?php foreach($school_list as $sc ){
               ...
               <label class="col-md-3 control-label">Select Department</label>
                   <div class="col-md-3">
  <select name="reporting_dept_wfh" id="reporting_dept_od" onchange="getEmp_using_deptforwfh(this.value)" class="form-control" required>
                        <option value="">Select Depart</option>
                        <?php 
                                                  ?>
                        </select>
                 ...
                 <div  id="wfhdiv" style="display:none;height:300px;overflow-y:scroll;">
  <table id="emp-table-wfh" style="width:100%;"class="table table-bordered table-striped">
...
//$('emp-table').tableCheckbox({ /* options */ });
               ...
               <div class="form-group">
                <label class="col-md-3 control-label">Location Of Duty</label>
                 <div class="col-md-3">
                 <input type="text" name="location_od" id="location_od" class="form-control" placeholder="WFH Address" required>
               </div>
                <label class="col-md-3 control-label">Mobile No.</label>
<div class="col-md-3">  
  <input type="text" name="od_contct_no" id="od_contct_no" value="<?=$emp_detail[0]['mobileNumber'];?>" class="form-control" placeholder="Mobile No." required>
  ...
  <label class="col-md-3 control-label">State</label>
   <div class="col-md-3">
   <select id="state" name="state" onchange="getcitybystateswfh(this.value)" class="form-control" required>
                  <option value="">Select</option>
                  <?php foreach($state as $key=>$val){?>
                  <option value="<?php echo $state[$key]['state_id'];?>"><?php echo $state[$key]['state_name'];?></option>
                  <?php } ?>
...
<!--<div class="form-group">
<label class="col-md-6" style="color:red;">Note:Do You Have Any Faculty who Will Be With You For WHF??</label>
<div class="col-md-3">
<label ><input type="radio" value="Y" id="facilty_with_yes" name="facilty_with">Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label ><input type="radio" value="N" id="facilty_with_no" name="facilty_with">No</label>
...
function display_duration(dr){
  ...
  $('#leave_duration').find('option[value="full-day"]').attr("selected", "selected");
  if(lty1=='ML'){
  $('#certify').show();
  }
  }else{
...
//alert("kk"+favorite[i]);  
  ...
  $("input[name='formtype']").click(function () {
        ...
        $("#forwfh").hide();
            ...
            else if($("#formtype_wfh").is(":checked")){
                 $("#forwfh").show();
               $("#forod").hide();
                $("#forleave").hide();
        $("#leaveBal").hide();
  ...
  getTotalDays1();
    ...
    format: 'dd-mm-yyyy',
     startDate: new Date() 
        ...
        var minDate = new Date(selected.date.valueOf());
    $('#dob-datepicker5').datepicker('setStartDate', minDate);
  var depid = $('#reporting_dept_wfh').val();
      getEmp_using_deptforwfh(depid);
  getTotalDays1wfh();
    });
  ...
  $("#dob-datepicker5").datepicker({      
        autoclose: true,
    format: 'dd-mm-yyyy',
      startDate: new Date() 
    }).on('changeDate', function (selected) {
            var minDate = new Date(selected.date.valueOf());
            $('#dob-datepicker4').datepicker('setEndDate', minDate);
      $('#form-forod').bootstrapValidator('revalidateField', 'od_applied_to_date');
  ...
  $('#timepicker2').datetimepicker({ format:'HH:mm',stepping:5}).on("dp.change", function (e) {
   ...
   $('#timepicker3').datetimepicker({ format:'HH:mm',stepping:5}).on("dp.change", function (e) {
           getTotalhrswfh();
        });
  $('#timepicker4').datetimepicker({ format:'HH:mm',stepping:5}).on("dp.change", function (e) {
           getTotalhrswfh();
        });
...
function calculateTime() {  
 ...
 // alert(valuestop1);
  ...
  var rn ='';
    ...
    function calculateTimewfh() {  
                       
        var valuestart1 = $('#timepicker3').val();// "8:45am";
        var valuestop1 = $('#timepicker4').val();//"8:46pm";    
  //  alert(valuestart1);
 // alert(valuestop1);
  if(valuestart1 != '' && valuestop1 !=''){
         var valuestart = moment(valuestart1, "HH:mm");
  ...
  function getTotalhrswhf(){   
  //alert('gg');
    var tdiff=calculateTimewfh();
    //alert(tdiff);
     $('#no_hrs_forwfh').val(tdiff);
    $('#form-forwfh').bootstrapValidator('revalidateField', 'od_departure_time');
    $('#form-forwfh').bootstrapValidator('revalidateField', 'od_arrival_time');
    $('#form-forwfh').bootstrapValidator('revalidateField', 'no_hrs_forod');
  }
...
function getTotalDays1wfh(){
  
  var date1=$("#dob-datepicker4").val();
  var date2=$("#dob-datepicker5").val();
  var firstValue = date1.split('-');
var secondValue = date2.split('-');
...
//alert(timeDifferenceInDays);
if(timeDifferenceInDays>0){
$("#no_days_forwfh").val(timeDifferenceInDays);  
$("#no_days_forwfh").attr('readonly',true);

}
 $('#form-forwfh').bootstrapValidator('revalidateField', 'applied_from_date');
 $('#form-forwfh').bootstrapValidator('revalidateField', 'no_days_forod');
  $('#form-forwfh').bootstrapValidator('revalidateField', 'od_departure_time');
}
