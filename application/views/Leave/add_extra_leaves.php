...
<div id="content-wrapper">
   <ul class="breadcrumb breadcrumb-page">
      ...
      <li class="active"><a href="#">Add Extra Leave </a></li>
   </ul>
   <div class="page-header">
      <div class="row">
         <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add Extra Leave </h1>
         ...
         <div class="col-sm-12">
                  ...
                  <div class="table-info">
                     <div id="dashboard-recent" class="panel-warning">
                        <div class="panel">
                           <div class="panel-heading"><strong>Add Extra Leave </strong></div>
                              ...
                              <div class="panel-padding no-padding-vr">
                                 <div class="form-group">
                                    ...
                                    <div class="portlet-body form">
                                       <form id="form" name="form" onsubmit="return validateForm()" action="<?=base_url($currentModule.'/add_extra_leave_deduction')?>" method="POST" >
                                          <div class="form-body">
                                             <div class="col-md-7">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                   <label class="col-md-3">Total CL</label>
                                                   <div class="col-md-4">
                                                      <input class="form-control" id="tcl" required name="ecl" required    type="text" >
                                                    </div>  
