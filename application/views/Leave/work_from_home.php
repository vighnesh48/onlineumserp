...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Apply Work From Home</a></li>
    </ul>
    <div class="page-header">     
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Application For Work From Home</h1>
...
<?php 
    ...
    ?>         
                              ...
                              <div class="panel-heading"><strong> Application For Work From Home</strong>
  ...
  <span class="pull-right"><b>Current Date: <?=$date->format('d-m-Y H:i:s a')?>     </b>        
           ...
           <form id="form-forleave" name="form-forleave" action="<?=base_url($currentModule.'/add_work_from_home')?>" method="POST" enctype="multipart/form-data">
...
<div class="col-md-3">  
 ...
 <div class="panel-heading"><strong> Application For OD</strong><?php $date = new DateTime('now', new DateTimeZone('Asia/Kolkata'));?>
  <span class="pull-right"><b>Current Date: <?=$date->format('d-m-Y H:i:s a')?></b>       
                                ...
                                <div class="panel-body">
                <form  id="form-forod"  name="form-forod" action="<?=base_url($currentModule.'/add_work_from_home')?>" method="POST" >
<input type="hidden" name="emp_id" value="<?php echo $this->session->userdata('name');?>">
...
<div class="form-group">
                                   ...
                                   <div class="panel" id="leaveBal" style="">
                              <div class="panel-heading"><strong>Work From Home</strong></div>
                                <div class="panel-body">
                <div class="form-group">
    ...
    <thead>
      <tr>
        ...
        <th style="width:2px;">Form&nbsp;Date</th>
        <th style="width:2px;">To&nbsp;Date</th>
...
</div><!--<script src="<?php // echo base_url('assets/jquery/jquery-2.2.3.min.js')?>"></script>
...
//resetPaging: false,
        ...
        "ajax": {
            "url": "<?php echo site_url('leave/work_ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
