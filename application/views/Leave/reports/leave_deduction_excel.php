...
$object->getActiveSheet()->setCellValue('G2','Leave Type');
$object->getActiveSheet()->setCellValue('H2','Duration');
$object->getActiveSheet()->setCellValue('I2','Approved By');
$object->getActiveSheet()->setCellValue('J2','Remark');
$object->getActiveSheet()->setCellValue('K2','Added On');
  $ci =&get_instance();
...
$object->getActiveSheet()->setCellValue('F'.$row,date('d-m-Y',strtotime($val['applied_from_date'])));
...
$filename='leave_deduction_list.xls'; //save our workbook as this file name
