...
<div class="container panel-body">
  <div class="row main-wrapper head-add">
	...
	<table class="table table-bordered" border=1 cellspacing ="5px" cellpadding="5px" width="100%">
	    ...
	    <tr>
	        <td><b>Subject Code:</b> <?=strtoupper($ut[0]['subject_code']);?></td><td colspan=2><b>Subject Name:</b> <?=strtoupper($ut[0]['subject_name']);?></td><td><b>Max marks:</b> <input type="text" class="form-control1 numbersOnly" style="width:70px" name="max_marks" id="max_marks" maxlength="3" value="<?php if($me[0]['max_marks'] !=''){ echo $me[0]['max_marks'];}?>" required readonly> &nbsp;&nbsp;&nbsp;<b>Min marks:</b> <?php if($ut[0]['internal_min_for_pass'] !=''){ echo $ut[0]['internal_min_for_pass'];}?></td>
	    </tr>
	</table>
		<!--div class="col-md-12">
...
<th style='border-top:1px solid #000;width: 7%;' align='left'>Stud. Name</th>				
	...
	//echo $me[0]['verified_by'].'verified_by';
	...
	<?php
	}else{echo 'Forwarded to HOD/Dean Successfully';}if($role_id =='12' || $role_id =='15' || $role_id =='6'){
	?>
	<input type="submit" name="save" value="Update" class="btn btn-primary">
