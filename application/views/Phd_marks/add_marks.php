...
<form method="post" action ="<?=base_url()?>Phd_marks/add">	
        <div class="row">
            <h1 class="col-xs-12 col-sm-2 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Marks Entry </h1>
			<div style="padding-top:5px;">Select Subject Type: &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="marks_type" id="marks_type2" value="TH" <?php if($_REQUEST['marks_type'] =='TH'){ echo "checked";}else{}?> checked required> Theory &nbsp;&nbsp;<input type="radio" name="marks_type" id="marks_type3" value="PR" <?php if($_REQUEST['marks_type'] =='PR'){ echo "checked";}else{}?> required> Practical&nbsp;&nbsp;<input type="checkbox" name="reval" id="reval" value="reval" <?php if($_REQUEST['reval'] =='reval'){ echo "checked";}else{}?> > Revaluation </div>
        </div>
        <div class="row ">
