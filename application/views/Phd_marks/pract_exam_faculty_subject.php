...
<div id="content-wrapper">
    ...
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Remuneration</a></li>
    ...
    <div class="page-header">			
        ...
        <div class="row">
            ...
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Remuneration</h1>
                ...
                <div class="panel">
                    ...
                    <div class="panel-heading" style="    background: #ffecb6 !important;
						...
						<div class="col-sm-3">
							...
							<span class="panel-title">Remuneration</span>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-info">                            
							...
							<div class="form-group">
								...
								if(!empty($sub[0]['fname'])){ ?>
                               <div class="form-group">                     
                                    <label class="col-sm-2"><b>Internal Faculty Name:</b></label>
...
<div class="form-group">                     
                                    <label class="col-sm-1"><b>Date:</b></label>
                                    <div class="col-sm-2"><?php if(!empty($sub[0]['exam_date'])){ echo $sub[0]['exam_date'];}?>
									<input type="hidden" class="form-control" name="exam_date" id="exam_date1" value="<?php if(!empty($sub[0]['exam_date'])){ echo $sub[0]['exam_date'];}?>"required>	
                                    </div>  
									<label class="col-sm-1"><b>From:</b></label>
                                    <div class="col-sm-2"><?php if(!empty($sub[0]['exam_from_time'])) echo $sub[0]['exam_from_time'];?>
									<input type="hidden" name="exam_from_time" id="exam_from_time" value="<?=$sub[0]['exam_from_time']?>">	
										
                                    <b>-</b>
                                    <?php if(!empty($sub[0]['exam_to_time'])) echo $sub[0]['exam_to_time'];?>
									<input type="hidden" name="exam_to_time" id="exam_to_time" value="<?=$sub[0]['exam_to_time']?>">										
                                    
									<?php if(!empty($sub[0]['time_format'])) echo $sub[0]['time_format'];?>
									<input type="hidden" name="time_format" id="time_format" value="<?=$sub[0]['time_format']?>">
