...
<td width height="30" valign="middle">&nbsp;<?=$me[0]['semester']?> </td>
...
<td  height="30" valign="middle">&nbsp;<?php if($me[0]['marks_entry_date'] !='0000-00-00' && $me[0]['marks_entry_date'] !=''){ echo date('d/m/Y', strtotime($me[0]['marks_entry_date']));}?></td>           
          ...
          <table width="800" border="0" cellspacing="0" cellpadding="0" align="center" style="margin:40px;">
            ...
            <td align="center">
			 ...
			 <tr>
            <td align="center" style="border-top:0px solid #333;">
            <table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td align="center">
                <table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td align="left" class="signature" height="50" colspan="3"><i><b>Declaration:</b>  I hereby declare that the above details are correct and verified to the best of my knowledge.
 </i></td>               
              </tr>
              <tr>
