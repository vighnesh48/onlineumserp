...
<div id="content-wrapper">
 ...
 <table class="table table-bordered" id="table2excel">
                          ...
                          $arr_status=0;
							...
							<?php
								...
								<td>
									...
									if($sub_list[$i]['cia_status'] =='Y' || $sub_list[$i]['th_status'] =='Y') {	 
									?>
                    ...
                    <?php 
                    	...
                    	if(($sub_list[0]['cia_status'] =='Y' || $sub_list[0]['th_status'] =='Y') && !in_array(1, $arr_stat)){
                    ?>
...
// comulative marks entry excel
	$('#emsexcl').on('click', function () {	
		var res_data = $("#res_data").val();
		if (res_data) {
			window.location.href = '<?= base_url() ?>Phd_marks/excel_cumMrkEntryStatus/'+res_data;
		} else {
