            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
							...
							<?php if(!empty($this->session->flashdata('dupmessage'))){ ?>
							<div style="color:red;"> <?php echo $this->session->flashdata('dupmessage'); ?></div>
							<?php }?>
                    </div>
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                <input type="hidden" value="" id="unit_test_id" name="unit_test_id" />
							  ...
							  <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select id="test_name" name="test_name" class="form-control" required="true" >
											...
											<option value="2A">CIA-2A</option>
											<option value="2B">CIA-2B</option>
											<option value="3">CIA-3</option>
											<option value="4">CIA-4</option>
                                        </select>                                        
                                    </div>    
									<label class="col-sm-3">CIA Date<?=$astrik?></label>
                                    <div class="col-sm-3">
									<!--for update-->
									<input type="text" id="test_date" name="test_date" class="form-control">	
								...
								<div class="form-group">
								 <label class="col-sm-3">Min Marks</label>
									 ...
									 <div class="col-sm-3"><input type="text" id="min_for_pass" name="min_for_pass" class="form-control" value="" maxlength=3 /></div>
								   	<label class="col-sm-3">Max Marks<?=$astrik?></label>
                                    <div class="col-sm-3">
									<input type="text" id="max_marks" name="max_marks" class="form-control" maxlength=3>
...
$('#test_date').datepicker( {format: 'dd/mm/yyyy',autoclose: true});
        ...
        $("#college_type_id").multiselect({
        includeSelectAllOption: true
        });
        $("#college_standards").multiselect({
        includeSelectAllOption: true
        });
    </script>
