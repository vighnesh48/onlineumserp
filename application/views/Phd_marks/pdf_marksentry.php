...
<tr>
<td></td>
<td align="center" style="text-align:center;margin:0;padding:0"><h3 style="font-size:12px;">OFFICE OF THE CONTROLLER OF EXAMINATIONS<br><u>END SEMESTER EXAMINATION MARKS ENTRY - <?=$exam_month?> <?=$exam_year?></u></h3></td>
<td></td>
</tr>
   ...
   <!--         <td height="30" valign="middle">&nbsp;<?=$me[0]['semester']?></td>-->
           ...
           <tr>
            ...
            <th  style="border-top:1px solid #000" align="left">EXT</th> 		
           ...
           <td align="center"><?=$stud['cia_marks']?></td>
