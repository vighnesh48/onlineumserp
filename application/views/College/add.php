...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Add College</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add College</h1>
                        ...
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select id="campus_id" name="campus_id" class="form-control" >
                                            ...
                                            <option value="<?=$campus_details[$i]['campus_id']?>"><?=$campus_details[$i]['campus_name']?></option>
                                            <?php } ?>
                                        </select>                                        
                                    </div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="college_code" name="college_code" class="form-control" value="<?=isset($_REQUEST['college_code'])?$_REQUEST['college_code']:''?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="college_name" name="college_name" class="form-control" value="<?=isset($_REQUEST['college_name'])?$_REQUEST['college_name']:''?>" /></div>                                    
                                    <div class="col-sm-3"><span style="color:red;"><?php echo form_error('college_name');?></span></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3">College City</label>
                                    <div class="col-sm-6"><input type="text" id="college_city" name="college_city" class="form-control" value="<?=isset($_REQUEST['college_city'])?$_REQUEST['college_city']:''?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="college_state" name="college_state" class="form-control" value="<?=isset($_REQUEST['college_state'])?$_REQUEST['college_state']:''?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="college_address" name="college_address" class="form-control" value="<?=isset($_REQUEST['college_address'])?$_REQUEST['college_address']:''?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="college_pincode" name="college_pincode" class="form-control" value="<?=isset($_REQUEST['college_pincode'])?$_REQUEST['college_pincode']:''?>" /></div>                                    
