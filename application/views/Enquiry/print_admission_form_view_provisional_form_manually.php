   ...
   <body>
      <div style="width:100%!important; margin:auto!important;padding:20px 30px!important;">
         ...
         <div>
            ...
            <p>
			   To,<br/>
               Dear Candidate Mast. /Ms. '.$Enquiry_data['first_name'].' '.$Enquiry_data['last_name'].'
           
			<p>
			  It gives us immense pleasure to inform you that you have beenprovisionally admitted to the program – <span><i><b>'.$Enquiry_data['course_short_name'].'</i> Semester '.$Enquiry_data['current_semester'].'</span> in the <span>Sandip
               University’s '.$Enquiry_data['school_name'].'</span> in the Academic Year-2022-23 on the following terms:
            </p>
...
$body = "Hi ".$Enquiry_data['first_name'].' '.$Enquiry_data['last_name']."
...
$namepdf='Provisional_2022_23-'.$Enquiry_data['enquiry_no'];


$mpdf->Output($namepdf.'.pdf', "D");
//$mpdf->Output($Enquiry_data['enquiry_no'].'_Provisional.pdf', "D");
