...
<div style="text-align:center;color:red;"><h4><b>Attendance Mark Report</b></h4></div>
  <table id="dis_data" class="table table-bordered" border='1' style="border-color:#249f8a;">
                         ...
                         //   echo"<pre>";print_r($timtab);echo"</pre>";
							...
							?>
                            <tr>
<td colspan="9" align="center" style="align:center;" ><H4><b>Current Session: <?=$this->config->item('current_year')?>(<?php if($this->config->item('current_sess')=='WIN'){ echo 'WINTER'; }else{ echo 'SUMMER'; }?>)</b></h4></td>
  </tr>
  <tr style="background-color:#6BCEEF;padding:10px;"> 
  <td colspan="9" align="left" style="padding:10px;">&nbsp;<b>Day: </b>&nbsp;<?=$day?>&nbsp; | &nbsp;<b>Date:</b>&nbsp;<?=$sdate?></td></tr>
