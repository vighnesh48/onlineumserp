...
<tr ><td colspan='9' align='right' style="padding:10px;" ><b>Total No. Ducks:</b></td><td colspan='3' align='center' style='color:red;padding:10px;font-size:18px;'><b><?php echo $t_duck=count($df[$sublist[$i]['faculty_code']]); 
$this->Student_Attendance_model->insert_duck_report($sublist[$i]['faculty_code'],$fdate,$acd_yr[0],substr($acd_yr[1], 0,3),$t_duck);//exit;
?></b></td></tr>
                         <?php  }else{     ?>
