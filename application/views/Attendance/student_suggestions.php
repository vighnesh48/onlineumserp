        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                     <div class="row ">
                             <div class="col-sm-6">
                                 <span class="panel-title text-primary">Student Suggestions</span>  
                    ...
                    <th>Student Name</th> 
                     ...
                     <th>Year</th>  
						...
						if(!empty($suggestions)){							
                            ...
                            <tr  class="myHead">
                                <td><?=$j?></td>  
                         <td><?=$suggestions['last_name']." ".$suggestions['first_name']." ".$suggestions['middle_name']." "?></td> 
                       <td><?=$suggestions['student_id']?></td> 
                        <td><?=$suggestions['stream_name']?></td> 
                        <td><?=$suggestions['current_year']?></td> 
                      ...
                      if($suggestions['category']=="A"){$stat ="Academics";}
                         elseif($suggestions['category']=="H"){$stat ="Hostel";}
                          ...
                          <td><?php if($suggestions['role_id']==4){echo "Student";} else{echo "Parent";}?></td> 
                       ...
                       <td>         
                     <a class="" id="editpayment" data-reg_no="<?=$payment_data[$i]['prov_reg_no']?>"  data-stud_name="<?= $payment_data[$i]['student_name']; ?>" val="<?=$i?>" 
    						data-sugg_id="<?=$suggestions['sugg_id']; ?>" data-exam_fee="<?= $inst['exam_fees']; ?>" data-exam="<?= $ext; ?>" data-exam_id="<?= $inst['exam_id']; ?>" data-applicable_fee="<?= $inst['exam_session']; ?>" data-toggle="modal" data-target="#walkinModal" style="cursor:pointer"><button class="btn btn-primary btn-xs">Update Status</button></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                   <span id="fform_id">Update Suggestion Status</span>
                </h4>
            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default panel-hovered panel-stacked" style="margin-top: 10px;">
                                    <div class="panel-body">
                                        <form name="editfrm" method="POST" action="<?=base_url()?>Attendance/student_suggestions" enctype="multipart/form-data" onsubmit="">
                                  
                                  <input type="hidden" name="sugg_id" id="sugg_id" value="">
                                  
                                  

								   <div class="form-group">
                                            <label class="col-sm-3" for="exampleInputEmail1"> Suggestion Status </label>
                                             <div class="col-sm-6">
                                             <select name="upstatus" id="upstatus" class="form-control" required>
                                           <option value="">Select Suggestion Status </option>  
                                            <option value="P">Pending</option> 
                                             <option value="F">Forwarded to Concerned Person</option> 
                                             <option value="A">Action Taken</option> 
									   ...
									   <div class="form-group">
                                            <label class="col-sm-3" for="exampleInputEmail1"> Remark </label>
                                             <div class="col-sm-6">
                                             <textarea id="comment" name="comment" class="form-control" style="margin: 0px -67px 0px 0px;
    width: 303px;
...
<script type="text/javascript">
   ...
   // var ye = $(this).value();
    ...
    //alert(va);
            ...
            var sugg_id = $(this).attr("data-sugg_id");
