...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add Department</h1>
                        ...
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="department_code" name="department_name" class="form-control" value="<?=isset($_REQUEST['department_name'])?$_REQUEST['department_name']:''?>" /></div>                                    
                                 ...
                                 <div class="form-group">
									...
									<select class="select2me form-control" name="school" id="school" required>
												...
												if($sc['college_id']==$emp[0]['organization']){
													$str="selected";
												}else{$str="";}
