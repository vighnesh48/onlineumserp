                                            ...
                                            <tr>
                                                <?php if ($event['status'] == 'Y') : ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($event['status'] == 'Y') : ?>
                                                            <a href="<?= base_url($currentModule . "/toggle_event_status/" . base64_encode($event['id']) . "/N") ?>"
                                                                class="text-success" title="Click to Deactivate" onclick="return confirm('Are you sure you want to deactivate this event?');">
                                                                <i class="fa fa-check-circle"></i> Active
                                                            </a>

                                                        <?php else : ?>
                                                            <span class="text-muted" style="cursor: not-allowed;" title="Already Inactive">
