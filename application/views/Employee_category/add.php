            ...
            fields: 
            {
                emp_cat_name:
                {
                    validators: 
                    {
                      notEmpty: 
                      {
                       message: 'Employee Category Name should not be empty'
                      }
                    }
...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Add Employee Category</a></li>
    </ul>
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                <input type="hidden" value="" id="emp_cat_id" name="emp_cat_id" />
                                <div class="form-group">
                                    <label class="col-sm-3">Organization Name <?=$astrik?></label>                                    
                                    <div class="col-sm-6"><input type="text" id="emp_cat_name" name="emp_cat_name" class="form-control" value="<?=isset($organization_details['org_name'])?$organization_details['org_name']:''?>" /></div>                                    
