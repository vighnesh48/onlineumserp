...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Hostel Caution</h1>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/hostel_add')?>" method="POST">                                                               
                        ...
                        <div class="col-sm-12">
							...
							<div class="col-sm-2">
								...
								<div class="col-sm-2">
									...
									<div class="col-sm-2">
<!--									<button class="btn btn-primary form-control" onclick="get_hostel_details()" id="" >Search</button>
-->									<a href="#" onclick="get_hostel_details()" class="btn btn-primary form-control">Search</a>
				...
				<span style="color:red;" id="err_msg"></span>
					...
					-->
                        ...
                        <div class="row">
                        <div class="form-group">
                                    <div class="col-sm-3">Per student Pay</div>
                                    <div class="col-sm-2">
                                                            <input type="text" name="Per_student" id="Per_student" value="" readonly="readonly"/>                    
                                    </div>                                    
                                    <div class="col-sm-2"><!--<button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url($currentModule)?>'">Cancel</button>--></div>
                                    <div class="col-sm-4"></div>
                                </div>
                        ...
                        <div class="form-group">
                                    <div class="col-sm-3"></div>
                                    <div class="col-sm-2">
                                        <button class="btn btn-primary form-control" id="btn_submit" type="submit" >Process To Pay</button>                                        
                                    </div>                                    
                                    <div class="col-sm-2"><!--<button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url($currentModule)?>'">Cancel</button>--></div>
                                    <div class="col-sm-4"></div>
                                </div>
...
function get_hostel_details()
{
	...
	{	
		...
		$.ajax({
			type: 'POST',
			url: '<?= base_url() ?>Caution_money/fetch_alloted_details',
						...
						for(i=0;i<len;i++)
							...
							//	console.log("rows=="+i+'f=='+ftemp+'r==='+array.flr_details[i].room_no);
								if(ftemp==array.flr_details[i].floor_no)
								{
									...
									//	}else{
									content='<input type="checkbox" style="margin: 2px 0 0;" onclick="check_caution(this);"  value="'+array.flr_details[i].student_id+'" name="lstd[]" class="checkBoxClass"><input type="hidden" style="margin: 2px 0 0;"  value="'+array.flr_details[i].enrollment_no+'" name="enrollment_no['+array.flr_details[i].student_id+']" class="checkBoxClass"><input type="hidden" style="margin: 2px 0 0;"  value="'+rtemp+'" name="room_no['+array.flr_details[i].student_id+']" class="checkBoxClass"><input type="hidden" value="5000" name="actual['+array.flr_details[i].student_id+']" id="actual_'+array.flr_details[i].student_id+'" class="stu-fe-list txtnum"><input type="hidden" value="0" name="current_pay['+array.flr_details[i].student_id+']" id="current_pay_'+array.flr_details[i].student_id+'"  class="stu-fe-list txtnum">&nbsp;<li '+alloc_status+'><p>&nbsp;</p><div>'+array.flr_details[i].bed_number+'&nbsp;</div></li>';
								//}
									}
									else
									{
									...
									console.log('room_changed i_'+i+'_room_no'+array.flr_details[i].room_no+'--'+array.flr_details[i].category);	
										...
										footer='</ul><div class="col-md-10">Room no. <strong>'+rtemp+'</strong></div></div></div><div class="col-lg-2"><div class="hostel-bg row"><ul class="list-inline list-unstyled"><input type="checkbox"  onclick="check_caution(this);" style="margin: 2px 0 0;"  value="'+array.flr_details[i].student_id+'" name="lstd[]" class="checkBoxClass"><input type="hidden" style="margin: 2px 0 0;"  value="'+array.flr_details[i].enrollment_no+'" name="enrollment_no['+array.flr_details[i].student_id+']" class="checkBoxClass"><input type="hidden" style="margin: 2px 0 0;"  value="'+array.flr_details[i].room_no+'" name="room_no['+array.flr_details[i].student_id+']" class="checkBoxClass"><input type="hidden" value="5000" name="actual['+array.flr_details[i].student_id+']" id="actual_'+array.flr_details[i].student_id+'" class="stu-fe-list txtnum"><input type="hidden" value="0" name="current_pay['+array.flr_details[i].student_id+']" id="current_pay_'+array.flr_details[i].student_id+'"  class="stu-fe-list txtnum"><li '+alloc_status+'><p>&nbsp;</p><div>'+array.flr_details[i].bed_number+'&nbsp;</div></li>';
										//alert(fullcontent);
							...
							console.log('floor changed '+i+'--'+array.flr_details[i].category);
									...
									//content='<li '+alloc_status+'><p>&nbsp;</p><div>Guest'+array.flr_details[i].bed_number+'</div></li>';
									//	}else{
									content='<input type="checkbox" style="margin: 2px 0 0;"><li '+alloc_status+'><p>&nbsp;</p><div>'+array.flr_details[i].bed_number+'&nbsp;</div></li>';
								//}
...
//$(function(){
     // $('.checkBoxClass').click(function(){alert();
	 function check_caution(m){
		// alert();
