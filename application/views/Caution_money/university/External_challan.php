							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Course/Stream:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									 <textarea class="form-control" id="guest_address" name="guest_address" /><?php echo $user_details[0]['stream_name']; ?></textarea>								   
								   </div>			 
							  </div>
                              <div class="form-group">
									...
									<div class="form-group">
									   ...
									   <div class="form-group">
										...
										<label class="col-md-5" style="padding-left:0px;" id="">Recepit No:<?=$astrik?> </label>
											<div class="col-md-6" >
											<input type="text" class="form-control"  name="TransactionNo" id="TransactionNo" value="<?php echo $user_details[0]['receipt_no'];?>"/>
										</div>
										</div>
									  ...
									  <div id="non_cash" style="display:none;">
										...
										<label class="col-md-5" style="padding-left:0px;" id="receipt"></label>
											<div class="col-md-6" >
											<input type="text" class="form-control numbersOnly"  name="receipt_number" id="receipt_number" value="<?php echo $user_details[0]['txtid'];?>" />
										</div>
										</div>
