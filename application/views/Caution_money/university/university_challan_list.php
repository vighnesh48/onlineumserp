                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr <?=$list["status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                               ...
                               <a href="<?=base_url($currentModule."/Challan_university/".$list['ucaution_id'])?>">Pay</a>                                                                        
                                    <?php //} ?>
                                    <?php // if(in_array("Delete", $my_privileges)) { ?>
                                    <!--<a href='<?=base_url($currentModule)."/"?><?=$list["status"]=="Y"?"disable/".$list["ucaution_id"]:"enable/".$list["item_id"]?>'><i class='fa <?=$list["status"]=="Y"?"fa-ban":"fa-check"?>' title='<?=$list["status"]=="Y"?"Disable":"Enable"?>'></i></a>-->
                                    <?php //} ?>
                                </td>
                            </tr>
                            <?php
