...
<div id="content-wrapper">
    ...
    <div class="page-header">
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Payment List</h1> <a href="<?=base_url()?>Online_fee/ic_adm_payment"><button class="btn-primary btn pull-right">Other Events Online Payments</button></a>
