...
function calc_final_amount(){
			...
			var certificate_fees =  $('#Certificate_fees').val();
			//alert(certificate_fees);
			...
			//alert(tutf);
			var final_amount = parseInt(tutf)+parseInt(devf)+parseInt(cauf)+parseInt(admf)+parseInt(certificate_fees)
...
<div id="content-wrapper">
							  ...
							  <div class="form-group">
                                ...
                                <div class="col-md-6" style="padding-left:0px;">
                                  <select class="form-control" name="facilty" id="facilty" onchange="faci_type()" >
									 ...
									 <option value="2" <?php if($productinfo=='Admission' || $productinfo=='Re-Registration' || $productinfo=='New_Admission'){ echo "selected";} ?>>Academic Fees</option>
                                      ...
                                      <option value="8" <?php if($productinfo=='Revaluation' || $productinfo=='REVAL_Examination'){ echo "selected";} ?>>Revaluation</option>
                                      <option value="9" <?php if($productinfo=='Photocopy' || $productinfo=='Photocopy_Examination'){ echo "selected";} ?>>Photocopy</option>
                                      <option value="10" >Other Fees</option>
                                      <option value="13">Certificate Fees</option>
                                      <option value="22" <?php if($productinfo=='Duplicate_hallticket'){ echo "selected";} ?>> Duplicate Exam Hallticket</option>
									   <?php 
    ...
    ADD.
        ...
        <label class="col-md-1"></label>
         <label class="col-md-1"></label>
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Revaluation_Fees" id="Revaluation_Fees" value="<?php if($productinfo=='REVAL_Examination'){echo $user_details[0]['amount'];}else{ echo "0";}?>"  onblur="calc_final_amount();"/></div>
             <div class="col-md-1">
									   </div>
								  </div>
                                  <div class="form-group">
		...
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Other_fees" id="Other_fees" value="0"  onblur="calc_final_amount();"/></div>
             <div class="col-md-1">
                        ...
                        <div class="form-group Backlog_Exam" style="display:none">
								...
								<div class="col-md-5" >
								<?php 
								if($productinfo=='Examination'){ 
									if($user_details[0]['degree_convocation_fees'] !=''){
										$backlogfees = $user_details[0]['amount'] - $user_details[0]['degree_convocation_fees'];
									}else{
										$backlogfees = $user_details[0]['amount'];
									}

								}
								?>
								<input type="text" class="form-control numbersOnly" name="Backlog_Exam" id="Backlog_Exam" value="<?php if($productinfo=='Examination'){ echo $backlogfees;}?>" onblur="calc_final_amount();" />
								</div>
								<div class="col-md-1">
								</div>
								
								<label class="col-md-4" style="padding-left:0px;">Degree Certificate Fees</label>
								<label class="col-md-1"></label>
								<label class="col-md-1"></label><br><br>
								<div class="col-md-5" >
								<input type="text" class="form-control numbersOnly" name="degree_certificate_fees" id="degree_certificate_fees" value="<?php if($productinfo=='Examination'){ echo $user_details[0]['degree_convocation_fees'];}?>" />
								</div>
								<div class="col-md-1">
								</div><?php echo $user_details[0]['amount'];?>
						 </div>
                                  <div class="form-group Photocopy_Fees" style="display:none">
		<label class="col-md-4" style="padding-left:0px;">Photocopy Fees</label>
        <label class="col-md-1"></label>
         <label class="col-md-1"></label>
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Photocopy_Fees" id="Photocopy_Fees" value="<?php if($productinfo=='Photocopy_Examination'){ echo $user_details[0]['amount'];}else{ echo 0;}?>" onblur="calc_final_amount();" /></div>
             <div class="col-md-1">
									   </div>
								  </div>
        ...
        <label class="col-md-1"></label>
         <label class="col-md-1"></label>
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Certificate_fees" id="Certificate_fees" value=""  /></div>
             <div class="col-md-1">
									   </div>
								  </div>
