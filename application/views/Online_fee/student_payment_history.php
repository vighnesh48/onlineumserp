                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr <?php //$bg ?> <?php //$hostpay_list[$i]["payment_status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                               <td><?=$j?></td>
								 ...
								 <td><?php if($hostpay_list[$i]['type_id']=="1"){ echo 'Hostel';}elseif($hostpay_list[$i]['type_id']=="2"){echo 'Transport';}?></td> 
                                <td><?php
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr <?php //$bg ?> <?php //$transpay_list[$i]["payment_status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                               <td><?=$j?></td>
								 ...
								 <td><?php if($transpay_list[$i]['type_id']=="1"){ echo 'Hostel';}elseif($transpay_list[$i]['type_id']=="5"){echo 'Transport';}?></td> 
                                <td><?php
...
-->                                <td>
		 ...
		 <div class="row ">
            <div class="col-sm-12">
                <div class="panel">
				<div class="panel-heading">
                            <span class="panel-title">Uniform Payment Details</span>
                    </div>
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr <?php //$bg ?> <?php //$transpay_list[$i]["payment_status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                               <td><?=$j?></td>
                                 ...
                                 <td><?=$uniform[$i]['receipt_no']?></td> 
                                 <td><?=$uniform[$i]['txtid']?></td> 
								 <td><?php echo $uniform[$i]['productinfo'];?></td> 
                                <td><?php
								echo $uniform[$i]['academic_year'];
								?></td>

                                <td>
							
							<?php
								echo $uniform[$i]['amount'];
								?>
								</td> 
								 
								<td><?=$uniform[$i]['pg_type']?></td> 
								<td><?=$uniform[$i]['payment_date']?></td> 
								<td><?=$uniform[$i]['bank_ref_num']?></td> 
								<td><?=$uniform[$i]['payment_status']?></td> 
