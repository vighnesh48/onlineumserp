...
$ipAddress = $_SERVER['REMOTE_ADDR'];
	...
	//	$site_url= $site_url."payment/";
        ...
        $qrImg = 'data:image/png;base64,'.$qrCodeDataImg;		
...
<td align="right" valign="top" style="padding:5px 5px 5px 5px;" height="30" ><img src="'.$qrImg.'" width="70"></td>
</tr>
...
<td align="right" valign="top" style="padding:5px 5px 5px 5px;" height="30" ><img src="'.$site_url.'uploads/online_payment/'.$qrImg.'" width="70"></td>
</tr>
...
$result = $this->awssdk->uploadFileContent($this->bucket_name, $file, $pdfContent);
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
