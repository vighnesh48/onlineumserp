...
$( document ).ready(function() {
   ...
   if(ftype=='Examination'){
	   $(".exam_session").show();
	   $("#exam_session").html('<select name="examsession" id="examsession" class="form-control" onchange="onPayment_type()"><option value="">Select exam session</option><option value="23">SEPT-2022</option><option value="20">JUNE-2022</option><option value="21">JULY-2022</option><option value="19">APRIL-2022</option></select>');
	    // $("#amount").val(data);
	  ...
	  // $('#amount').attr('readonly', true); 
	   ...
	   if(year=="2022"){
		   $(".Paymenttype").show();
	  /* <option value="3">35% Payment</option><option value="3">35% Payment</option>*/
	  if(admission_session==2022){
		  $("#PaymentType").html('<select name="Payment_type" id="Payment_type" class="form-control" onchange="onPayment_type()"><option value="">Select Payment Type</option><option value="3">70% Payment</option><option value="2">Full Payment</option></select>');
	  }else{
	 ...
	 // $("#amount").val(data);
	   ...
	   /*<option value="4">70% Payment</option>*/
	     $(".Paymenttype").show();
	     $("#PaymentType").html('<select name="Payment_type" id="Payment_type" class="form-control" onchange="onPayment_type()"><option value="">Select Payment Type</option><option value="3">35% Payment</option><option value="2">Full Payment</option></select>');//<option value="1">Half Payment</option>
   ...
   if(ftype=='Examination'){
	...
	//  $('#amount').attr('readonly', true); 
	   ...
	   $("#amount").val(0);
		   ...
		   if(year=="2022"){$("#amount").val(Math.round(amt[3])); }else{
		  $("#amount").val(Math.round(amt[2])); 
		   }
	   }
	 ...
	 // $("#amount").val(data);
	   ...
	   $("#udf5").val(amt[2]);
	  // var tbl_tot_fees='<table border="1" ><tr style="background:#3175af"><th><label class="">Total fees </label></th></tr><tr style="color:#000000"><td><b><label class="">'+Math.round(amt[0])+'</label></td></tr></table>';
	 var tbl_tot_fees='<table border="1" ><tr style="background:#3175af"><th><label class="">Total fees </label></th><th><label class="">Pending fees </label></th></tr><tr style="color:#000000"><td><b><label class="">'+Math.round(amt[0])+'</label></td><td><label class="">'+Math.round(amt[2])+'</label></b></td></tr></table>';
            ...
            <form  name="payuForm"  id="payuForm" method="post" action="<?php echo base_url();?>/online_fee/Online_fee_entery_ccavenue" >
                            ...
                            <div class="row">
                                <div class="form-group">
                                     ...
                                     <div class="col-sm-6" id="">
                                        ...
                                        <option value="2022" selected="selected">2022-22</option>
                                        <?php // if(empty($adm)){?>
                             ...
                             <div class="row exam_session" style="display:none;">
                               <div class="form-group">
                                     ...
                                     <div class="col-sm-6" id="exam_session">
                                        ...
                                        <select name="examsession" id="examsession" class="form-control">
                                        </select>
                                     </div>
                                </div>
                                </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-6" id="">
                                    <input data-bv-field="slname" id="amount" name="amount" class="form-control"  required value="<?php echo (empty($_POST['amount'])) ? '' : $_POST['amount'] ?>" placeholder="Amount" type="text"> <!--+ Late Fee <input id="udf6" name="udf6" class="form-control" value="0" placeholder="Late Fee" type="text" readonly>-->
                                 </div>
                              </div>
                               </div>
			  ...
			  <div class="row">
                          ...
                          <ol style="font-family:verdana;">
                            <li>For <b>Re-registration</b> select Academic Year <b>2022-22</b> and fees type <b>Re-registration</b> then click on Pay now button.</li>
