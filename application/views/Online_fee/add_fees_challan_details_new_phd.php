...
$(document).ready(function(){
    ...
    $('#sbutton').click(function()
	{
		...
		{  
			$.ajax({
				'url' : base_url + 'Phd_Challan/students_data',
				...
				'success' : function(data){ //probably this request will return anything, it'll be put in var "data"
					...
					if(data != "{\"std_details\":null}")
					{
						...
						$('#admission_cycle').val(array.std_details.admission_cycle);
						$('#Batch').html(array.std_details.admission_cycle);
					...
					else
					{
						$('#std_details').hide();
						$('#fee_details').hide();
						$('#err_msg').html('This student Not Found');
						//return false;
					}
				}
			});
...
function faci_type(){
	...
	if(academic!='' && facility!=''){
		...
		//$("#form").trigger("reset");
		type='POST',url='<?= base_url() ?>Phd_Challan/get_fee_details_new',datastring={academic:academic,facility:facility,
		enroll:enroll,stud:stud,curr_yr:curr_yr,admission_session:admission_session,admission_cycle:admission_cycle};
		html_content=ajaxcall(type,url,datastring);
	//	alert(html_content);
		...
		//}
			...
			$('#totf').html(array[0].applicable_fee);
						...
						$("#devf").attr('readonly', true);
							...
							$("#Development_Fees_check").attr("disabled", false);
						...
						$("#cauf").attr('readonly', true);
							...
							$("#Caution_Form_check").attr("disabled", false);
						...
						if((array[1].admission_status)=="Y"){
							...
							$("#Admission_Form_check").attr("disabled", false);
						...
						$("#exmf").attr('readonly', true);
							...
							$("#Exam_fees_check").attr("disabled", false);
						...
						$("#Balance_Amount").attr('readonly', true);
							...
							$("#Balance_Amount_check").attr("disabled", false);
	...
	//	$('#depositto').html(html_content);
			...
			$('.Refresh').hide();
			$('.cert').hide();
			$("#exam_monthyear").removeAttr("required");
			$("#amth").removeAttr("readonly");
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-5 text-ctext-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Phd Generate challan </h1>
            ...
            <div class="col-sm-12">
                <div class="panel">
					...
					<div class="row">
                        ...
                        <div class="col-sm-2">
			<a href="<?php echo base_url();?>Phd_Challan/External_challan"><button class="btn btn-primary form-control" id="" type="button" >External Challan</button></a>
						</div>
						<div class="col-sm-5">
		...
		<form id="form" name="form" action="<?=base_url('phd_Challan/add_fees_challan_submit')?>" method="POST" >
        ...
        <input type="hidden" id="academic_year" name="academic_year" value="" />
                            ...
                            <div class="panel-body">
							 ...
							 <!-- <div class="form-group">
                              ...
                              <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Batch:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									 
									 <span id="Batch" name="Batch"></span>								   
								   </div>			 
							  </div>
                              <input type="hidden" name="admission_cycle" id="admission_cycle" value="" />
							  <div class="form-group" >
                                ...
                                <div class="col-md-6" style="padding-left:0px;">
                                  <select class="form-control" name="academic" id="academic" >
                                       ...
                                       <option  value="<?=$user_details[0]['academic_year']?>" selected="selected"><?=$user_details[0]['academic_year']?></option> 
							  ...
							  <div class="form-group">
                                ...
                                <div class="col-md-6" style="padding-left:0px;">
                                  <select class="form-control" name="facilty" id="facilty" onchange="faci_type()" >
									 ...
									 <option value="2" selected="selected">Academic Fees</option>
									  <option value="5">Examination Fees</option>
                       
                                      <option value="7">Examination Late fess</option>
                                      <option value="8">Revaluation</option>
                                      <option value="9">Photocopy</option>
									   ...
									   <?php 
										if(!empty($depositedto_details)){
											foreach($depositedto_details as $deposit){
												?>
											  <option value="<?=$deposit['bank_id']?>" <?php if($deposit['bank_id']==4){?> selected="selected"<?php } ?>><?=$deposit['branch_name']?> - <?=$deposit['bank_name']?></option>  
											<?php 
    ...
    more.
		...
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Excess" id="Excess" value="0" readonly="readonly"/></div>
             <div class="col-md-1">
                        ...
                        <div class="form-group" id="exsess">
		<label class="col-md-4" style="padding-left:0px;">Exam Session</label>
        <label class="col-md-1"></label>
         <label class="col-md-1"></label>
		<div class="col-md-5" >
        
        <select class="form-control" name="exam_monthyear" id="exam_monthyear" >
		...
		<?php }} ?>
             ...
             <div class="col-md-1">
                        ...
                        <div class="form-group Backlog_Exam">
		...
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Backlog_Exam" id="Backlog_Exam" value="0" onblur="calc_final_amount();" /></div>
             <div class="col-md-1">
                                  ...
                                  <div class="form-group Photocopy_Fees">
		...
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Photocopy_Fees" id="Photocopy_Fees" value="0" onblur="calc_final_amount();" /></div>
             <div class="col-md-1">
                                  ...
                                  <div class="form-group Revaluation_Fees">
		...
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Revaluation_Fees" id="Revaluation_Fees" value="0"  onblur="calc_final_amount();"/></div>
             <div class="col-md-1">
                                  ...
                                  <div class="form-group Late_Fees">
		...
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly " name="Late_Fees" id="Late_Fees" value="0" onblur="calc_final_amount();" /></div>
             <div class="col-md-1">
                                ...
                                <div class="form-group Certificate_Fees" style="display:none">
									<label class="col-md-4" style="padding-left:0px;">Certificate Fees</label>
									<label class="col-md-1"></label>
									 <label class="col-md-1"></label>
									<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Certificate_fees" id="Certificate_fees" value="1500"  /></div>
										 <div class="col-md-1">
									   </div>
								  </div>  
                                  ...
                                  <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-6" >
											...
											<option value="POS-UPI">POS-UPI</option>
									   ...
									   <div class="form-group">
										...
										<label class="col-md-4" style="padding-left:0px;" id="">Transaction No11:<?=$astrik?> </label>
											<div class="col-md-6" >
											<input type="text" class="form-control"  name="TransactionNo" id="TransactionNo" value="<?php echo $user_details[0]['bank_ref_num']; ?>"/>
										</div><div class="col-md-1"><a href="javascript:void(0);" id="Check_recepit" class='Check_recepit'>Check</a>
										</div>
										<div class="form-group">
										...
										<label class="col-md-4" style="padding-left:0px;" id="">Transaction Date:<?=$astrik?> </label>
											<div class="col-md-6" >
											<input type="text" class="form-control"  name="TransactionDate" id="TransactionDate" value="<?php echo $user_details[0]['payment_date']; ?>" />
										</div></div>
										</div>
                               ...
                               <input type="hidden" name="University_org" id="University_org" value="" />
                                ...
                                <div class=" col-md-5">
                                  <button type="submit" class="btn btn-primary form-control" >Generate</button>
                                   ...
                                   <div class="col-sm-5"><button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url($currentModule)?>/'">Cancel</button></div>
...
<div class="modal fade" id="myModal_add">
    ...
    <tbody>
		<tr>
        <th width="5%">Tuition Fees<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal_add">
    ADD.
  </button></th><td><input type="text" id="add_Tuition" name="add_Tuition" value="" /></td>
		</tr>
        	<tr>
        <th width="5%">Development Fees</th><td><input type="text" id="add_Development" name="add_Development" value="" /></td>
		</tr>
        
        	<tr>
        <th width="5%">Caution Money Fees</th><td><input type="text" id="add_Caution" name="add_Caution" value="" /></td>
		</tr>
        <tr>
        <th width="5%">Admission FROM</th><td><input type="text" id="add_Admission" name="add_Admission" value="" /></td>
		</tr>
        <tr>
        <th width="5%">Exam fees</th><td><input type="text" id="add_Examfees" name="add_Examfees" value="" /></td>
		</tr>
        <tr>
        <th width="5%">University Fees</th><td><input type="text" id="add_University" name="add_University" value="" /></td>
		</tr>
        <tr>
        </tr>
        <tr><td><button name="" id="add_save" >SAVE</button></td></tr>
...
<script>
	$('.Check_recepit').on('click',function(){
	    ...
	    $.ajax({
		type:"POST",
		url:'<?php echo base_url();?>phd_Challan/check_recepit',
		data:formData,
...
$(document).ready(function(e) {
	...
	$('#add_save').on('click',function(){
		...
		var add_Tuition=$("#add_Tuition").val();
		var add_Development=$("#add_Development").val();
		var add_Caution=$("#add_Caution").val();
		
		var add_Admission=$("#add_Admission").val();
		var add_Examfees=$("#add_Examfees").val();
		var add_University=$("#add_University").val();
		...
		var academic=$("#academic").val();
		//alert(receipt_number);
		var formData = {add_Tuition:add_Tuition,add_Development:add_Development,add_Caution:add_Caution,add_Admission:add_Admission,add_Examfees:add_Examfees,add_University:add_University,enroll:enroll,student_id:student_id,academic:academic};
		if(student_id!=''){
		
	    $.ajax({
		type:"POST",
		url:'<?php echo base_url();?>Phd_Challan/add_Tuition_ajax',
		data:formData,
