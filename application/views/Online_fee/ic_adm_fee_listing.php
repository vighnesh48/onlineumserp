...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        ...
        if($this->session->userdata('role_id')==5 || $this->session->userdata('role_id')==6 || $this->session->userdata('um_id')==120 || $this->session->userdata('role_id')==40){?>
        <div class="row ">
            <div class="col-sm-12">
                <div class="panel">
                            ...
                            <tr <?=$bg?> <?=$emp_list[$i]["status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                               <td><?=$j?></td>
                                 ...
                                 <td>
                                     ...
                                     ?>
                                     <a href="https://onlinepayments.sandipuniversity.com/uniform_payment/manual_eventpayment_receipt/<?=$emp_list[$i]['payment_id']?>" target="_blank"> <?=$emp_list[$i]['bank_ref_num']?></a>
                                     <?php
                                     }
                                    else
                                     {
                                    echo $emp_list[$i]['bank_ref_num'];
                                     }
                                     ?>
