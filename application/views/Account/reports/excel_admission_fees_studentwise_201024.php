...
else if($report_type=="8")
{
	...
	$filename='Sem Wise Student Wise Outstanding Fees-'.$academic_year.'.xls'; 
       ...
       $this->load->library("excel");
					...
					$object->getActiveSheet()->setCellValue('I4', 'Is Reported');
	                ...
	                $object->getActiveSheet()->setCellValue('X4', 'Admission Cancel');
					...
					$object->getActiveSheet()->setCellValue('AA4', 'nationality');
					...
					$object->getActiveSheet()->setCellValue('AF4', 'Remark ');
					...
					$object->getActiveSheet()->setCellValue('AP4', 'Package');
	               ...
	               $object->getActiveSheet()->getStyle('A1:AP4')->getFont()->setBold(true);
	...
	$object->getActiveSheet()->setCellValue('I'.$x, $row['reported_status']);
...
//	$object->getActiveSheet()->setCellValue('T'.$x, $pending);
	$object->getActiveSheet()->setCellValue('X'.$x, $row['cancelled_admission']);
	...
	//if(belongs_to)
	$object->getActiveSheet()->setCellValue('AF'.$x, $row['concession_remark']); //$exam_status
