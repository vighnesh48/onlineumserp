...
<table border="1" align="center" width="100%" cellpadding="3" cellspacing="0" style="font-size:12px;">
    <thead>
        <tr style="border:1px solid #000;">
            ...
            <th style="border:1px solid #000" align="left">ABN</th>
        ...
        if (!empty($mrks)) {
            foreach ($mrks as $stud) {
                ...
                <tr style="border:1px solid #000;">
                    ...
                    <td style="border:1px solid #000;" width="20%"><?= $stud['ans_bklet_no'] ?></td>
    ...
    <tr>
        <td align="center">
            <table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    <td align="center" class="signature" valign="bottom"><strong>No.of Present :</strong>
                        <?= count($mrks) - $count_AB; ?></td>
                    <td align="center" class="signature" valign="bottom"><strong>No.of. Absent :</strong> <?= $count_AB ?>
                    </td>
                    <td align="center" class="signature" valign="bottom"><strong>Total :</strong> <?= count($mrks); ?>
                    </td>
                </tr>
            </table>
        </td>
