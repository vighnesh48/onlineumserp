...
<div id="content-wrapper">
   <ul class="breadcrumb breadcrumb-page">
      ...
      <li class="active"><a href="#">Online SU-JEE </a></li>
   ...
   <div class="page-header">
      <div class="row">
         <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Online SU-JEE Payments</h1>
...
//resetPaging: false,
        ...
        "ajax": {
            "url": "<?php echo site_url('sujee_online/ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
