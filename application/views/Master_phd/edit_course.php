...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
			...
			<i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Update Course </h1>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/edit_course_submit')?>" method="POST" onsubmit="return validate_faci_category(event)">        
								<input type="hidden" name="c_id" id="c_id" value="<?=$course_details['course_id']?>"/>
                                <div class="form-group">
                                    <label class="col-sm-3">Course Name <?=$astrik?></label>                                    
                                    <div class="col-sm-4">
                                        <input type="text" id="cname" name="cname" value="<?=$course_details['course_name']?>" onchange="check_crs_exists()" class="form-control alphaonly" />
                                    </div>                                    
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" id="csname" name="csname" value="<?=$course_details['course_short_name']?>"  onchange="check_crs_exists()" class="form-control alphaonly" />
                                    </div>                                    
...
function check_crs_exists()
{
	...
	else
	{
		...
		$.ajax({
				...
				data: {cname:cname,csname:csname,id:id},
