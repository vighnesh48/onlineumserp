...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-5 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add Academic Session </h1>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/add_academic_session_submit')?>" method="POST" onsubmit="return validate_faci_category(event)">                                                               
...
function check_session_exists()
{
	...
	else
	{
		...
		$.ajax({
				...
				data: {academic:academic,session:session,smonth:smonth,lmonth:lmonth},
