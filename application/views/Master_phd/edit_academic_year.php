...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-5 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Update Academic Year </h1>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/edit_academic_year_submit')?>" method="POST" onsubmit="return validate_faci_category(event)">     
...
function check_year_exists()
{
	...
	else
	{
		...
		$.ajax({
				...
				data: {academic:academic,smonth:smonth,lmonth:lmonth,id:id},
