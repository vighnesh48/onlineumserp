...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-5 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add Course Category </h1>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/add_course_category_submit')?>" method="POST" onsubmit="return validate_faci_category(event)">                                                               
                                <div class="form-group">
                                    <label class="col-sm-3"> Course Category <?=$astrik?></label>                                    
                                    <div class="col-sm-4">
                                        <input type="text" id="cname" name="cname" onchange="check_crs_cat_exists()" class="form-control alphaonly" />
                                    </div>                                    
