...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Syllabus</h1>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            <form id="form" name="form" action="<?=base_url($currentModule.'/')?>" method="POST">    <div class="form-group">
										...
										foreach ($subj_details as $sub) {	
												...
												?>
													<tr>
														...
														<a href="<?=base_url()?>Syllabus/add_syllabus/<?=$sub['sub_id']?>" target="_blank"><button type="button" class="btn btn-info" onclick1="add_subjects(<?=$sub['sub_id']?>);" >Add/view</button></a>
														</td>
													</tr>
							<tr>
...
<div class="col-sm-6">									
									<table class="table table-bordered" >
										...
										<thead>
											...
											$topc =$CI->Syllabus_model->get_topic_details($sub['sub_id']);
									if(!empty($topc)){
										foreach($topc as $tpc){
												?>
													<tr>
