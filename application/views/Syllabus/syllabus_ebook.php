            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <!--<button class="btn btn-info" data-toggle="modal" data-target="#importModal" style="float:right">
                                        ...
                                        <?php if (!empty($topic['subtopics'])): ?>
                                            <?php foreach ($topic['subtopics'] as $sub): ?>
                                                <tr>
                                                    ...
                                                    <!-- <td>
                                                        <center><img src="<?php echo base_url('assets/progress_bar_100.gif'); ?>" height="100px" width="130px"></center>
                                                    </td>-->
													...
													<td>
                                                        <!--<div class="circle-progress">
														  <svg viewBox="0 0 120 120">
															...
															<circle class="bar" cx="60" cy="60" r="44"></circle>
														  </svg>
														  <div class="cp-label">0%</div>
														</div>-->
                                                    </td>
                                                    ...
                                                    <td>
                                                       ...
                                                       <a href="<?= $sub['video_link'] ?>" target="_blank"><img src="<?php echo base_url('assets/youtube.png'); ?>" height="70px" width="90px"></a>
