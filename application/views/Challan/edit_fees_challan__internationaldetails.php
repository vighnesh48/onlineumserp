...
var stud = $('#student_id').val();
	if(academic!='' && facility!='')	{	
		type='POST';		url='<?= base_url() ?>Challan/get_fee_details_international';		datastring={academic:academic,facility:facility,enroll:enroll,stud:stud};	
    ...
    <div class="page-header">			
        ...
        <div class="row ">
            <div class="col-sm-12">
                   ...
                   <form id="form" name="form" action="<?=base_url($currentModule.'/edit_fees_challan_international_submit/'.$challan_details['fees_id'])?>" method="POST" >
									...
									//if(!empty($bank_details)){
										//foreach($bank_details as $bank){	
											...
											//	{
											  ...
											  <input type="text" class="form-control " value="<?=$challan_details['ubank_name']?>" readonly name="bankname" id="bankname" />
											<?php 
											//	}														
											//}
										//}
							...
							<div class="form-group">
                                ...
                                <div class=" col-md-4">
                                  <button type="submit" id="display" class="btn btn-primary form-control" >Submit</button>
                                   ...
                                   <div class="col-sm-4"><button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url($currentModule)?>/challan_international_list'">Cancel</button></div>
