...
<table class="table table-bordered" id="search-table" style="width:100%;max-width:100%;">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr>
                               ...
                               <td><?php echo $challan_details[$i]['TransactionNo'];  if($challan_details[$i]['fees_paid_type']=="CASH"){ echo $challan_details[$i]['fees_paid_type']; }?></td>
                               <td><?php if($challan_details[$i]['TransactionDate']!=''){ echo date('d-m-Y',strtotime($challan_details[$i]['TransactionDate'])); } 
							           
							   ?></td>
                               <td><?php echo $challan_details[$i]['student_bank'];
							   if($challan_details[$i]['fees_paid_type']=="CASH"){ echo $challan_details[$i]['su_bank_name']; }?></td>
                               
                                <td><?=$challan_details[$i]['amount'];?></td>
                                  <td><?=$challan_details[$i]['stream_short_name'];?></td>
                                  <td><?=$challan_details[$i]['current_year'];?></td>
                               
                                <td><?=$challan_details[$i]['branch_name']?> (<?=$challan_details[$i]['su_bank_name']?>)</td> 
