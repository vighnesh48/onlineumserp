...
//echo '<pre>';print_r($std_challan_details);exit;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   <?php if($this->session->userdata('role_id')!='4' && $std_challan_details['fees_paid_type']!="CASH")
	  {
		if($std_challan_details['fees_paid_type']=="CASH" || $std_challan_details['fees_paid_type']=="CHQ" || $std_challan_details['fees_paid_type']=="DD")
		{
		?>
<td width="33%">
          ...
          <tr>
          <td colspan="2" align="center"><strong>Sandip University Fees Challan Cum Receipt</strong></td>
        </tr>
          </table>
       ...
       <tr>
		<td>
		 ...
		 <?php }else{ ?>
         <strong>Student ID :</strong> <?=$std_challan_details['enrollment_no']?>
		 <?php } ?></td>
         <td> <?php if(!empty($std_challan_details['enquiry_no'])){?><strong>Enquiry No :</strong>  <?=$std_challan_details['enquiry_no']?><?php } ?></td>
		</tr>
        <tr>
        ...
        <tr>
          ...
          <?php if($std_challan_details['remark']=="Online_Admission_Form"){ ?>
          <strong>Details :</strong><?=$std_challan_details['guest_address'];?>&nbsp;&nbsp;<?php echo (($std_challan_details['guest_year']));?>&nbsp;Year
		  <?php }else{ ?>
        ...
        <tr>
		  ...
		  echo 'Academic Fees';}else if($std_challan_details['type_id']=="5"){
		   echo 'Exam Fees -'; echo $std_challan_details['exam_monthyear']; }else if($std_challan_details['type_id']=="10"){
			...
			}else if($std_challan_details['type_id']=="13"){
			echo 'Certificate Fees';
			}
		   ?></strong></td>
          <td></td>
        </tr>
     ...
     <?php //if($std_challan_details['Balance_Amount_status']=="Y"){?>
		...
		<tr>
          <!--<td align="center">1</td>-->
          <td>Package Fees</td>
          <td><?=$std_challan_details['package_fees']?></td>
        </tr>
        <?php //} ?>
        <tr>
        ...
        <tr>
          ...
          <td>Hostel Fees	</td>
          <td><?=$std_challan_details['hostel_fee']?></td>
        </tr>
	<tr>
         <!-- <td align="center">8</td>-->
          <td>Excess Fees	</td>
		 ...
		 <tr>
          <!--<td align="center">4</td>-->
          <td>Late Fees</td>
          <td><?=$std_challan_details['exam_fee_fine']?></td>
        </tr>
        <?php }elseif(($std_challan_details['type_id']==5)||($std_challan_details['type_id']==7)||($std_challan_details['type_id']==8)
		||($std_challan_details['type_id']==9)) {?>
         <tr>
         <!-- <td align="center">1</td>-->
		...
		<tr>
          <!--<td align="center">4</td>-->
          <td>Degree Certificate Fees</td>
          <td><?=$std_challan_details['degree_certificate_fees']?></td>
        </tr>
		...
		<?php }elseif($std_challan_details['type_id']==22){ ?>
         <tr>
          <!--<td align="center">1</td>-->
          <td>Duplicate Hallticket Fees</td>
        ...
        <tr>
          ...
          <td><?php if($std_challan_details['remark']=="Online_Admission_Form"){ ?>Admission Form<?php }else{ ?>Registration Fees<?php } ?></td>
        ...
        <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
		<tr>
          <td colspan="3"><strong>Remark:</strong>
		  <?php if($std_challan_details['remark']=="Online_Admission_Form"){ ?>
          <?php echo $std_challan_details['remark'];?>&nbsp;&nbsp;<?php echo $std_challan_details['academic_year']; ?>  
          <?php }else{?>
		  <?php echo (($std_challan_details['remark']));?>
          <?php } ?></td>
        </tr>
        <tr>
		...
		<tr>
		<td colspan="3"><strong>Mode of Payment:</strong> <?php if($std_challan_details['fees_paid_type']=="CASH"){
			echo 'Challan';}else{ echo $std_challan_details['fees_paid_type'];} ?><?php //$std_challan_details['fees_paid_type']?></td>
		</tr>
		<!--	<tr>
      ...
      <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
        ...
        <tr>
          ...
          <td><strong>Date :</strong> <?=date("d/m/Y", strtotime($std_challan_details['created_on']));?><?php //date("d/m/Y")?></td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr>
          <td align="left"><span style="alignment-adjust:left;font-size:8px;"><strong>Note:-</strong>Cheque/DD are Subject to realisation</span></td>
         <td align="left"><span style="alignment-adjust:left;font-size:8px;"><strong>User Name-:</strong> <?=$std_challan_details['display_name']?></span></td>
    ...
    <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
      ...
      <table width="350" border="1" cellspacing="0" cellpadding="0" class="table">
       ...
       <?php }elseif($std_challan_details['type_id']==11){ ?>
		...
		<tr>
		<td colspan="3"><strong>Mode of Payment:</strong> <?php if($std_challan_details['fees_paid_type']=="CASH"){
			echo 'Challan';}else{ echo $std_challan_details['fees_paid_type'];} ?></td>
		</tr>
		<!--	<tr>
		<td colspan="3"><?php if($std_challan_details['fees_paid_type']=='OL'){ ?><strong>Transaction No:</strong> <?=$std_challan_details['TransactionNo']?><?php } ?></td>
		</tr>
