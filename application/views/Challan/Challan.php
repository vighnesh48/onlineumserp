...
//exit;
		...
		if($last_inserted_id)
		{
			...
			$challan_no='19SUN'.$addmision_type.$month_session.str_pad( $last_inserted_id, $challan_digits, "0", STR_PAD_LEFT );
...
//$this->load->view($this->view_dir.'facility_challan_pdf', $this->data);
	...
	public function Exam_challan()
	{
		...
		$this->data['challan_details']=$this->Challan_model->examfees_challan_list($_POST);
