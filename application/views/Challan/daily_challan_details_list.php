            ...
            <div class="col-sm-12">
                ...
                <div class="panel-heading">  
                    ...
                    <!--label class="col-sm-1">Status</label>-->
                     ...
                     <div class="col-sm-3">
                            <select class="form-control" name="challan_type" id="challan_type">
                                <option value="">Select Challan Type</option>
                                <option value="receipt">New Students</option>
                                <option value="challan">Regular Students</option>
              ...
              <?php foreach ($receipt_typ as $key => $value) {
               echo '<option value="'.$value['fees_paid_type'].'" >'.$value['fees_paid_type'].'</option>';
                        ...
                        <div  id="datewise" class="col-sm-3" >
...
<form action="<?php echo base_url()?>Challan_new/download_modefor_today_pdf" id="exportpf" name="exportpf" method="post">
  <input type="hidden" name="selectdate" id="selectdate"/>
   <input type="hidden" name="challan_type_new" id="challan_type_new"/>
    <input type="hidden" name="feetype_new" id="feetype_new"/>
...
function common_call()
{
    ...
    type='POST',url='<?= base_url() ?>Challan_new/challan_list_reportview_daily_report';
...
<script>
  ...
  $("#getpdf").click(function(){
    ...
    $("#challan_type_new").val($("#challan_type").val());
    $("#feetype_new").val($("#feetype").val());
    $("#status_new").val($("#status").val());
