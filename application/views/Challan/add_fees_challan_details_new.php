			...
			$.ajax({
				...
				'success' : function(data){ //probably this request will return anything, it'll be put in var "data"
					...
					if(data != "{\"std_details\":null}")
					{
						...
						if(array.std_details.admission_cycle==null){
						...
						$('#std_details').hide();
						$('#fee_details').hide();
						$('#err_msg').html('Please Generate Challan On - PHD Challan Tab');
						}
					}else{
...
function faci_type(){
	...
	//	alert(html_content);
		...
		//}else{
			 var apend = parseInt(array[0].applicable_fee) + parseInt(array[0].opening_balance);
			 
                 apend= parseInt(apend) - parseInt(array[0].amount_paid);
		//}
			...
			$('#exepmted_fees').html(array[0].exepmted_fees);
			$('#tActul').html(array[0].actual_fee);
						...
						//if (typeof array[1] !== 'undefined' && array[1].length > 0)
						 {
							...
							if((array[1].fees_id)!=0){
							$('.package_Fees_read').html(array[1].package_fees_pending);
							$('#package_Fees_check').val(array[1].package_fees_pending);
							if((array[1].package_fees_status)=="Y"){
							$("#package_Fees_check").attr("disabled", true);
							$("#pkgf").attr('readonly', true);
							}
							}else{
							$('.package_Fees_read').html(array[0].package_fees_pending);
							$('#package_Fees_check').val(array[0].package_fees_pending);
							}
						}
...
<div id="content-wrapper">
							  ...
							  <div class="form-group">
                                ...
                                <div class="col-md-6" style="padding-left:0px;">
                                  <select class="form-control" name="facilty" id="facilty" onchange="faci_type()" >
                                      ...
                                      <option value="15">Transcript</option>
                                      <option value="16">Corrections in Degre</option>
                                      <option value="17">Corrections in GRade</option>
                                      <option value="18">Duplicate Degree</option>
                                      <option value="19">Duplicate Diploma/Certificate</option>
                                      <option value="20">Duplicate Grade card</option>
                                      <option value="21">Student Verification</option>
									   <?php 
    ...
    more.
							...
							<!--	<div class="form-group">
							   ...
							   <div class="form-group">
                                <label class="col-md-12" style="padding-left:0px;"> Actul Fee:<span id='tActul'></span><br />
                                 Appli Fee:<span id='totf'></span>, Amount Paid: <span id='amtpaid'></span>, Amount Pending: <span id='amtpand'></span><br /> Consession <span id='exepmted_fees'></span></label> 
		...
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Balance_Amount" id="Balance_Amount" value="0" readonly="readonly" /></div>
			...
			<div class="form-group">
					<label class="col-md-4" style="padding-left:0px;">Package fees <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#mypkgModal_add">
    ADD.
  </button> </label> 
                    <label class="col-md-2"><i class="fa fa-rupee" style="font-size:11px">&nbsp;</i><span class="package_Fees_read"></span></label>
                    
					<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="pkgf" id="pkgf" value="0"  readonly="readonly" /></div>
                    <div class="col-md-1" ><input type="checkbox" class="cal_math" name="" id="package_Fees_check" value="" /></div>
					</div>
					
					<div class="form-group">
					<label class="col-md-4" style="padding-left:0px;">Tuition Fees <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal_add">
    ADD.
  </button> </label> 
        ...
        <label class="col-md-1"></label>
         <label class="col-md-1"></label>
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Certificate_fees" id="Other_fees" value="0" onblur="calc_final_amount();" /></div>
             <div class="col-md-1">
									   </div>
								  </div>
		...
		<div class="col-md-5" ><input type="text" class="form-control numbersOnly" name="Other_fees" id="Other_fees" value="0"  onblur="calc_final_amount();"/></div>
             <div class="col-md-1">
                        ...
                        <div class="form-group">
                                  ...
                                  <div class="form-group">
									...
									<div class="form-group">
									  ...
									  <div id="non_cash" style="display:none;">
										...
										</div><div class="col-md-1"><a href="javascript:void(0);" id="Check_recepit" class='Check_recepit'>Check</a></div>
										</div>
                                        <div class="form-group">
                               ...
                               <input type="hidden" name="package_org" id="package_org" value="" />
...
<!-- The Modal -->
  ...
  <div class="modal fade" id="myModal_add">
    ...
    <tbody>
		...
		<tr>
        <th width="5%">Development Fees</th><td><input type="text" id="developmentfees" name="developmentfees" value="" /></td>      		
		</tr>
		<tr>
        <th width="5%">Caution Money</th><td><input type="text" id="cautionmoney" name="cautionmoney" value="" /></td>      		
		</tr>
		<tr>
        <th width="5%">Admission Form</th><td><input type="text" id="admissionform" name="admissionform" value="" /></td>      		
		</tr>
		<tr>
        <th width="5%">Exam fees</th><td><input type="text" id="examfees" name="examfees" value="" /></td>      		
		</tr>
		<tr>
        <th width="5%">University Fees</th><td><input type="text" id="universityfees" name="universityfees" value="" /></td>      		
		</tr>
        <tr>
        </tr>
  ...
  <div class="modal fade" id="mypkgModal_add">
    <div class="modal-dialog modal-xl">
      <div class="modal-content" >
    ...
    <tbody>
		<tr>
        <th width="5%">Package Fees</th><td><input type="text" id="pkg_fee" name="pkg_fee" value="" /></td>      		
		</tr>
		
        <tr>
        </tr>
        <tr><td><button name="" id="add_package" >SAVE</button></td></tr>
...
$(document).ready(function(e) {
	$('.Refresh').on('click',function(){
		...
		var development_fees=$("#developmentfees").val();
		var caution_money=$("#cautionmoney").val();
		var admission_form=$("#admissionform").val();
		var exam_fees=$("#examfees").val();
		var university_fees=$("#universityfees").val();
		var academic=$("#academic").val();
		//alert(receipt_number);
		var formData = {add_fee:add_fee,enroll:enroll,student_id:student_id,academic:academic,development_fees:development_fees,caution_money:caution_money,admission_form:admission_form,exam_fees:exam_fees,university_fees:university_fees};
		if(student_id!=''){
	...
	$('#add_package').on('click',function(){
	    ...
	    $.ajax({
		type:"POST",
		url:'<?php echo base_url();?>Challan/add_package',
		data:formData,
    ...
    $('.cal_math').on('click',function(){
		...
		if(id=="package_Fees_check"){
			...
			if($(this).is(":checked")) {
			alert('Balance Amount is less Than Current Amount');
			$('#package_Fees_check').prop('checked',false);
			}else{
			//	alert('6');
			var amth=$('#amth').val();
			var tutf=$('#pkgf').val();
