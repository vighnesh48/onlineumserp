        ...
        <div class="row">
			...
			<div class="col-xs-12 col-sm-8">
                <div class="row"> 
                  ...
                  <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add_fees_challan_internationl")?>"><span class="btn-label icon fa fa-plus"></span>Generate </a></div>
                       ...
                       <table class="table table-bordered" style="width:100%;max-width:100%;">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr>
								...
								-->
								<a title="View challan Details" class="btn btn-primary btn-xs" href="<?=base_url($currentModule."/edit_challan_international/".$challan_details[$i]['fees_id'])?>">View</a>
								   
								<a  href="<?=base_url($currentModule."/download_challan_international_pdf/".$challan_details[$i]['fees_id'])?>" title="View" target="_blank" <?=$disable?>><i class="fa fa-file-pdf-o" aria-hidden="true"  style="font-size:20px;color:red;"></i> </a>
								</td>
