...
function faci_type(){
	...
	if(academic!='' && facility!=''){
		...
		//$("#form").trigger("reset");
		type='POST',url='<?= base_url() ?>Challan/get_fee_details_international',datastring={academic:academic,facility:facility,enroll:enroll,stud:stud,curr_yr:curr_yr,admission_session:admission_session};
		html_content=ajaxcall(type,url,datastring);
	//	alert(html_content);
		...
		//}
			...
			$('#totf').html(array[0].applicable_fee);
						...
						$('#Accommodation').val(array[0].accommodation);
...
function calc_final_amount(){
			...
			+parseInt(OtherFINE_Brekage)+parseInt(Other_Registration)+parseInt(Other_Late)+parseInt(Other_fees)+parseInt(Accommodation); 
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        ...
        <div class="row ">
            <div class="col-sm-12">
                <div class="panel">
					...
					<div class="row">
						<div class="col-sm-3">
							<input type="number" class="form-control" required name="prn" id="prn" placeholder="PRN No."/>
						</div>
                        <div class="col-sm-2">
		...
		<form id="form" name="form" action="<?=base_url($currentModule.'/add_fees_challan_international_submit')?>" method="POST" >
             ...
             <div class="col-md-1">
                        ...
                        <div class="form-group">
                                   ...
                                   <input type="hidden" class="form-control" name="amth_status" id="amth_status" value="N"/>
								     ...
								     <div class="form-group">
								   <label class="col-md-4" style="padding-left:0px;"> Accomodation Fees:</label>
                                   
													 <div class="col-md-6" >
											
                                   <input type="text" class="form-control numbersOnly" name="Accommodation" id="Accommodation" value="" readonly="readonly"/>
                               ...
                               <input type="hidden" name="University_org" id="University_org" value="" />
                                ...
                                <div class=" col-md-5">
                                  <button type="submit" class="btn btn-primary form-control" >Generate</button>
                                   ...
                                   <div class="col-sm-5"><button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url($currentModule)?>/challan_international_list'">Cancel</button></div>
