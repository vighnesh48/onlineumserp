            ...
            <div class="col-sm-12">
                   ...
                   <form id="form" name="form" action="<?=base_url($currentModule.'/edit_fees_challan_submit/'.$challan_details['fees_id'])?>" method="POST" >
							...
							?>
							  ...
							  <div class="form-group"><!--<option value="13">Certificate Fees</option>-->
                                ...
                                <div class="col-md-5"  style="padding-left:0px;">
									...
									$ftype='Examination Fees';
									else if($challan_details['type_id']==7)
									$ftype='Late fess';
									else if($challan_details['type_id']==8)
									$ftype='Revaluation Fees';
									else if($challan_details['type_id']==9)
									$ftype='Photocopy Fees';
									else if($challan_details['type_id']==10)
									$ftype='Other Fees';
									else if($challan_details['type_id']==11)
									$ftype='External Fees';
									else if($challan_details['type_id']==13)
									$ftype='Certificate Fees';
										?> 
...
<input type="text" class="form-control numbersOnly" readonly name="facilty_type" id="facilty_type" value="<?=$ftype?>" />
						...
						<div class="panel" id="fee_details" >
                            ...
                            <div class="panel-body">
							<?php if($challan_details['type_id']==5){?>
							<div class="form-group">                               
                             <label class="col-md-5" style="padding-left:0px;">Exam Session:</label>  
                             <div class="col-md-6">                        
                             <input type="hidden" value="<?=$challan_details['exam_id']?>" name="exam_session" id="exam_session"/><?=ucwords($challan_details['exam_monthyear']);?>                               
							 </div>  
							 </div>
							<?php }?>
                             <input type="hidden" value="<?=$challan_details['exam_id']?>" name="exam_id" id="exam_id"/>
                            <div class="form-group">                              
                                  <label class="col-md-5" style="padding-left:0px;"> Challan No:</label>                      
                                  <div class="col-md-6">                                   
<input type="text" id="challan_no" name="challan_no" value="<?=$challan_details['exam_session']?>" class="form-control" readonly />                                     </div>                                                              </div>
                       ...
                       <input type="text" class="form-control numbersOnly"  value="<?=$challan_details['amount']?>" readonly name="facility" id="facility" />                 
                             ...
                             <div class="col-md-6">                        
                             <input type="text" class="form-control numbersOnly"  value="<?=$challan_details['amount']?>" readonly name="apaid" id="apaid" readonly/>                               
							 </div>  
							 </div>
                             <div class="form-group">                               
                             <label class="col-md-5" style="padding-left:0px;">Previous paid:</label>  
                             <div class="col-md-6">                        
                             <input type="text" class="form-control numbersOnly"  value="<?=$challan_details['Balance_Amount']?>" readonly name="Previouspaid" id="Previouspaid" readonly/>                               
							 </div>  
							 </div>
							 
							 <div class="form-group">                                <label class="col-md-5" style="padding-left:0px;">Amount Pending:</label>                                <div class="col-md-6">                                   <input type="text" class="form-control numbersOnly"  value="0" readonly name="apend" id="apend" readonly/>                               
                                             </div>                                                            
                                               </div> 
										<div class="form-group">
					...
					<div id="non_cash" style="display:none;">
										...
										<label class="col-md-5" id="receipt"></label>
											<div class="col-md-6" >
											<input type="text" class="form-control numbersOnly"  name="receipt_number" <?php if($challan_details['receipt_no']==""){}else{?> readonly <?php } ?> id="receipt_number" value="<?=$challan_details['receipt_no']?>" />
										</div>
										</div>
								...
								<div class="col-md-6" >
									...
									//if(!empty($bank_details)){
										//foreach($bank_details as $bank){	
											...
											//	{
												?>
											  <input type="hidden" class="form-control " value="<?=$challan_details['ubank_id']?>" name="bank" id="bank" />
											  <input type="text" class="form-control " value="<?=$challan_details['ubank_name']?>"  name="bankname" id="bankname" />
											<?php 
											//	}														
											//}
										//}
							...
							<div class="form-group">
								...
								<div class="col-md-6" >
                                <?php if($challan_details['challan_status']=="VR"){?>
								<input type="text" class="form-control" readonly="readonly" value="Deposited"  name="currentstatus" id="currentstatus" />
								<input type="hidden" class="form-control " value="<?=$challan_details['challan_status']?>"  name="current_status" id="current_status" />
