...
$(document).ready(function()
{
	...
	$('#err_msg').html('');
	type='POST',url='<?= base_url() ?>Master/get_school_stream_details',datastring={id:''};
	...
	$('#school').on('change', function () {
		...
		$('#header_year').html($("#school option:selected").text());
		type='POST',url='<?= base_url() ?>Master/get_school_stream_details',datastring={id:school[1]};
		html_content=ajaxcall(type,url,datastring);
		//alert(html_content);
		if(html_content!="")
		{
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp; School Stream List</h1><span id="err_msg" style="color:red;"></span>
			<div class="pull-right col-xs-4 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add_school_stream")?>"><span class="btn-label icon fa fa-plus"></span>Add </a></div>
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                    <div class="row">
						<div class="col-sm-8">
						<span class="panel-title"><b>For School:</b> <span id="header_year"></span></span>
						</div>
                ...
                <div id="show_list" class="panel-body" style="display:none;">
                    <div class="table-info" style="overflow-x:scroll;height:450px;">    
