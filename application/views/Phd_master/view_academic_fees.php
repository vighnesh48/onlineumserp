...
{
	type='POST',url='<?= base_url() ?>Phd_master/fullview_feedetails',datastring={academic_fees_id:fid};
...
function common_call()
{
	...
	$('#err_msg').html('');
	type='POST',url='<?= base_url() ?>Phd_master/get_academic_fees_details',datastring={academic:academic,admission_year:admission_year};
	...
	if(html_content!="")
	{
		...
		$('#show_list').show();
		$('#report').attr('href','<?=base_url()?>Phd_master/academic_fee_details_excelReports/'+academic);
		$('#excel').show();
	}
	else
	{
