...
<script>    
var syear="<?=$school_details['start_year']?>";
var campus="<?=$school_details['campus']?>";
var stype="<?=$school_details['school_type']?>";  
var active="<?=$school_details['is_active']?>";     
    $(document).ready(function()
    {
		$('#syear option').each(function()
		 {              
			if($(this).val()== syear)
			{
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-5 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Update School </h1>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/edit_school_submit')?>" method="POST" onsubmit="return validate_faci_category(event)">   
								<input type="hidden" name="s_id" id="s_id" value="<?=$school_details['school_id']?>"/>
								<div class="form-group">
                                    <div class="col-sm-4">
									<label >Select Start Year:<?=$astrik?></label>
                                        ...
                                        <option value="">Select Start Year</option>
                                            <?php 
												 ...
												 $yy=date('y')+1;
												   for($i=1;$i<=4;$i++)
												   {
													   if($yyyy==$school_details['start_year'])
                                   ...
                                   <span style="color:red;"><?php echo form_error('syear');?></span>
									...
									<div class="col-sm-4">
									<label >Select School Type:<?=$astrik?></label>
								...
								<div class="form-group">
									...
									<input type="text" id="ccode"  value="<?=$school_details['school_code']?>" onchange="check_schl_exists()" name="ccode" class="form-control numbersOnly" placeholder="School Code"  />                                    
                                    <span style="color:red;"><?php echo form_error('ccode');?></span>
									</div>
									
                                    <div class="col-sm-4">
									<label >School Name:<?=$astrik?></label>
									<input type="text" id="cname"  value="<?=$school_details['school_name']?>" name="cname" onchange="check_schl_exists()" placeholder="School Name " class="form-control alphaonly"  /><span style="color:red;"><?php echo form_error('cname');?></span>
									</div>
									
									<div class="col-sm-4">
									<label >School Short Name:<?=$astrik?></label>
									<input type="text" id="ssname" value="<?=$school_details['school_short_name']?>"  name="ssname" onchange="check_schl_exists()" class="form-control alphaonly" placeholder="School Short Name" />                                    
								...
								<div class="form-group">
									...
									<input type="text" id="semail"  value="<?=$school_details['school_email']?>" name="semail" placeholder="School Email" class="form-control "  /><span style="color:red;"><?php echo form_error('semail');?></span>
									</div>
									
									<div class="col-sm-4">
									<label >School Address:<?=$astrik?></label>
									<input type="text" id="saddress" value="<?=$school_details['school_address']?>"  name="saddress" class="form-control alphaonly" placeholder="School Address" />                                    
                                   <span style="color:red;"><?php echo form_error('saddress');?></span>
								   </div>
								   <div class="col-sm-4">
									<label >Pincode:<?=$astrik?></label>
									<input type="text" id="pincode"  value="<?=$school_details['pincode']?>" name="pincode" placeholder="Pincode" class="form-control "  /><span style="color:red;"><?php echo form_error('pincode');?></span>
									</div>
								...
								<div class="form-group">
									...
									<input type="text" id="country"  value="<?=$school_details['country']?>" name="country" placeholder="Country" class="form-control alphaonly"  /><span style="color:red;"><?php echo form_error('country');?></span>
									</div>
									
                                    <div class="col-sm-4">
									<label >State:<?=$astrik?></label>
									<input type="text" id="state"  value="<?=$school_details['state']?>" name="state" placeholder="State" class="form-control alphaonly"  /><span style="color:red;"><?php echo form_error('state');?></span>
									</div>
									
									<div class="col-sm-4">
									<label >District:<?=$astrik?></label>
									<input type="text" id="district"  value="<?=$school_details['district']?>" name="district" class="form-control alphaonly" placeholder="District" />                                    
								...
								<div class="form-group">
									...
									<input type="text" id="cperson" value="<?=$school_details['contact_person']?>"  name="cperson" placeholder="Contact Person" class="form-control alphaonly"  /><span style="color:red;"><?php echo form_error('cperson');?></span>
									</div>
									<div class="col-sm-4">
									<label >Contact Email:<?=$astrik?></label>
									<input type="text" id="cemail" value="<?=$school_details['contact_email']?>"  name="cemail" placeholder="Contact Email" class="form-control"  /><span style="color:red;"><?php echo form_error('cemail');?></span>
									</div>
                                    <div class="col-sm-4">
									<label >Contact no. :<?=$astrik?></label>
									<input type="text"  value="<?=$school_details['contact_no']?>" id="contact" name="contact" placeholder="contact" class="form-control "  /><span style="color:red;"><?php echo form_error('contact');?></span>
									</div>
								...
								<div class="form-group">
									<div class="col-sm-4">
									<label >Is Active :<?=$astrik?></label>
									<select id="active" name="active" class="form-control" required>
											  <option value="">select Is Active</option>
											  <option value="Y">yes</option>
											  <option value="N">No</option>
                                        </select>  
										<span style="color:red;"><?php echo form_error('active');?></span>
									</div>
...
function check_schl_exists()
{
	...
	else
	{
		...
		$.ajax({
				...
				data: {syear:syear,ccode:ccode,stype:stype,cname:cname,ssname:ssname,campus:campus},
