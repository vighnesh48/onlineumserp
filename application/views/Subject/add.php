                              ...
                              <div class="col-sm-3" >
                                <select name="regulation" id="regulation" class="form-control" required>
                                  ...
                                  <?php
                                    ...
                                    ?>
									<!--option value="NEP2020">NEP2020</option-->
                               </select>
                              </div>
...
<option value="VADD" <?php if($subdet[0]['subject_category']=='VADD'){ echo "selected";} ?>>Value Added Subjects</option>											
									    </select>
									</div>                                    
												...
												<option value="Management" <?php if($subdet[0]['evaluation_board']=='Management'){ echo "selected";} ?>>Management</option> 												
                                                 <option value="Law" <?php if($subdet[0]['evaluation_board']=='Law'){ echo "selected";} ?>>Law</option> 
                                                  <option value="Pharmacy" <?php if($subdet[0]['evaluation_board']=='Pharmacy'){ echo "selected";} ?>>Pharmacy</option> 
                                                   <option value="Design" <?php if($subdet[0]['subject_category']=='Design'){ echo "selected";} ?>>Design</option> 
                                                   <option value="Fashion Design" <?php if($subdet[0]['subject_category']=='Fashion Design'){ echo "selected";} ?>>Fashion Design</option> 
												   <option value="Interior Design" <?php if($subdet[0]['evaluation_board']=='Interior Design'){ echo "selected";} ?>>Interior Design</option>  
                                                    <option value="CSE" <?php if($subdet[0]['evaluation_board']=='CSE'){ echo "selected";} ?>>CSE</option> 
                                                     <option value="Aerospace" <?php if($subdet[0]['subject_category']=='Aerospace'){ echo "selected";} ?>> Aerospace</option> 
                                                      <option value="Fire & Safety" <?php if($subdet[0]['evaluation_board']=='Fire & Safety'){ echo "selected";} ?>>Fire & Safety</option>  
<option value="Engineering Science" <?php if($subdet[0]['evaluation_board']=='Engineering Science'){ echo "selected";} ?>>Engineering Science</option>  
<option value="Forensic science" <?php if($subdet[0]['evaluation_board']=='Forensic science'){ echo "selected";} ?>>Forensic science</option>                                           													  
<option value="Biotechnology" <?php if($subdet[0]['evaluation_board']=='Biotechnology'){ echo "selected";} ?>>Biotechnology</option>                                           													  
                                        </select>
                                    </div>                                    
                                           ...
                                           <option value="University Core(UC)" <?php if($subdet[0]['category_subject']=='University Core(UC)'){ echo "selected";} ?>>University Core(UC)</option>
                                            <option value="Programme Core(PC)" <?php if($subdet[0]['category_subject']=='Programme Core(PC)'){ echo "selected";} ?>>Programme Core(PC)</option>
                                             <option value="Programme Elective(PE)" <?php if($subdet[0]['category_subject']=='Programme Elective(PE)'){ echo "selected";} ?>> Programme Elective(PE)</option>
											  ...
											  <option value="Value Added Course(VAC)" <?php if($subdet[0]['category_subject']=='Value Added Course(VAC)'){ echo "selected";} ?>> Value Added Course(VAC)</option>
											  <option value="Programme Honour(PH)" <?php if($subdet[0]['category_subject']=='Programme Honour(PH)'){ echo "selected";} ?>> Programme Honour(PH)</option>
								...
								//}
								if(isset($subdet[0]['syllabus_uploaded']) && $subdet[0]['syllabus_uploaded']=="Y"){
									$bucketname = 'uploads/syllabus/'
									?>
									<div class="col-sm-3">
										<a download href="">
									<a download href="<?= site_url() ?>Upload/download_pdfdocument/<?php echo $subdet[0]['syllabus_path'].'?b_name='.$bucketname;?>">
