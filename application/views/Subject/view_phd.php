...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Course Work Master</a></li>
    </ul>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                    ...
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add_phd")?>"><span class="btn-label icon fa fa-plus"></span>Add Course Work</a></div>                        
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                        ...
                        <form name="searchTT" id="forms" method="POST" action="<?=base_url()?>subject/phd_subject_list">
				...
				<div class="row">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
									...
									<th>Order</th>
                                    <th>Action</th>
                                    <?php if($this->session->userdata('role_id')==6 || $this->session->userdata('role_id')==16 ){?>
                                    <th>Syllabus</th>
                                    <?php }?>
                            </tr>
                        </thead>
                        <tbody id="itemContainer">
                            ...
                            <tr <?=$subj_details[$i]["status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                                ...
                                <td>
									...
									if($cred_date[0]=='2019' || ($this->session->userdata('role_id')==23) || ($this->session->userdata('role_id')==30) || ($this->session->userdata('role_id')==20)  || ($this->session->userdata('role_id')==6) || $this->session->userdata('role_id')==10 || $this->session->userdata('role_id')==23){
                                    ?>
					...
					<table class="table table-bordered" style="width:100%!important;">
                        <tr>
                            ...
                            <?php }else{
                                if($role_id==23 || $role_id==15 || $role_id==30 || $role_id==10 || $role_id==20){ ?>
