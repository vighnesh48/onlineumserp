...
$(document).ready(function()
{
	...
	$('#yr').on('change', function () {
		...
		{
			type='POST',url='<?= base_url() ?>Master/get_academic_stream_list',datastring={Country:Country,academic:academic,year:year,yr:yr};
	...
	$('#year').on('change', function () {
		...
		if(academic) 
		{
			...
			else
			{
				...
				$('#2017').show();
				$('#current_year').hide();
				type='POST',url='<?= base_url() ?>Master/get_academic_stream_list',datastring={Country:Country,academic:academic,year:year};
				html_content=ajaxcall(type,url,datastring);
				//alert(html_content);
				if(html_content!="")
				{
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="form-group">
					<label class="col-md-7">Country</label>
					<div class="col-md-5">
				...
				if(!empty($countryies_details)){
					foreach($countryies_details as $countryieslist){
						...
						?>
					  <option value="<?=$countryieslist['id']?>" <?php if($countryieslist['id']==$defult_id){?> selected="selected"<?php }?> ><?=$countryieslist['name']?></option>  
					<?php 
				...
				?>
				   ...
				   <div class="form-group">
					<label class="col-md-7  " id="gym">Gymkhana</label>
								 <div class="col-md-4" >
								 <input type="text" class="form-control numbersOnly" onchange="total_fees()" value="0"  name="Gymkhana" id="Gymkhana" />
						   </div>
					  </div> 
                       <div class="form-group">
					<label class="col-md-7 ">Disaster Management</label>
					<div class="col-md-4">
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="Disaster_Management" id="Disaster_Management"  />
					</div>
				  </div>
                    <div class="form-group">
					<label class="col-md-7 ">Computerization&nbsp;</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  value="0" onchange="total_fees()" name="Computerization" id="Computerization"  />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7" id="regt">Registration</label>
					<div class="col-md-4" >
					<input type="text" class="form-control numbersOnly"   onchange="total_fees()" value="0" name="Registration" id="Registration" />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7">Student Safety Insurance</label>
					<div class="col-md-4">
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="Insurance" id="Insurance" />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7">Library</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"   onchange="total_fees()" value="0" name="Library" id="Library" />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7">NSS</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="NSS" id="NSS"  />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7">Eligibility</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="eligibility" id="eligibility" />
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="internet" id="internet" />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7">Industrial visit</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="Industrial_visit" id="Industrial_visit" />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7">Seminar training</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="Seminar_training" id="Seminar_training" />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7">Student activity</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="Student_activity" id="Student_activity" />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7">Exam Fees</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="exam_fees" id="exam_fees" />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7">Lab</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="lab" id="lab" />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7">accommodation</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="0" name="accommodation" id="accommodation" />
					</div>
				  </div>
				  ...
				  <div class="form-group">
					<label class="col-md-7">Computerization&nbsp;/&nbsp;Lab</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly" required value="0" onchange="total_fees()" name="Computer" id="Computer" />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7" id="regt">Registration</label>
