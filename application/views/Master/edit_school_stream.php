...
$(document).ready(function()
{
	...
	var school='<?=$school_stream_details['school_id']?>'+'||'+'<?=$school_stream_details['school_code']?>'+'||'+'<?=$school_stream_details['school_short_name']?>';
	...
	var category='<?=$school_stream_details['course_cat']?>';
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-5 text-ctext-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit School Streams </h1>
            ...
            <div class="col-sm-12">
                <div class="panel">
				   ...
				   <div class="panel-heading">
                        <span class="panel-title">Update Details</span><span id="err_msg" style="color:red;padding-left:50px;"></span>
					</div>
					
                    <div class="panel-body">
							<div class="portlet-body form">
                          <form id="form" name="form" action="<?=base_url($currentModule.'/edit_school_stream_submit')?>" method="POST" onsubmit="return form_validate(event)">
