...
{
	type='POST',url='<?= base_url() ?>Master/fullview_feedetails',datastring={academic_fees_id:fid};
...
function common_call()
{
	...
	$('#err_msg').html('');
	type='POST',url='<?= base_url() ?>Master/get_academic_fees_details',datastring={academic:academic,admission_year:admission_year};
