...
$(document).ready(function()
{
	...
	if(year>=2019)
	{
		...
		other_fee=parseInt('<?=$academic_fee_details['Gymkhana']?>')+parseInt('<?=$academic_fee_details['registration']?>')+
		parseInt('<?=$academic_fee_details['disaster_management']==''?0:$academic_fee_details['disaster_management']?>')+
		parseInt('<?=$academic_fee_details['nss']==''?0:$academic_fee_details['nss']?>')+
		parseInt('<?=$academic_fee_details['student_safety_insurance']?>')+parseInt('<?=$academic_fee_details['library']?>')
		+parseInt('<?=$academic_fee_details['eligibility']?>')+parseInt('<?=$academic_fee_details['internet']?>')
		+parseInt('<?=$academic_fee_details['educational_industrial_visit']?>')
		+parseInt('<?=$academic_fee_details['seminar_training']?>')+parseInt('<?=$academic_fee_details['student_activity']?>')
		+parseInt('<?=$academic_fee_details['lab']?>')+
		parseInt('<?=$academic_fee_details['exam_fees']==''?0:$academic_fee_details['exam_fees']?>')
		+parseInt('<?=$academic_fee_details['accommodation']==''?0:$academic_fee_details['accommodation']?>')+parseInt('<?=$academic_fee_details['computerization']?>');
	...
	if(year<2019)
	{
		...
		other_fee=parseInt('<?=$academic_fee_details['Gymkhana']?>')+parseInt('<?=$academic_fee_details['registration']?>')
		+parseInt('<?=$academic_fee_details['student_safety_insurance']?>')+parseInt('<?=$academic_fee_details['library']?>')
		+parseInt('<?=$academic_fee_details['disaster_management']?>')+parseInt('<?=$academic_fee_details['computerization']?>')
		+parseInt('<?=$academic_fee_details['nss']?>')+parseInt('<?=$academic_fee_details['lab']?>')
		+parseInt('<?=$academic_fee_details['student_activity']?>')
		+parseInt('<?=$academic_fee_details['educational_industrial_visit']?>')
		+parseInt('<?=$academic_fee_details['internet']?>')
		+parseInt('<?=$academic_fee_details['eligibility']?>')
		+parseInt('<?=$academic_fee_details['exam_fees']==''?0:$academic_fee_details['exam_fees']?>');
		//alert(other_fee);
		$('#other_fee').val(other_fee);
		//alert('2018');
	...
	var html_content='';
	   $('#academic').on('change', function () {
		...
		if(academic=='' || adyear=='')
			...
			type='POST',url='<?= base_url() ?>Master/edit_check_academicfee_exists',datastring={Country:Country,academic:academic,fees_id:fees_id,stream_id:stream,year:adyear};
	...
	$('#year').on('change', function () {
		...
		if(academic=='' || admyear=='')
			...
			{
				//alert('inside');
				other_fee=parseInt('<?=$academic_fee_details['Gymkhana']==''?0:$academic_fee_details['Gymkhana']?>')
				+parseInt('<?=$academic_fee_details['registration']==''?0:$academic_fee_details['registration']?>')
				+parseInt('<?=$academic_fee_details['student_safety_insurance']==''?0:$academic_fee_details['student_safety_insurance']?>')
				+parseInt('<?=$academic_fee_details['library']==''?0:$academic_fee_details['library']?>')+
				parseInt('<?=$academic_fee_details['eligibility']==''?0:$academic_fee_details['eligibility']?>')+
				parseInt('<?=$academic_fee_details['internet']==''?0:$academic_fee_details['internet']?>')+
				parseInt('<?=$academic_fee_details['educational_industrial_visit']==''?0:$academic_fee_details['educational_industrial_visit']?>')+
				parseInt('<?=$academic_fee_details['seminar_training']==''?0:$academic_fee_details['seminar_training']?>')+
				parseInt('<?=$academic_fee_details['student_activity']==''?0:$academic_fee_details['student_activity']?>')+
				parseInt('<?=$academic_fee_details['lab']==''?0:$academic_fee_details['lab']?>')+
				parseInt('<?=$academic_fee_details['exam_fees']==''?0:$academic_fee_details['exam_fees']?>');
		//+parseInt('<?=$academic_fee_details['caution_money']?>')+parseInt('<?=$academic_fee_details['admission_form']?>')
		$('#other_fee').val(other_fee);
		alert('inside111');
		...
		$('#other_fee').val(other_fee);
			...
			type='POST',url='<?= base_url() ?>Master/edit_check_academicfee_exists',datastring={Country:Country,academic:academic,fees_id:fees_id,stream_id:stream,year:admyear};
			html_content=ajaxcall(type,url,datastring);
			if(html_content>0)
			{
...
function total_fees()
{
	...
	if($('#Disaster_Management').val()=='')$('#Disaster_Management').val(0);
	...
	if($('#Industrial_visit').val()=='')$('#Industrial_visit').val(0);
	if($('#Seminar_training').val()=='')$('#Seminar_training').val(0);
	if($('#Student_activity').val()=='')$('#Student_activity').val(0);
	if($('#exam_fees').val()=='')$('#exam_fees').val(0);
	if($('#lab').val()=='')$('#lab').val(0);
	if($('#accommodation').val()=='')$('#accommodation').val(0);
	...
	{		
		...
		//alert(2);
			...
			other_fee=parseInt($('#Gymkhana').val())+parseInt($('#Registration').val())+parseInt($('#Insurance').val())+
			parseInt($('#Library').val())+parseInt($('#eligibility').val())+parseInt($('#internet').val())+
			parseInt($('#visit').val())+parseInt($('#training').val())+parseInt($('#activity').val())+
			parseInt($('#lab').val())+parseInt($('#exam_fees').val());
		...
		//alert(1);
		//exam_fees
			other_fee=parseInt($('#khana').val())+parseInt($('#mngmt').val())+parseInt($('#Computer').val())+
			parseInt($('#Regis').val())+parseInt($('#Insur').val())+parseInt($('#Libr').val())+parseInt($('#NSS').val())+
			parseInt($('#exm_fees').val());
			$('#other_fee').val(other_fee);
		}*/
		
		other_fee=parseInt($('#Gymkhana').val())+parseInt($('#Disaster_Management').val())+parseInt($('#Computerization').val())+parseInt($('#Registration').val())+parseInt($('#Insurance').val())+parseInt($('#Library').val())+parseInt($('#NSS').val())+parseInt($('#eligibility').val())+parseInt($('#internet').val())+parseInt($('#Industrial_visit').val())+parseInt($('#Seminar_training').val())+parseInt($('#Student_activity').val())+parseInt($('#exam_fees').val())+parseInt($('#lab').val())+parseInt($('#accommodation').val());
			//+parseInt($('#caution_money').val())+parseInt($('#admission_form').val())
			/*alert(''+parseInt($('#Gymkhana').val())+''+parseInt($('#Disaster_Management').val())+''+parseInt($('#Computerization').val())+
			parseInt($('#Registration').val())+''+parseInt($('#Insurance').val())+''+parseInt($('#Library').val())+
			parseInt($('#NSS').val())+''+parseInt($('#eligibility').val())+''+parseInt($('#internet').val())+
			parseInt($('#Industrial_visit').val())+''+parseInt($('#Seminar_training').val())+''+parseInt($('#Student_activity').val())+''+parseInt($('#exam_fees').val())+''+parseInt($('#lab').val())+parseInt($('#exam_fees').val())+parseInt($('#accommodation').val()));*/
        ...
        <div class="row ">
            <div class="col-sm-12">
                   ...
                   <div class="panel-heading">
                    ...
                    <div class="panel-body">
                          ...
                          <form id="form" name="form" action="<?=base_url($currentModule.'/edit_academic_fees_submit')?>" method="POST" onsubmit="return form_validate(event)">
							...
							<div class="form-group">
					<label class="col-md-6 text-right">Country</label>
					<div class="col-md-5">
					  <select class="form-control" name="Country" id="Country" required>
						  <option value="">select Country</option>
						<?php //$defult_id=101;
				if(!empty($countryies_details)){
					foreach($countryies_details as $countryieslist){
						
						
						?>
					  <option value="<?=$countryieslist['id']?>" <?php if($countryieslist['id']==$academic_fee_details['country']){?> selected="selected"<?php }?> ><?=$countryieslist['name']?></option>  
					<?php 
				...
				?>
				   ...
				   <div class="form-group">
					<label class="col-md-7 text-right " id="gym">Gymkhana</label>
								 <div class="col-md-4" >
								 <input type="text" class="form-control numbersOnly" onchange="total_fees()" value="<?php if(empty($academic_fee_details['Gymkhana'])){echo '0';}else{echo $academic_fee_details['Gymkhana'];}?>"  name="Gymkhana" id="Gymkhana" />
						   </div>
					  </div> 
                       <div class="form-group">
					<label class="col-md-7 text-right">Disaster Management</label>
					<div class="col-md-4">
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['disaster_management'])){echo '0';}else{ echo $academic_fee_details['disaster_management']; }?>" name="Disaster_Management" id="Disaster_Management"  />
					</div>
				  </div>
                    <div class="form-group">
					<label class="col-md-7 text-right">Computerization&nbsp;</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  value="<?php if(empty($academic_fee_details['computerization'])){echo '0';}else{ echo $academic_fee_details['computerization']; }?>" onchange="total_fees()" name="Computerization" id="Computerization"  />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7 text-right" id="regt">Registration</label>
					<div class="col-md-4" >
					<input type="text" class="form-control numbersOnly"   onchange="total_fees()" value="<?php if(empty($academic_fee_details['registration'])){echo '0';}else{ echo $academic_fee_details['registration']; }?>" name="Registration" id="Registration" />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7 text-right">Student Safety Insurance</label>
					<div class="col-md-4">
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['student_safety_insurance'])){echo '0';}else{ echo $academic_fee_details['student_safety_insurance']; }?>" name="Insurance" id="Insurance" />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7 text-right">Library</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"   onchange="total_fees()" value="<?php if(empty($academic_fee_details['library'])){echo '0';}else{ echo $academic_fee_details['library']; }?>" name="Library" id="Library" />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7 text-right">NSS</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['nss'])){echo '0';}else{ echo $academic_fee_details['nss']; }?>" name="NSS" id="NSS"  />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7 text-right">Eligibility</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['eligibility'])){echo '0';}else{ echo $academic_fee_details['eligibility']; }?>" name="eligibility" id="eligibility" />
					</div>
				  </div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['internet'])){echo '0';}else{ echo $academic_fee_details['internet'];}?>" name="internet" id="internet" />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7 text-right">Industrial visit</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['educational_industrial_visit'])){echo '0';}else{ echo $academic_fee_details['educational_industrial_visit'];}?>" name="Industrial_visit" id="Industrial_visit" />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7 text-right">Seminar training</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['seminar_training'])){echo '0';}else{ echo $academic_fee_details['seminar_training']; }?>" name="Seminar_training" id="Seminar_training" />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7 text-right">Student activity</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['student_activity'])){echo '0';}else{ echo $academic_fee_details['student_activity'];}?>" name="Student_activity" id="Student_activity" />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7 text-right">Exam Fees</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['exam_fees'])){echo '0';}else{ echo $academic_fee_details['exam_fees'];}?>" name="exam_fees" id="exam_fees" />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7 text-right">Lab</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['lab'])){echo '0';}else{echo $academic_fee_details['lab']; }?>" name="lab" id="lab" />
					</div>
				  </div>
                  <div class="form-group">
					<label class="col-md-7 text-right">accommodation</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  onchange="total_fees()" value="<?php if(empty($academic_fee_details['accommodation'])){echo '0';}else{ echo $academic_fee_details['accommodation'];}?>" name="accommodation" id="accommodation" />
					</div>
				  </div>
				...
				<!--<div id="2017" style="display:none;">
				  ...
				  <div class="form-group">
					<label class="col-md-7 text-right">Computerization&nbsp;/&nbsp;Lab</label>
					<div class="col-md-4" >
					  <input type="text" class="form-control numbersOnly"  value="<?=$academic_fee_details['computerization']?>" onchange="total_fees()" name="Computer" id="Computer"  />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-7 text-right" id="regt">Registration</label>
