            ...
            <div class="col-sm-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="form" name="form" action="<?=base_url($currentModule.'/add_stream_submit_test')?>" method="POST">   
								...
								<div class="form-group">
                                   ...
                                   <span style="color:red;"><?php echo form_error('duration');?></span>
									...
									<div class="col-sm-3">
									<select id="partnership" name="partnership" onchange="is_partnership()"  class="form-control">
