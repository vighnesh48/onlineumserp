				...
				pname_short:
                {
                    validators: 
                    {
                      ...
                      stringLength: 
                        ...
                        max: 10,
                        min: 2,
                        message: 'Parternship name should be 2-10 characters.'
                        }
                    }
                },
				cperson:
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-5 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Update Parternship </h1>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/edit_partnership_submit')?>" method="POST" onsubmit="return validate_faci_category(event)"  enctype="multipart/form-data">   
								<input type="hidden" value="<?=$partnership_details['partner_id']?>" id="pid" name="pid"/>
								<div class="form-group">
								
									<div class="col-sm-2">
									<label >Parternship Code:<?=$astrik?></label>
									<input type="text" id="pcode" onchange="check_partnership_exists()" value="<?=$partnership_details['partnership_code']?>" name="pcode" class="form-control alphanum" placeholder="Parternship Code"  />                                    
                                    <span style="color:red;"><?php echo form_error('pcode');?></span>
									</div>
									
									<div class="col-sm-4">
									<label >Parternship Name:<?=$astrik?></label>
									<input type="text" id="pname"  value="<?=$partnership_details['partner_name']?>" name="pname" onchange="check_partnership_exists()" class="form-control alphaonly"  placeholder="Parternship Name" />                                    
                                   <span style="color:red;"><?php echo form_error('pname');?></span>
								   </div>
								   <div class="col-sm-3">
									<label >Parternship Short Name:<?=$astrik?></label>
									<input type="text" id="pname_short" name="pname_short" onchange="check_partnership_exists()" class="form-control alphanum" value="<?=$partnership_details['partner_short_name']?>" placeholder="Short Name "  />                                    
                                    <span style="color:red;"><?php echo form_error('pname_short');?></span>
									</div>
									<div class="col-sm-3">
									<label >Contact Person:<?=$astrik?></label>
									<input type="text" id="cperson" name="cperson" value="<?=$partnership_details['contact_person']?>"  placeholder="Contact Person" class="form-control alphaonly"  /><span style="color:red;"><?php echo form_error('cperson');?></span>
									</div>
								...
								<div class="form-group">
									...
									<input type="text" id="pemail" name="pemail" value="<?=$partnership_details['contact_person_email']?>"  placeholder="Personal Email" class="form-control"  /><span style="color:red;"><?php echo form_error('pemail');?></span>
									</div>
									
									<div class="col-sm-4">
									<label >Office Email:<?=$astrik?></label>
									<input type="text" id="oemail" name="oemail" value="<?=$partnership_details['office_email']?>"  placeholder="Office Email" class="form-control"  /><span style="color:red;"><?php echo form_error('oemail');?></span>
									</div>
									
									 <div class="col-sm-4">
									<label>Mobile:<?=$astrik?></label>
									<input type="text" id="mobile" name="mobile"  value="<?=$partnership_details['mobile']?>" placeholder="Mobile" class="form-control"  />                                  
								...
								<div class="form-group">
									...
									<textarea class="form-control" id="address" name="address" ><?=$partnership_details['address']?></textarea>                                    
                                   <span style="color:red;"><?php echo form_error('address');?></span>
								   </div>
									 
									<div class="col-sm-4">
									<label >Pincode:<?=$astrik?></label>
									<input type="text" id="pincode" name="pincode" placeholder="Pincode"  value="<?=$partnership_details['pincode']?>" class="form-control"  /><span style="color:red;"><?php echo form_error('pincode');?></span>
									</div>
									
									<div class="col-sm-4">
									<label >Country:<?=$astrik?></label>
									<input type="text" id="country" name="country"  value="<?=$partnership_details['country']?>"  placeholder="Country" class="form-control"  /><span style="color:red;"><?php echo form_error('country');?></span>
									</div>
							...
							<div class="form-group">
									...
									<input type="text" id="fparty" name="fparty"  value="<?=$partnership_details['first_party_person']?>" class="form-control " placeholder="University Person Name"  />                                    
                                    <span style="color:red;"><?php echo form_error('fparty');?></span>
									</div>
									
									<div class="col-sm-4">
									<label >Mou Sign From University Partnership:<?=$astrik?></label>
									<input type="text" id="sparty" name="sparty" value="<?=$partnership_details['third_party_person']?>"  class="form-control " placeholder="University Partnership Name" />                                    
                                   <span style="color:red;"><?php echo form_error('sparty');?></span>
								   </div>
								   
								   <div class="col-sm-4">
									<label >Mou Placed:<?=$astrik?></label>
									<input type="text" id="place" name="place" value="<?=$partnership_details['mou_done_place']?>"  class="form-control " placeholder="Mou Placed" />                                    
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" value="<?=$partnership_details['mou_sign_date']?>"  id="doc-sub-datepicker21" placeholder="Signed Date" name="fdate" required readonly="true"/>
									<span style="color:red;"><?php echo form_error('fdate');?></span>
									</div>
									
									<div class="col-sm-4">
									<label >Mou Start Date:<?=$astrik?></label>
									<input type="text" class="form-control"  value="<?=$partnership_details['mou_start_date']?>" id="doc-sub-datepicker22" placeholder="Start Date" name="sdate" required readonly="true"/>
									<span style="color:red;"><?php echo form_error('sdate');?></span>
									</div>
									
									<div class="col-sm-4">
									<label >Mou Expiry Date:<?=$astrik?></label>
									<input type="text" class="form-control"  value="<?=$partnership_details['mou_expiray_date']?>" id="doc-sub-datepicker23" placeholder="Expiry Date" name="edate" required readonly="true"/>
...
$(document).ready(function(){
   ...
   .on('changeDate', function (e) {
	...
	var hstate_id='<?=$partnership_details['state_id']?>';
	var district_id='<?=$partnership_details['district_id']?>';
	//alert(district_id);
	var taluka_id='<?=$partnership_details['taluka_id']?>';
	...
	var str='<?=$partnership_details['mou_sharing_ratio']?>';
	var arr=str.split(":");
	var r1=arr[0];
	$('#r1 option').each(function()
	 {              
		 if($(this).val()== r1)
		{
		$(this).attr('selected','selected');
	...
	var factor='<?=$partnership_details['mou_share_factor']?>';
	$('#factor option').each(function()
	 {              
		 if($(this).val()== factor)
		{
		$(this).attr('selected','selected');
