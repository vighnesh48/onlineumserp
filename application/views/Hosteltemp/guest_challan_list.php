...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp; Hostel Guest challan List</h1>
			<span id="err_msg1" style="color:red;"></span>
			<div class="col-xs-12 col-sm-8">
                <div class="row"> 
					   <hr class="visible-xs no-grid-gutter-h">
                  <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add_guest_challan")?>"><span class="btn-label icon fa fa-plus"></span>Generate </a></div>
                       ...
                       <table class="table table-bordered" style="width:100%;max-width:100%;">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr>
								...
								<td><?=$challan_details[$i]['guest_name']?></td>
								...
								-->
								<a title="View challan Details" class="btn btn-primary btn-xs" href="<?=base_url($currentModule."/edit_guest_challan/".$challan_details[$i]['fees_id'])?>">View</a>
								   
								<a  href="<?=base_url($currentModule."/download_guest_challan_pdf/".$challan_details[$i]['fees_id'])?>" title="View" target="_blank" <?=$disable?>><i class="fa fa-file-pdf-o" aria-hidden="true"  style="font-size:20px;color:red;"></i> </a>
								</td>
