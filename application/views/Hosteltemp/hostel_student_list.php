	 ...
	 $(document).ready(function(){
         ...
         // alert("hi");
             var base_url = '<?=base_url();?>';
                ...
                $.ajax({
                    'url' : base_url + '/Hosteltemp/search_students_data',
  ...
  else
  {
		      ...
		      <option value="SU">Sandip University</option>
			   ...
			   <ul class="nav nav-tabs">
						...
						<li><a data-toggle="tab" href="#allocated">Allocated List</a></li>
						<li class="active"><a data-toggle="tab" href="#cancelled">Cancelled List</a></li>
					  ...
					  <div class="tab-content">
						...
						<form name="form" id="form" method="post" action="<?=base_url()?>Hosteltemp/export_allocated">	
				...
				<form name="form1" id="form1" method="post" action="<?=base_url()?>Hosteltemp/export_cancelled">	
