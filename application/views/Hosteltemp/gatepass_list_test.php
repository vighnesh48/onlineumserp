...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp; Gate Pass List</h1>
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">  
					<div class="row">
						<div class="col-sm-4">
						<span class="panel-title">List for the date of </span><span id="header_date"></span>
						</div>
										...
										<div class="panel-body">
											...
											<input type="hidden" id="hgp_id" name="hgp_id" />
												...
												<div class="col-sm-12">
													...
													<tr>
													  <th scope="col">Type of Gatepass :</th>
                       ...
                       <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr>
								...
								{
									echo '<a title="Gatepass Approved" class="btn btn-success btn-xs"> A </a>';
								}
								else if($hostel_details[$i]['approval_status']=="P")
								{
									...
									echo "<a title=\"Gatepass Pending\" onclick=".$temp." class=\"btn btn-primary btn-xs\"> P </a>";
								}
								else
								{
									echo '<a title="Gatepass Rejected" class="btn btn-danger btn-xs"> R </a>';
								}
								...
								{
									?>
									<a href="<?=base_url($currentModule."/download_gatepass_pdf/".$hostel_details[$i]['hgp_id']."/".$hostel_details[$i]['stud_prn']."/".$hostel_details[$i]['stud_org'])?>" title="View" target="_blank" <?=$disable?>><i class="fa fa-file-pdf-o" aria-hidden="true"  style="font-size:20px;color:red;"></i> </a>
								<?php }
...
function gatepass_process(prn,org,id)
{
	...
	$.ajax({
				...
				data: {hgp_id:id,enroll:prn,org:org},
				success: function (html) {
					//alert(html);
					var array=JSON.parse(html);
					$('#acadmic').html(array.std_gatepass_details.academic_year);
					$('#prn').html(prn);
					...
					$('#fdate').html(array.std_gatepass_details.from_date);
					$('#tdate').html(array.std_gatepass_details.to_date);
