...
<div class="m" style="padding:20px;">
	...
	<p><h3 align="center"><u><?=$org.' Hostel'.$header.' Student Details for the academic year -'.$student_details[0]['academic_year']?></u></h3></p>
    </td> 
   </tr>
</table><br/>
...
for($i=0;$i<count($student_details);$i++){		 
	...
	//$remaining=($applicable+$student_details[$i]['opening_balance']+$student_details[$i]['gym_fees']+$student_details[$i]['fine_fees']+$student_details[$i]['refund_paid'])-($student_details[$i]['paid_amt']+$student_details[$i]['cancellation_charges']);
	...
	<td><?=$applicable?></td>
	<td><?=$student_details[$i]['opening_balance']?></td>
...
?>
	...
	<div>
	   <br><br><br>
	   <strong>Hostel Coordinator Sign</strong>
	    </div>
</div>    
</body>
</html>