                        ...
                        <div class="col-sm-7">                            
							...
							<input type="hidden" id="hostel_id" name="hostel_id" class="form-control" value="<?=$h_room_details['host_id']?>"/>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-8"><input type="text" id="tot_flr" name="tot_flr" class="form-control" value="<?=$h_room_details['floor_no']?>" readonly/>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-8"><input type="text" id="tot_rooms" name="tot_rooms" class="form-control" value="<?=$h_room_details['room_no']?>" onchange="check_r(this.id)" readonly/>
