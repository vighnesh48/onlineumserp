...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Student Facility Allocation</h1>
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                        <span class="panel-title">Student Facility Allocation</span>
                        <div class="holder"></div>
                </div>
                    <div class="panel-body">
                        <div class="table-info">                            
                            
                            <form id="form" name="form" action="<?=base_url($currentModule.'/stdnt_faci_submit')?>" method="POST">     
							...
							<input type="hidden" id="noofbeds" name="noofbeds" />
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                      <input type="text" class="form-control" id="doc-sub-datepicker21" name="validfrom" required value="<?= isset($fee[0]['dd_drawn_date']) ? $fee[0]['dd_drawn_date'] : '' ?>" placeholder="Valid from Date" required />
                                    </div>                                    
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                      <input type="text" class="form-control" id="doc-sub-datepicker42" name="validto" required value="<?= isset($fee[0]['dd_drawn_date']) ? $fee[0]['dd_drawn_date'] : '' ?>" placeholder="Valid to Date" required readonly="true"/>
                                    </div>                                    
                                    <div class="col-sm-3"><span style="color:red;"><?php echo form_error('deposit');?></span></div>
                                </div>
...
<script>
var campus='',htype='',hostels='',floors='',room='',host_id='',hostel_code='',std_id='1',enroll='sdhgwqwqe';
$(document).ready(function(){
	    // Num check logic
