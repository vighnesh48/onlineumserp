...
<div id="content-wrapper">
    ...
    <div class="page-header">
    	<div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Markseets Generation</h1>
            ...
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                        <span class="panel-title">
                            <form method="post" action ="<?=base_url()?>Results/marksheets">	
			...
			//if(isset($role_id) && $role_id==1 ){?>
				...
				<form name="mrkcrdfrom" id="mrkcrdfrom" method="post" action="<?=base_url()?>Results/generate_marksheets">
 					<table class="table table-bordered1" id="table2excel1">
                        ...
                        <tbody id="studtbl">
                        	<input type="text" name="regu_lation" id="regu_lation" value="<?=$regulation?>" style="display:none;">
                            ...
                            for($i=0;$i<count($stud_list);$i++)
                            {
								...
								$ce_applied = $this->Results_model->fetch_student_applied_ce_semester($stud_list[$i]['stud_id'],$stud_list[$i]['semester'],$stream);
								
								echo $stud_list[$i]['enrollment_no'].'->';    print_r($ce_earnd->credit_earned); 
							...
							<td class="noExl"><input type="checkbox" name="chk_stud[]" id="chk_stud" class='studCheckBox' value="<?=$stud_list[$i]['stud_id']?>"></td>
                              <td><?=$j?></td>
								...
								<td></td> 
								<td></td> 	
								<td><a href="<?=base_url()?>Examination/search_arrears/<?=$stud_list[$i]['enrollment_no']?>" target="_blank">View</a></td> 									
                            </tr>
                            <?php
                            $j++;
                            }
