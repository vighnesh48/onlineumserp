...
//print_r($uniq_sems);exit;
  ...
  $res_uniq_subjects = $this->Results_model->fetch_student_subject_completion($stud[0]['stud_id'],$semester_post);
...
<table cellpadding="0" cellspacing="0" border="0" valign="top" width="800">
    <tr>
		...
		?>
			<td  align="center" width="100" style="text-align:center;margin-left:15px;"><img src="<?php  echo $imageData; ?>" class="pull-right" style="margin:2px;float:right;"></td>
   ...
   <tr>
    ...
    <?php
	  ...
	  $bucket_key = 'uploads/student_photo/' . $photo;
        $imageData = $this->awssdk->getsignedurl($bucket_key);
    ?>
	<td rowspan="4" style="padding:0;"><center><img src="<?=$imageData?>" width="100" height="100"/></center></td>
    </tr>
...
<table width="100%" border="" cellspacing="0" cellpadding="0" class="head-table" style="border:2px solid #000">
  ...
  <tr>
    <td><strong>Grade Points Average(GPA)<?php // echo $stud[0]["grades"][8]['alocated_credites'] .'-'. $stud[0]["grades"][8]['earn_total_credits_for_sem'].'-'. $stud[0]["grades"][8]['sgpa']; // print_r($arr_sems);?></strong></td>
	<td align="center"><?php if(in_array('1', $arr_sems)){echo "-";}else{ echo ($stud[0]["grades"][1]['alocated_credites'] == $stud[0]["grades"][1]['earn_total_credits_for_sem'])?$stud[0]["grades"][1]['sgpa']:'';}?></td>
    <td align="center"><?php if(in_array('2', $arr_sems)){echo "-";}else{ echo ($stud[0]["grades"][2]['alocated_credites'] == $stud[0]["grades"][2]['earn_total_credits_for_sem'])?$stud[0]["grades"][2]['sgpa']:'';}?></td>
    <td align="center"><?php if(in_array('3', $arr_sems)){echo "-";}else{ echo($stud[0]["grades"][3]['alocated_credites'] == $stud[0]["grades"][3]['earn_total_credits_for_sem'])?$stud[0]["grades"][3]['sgpa']:'';}?></td>
    <td align="center"><?php if(in_array('4', $arr_sems)){echo "-";}else{ echo($stud[0]["grades"][4]['alocated_credites'] == $stud[0]["grades"][4]['earn_total_credits_for_sem'])?$stud[0]["grades"][4]['sgpa']:'';}?></td>
    <td align="center"><?php if(in_array('5', $arr_sems)){echo "-";}else{ echo($stud[0]["grades"][5]['alocated_credites'] == $stud[0]["grades"][5]['earn_total_credits_for_sem'])?$stud[0]["grades"][5]['sgpa']:'';}?></td>
    <td align="center"><?php if(in_array('6', $arr_sems)){echo "-";}else{ echo($stud[0]["grades"][6]['alocated_credites'] == $stud[0]["grades"][6]['earn_total_credits_for_sem'])?$stud[0]["grades"][6]['sgpa']:'';}?></td>
    <td align="center"><?php if(in_array('7', $arr_sems)){echo "-";}else{ echo($stud[0]["grades"][7]['alocated_credites'] == $stud[0]["grades"][7]['earn_total_credits_for_sem'])?$stud[0]["grades"][7]['sgpa']:'';}?></td>
    <td align="center"><?php if(in_array('8', $arr_sems)){echo "-";}else{ echo($stud[0]["grades"][8]['alocated_credites'] == $stud[0]["grades"][8]['earn_total_credits_for_sem'])?$stud[0]["grades"][8]['sgpa']:'';}?></td>
	<td align="center"><?php if(in_array('9', $arr_sems)){echo "-";}else{ echo($stud[0]["grades"][9]['alocated_credites'] == $stud[0]["grades"][9]['earn_total_credits_for_sem'])?$stud[0]["grades"][9]['sgpa']:'';}?></td>
	<td align="center"><?php if(in_array('10', $arr_sems)){echo "-";}else{ echo ($stud[0]["grades"][10]['alocated_credites'] == $stud[0]["grades"][10]['earn_total_credits_for_sem'])?$stud[0]["grades"][10]['sgpa']:'';}?></td>
  </tr>
  <tr>
 ...
 /*print_r($arr_sems); echo "<br>";
 print_r($bklg_grade);echo "<br>";
 print_r($resultsgrade);
 exit;*/
	if((empty($arr_sems) && empty($uniq_sems))){  //||(empty($res_bklogsems)
	
	
	
	if((in_array('U',$res_grade))||(in_array('F',$res_grade))||(in_array('U',$bklg_grade))||(in_array('F',$bklg_grade))||(in_array('U',$resultsgrade))||(in_array('F',$resultsgrade)) || !empty($res_uniq_subjects)){
       ...
       unset($uniq_sems);
	    unset($arr_sems);
	   unset($stud[0]["grades"]);
	   unset($resultsgradenew);
	   unset($backlog_grades);
	   unset($arr_bklog_sems);
	   unset($studcredits);
	 //  echo '<br>';
	 //  echo 'k';
	//   print_r($res_grade); 
