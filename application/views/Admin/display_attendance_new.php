...
function validateForm1() {
	var url="<?=base_url().strtolower($currentModule).'/view_visiting_attendance/'?>";
	var url1="<?=base_url().strtolower($currentModule).'/view_visiting_attendance_excel/'?>";
	var type=$('#type1').val();
   if(type=='pdf')
   {	  
                      ...
                      <div class="form-group">
                        ...
                        <div class="portlet-body form">
                          <form id="form" name="form" action="" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                            <div class="form-body">
							<?php if($role_id ==1 || $role_id ==6 || $name =='110002' || $name =='su_hr'){ ?>
                              <div class="row"> 
                                <div class="form-group">
...
<?php 
if($role_id==1 || $role_id ==6 || $name =='su_hr'){?>
<div class="col-sm-6">
<div class="table-info">
              <div id="dashboard-recent" class="panel-warning">
                <div class="panel">
                  ...
                  <div class="panel-body"> 
                    ...
                    <div class="panel-padding no-padding-vr">
                      <div class="form-group">
                        ...
                        <div class="portlet-body form">
                          <form id="form1" name="form1" action="" method="POST" enctype="multipart/form-data" onsubmit="return validateForm1()">
                            <div class="form-body">
                             <!-- <div class="row"> 
                                <div class="form-group">
...
<input type="checkbox" name="empsidv[]" id="'.$vemp_list[$key]['emp_id'].'" onclick="onclick_checkbox_empv('.$vemp_list[$key]['emp_id'].');" value="'.$vemp_list[$key]['emp_id'].'" /> '.$vemp_list[$key]['emp_id'].' - '.$vemp_list[$key]['fname'].' '.$vemp_list[$key]['lname'].' </li>';
                             ...
                             <div class="row">
                                <div class="form-group">
                                  ...
                                  <div class="col-md-8" >
                                    <select class="form-control select2me" id='type1'>                                     
                                      <option value="pdf">PDF</option>
									  <option value="excel">Excel</option>
                                    </select>
                                  </div>
