            ...
            <div class="col-sm-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
					  ...
					  <td><label >Employee Id</label></td><td style="color:Blue;"><?php echo $temp[0]['emp_id'];?></td>
					  </tr>
					 <tr class=""><td><label>Reference Id</label></td><td style="color:Blue;"><?php echo $temp[0]['referenceID']; ?></td>
					  <td><label>Date Of Birth</label></td><td style="color:Blue;"><?php echo $temp[0]['date_of_birth'];?></td>
					  </tr>
					  ...
					  <tr class=""><td><label>Joining Date</label></td><td style="color:Blue;"><?php echo $temp[0]['joiningDate']; ?></td>
					  <td>Employee School</td><td style="color:Blue;"><?php echo $temp[0]['college_name'];?></td>
					  </tr>
					  <tr class=""><td><label>Designation</label></td><td style="color:Blue;"><?php echo $temp[0]['designation_name']; ?></td>
					  ...
					  <tr class=""><td><label>Qualifiaction</label></td><td style="color:Blue;"><?php echo $temp[0]['qualifiaction']; ?></td>
					  <td><label>Physical Status(Handicapped)</label></td><td style="color:Blue;"><?php if($temp[0]['phy_status']==1)echo "Yes"; else echo "No";?></td>
					  </tr>
					  <tr class=""><td><label>PF Status(Having PF)</label></td><td style="color:Blue;"><?php if($temp[0]['pf_status']==1)echo "Yes"; else echo "No";?></td>
					  <td><label>Weekly Off</label></td><td style="color:Blue;"><?php echo $temp[0]['week_off'];?></td>
					  </tr>
					  <tr class=""><td><label>Alloted shift</label></td><td style="color:Blue;"><?php  echo $temp[0]['shift_name'];?></td>
					  <td><label>Daily work Duration</label></td><td style="color:Blue;"><?php echo $temp[0]['intime']." -- ".$temp[0]['outtime'];?></td>
					  </tr>
					  <tr class=""><td><label>LandLine No.</label></td><td style="color:Blue;"><?php echo $temp[0]['landline_std']."-".$temp[0]['landline_no']; ?></td>
					  <td><label>Mobile Number</label></td><td style="color:Blue;"><?php echo $temp[0]['mobileNumber'];?></td>
					  </tr>
					  <tr class=""><td><label>Personal Email ID</label></td><td style="color:Blue;"><?php echo $temp[0]['pemail']; ?></td>
					  <td><label>Official Email ID</label></td><td style="color:Blue;"><?php echo $temp[0]['oemail'];?></td>
					  </tr>
					   <tr ><td><label>Academic/Technical Experience</label></td><td style="color:Blue;"><?php echo $temp[0]['aexp_yr'].".".$temp[0]['aexp_mnth']."Yr"; ?></td>
					  ...
					  <tr ><td><label>Scale Type</label></td><td style="color:Blue;"><?php echo $temp[0]['scaletype']; ?></td>
					  <td><label>Basic Salary</label></td><td style="color:Blue;"><?php echo $temp[0]['basic_sal']; ?></td>
					  </tr>
					  <tr ><td><label>Special Allowance</label></td><td style="color:Blue;"><?php echo $temp[0]['allowance']; ?></td>
					  <td><label>Pay Band</label></td><td style="color:Blue;"><?php if(!empty($temp[0]['pay_band_min'])&&!empty($temp[0]['pay_band_max'])&&!empty($temp[0]['pay_band_gt']))echo "Min=".$temp[0]['pay_band_min'].", Max=".$temp[0]['pay_band_max'].", GT=".$temp[0]['pay_band_gt'];else echo "NA"; ?></td>
					  </tr>
					  <tr ><td><label>Other</label></td><td style="color:Blue;"><?php echo $temp[0]['other_pay']; ?></td></tr>
...
<div class="form-group">
<label  class="col-sm-3">Dist/City:</label><div class="col-sm-3" style="color:Blue;"><?php echo $temp[0]['ldist'];?></div>
</div>
<div class="form-group">
<label  class="col-sm-3">Pin Code:</label><div class="col-sm-3" style="color:Blue;"><?php echo $temp[0]['lpincode'];?></div>
</div>
<div class="form-group">
<label  class="col-sm-3">State:</label><div class="col-sm-3" style="color:Blue;"><?php echo $temp[0]['lstate'];?></div> 
</div>
<div class="form-group">
...
<div class="form-group">
<label  class="col-sm-3">Dist/City:</label><div class="col-sm-3" style="color:Blue;"><?php echo $temp[0]['pdist'];?></div>
</div>
<div class="form-group">
<label  class="col-sm-3">Pin Code:</label><div class="col-sm-3" style="color:Blue;"><?php echo $temp[0]['p_pincode'];?></div>
</div>
<div class="form-group">
<label  class="col-sm-3">State:</label><div class="col-sm-3" style="color:Blue;"><?php echo $temp[0]['pstate'];?></div> 
</div>
<div class="form-group">
