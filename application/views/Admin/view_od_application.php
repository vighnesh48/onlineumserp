                    ...
                    <div class="panel-body">
                        <div class="table-info">
                             ...
                             <div id="dashboard-recent" class="panel-warning">   
                               <div class="panel">
                            	<div class="panel-heading"><strong>OD Application </strong></div>
                                <div class="panel-body">
                                <div class="panel-padding no-padding-vr">
								<form id="form" name="form" action="<?=base_url($currentModule.'/update_od_application')?>" method="POST">
								<?php  //print_r($details);?>
								<div class="form-body">
                                <div class="form-group">
								<label class="col-md-3">Applicant Name</label>
								<input type="hidden" name="oid" value="<?php echo isset($details[0]['oid'])?$details[0]['oid']:'';?>">
								...
								<div class="col-md-3">
                                       <input class="form-control" readonly name="ename" value="<?php echo isset($details[0]['ename'])?$details[0]['ename']:'';?>" type="text">
											 ...
											 <div class="form-group">
								<label class="col-md-3">OD Type</label>
								<div class="col-md-3">
								<input type="text" class="form-control" readonly name="od_type" value="<?php echo $details[0]['od_type'];?>">
																				
                                            </div>
								
											</div>
											 <div class="form-group">
								<label class="col-md-3">OD from Date</label>
                                             <div class="col-md-3" >
								  ...
								  <div class="form-group">
								<label class="col-md-3">OD To Date</label>
                                             <div class="col-md-3" >
                                  ...
                                  <!--<input id="dob-datepicker" class="form-control date-picker" name="applied_for_date" value="<?=isset($details[0]['applied_for_date'])?$details[0]['applied_for_date']:'';?>"  readonly placeholder="Enter Date" type="text">-->
								   ...
								   <div class="form-group">
								<label class="col-md-3">Reason For OD</label>
                                             <div class="col-md-3" >
                                  <textarea name="reason_od" readonly class="form-control"><?=isset($details[0]['reason_od'])?$details[0]['reason_od']:'';?></textarea>

                                             </div>
                                  </div>
				              <div class="form-group">
							 <label class="col-md-3">OD Applied On</label>
                                            <div class="col-md-3">
							<input type="text" class="form-control" readonly name="od_applied_on_date" value="<?php echo isset($details[0]['od_applied_on_date'])?$details[0]['od_applied_on_date']:'';?>" >				
                                             <!-- <input id="datepicker2" class="form-control date-picker" name="applied_on_date" readonly  value="<?=isset($details[0]['od_applied_on_date'])?$details[0]['od_applied_on_date']:'';?>" placeholder="Enter Date" type="text">-->
                                            </div>
                                  </div>
                                  <div class="form-group">
