...
<div id="content-wrapper">
  <ul class="breadcrumb breadcrumb-page">
    ...
    <li class="active">
      <a href="#">Earlygo-Latemark Report
      </a>
    </li>
  </ul>
                    ...
                    <div class="panel-padding no-padding-vr">
                      <div class="form-group">
                        ...
                        <div class="portlet-body form">
                          <form id="form" name="form" action="<?=base_url($currentModule.'/earlygo_latemark_show')?>" method="POST" enctype="multipart/form-data">
                            <div class="form-body">
                              <div class="row">
                                <div class="form-group">
