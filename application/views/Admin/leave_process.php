						...
						<!--<a class="btn btn-primary form-control"id="btnNext" href="">Add Employee <i class="fa fa-plus"></i></a>-->	
                            ...
                            <div class="form-group">
							  ...
							  <!-- class='dataTable' for sorting arrows icon for col-->
                                     <thead>
                                    <tr role="row">
									<th aria-label="ID: activate to sort column ascending" style="width: 30px;" colspan="1" rowspan="1" aria-controls="applications" tabindex="0" class="center sorting">Leave ID</th>
									...
									<th aria-label="Reason: activate to sort column ascending" style="width: 122px;" colspan="1" rowspan="1" aria-controls="applications" tabindex="0" class="center sorting">No.Of Days</th>
				                 ...
				                 <th aria-label="Applied on: activate to sort column ascending" style="width: 116px;" colspan="1" rowspan="1" aria-controls="applications" tabindex="0" class="center sorting">Applied on</th>
                                   ...
                                   <?php if(empty($applicant)){?>
									...
									<tr id="row<?php echo $i;?>" class="odd" role="row">
										...
										<td class="center"><?php echo $applicant[$key]['no_days'];?></td>
										...
										<a class="btn btn-success" data-toggle="modal" href="view_leave_application?id=<?php echo $applicant[$key]['lid'];?>" ><i class="fa fa-edit"></i> View/Edit</a>
										<?php }elseif($this->session->userdata('role_id')==7){ ?>
										<a class="btn btn-success" data-toggle="modal" href="view_leave_application_reg?id=<?php echo $applicant[$key]['lid'];?>" ><i class="fa fa-edit"></i> View/Edit</a>
										<?php } ?>
										</p>
