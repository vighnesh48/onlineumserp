    ...
    <div class="page-header">     
        ...
        <div class="row ">
            <div class="col-sm-12">                
                ...
                <form id="form" name="form" action="<?=base_url($currentModule.'/total_datewise_attendance')?>" method="POST" enctype="multipart/form-data">
                <div class="form-body">
                <div class="col-md-6">
                <div class="form-group">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="add-table">
  <tr>
    <td align="center"><b>Datewise Employee Present Report Of <?=$monthName?>  <?=$ysearch?>--- <?=$sbtn?></b></td>
  </tr>
</table>
<br/>
...
<tbody>
 ...
 <td ><strong>Work For Home</strong></td>
...
<td ><?php //$all_attend[$key]['month_days']?> <input type="radio" name="Attendance[<?=$all_attend[$key]['UserId']?>]" id="Attendance_<?=$all_attend[$key]['UserId']?>" value="Present" /></td><!--Total Month Days-->
<td ><?php //$all_attend[$key]['working_days']?><input type="radio" name="Attendance[<?=$all_attend[$key]['UserId']?>]" id="Attendance_<?=$all_attend[$key]['UserId']?>" value="Absent" /></td><!--Working days of Month excluding Sundays and Holidays-->
<td ><?php //($all_attend[$key]['total_present']);?><input type="radio" name="Attendance[<?=$all_attend[$key]['UserId']?>]" id="Attendance_<?=$all_attend[$key]['UserId']?>" value="WHome" /></td><!--Total Present Day without OD-->
