                    ...
                    <div class="panel-body">
                        <div class="table-info">
							...
							<input type="text" class="form-control" readonly name="applied_on_date" value="<?php echo isset($details[0]['applied_on_date'])?$details[0]['applied_on_date']:'';?>" >				
								...
								<div class="col-md-3">
                                <select class="form-control form-control-inline" name="status"  type="text" onchange="change_leave_status(this.value)">
													...
													<option <?=$val2?> value="Approved">Approved And Forward</option>
												</select>
                                            </div>
											</div>                                      
								...
								<label class="col-md-3">Recommendation</label>
                                 <div class="col-md-3" >
                                  <textarea id="ro_recommendation" name="ro_recommendation" class="form-control" required><?=isset($details[0]['ro_recommendation'])?$details[0]['ro_recommendation']:'';?></textarea>
							  ...
							  <div class="col-md-3"></div>
                                      <div class="col-md-3">  
                                            <input type="submit" name="afsubmit" value="Approved And Forward" class="btn btn-primary form-control" >
                                        </div>
                                        </div>
                                        </div>
										<div id="rege" style="display:none">
										 <div class="form-group"> 					   
								<label class="col-md-3">Reason For Rejection</label>
                                 <div class="col-md-3" >
                                  <textarea id="ro_rejection" name="ro_rejection" class="form-control" required><?=isset($details[0]['ro_rejection'])?$details[0]['ro_rejection']:'';?></textarea>
                                    ...
                                    <div class="col-md-3"></div>									
										<div class="col-md-3">  
                                  <input type="submit" class="btn btn-primary form-control" name="resubmit" value="Reject">
                                        </div>
