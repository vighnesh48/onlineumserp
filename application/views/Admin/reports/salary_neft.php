...
<div style="text-align:left;margin-left:50px;">Find enclosed Cheque No. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dt. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; of Rs. <b><?php echo $total_salary; ?></b>&nbsp;&nbsp;towards Remuneration for visiting Faculties_odd sem for the month of <b><u><?php echo strtoupper(date('F Y', strtotime($dt))); ?></u></b><br/><br/>Kindly arrange to transfer the amount to their respective Bank Accounts.</div><br/>
	...
	<table  border="1" style="page-break-inside:always;width:50%;" id="saltab"  width="100%"  cellpadding="3" cellspacing="0">
								  ...
								  <th style="border: 1px solid black;width:10%;" width="3%"  ><b>Sr.No.</b></th>
								    <th style="border: 1px solid black;width:30%;padding:7px;text-align:left;" width="20%"><b>Name</b></th>
									<th style="border: 1px solid black;width:5%;" width="15%"><b>Bank Account No.</b></th>
									<th style="border: 1px solid black;width:5%;" width="15%"><b>Bank Name</b></th>
									<th style="border: 1px solid black;width:5%;" width="15%"><b>Bank Branch</b></th>
									<th style="border: 1px solid black;width:5%;" width="15%"><b>IFSC Code </b></th>
...
<tr>
 <td colspan='6' style='text-align:right;'><b>TOTAL AMOUNT IN RS. :-</b></td><td style='text-align:right;'><?php echo format_inr(array_sum($tsoc));?></td>
	</tr>
	</tbody>
	  </table>
	  </div>
