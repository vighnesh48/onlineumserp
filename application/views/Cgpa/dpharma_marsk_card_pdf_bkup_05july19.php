...
//print_r($val['subject_code']);
	...
	?>
  <tr>
    <td align="center" rowspan="3"><?=$val['semester'];?></td>
    <td align="center"  rowspan="3"><?=strtoupper($val['subject_code']);?></td>
    <td rowspan="3"><?=strtoupper($val['subject_name']);?> <?=$subject_category;?></td>
