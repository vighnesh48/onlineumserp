  ...
  */
  ...
  ?>
	...
	foreach($stud_year as $res){ 
		...
		//print_r($f_grade);exit;
		foreach($subdet as $res1){
			
			
			
			$percentage =$res1['obt_marks']/$res1['tot_marks']*100;
	...
	<tr>
		<td align="center"><?=$res1['semester']?></td>
		<td align="center"><?=$res1['tot_marks']?></td>
		<td align="center"><?=$res1['obt_marks']?></td>
		<td align="center"><?php if(!in_array('U', $f_grade)){ echo $perctage; }else{ echo '--';}?></td>
	</tr>
	<?php 
	   // unset($f_grade);
		//unset($percentage);
...
<table width="100%" border="" cellspacing="0" cellpadding="0" class="head-table" style="border:2px solid #000">
    ...
    &nbsp;&nbsp;&nbsp;<strong>TH</strong>-Theory, &nbsp;&nbsp;&nbsp;<strong>INT</strong>-Internal, &nbsp;&nbsp;&nbsp;<strong>PR</strong>-Practical, &nbsp;&nbsp;&nbsp;<strong>TOT</strong>-Total, &nbsp;&nbsp;&nbsp;<strong>RA</strong>-Reappearance</td>
    </tr>
