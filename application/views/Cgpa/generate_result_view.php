                           ...
                           // echo "<pre>";
                            ...
                            <tr <?=$bg?> <?=$stream_list[$i]["cancelled_admission"]=="Y"?"style='background-color:#f5b9a1'":""?>>
                              ...
                              <td><?=$j?></td>
                                ...
                                <td>
                                    <a href="#">2018<i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size:20px;color:red;margin-left:15px;" title="PDF" id="<?=$stream_list[$i]['semester']?>~pdf" onclick="generate_pdfreport(this.id,'2018')"></i> &nbsp; | <i class="fa fa-file-excel-o" aria-hidden="true" style="font-size:20px;color:green;margin-left:15px;" title="EXCEL" id="<?=$stream_list[$i]['semester']?>~excl" onclick="generate_excelreport(this.id,'2018')"></i></a><br>
                                    <a href="#">2017<i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size:20px;color:red;margin-left:15px;" title="PDF" id="<?=$stream_list[$i]['semester']?>~pdf" onclick="generate_pdfreport(this.id,'2017')"></i> &nbsp; | <i class="fa fa-file-excel-o" aria-hidden="true" style="font-size:20px;color:green;margin-left:15px;" title="EXCEL" id="<?=$stream_list[$i]['semester']?>~excl" onclick="generate_excelreport(this.id,'2017')"></i></a><br>
                                    <a href="#">2016<i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size:20px;color:red;margin-left:15px;" title="PDF" id="<?=$stream_list[$i]['semester']?>~pdf" onclick="generate_pdfreport(this.id,'2016')"></i> &nbsp; | <i class="fa fa-file-excel-o" aria-hidden="true" style="font-size:20px;color:green;margin-left:15px;" title="EXCEL" id="<?=$stream_list[$i]['semester']?>~excl" onclick="generate_excelreport(this.id,'2016')"></i></a>
                                
                                </td>

                                	<td>
									<?php if($stream==71){ ?>
									<a href="#"><i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size:20px;color:red;margin-left:15px;cursor:pointer;" title="PDF" id="<?=$stream_list[$i]['semester']?>~pdf" onclick="generate_pdfreport_dpharma(this.id)"></i></a>
									<?php }else{?>
										<a href="#">2018 <i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size:20px;color:red;" title="PDF" id="<?=$stream_list[$i]['semester']?>~excl" onclick="gradesheet_excelreport(this.id,'2018')"></i></a><br>
										<a href="#">2017 <i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size:20px;color:red;" title="PDF" id="<?=$stream_list[$i]['semester']?>~excl" onclick="gradesheet_excelreport(this.id,'2017')"></i></a><br>
										<a href="#">2016 <i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size:20px;color:red;" title="PDF" id="<?=$stream_list[$i]['semester']?>~excl" onclick="gradesheet_excelreport(this.id,'2016')"></i></a>
									<?php }?>
									</td>
...
function generate_pdfreport_dpharma(sem) {
	//alert(sem);
		var res_data = $("#res_data").val();
		var dpharma ='Y';
		var gdview ='Y';
		//alert(res_data+'~'+sem);
		window.location.href = '<?= base_url() ?>Results/pdf_resultReport/'+res_data+'~'+sem+'~'+dpharma+'~'+gdview;
		return true;
	}	
