...
var admission_course = '<?=$admissioncourse?>';
	...
	$('#btn_download_excel').on('click', function () {	
		...
		//alert(report_type);
    	window.location.href = '<?= base_url() ?>Reval/excel_summary_report/'+stream_id+'/'+exsess+'/'+report_type+'/'+reval_type+'/'+entry_date;
	}); 
});
</script>
<?php 
                ...
                <div class="panel-heading">
                        <span class="panel-title">
                            ...
                            <!--  <label class="col-sm-2">Stream<sup class="redasterik" style="color:red">*</sup></label>-->
							  ...
							  <div class="col-sm-2" id="photocopy_entry_div" >
								<input type="date" name="entry_date" id="entry_date" class="form-control datepicker" 
									value="<?=$entry_date;?>" 
									placeholder="Photocopy Entry On" >
							</div>
                        ...
                        ?>
                           ...
                           //echo "<pre>";
                            ...
                            foreach ($value['subject_list'] as $val) {
                                $sub_stud =$this->Reval_model->fetch_revalsub_students($value['stream_id'], $val['subject_id'],$exam_id, $reval_type,$entry_date);
                            ...
                            <tr>
                              ...
                              <td colspan=4 style="word-wrap: break-word;"><?=implode(', ', $enrollment_no);?> (<?=implode(', ', $ans_bklet_no);?>)</td>     
                            </tr>
...
$(document).ready(function(){
		...
		var report_type = '<?=$report_type?>';
		var reval_type = '<?=$reval_type?>';
    	window.location.href = '<?= base_url() ?>Reval/download_summary_report/'+stream_id+'/'+exsess+'/'+report_type+'/'+reval_type+'/'+date;
	}); 
});
</script>