                            ...
                            <tr>
                                   <!--th><input type="checkbox" name="chk_stud_all" id="chk_stud_all"></th-->
									...
									<?php foreach($sub_list as $sb){
										...
										?>
									<th colspan="2" style="<?=$style?>"><?=$sb['subject_code']?><BR> <?=$sb['subject_short_name']?></th>
									<?php }?>
                                ...
                                <td><?=strtoupper($stud_list[$i]['first_name'].' '.$stud_list[$i]['last_name']);?></td> 							
                          		<?php foreach($sub_list as $sb){
                          			...
                          			?>
										...
										<td align='center'><?php if(!empty($ciamrks[0]['cia_marks'])){ echo $ciamrks[0]['cia_marks'];}else{ echo "-";}?></td>
