            ...
            <div class="col-sm-12">
				<div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title" id="stdname">Faculty Subject List : (<small style="color:red">Marks submission Start at <b><?php echo date('d/m/Y H:i:s', strtotime($Marks_submission_date[0]['date_start'])) ?></b> and end on <b><?php echo date('d/m/Y H:i:s', strtotime($Marks_submission_date[0]['date_end'])) ?></b>  </small>)
							<?php 
                        ...
                        <div class="table-info">  
							...
							<thead>
								...
								$i=1;
									if(!empty($subject)){
										...
										for($p=0; $p<count($subject);$p++){
											...
											for($q=0; $q< count($subject[$p]['batches']); $q++){
												...
												$meid_detailes =$this->Marks_model->fetchDivBatchEntryDetails($subject[$p]['sub_id'], $subject[$p]['stream_id'], $subject[$p]['semester'], $division, $batch1, $exam_month, $exam_year);
									...
									//if($fac_id == '660033' || $fac_id == '210299' || $fac_id == '210300' ){
