    ...
    $(document).ready(function()
    {
		$('#test_date')
               ...
               .on('changeDate', function (e) {
                   ...
                   $('#form').bootstrapValidator('revalidateField', 'test_date');
               });
            ...
            fields: 
            {
				...
				max_marks:
                {
                    validators: 
                    {
                      notEmpty: 
                      {
                       message: 'max mark should not be empty'
                      },
                    
					regexp: 
                      {
                        regexp: /^[0-9/]+$/,
                        message: 'max mark should be numeric'
                      }
					  }
                },
				min_for_pass:
...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Add CIA</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add CIA</h1>
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title">CIA Details</span>
                    </div>
                        ...
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
							  ...
							  <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3">CIA<?=$astrik?></label>                                    
                                    <div class="col-sm-3">
                                        <select id="test_name" name="test_name" class="form-control" required="true" >
                                            <option value="">--Select--</option>
											<option value="1" <?php if($ut[0]['test_no']=='1'){ echo "selected";}?>>CIA-1</option>
											<option value="2A" <?php if($ut[0]['test_no']=='2A'){ echo "selected";}?>>CIA-2A</option>
											<option value="2B" <?php if($ut[0]['test_no']=='2B'){ echo "selected";}?>>CIA-2B</option>
											<option value="3" <?php if($ut[0]['test_no']=='3'){ echo "selected";}?>>CIA-3</option>
											<option value="4" <?php if($ut[0]['test_no']=='4'){ echo "selected";}?>>CIA-4</option>
                                        </select>                                        
                                    </div>    
									<label class="col-sm-3">Date<?=$astrik?></label>
                                    <div class="col-sm-3">
									<!--for update-->
									<input type="text" id="test_date" name="test_date" class="form-control" value="<?=date('d/m/Y', strtotime($ut[0]['test_date']))?>">	
									
                                    </div>                                  
                                </div>
								<div class="form-group">
								 <label class="col-sm-3">Min Marks</label>
                                    
									 <div class="col-sm-3"><input type="text" id="min_for_pass" name="min_for_pass" class="form-control" value="<?=$ut[0]['min_for_pass']?>" maxlength=3 /></div>
								   	<label class="col-sm-3">Max Marks<?=$astrik?></label>
                                    <div class="col-sm-3">
									<input type="text" id="max_marks" name="max_marks" class="form-control" maxlength=3 value="<?=$ut[0]['max_mark']?>">
