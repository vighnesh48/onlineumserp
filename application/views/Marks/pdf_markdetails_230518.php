...
<tr>
<td></td>
<td align="center" style="text-align:center;margin:0;padding:0"><h3 style="font-size:18px;">Mark Entry -<?php if($me[0]['marks_type']=='TH'){ echo "Theory";}else{ echo "Practical";}?> - <?=$me[0]['exam_month'].' '.$me[0]['exam_year'] ?></h3></td>
<td></td>
</tr>
   ...
   <!--         <td height="30" valign="middle">&nbsp;</td>-->
            ...
            <tr>
            <td width="100" height="30" valign="middle">&nbsp;<strong>Max Marks:</strong></td>
            <td  valign="middle">&nbsp;<?php if($me[0]['max_marks'] !=''){ echo $me[0]['max_marks'];}?></td>
            <td width="80" height="30" valign="middle">&nbsp;<strong>Date:</strong> </td>
           ...
           <tr>
			...
			$k=1;
				...
				<tr><th style='border-top:1px solid #000' align='left'>Sr.No</th><th style='border-top:1px solid #000' align='left'>PRN</th><th style='border-top:1px solid #000' align='left'>MARKS</th></tr>
				";
			}
