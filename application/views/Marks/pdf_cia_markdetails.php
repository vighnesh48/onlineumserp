<table  border="1" align="center" width="100%" cellpadding="3" cellspacing="0" style="font-size:12px;">
			...
			<th  style="border:1px solid #000" align="left">CIA MARKS (<?php if($me[0]['max_marks'] !=''){ echo $me[0]['max_marks'];}?>)</th>	
            <th  style="border:1px solid #000" align="left" width="15%">ATTENDANCE (100)</th>		
            ...
            <td style="border:1px solid #000;"><?=$stud['first_name'].' '.$stud['middle_name'].' '.$stud['last_name']?></td>	
           <td style="border:1px solid #000;"><?=$stud['cia_marks']?></td>
           <td style="border:1px solid #000;"><?=$stud['attendance_marks']?></td>
