...
<div id="content-wrapper">
            ...
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                        <span class="panel-title">
                            <form method="post" action ="<?=base_url()?>marks/entry_status">	
 ...
 <table class="table table-bordered" id="table2excel">
                        ...
                        <tbody id="studtbl">
                          ...
                          $arr_status=0;
							...
							<?php
								...
								<td>
									<?php
									if($sub_list[$i]['cia'][0]['entry_status'] !=''){
										echo "Entered";
									}else{
										echo "Not Entered";
										$arr_status=1;
								...
								<td>
									<?php
									$subDetails = $sub_list[$i]['sub_id'].'~'.$school_code.'~'.$admissioncourse.'~'.$stream.'~'.$semester.'~'.$exam.'~'.$marks_type;
									if($sub_list[$i]['mrk'][0]['me_id'] !='') {	 
									?>
                                    <a href="<?=base_url($currentModule."/download_mrkdentrystatus_pdf/".base64_encode($subDetails).'/'.base64_encode($sub_list[$i]['mrk'][0]['me_id']).'/'.base64_encode($sub_list[$i]['cia'][0]['me_id']))?>"><i class="fa fa-file-pdf-o" aria-hidden="true"  style="font-size:20px;color:red;"></i></a>
									<?php } ?>
								</td>								
                    ...
                    <?php } ?>
                    <?php 
                    	$result_data = $school_code.'~'.$stream.'~'.$semester.'~'.$exam_month.'~'.$exam_year.'~'.$exam_id;
                    	if($sub_list[0]['mrk'][0]['entry_status'] !='' && $arr_status !=1){
                    ?>
