...
<?php
    ...
    //echo "<pre>";print_r($branch_details); echo "</pre>";
?>
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        <div class="breadcrumb-label text-light-gray">You are here: </div>
        <li><a href="#">Masters</a></li>
        <li class="active"><a href="#">Edit Branch</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit Branch</h1>
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                <input type="hidden" value="<?=isset($branch_details['branch_id'])?$branch_details['branch_id']:""?>" id="branch_id" name="branch_id" />
                                <div class="form-group">
                                    <label class="col-sm-3">Branch Code <?=$astrik?></label>                                    
                                    <div class="col-sm-6"><input type="text" id="branch_code" name="branch_code" class="form-control" value="<?=isset($branch_details['branch_code'])?$branch_details['branch_code']:''?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="branch_code" name="branch_name" class="form-control" value="<?=isset($branch_details['branch_name'])?$branch_details['branch_name']:''?>" /></div>                                    
