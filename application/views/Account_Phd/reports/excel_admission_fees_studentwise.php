...
else if($report_type=="8")
{
	...
	$filename='Sem Wise Student Wise Outstanding Fees-'.$academic_year.'.xls'; 
       ...
       $this->load->library("excel");
					...
					$object->getActiveSheet()->setCellValue('Y4', 'District');
					$object->getActiveSheet()->setCellValue('Z4', 'City');
...
//	$object->getActiveSheet()->setCellValue('T'.$x, $pending);
	...
	$object->getActiveSheet()->setCellValue('Y'.$x, $row['district_name']);
	$object->getActiveSheet()->setCellValue('Z'.$x, $row['taluka_name']);
