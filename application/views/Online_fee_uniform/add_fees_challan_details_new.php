...
var facilty=$("#facilty").val();
		...
		{  
			$.ajax({
				'url' : base_url + 'Uniform/loadstudents_data1',
				'type' : 'POST', //the way you want to send data to your URL
				'data' : {'enrollment_no':prn,'facilty':facilty},
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
		...
		<form id="form" name="form" action="<?=base_url('Uniform/add_fees_challan_submit')?>" method="POST" >
        ...
        <input type="hidden" id="enroll" name="enroll" value="<?=$user_details[0]['registration_no'];?>" />
		<input type="hidden" id="student_id" name="student_id" value="<?=$user_details[0]['student_id'];?>" />
		<input type="hidden" id="curr_yr" name="curr_yr" value="" />
        <input type="hidden" id="admission_year" name="admission_year" value="" /> 
        <input type="hidden" id="academic_year" name="academic_year" value="<?=$user_details[0]['academic_year'];?>" />
		<input type="hidden" id="institute" name="institute" value="<?=$user_details[0]['institute'];?>" />
		<input type="hidden" id="org_from" name="org_from" value="<?=$user_details[0]['org_frm'];?>" />
                          
                            <div class="col-md-5" id="std_details1" style="padding-right:0px;">
							<?php //print_r($user_details);
                            ...
                            <div class="panel-body">
                              ...
                              <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">ID/PRN:</label>
									 ...
									 <span id="prnno" name="prnno"><?=$user_details[0]['registration_no'];?></span>								   
								   </div>			 
							  </div>
								<div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Name:</label>
									 <div class="col-md-7" style="padding-left:0px;">
									  <span id="std_name" name="std_name"><?=$user_details[0]['firstname'];?></span>								   
								   </div>			 
							  </div>
							  <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Course:</label>
									 ...
									 <span id="course" name="course"><?=$user_details[0]['institute'];?></span>								   
								   </div>			 
							  </div>
							 <!-- <div class="form-group">
							  ...
							  <!--div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Current Year:</label>
									 ...
									 <span id="current_year" name="current_year"><?=$user_details[0]['institute'];?></span>								   
								   </div>			 
							  </div-->
							  <div class="form-group">
								<label class="col-md-5" style="padding-left:0px;">Mobile:</label>
									 ...
									 <span id="mobile1" name="mobile1"><?=$user_details[0]['phone'];?></span>								   
								   </div>			 
							  </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
                                ...
                                <div class="col-md-6" style="padding-left:0px;">
                                  <select class="form-control" name="facilty" id="facilty" onchange="faci_type()" >
                                      ...
                                      <option value="6">Uniform Fees</option>
								  </select>
                                </div>
                        ...
                        <div class="panel" id="fee_detailss">
                           ...
                           <div class="panel-body">
							<div id="fee_details" style="display:none;">
						...
						<input type="hidden" value="" id="famt">
							  ...
							  <div class="form-group">
                                <label class="col-md-5" style="padding-left:0px;">Uniform Fee:</label>
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly" value="<?php echo $user_details[0]['amount'];?>" name="uniform_fees" id="uniform_fees" onblur="calc_final_amount();"/>
                                </div>
