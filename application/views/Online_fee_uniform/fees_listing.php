...
<div>
                           ...
                           <div class="col-sm-2"><select name="Verify_status" id="Verify_status" class="form-control" onchange="Verify_status_change(this)">
                            ...
                            <option value="Approved">Approved</option><option value="AdmissionCancel">Admission Cancel</option></select></div>
                            </div>
                      <div class="col-sm-1">Year</div>
						...
						<div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url("online_uniform_fee/add")?>"><span class="btn-label icon fa fa-plus"></span>Add Package Students</a></div> 
                    </div>
                    </span>
                  </div>
...
$(document).ready(function() {
        ...
        "ajax": {
                "url": "<?php echo site_url('Online_uniform_fee/getOnlineFeeDetail')?>",
                "type": "POST",
                 "data": function ( data ) {
	...
	function change_productinfo(m){
		...
		var retVal = confirm("Do you want to continue ?");
               if( retVal == true ) {
				   ...
				   $.ajax({
   'url' : base_url + 'Online_uniform_fee/change_productinfo',
...
$(document).on('click', '#admission_cancel', function() {
...
if(payment_id!="" && student_id!="" && (status=="N" || status=="Y") )
{

  $.ajax({
url: "<?php echo site_url('Online_uniform_fee/admissioncancel')?>",
type: "post",
data: {payment_id:payment_id,student_id:student_id,status:status } ,
