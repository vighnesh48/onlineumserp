                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="contact_des">
                                        <h4 class="text-center"><span> Transaction Success </span></h4>
                                 
        
                                <p class="text-center">Your payment has been received.  Your Transaction id# is:<b><?php if(isset($txnid)){echo $txnid;}else{ echo $_REQUEST['txnid'];} ?></b></p>
                                <p class="text-center"></p>
                               <p class="text-center">You will receive payment confirmation email. Kindly contact account section for Payment Receipt.<!--Please provide the receipt for further reference.--></p>
                              <!-- <p class="text-center"><br><span type="button" class="btn btn-danger btn-sm">
          <span class="glyphicon glyphicon-download-alt"></span><a href="http://www.sandipuniversity.com/payment/chpdf/receipt_<?php //echo $bank_ref_num?>.pdf" target="_blank"> Download Payment Receipt  </span></p>
                         -->    
