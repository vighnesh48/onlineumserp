...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add Color</h1>
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                <input type="hidden" value="" id="color_id" name="designation_id" />
                                <div class="form-group">
                                    <label class="col-sm-3">Color Code <?=$astrik?></label>                                    
                                    <div class="col-sm-6"><input type="text" id="colorcode" name="colorcode" class="form-control" value="<?=isset($_REQUEST['colorcode'])?$_REQUEST['colorcode']:''?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="designation_code" name="colorname" class="form-control" value="<?=isset($_REQUEST['colorname'])?$_REQUEST['colorname']:''?>" /></div>                                    
