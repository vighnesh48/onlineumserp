                        ...
                        <thead>
                            <tr>
                                   <th class="noExl"><input type="checkbox"  id="ckbCheckAll"></th>
                                    ...
                                    <th>Reported</th>
                                    <?php
                                    if( $_SESSION['role_id']=='5' || $_SESSION['role_id']=='40')
                                    {
                                    ?>
                                    ...
                                    ?>
                                    <?php if($role_id==41 || $role_id==15 || $role_id==10 || $role_id==6 || $role_id==20 || $role_id==44){ ?>
...
<td><?=$emp_list[$i]['password'];?></td> 								
	        ...
	        <?php
                                    if($_SESSION['role_id']=='1' || $_SESSION['role_id']=='2' || $_SESSION['role_id']=='41'  || $_SESSION['role_id']=='43')
                                    {
