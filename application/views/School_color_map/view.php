...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">School Color Mapping Master</a></li>
    </ul>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                    ...
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add")?>"><span class="btn-label icon fa fa-plus"></span>Add School Color Mapping</a></div>                        
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            for($i=0;$i<count($schoolcolor_details);$i++)
                            {
                                
                            ?>
                            <tr <?=$schoolcolor_details[$i]["is_active"]=="1"?"style='background-color:#FBEFF2'":""?>>
                                <td><?=$j?></td>  
                                <td><?=$schoolcolor_details[$i]['school_name']?></td>                                                              
                                <td><?=$schoolcolor_details[$i]['color_name']?></td>
                                                              
                                <td>
                                    <?php if(in_array("Edit", $my_privileges)) { ?>
                                    <a href="<?=base_url($currentModule."/edit/".$schoolcolor_details[$i]['id'])?>"><i class="fa fa-edit"></i></a>                                                                        
                                    <?php } ?>
