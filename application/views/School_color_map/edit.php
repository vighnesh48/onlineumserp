...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Edit School Color Mapping</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit School Color Mapping</h1>
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title">School Color Mapping</span>
                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <option value=""> -- Select -- </option>
                                         <?php foreach($school as $schools) {
                                                if($schoolcolor_details['school_id'] == $schools['id']) {?>
                                    ...
                                    <div class="col-sm-6">
										...
										<option value=""> -- Select -- </option>
                                         <?php foreach($color as $colors) {
                                                if($schoolcolor_details['color_id'] == $colors['id']) {?>
