        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                        <span class="panel-title">
                            <form method="post" action ="<?=base_url()?>Certificate/markscard_new">	
			...
			//if(isset($role_id) && $role_id==1 ){?>
                ...
                <div class="row">
						...
						<div class="col-lg-5"><input type="button" name="generate" value="GENERATE MARKSCARD" id="gmarkscard1" class="btn btn-primary" onclick="return validate_student(this.value)"></div>
					</div>
