...
<div id="content-wrapper">
    ...
    <div class="page-header">
    	<div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Transcript Generation</h1>
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                        <span class="panel-title">
                            <form method="post" action ="<?=base_url()?>Certificate/Transcript">	
			...
			//if(isset($role_id) && $role_id==1 ){?>
               ...
               <!-- <input type="hidden" name="stud_prn[]" id='stud_prn' value=""> -->
                <div class="row">
			<div class="col-lg-3"><input type="text" name="current_date" value="" id="datepicker" class="form-control" placeholder="Select Date">
			</div>
                        <div class="col-lg-2">
...
<td>&nbsp;</td>
                      ...
                      <input type="checkbox" name="chk_stud[]" id="chk_stud" class='studCheckBox' value="<?=$stud_list[$i]['stud_id']?>">
                              ...
                              <td><?=$j?></td>
								...
								?>
                                <td><img src="<?php // $imageData?>" alt="<?=$stud_list[$i]['student_id']?>" width="50" ></td>
...
$("#datepicker").css('border-color', 'red');
		...
		//var values = $("input[name='stud_prnn[]']")
          //    .map(function(){return $(this).val();}).get();
			...
			//  $("#stud_prn").val(values);
		$("#mrkcrdfrom").attr("action",'<?=base_url()?>Certificate/Manual_Transcript_All');
