...
and</em></h2></div>
	<div class="prfpic"><img src="<?=base_url()?>uploads/student_photo/<?=$emp[0]['enrollment_no']?>.jpg" alt="" width="100" ></div>
	
	<div class="contain">
	<h2><em>Members of the Governing Body of the Sandip University, Nashik<br />
    certify that <span style="text-decoration:underline;"><b><?=$emp[0]['stud_name']?> <? //$emp[0]['first_name']?> <? //$emp[0]['middle_name']?></b></span> having been examined<br />and found duly qualified for the Integrated degree of	
    </em></h2>
	...
	<h2 style=""><em>and placed in <span style="text-decoration:underline;"><b><?php echo $result;?></b></span> in <?php echo ucfirst( $emp[0]['sexam_month']).' '.$emp[0]['sexam_year'];?>.<br> The said degree has been conferred on <?=$initial_3;?>.<br>In testimony whereof is set the seal of the said University.</em></h2>
	</div>
	<div class="idate"><?php //if($mrk_cer_date !='0000-00-00'){ echo $mrk_cer_date;} //echo date('d-m-Y'); ?><!--<? //=$issued_date;?>--></div>
</div>
</body>
</html>
