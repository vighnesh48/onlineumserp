...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Degree Certificate List-2016</h1>
                        ...
                        <tbody id="studtbl">
                            ...
                            <tr>
								...
								<td style="width: 75px;">
									...
									<a href="<?=base_url()?>Certificate/download_degree_certificate_for_2016/<?=$emp_list[$i]['enrollment_no']?>" target="_blank">
