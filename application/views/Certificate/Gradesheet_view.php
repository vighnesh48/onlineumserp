...
<div id="content-wrapper">
    ...
    <div class="page-header">
    	<div class="row">
            <h1 class="col-xs-12 col-sm-8 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;CONSOLIDATED GRADESHEET  Generation</h1>
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                        <span class="panel-title">
                            <form method="post" action ="<?=base_url()?>Certificate/Gradesheet">	
							...
							<div class="col-sm-2">
							 ...
							 <div class="col-sm-2" id="">
								<input type="text" name="prn" id="prn" value="<?=$prn?>" class="form-control" />
                             </div><br><br>
			...
			//if(isset($role_id) && $role_id==1 ){?>
               ...
               <!-- <input type="hidden" name="stud_prn[]" id='stud_prn' value=""> -->
                <div class="row">
			<div class="col-lg-2"><input type="text" name="current_date" value="" id="datepicker" class="form-control" placeholder="Select Date">
			</div>
			<div class="col-lg-3">
			<input type="text" name="remark" value="" id="remark" class="form-control" placeholder="Enter Remark">
			</div>
                        <div class="col-lg-2">
...
<td>&nbsp;</td>
						...
						<td class="noExl">
                           ...
                           <!-- <input type="hidden" name="stud_prnn[]" id='stud_prnn' value="<?=$stud_list[$i]['enrollment_no']?>"> 
                             ...
                             -->
                             <input type="hidden" name="schoold[]" id='schoold' value="<?=$stud_list[$i]['school_code']?>">

                      <input type="checkbox" name="chk_stud[]" id="chk_stud" class='studCheckBox' value="<?=$stud_list[$i]['stud_id']?>">
                            </td>
                              <td><?=$j?></td>
							...
							$raw = file_get_contents($imgInput);

							$compressedImage = compress_image_to_base64($raw, 500);

							?>
							<td><img src="<?= $compressedImage ?>" alt="<?= $stud_list[$i]['student_id'] ?>" width="50"></td>

                                
                                <td><?=$stud_list[$i]['cumulative_gpa'];?></td>
                                <td><?php if($stud_list[$i]['checb']==0 && $stud_list[$i]['easchecb']==0){ echo 'First Attempt'; }else{ echo '-';} ?></td>
                               
                             <!-- <td>  <a href="<?=base_url()?>Certificate/Manual_certificate/<?=$stud_list[$i]['enrollment_no']?>/<?=$stud_list[$i]['stream_id']?>/<?=$stud_list[$i]['school_code']?>/<?=$stud_list[$i]['exam_id']?>/<?=$stud_list[$i]['semester']?>/<?=$stud_list[$i]['stud_id']?>" target="_blank">
