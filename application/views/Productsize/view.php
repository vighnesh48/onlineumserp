...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Product Size Master</a></li>
    </ul>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                    ...
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add")?>"><span class="btn-label icon fa fa-plus"></span>Add Product Size</a></div>                        
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            for($i=0;$i<count($proudctsize_details);$i++)
                            {
                                
                            ?>
                            <tr <?=$proudctsize_details[$i]["is_active"]=="1"?"style='background-color:#FBEFF2'":""?>>
                                <td><?=$j?></td>  
                                <td><?=$proudctsize_details[$i]['product_name']?></td>                                                              
                                <td><?=$proudctsize_details[$i]['sizecode']?></td>
                                <td><?=$proudctsize_details[$i]['size']?></td>                                
                                <td>
                                    <?php if(in_array("Edit", $my_privileges)) { ?>
                                    <a href="<?=base_url($currentModule."/edit/".$proudctsize_details[$i]['id'])?>"><i class="fa fa-edit"></i></a>                                                                        
                                    <?php } ?>
