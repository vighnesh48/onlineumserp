<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" style="margin-bottom:5px;">
	<tr>
		...
		<td width="120" align="right" valign="top" style="text-align:center;padding-top:15px;">
			<h3 style="font-size: 25px">COE</h3>
		</td>
	...
	<tr>
		...
		<?php if ($sts == 'Y') { ?>
			<td align="center" style="text-align:center;margin:0;padding:0">
				<h3 style="font-size:18px;"><?php if ($me[0]['marks_type'] == 'TH') {
					echo "Theory";
				} else {
					echo "Laboratory";
				} ?>
					Mark Entry - <?= $me[0]['cia_exam_type'] ?></h3>
			</td>
		<?php } else { ?>
			<td align="center" style="text-align:center;margin:0;padding:0">
				<h3 style="font-size:18px;">CIA Marks Report - <?= $me[0]['cia_exam_type'] ?></h3>
			</td>
		<?php } ?>
		<td></td>
	</tr><br>
...
<table width="100%" cellpadding="0" cellspacing="0" border="1" align="center" style="font-size:12px;height:150px;">
	...
	<tr>
		...
		<td height="30" colspan='3'>&nbsp;<?php if ($me[0]['max_marks'] != '') {
			echo $me[0]['max_marks'];
		} ?></td>
		...
		<td height="30" valign="middle">
			&nbsp;<?php if ($me[0]['marks_entry_date'] != '0000-00-00' && $me[0]['marks_entry_date'] != '') {
