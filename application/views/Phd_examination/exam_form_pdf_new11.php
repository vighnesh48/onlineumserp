...
<td rowspan="4" align="center" width="20%"><img src="https://erp.sandipuniversity.com/uploads/student_photo/<?=$emp[0]['enrollment_no']?>.jpg" alt="" width="100" height="90"/></td>
</tr> 
...
?>
 <tr>
			...
			<span>Backlog Fees: <b> <?php  echo (int)$examdetails[0]['exam_fees']-(int)$degree_fees;?></span>, 
			<?php } } } ?>
