...
<script>    
  ...
  $('#sbutton').click(function(){
   ...
   // alert("hi");
      ...
      $.ajax({
          'url' : base_url + 'Phd_examination/search_student_for_exam_allow',
...
if($exam[0]['exam_type'] =='Regular'){
	...
	$title='Allow Special Supplementary Examinations';
}	
?>
                    ...
                    <div id="dashboard-recent" class="panel panel-warning">        
                     <div class="panel-heading">
                       <span class="panel-title"><i class="panel-title-icon fa fa-fire text-danger"></i>Exam Session : <?=$exam[0]['exam_month']?>-<?=$exam[0]['exam_year']?></span>
						...
						<br>
						<!--<form id="form1" name="form1" enctype="multipart/form-data" action="<?=base_url($currentModule.'/search_student_for_allow')?>" method="POST">-->
