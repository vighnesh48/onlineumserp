...
<form id="form1" name="form1" enctype="multipart/form-data" action="<?=base_url('Phd_examination/allow_student_for_exam')?>" method="POST">
 <table class="table table-bordered" id="table2excel">
                        ...
                        <tbody id="itemContainer">
							...
							<td><?=$exam[0]['exam_month'];?>-<?=$exam[0]['exam_year'];?></td> 
								...
								<td class="noExl"><a  href="<?php echo base_url()."phd_examination/index/".base64_encode($emp_list[$i]['enrollment_no']).""?>" title="View" target="_blank"><button type="submit" class="btn btn-primary" >Allow for exam</button> </a>&nbsp;&nbsp;&nbsp;&nbsp;</td> 
