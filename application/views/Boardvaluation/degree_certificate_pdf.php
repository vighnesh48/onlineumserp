...
and</em></h2></div>
	...
	<h2><b><?php   echo $emp[0]['course_name']?><br />in<br /> <?php echo $emp[0]['degree_specialization'];?></b>
    <!--with the specialisation of <br />
	<?php // echo $specialization;?>--></h2>
	<h2 style=""><em>and placed in <span style="text-decoration:underline;"><b><?php echo $result;?></b></span> in <?php echo ucfirst( $emp[0]['sexam_month']).' '.$emp[0]['sexam_year'];?>.<br> The said degree has been conferred on him.<br>In testimony whereof is set the seal of the said University.</em></h2>
	</div>
