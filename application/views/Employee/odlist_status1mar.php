                        ...
                        <i class="fa fa-trash"></i> Delete</a></p></td>-->
							 ...
							 <div class="form-group">
								...
								<?php if(!empty($getpass_data)){?>
								 <div class="panel">
                            	<div class="panel-heading"><strong>Gate Pass For OD</strong></div>
                                <div class="panel-body">
							...
							$str.="<tr><td >
								...
								<tr><td style='text-align:center;padding:10px 0'><h1 style='color:red'><b>Gate Pass For OD</b></h1></td><td></td></tr><br>
