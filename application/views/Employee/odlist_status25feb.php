                                   ...
                                   <?php if(empty($od)){?>
									...
									<?php }else{
									   ...
									   <tr id="row<?php echo $i;?>" class="odd" role="row">
										...
										<td class="center">
						<?php
							if(isset($od[$key]['applied_from_date']) && $od[$key]['applied_from_date']!='0000-00-00'){
											echo $od[$key]['applied_from_date'];
											}else if(isset($od[$key]['departure_time']) && $od[$key]['departure_time']!='00:00:00'){
											echo $od[$key]['departure_time'];
											}?>
											</td>
										<td class="center">
										<?php if(isset($od[$key]['applied_to_date']) && $od[$key]['applied_to_date']!='0000-00-00'){
											echo $od[$key]['applied_to_date'];
											}else if(isset($od[$key]['arrival_time']) && $od[$key]['arrival_time']!='00:00:00'){
...
<!--<a data-toggle="modal" data-book-id="<?=$od[$key]['oid']?>" data-target="#myModal"> View</a>-->
                        ...
                        <i class="fa fa-trash"></i> Delete</a></p></td>-->
							 ...
							 <div class="form-group">
								...
								<!--Gate Pass-->
								<?php if(!empty($getpass_data)){?>
								 <div class="panel">
                            	<div class="panel-heading"><strong>Gate Pass</strong></div>
                                <div class="panel-body">
                               
							<?php 
							$str="";
							 $str="<table border='1'>";
						    //$str.="<tr> <td><img src='".base_url().'assets/images/lg.png'."'></td><td></td></tr>";
						//$str.="<tr> <td><img src='http://www.sandipuniversity.com/erp/assets/images/lg.png'></td><td></td></tr>";
						     $str.="<tr> <td><label style='color:red;font-size:36px'><b>Sandip University</b></label></td><td></td></tr>";
							$str.="<tr><td >
								...
								<tr><td style='text-align:center;padding:10px 0'><h1 style='color:red'><b>Gate Pass</b></h1></td><td></td></tr><br>
								...
								<tr><td style='padding:10px 0'>Departure Time :&nbsp;<b>".$getpass_data[0]['departure_time']."</b></td><td style='padding:10px 0'>Arrival Time :&nbsp;<b>".$getpass_data[0]['arrival_time']."</b></td></tr>"
								;
								...
								<tr><td style='xxwidth:30%;padding:10px 0'>Signature of Registrar : </td> <td>   </td></tr>
								</table>";
								echo $str; 
