							 ...
							 <table style="width: 1040px;" aria-describedby="applications_info" role="grid" 
							  ...
							  <!-- class='dataTable' for sorting arrows icon for col-->
				                 ...
				                 <th aria-label="Applied on: activate to sort column ascending" style="width: 116px;" colspan="1" rowspan="1" aria-controls="applications" tabindex="0" class="center sorting">Applied on</th>
									...
									<?php if($leave[$key]['ro_approval_status']!='Approved'){?>
...
<!--<a data-toggle="modal" data-book-id="<?=$leave[$key]['lid']?>" data-target="#myModal"> View</a>-->
											<a href="<?=base_url().'employee/create_getpass?lv_id='.$leave[$key]['lid'].'&emp_id='.$leave[$key]['emp_id']?>">GetPass</a>
											<?php }?>
                                         </td>	
										<td class="center">
										 <?php if($leave[$key]['ro_approval_status']!='Approved'){?>
							<p><a style="width: 106px;" href="<?=base_url()."employee/del_leave_app?id="?><?=$leave[$key]['lid'];?>" class="btn btn-danger">
                        <i class="fa fa-trash"></i> Delete</a></p>
							 ...
							 <div class="form-group">
								...
								<!--Gate Pass-->
								<?php if(!empty($getpass_data1)){?>
								 <div class="panel">
                            	<div class="panel-heading"><strong>Gate Pass For Leave</strong></div>
                                <div class="panel-body">
							...
							$str.="<tr><td >
								...
								<tr><td style='text-align:center;padding:10px 0'><h1 style='color:red'><b>Gate Pass For Leave</b></h1></td><td></td></tr><br>
								...
								<tr><td style='padding:10px 0'>Location of Leave :&nbsp;<b>".$getpass_data1[0]['leave_contct_address']."</b></td><td style='padding:10px 0'>Purpose Of Leave:&nbsp;<b>".$getpass_data1[0]['reason']."</b></td></tr>
								<tr><td style='padding:10px 0'>From Date :&nbsp;<b>".$getpass_data1[0]['applied_from_date']."</b></td><td style='padding:10px 0'>To Date :&nbsp;<b>".$getpass_data1[0]['applied_to_date']."</b></td></tr>
								<tr><td style='padding:10px 0'>Departure Time :&nbsp;<b>".$getpass_data1[0]['departure_time']."</b></td><td style='padding:10px 0'>Arrival Time :&nbsp;<b>".$getpass_data1[0]['arrival_time']."</b></td></tr>
								";
																
								$str.="<tr><td style='padding:10px 0'>Staff ID:&nbsp;<b>".$getpass_data1[0]['emp_id']."</b></td><td style='padding:10px 0'>Name :&nbsp;<b>".$getpass_data1[0]['fname'].' '.$getpass_data1[0]['mname'].' '.$getpass_data1[0]['lname']."</b></td></tr>
								<tr><td style='padding:10px 0'>Designation:&nbsp;<b>".$getpass_data1[0]['designation_name']."</b></td><td style='padding:10px 0'>Department :&nbsp;<b>".$getpass_data1[0]['department_name']."</b></td></tr>
