            ...
            <div class="panel">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <span class="text-muted">View Marked Event Attendance</span> |
                ...
                <div class="panel-body">
                    <div class="table-info">
                        ...
                        <form method="POST" action="<?= base_url('Event/view_uploaded_attendance/' . base64_encode($event_allocation_data[0]['event_allocation_id'] ?? '')) ?>">
                        ...
                        <script>
                            ...
                            document.querySelector("form[action*='view_uploaded_attendance']").addEventListener("submit", function(e) {
                        ...
                        <form method="POST" action="<?= base_url('Event/view_uploaded_attendance'); ?>" onsubmit="return validateAttendanceForm();">
                            <input type="hidden" name="event_allocation_id" value="<?= $event_allocation_data[0]['event_allocation_id'] ?? '' ?>">
                            <input type="hidden" name="event_id" value="<?= $event_allocation_data[0]['id'] ?? '' ?>">
