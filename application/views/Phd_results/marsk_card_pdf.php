...
<table width="100%" border="0" cellspacing="" cellpadding="2" class="head-table" style="xborder:2px solid #000">
...
<table width="100%"  border="0" cellspacing="" cellpadding="3" class="details-table" style="xborder:2px solid #000">
  <tr>
  <th width="5%">Sr.no</th>
   <!-- <th width="5%">SEM NO</th>-->
    <th width="15%">COURSE CODE</th>
    <th align="left" width="44%">NAME OF THE COURSE</th>
	<!--th width="10%">ATTENDANCE GRADE</th-->
    <th width="8%">CREDITS</th>
    <th width="8%">LETTER GRADE</th>
    <th width="8%">GRADE POINT</th>
    <th width="15%">RESULT<?php // print_r($backlog_kiran); ?></th>
  </tr>
  <?php 
 $sr=1;
...
<table width="100%" border="" cellspacing="0" cellpadding="0" class="head-table" style="border:2px solid #000">
 <!-- <tr>
  ...
  <tr>
    <td width="70%"><strong>Credits Registered</strong>
    <?php
   ...
   //var_dump($stud[0]['grades']);//exit;
    ...
    <td  align="center" width="30%"><?php //echo $stud[0]["grades"][1]['credits_registered'];
