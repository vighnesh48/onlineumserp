...
<script>    
    $(document).ready(function(){
     var base_url = 'https://sandipuniversity.com/erp';
        ...
        $('#btnView').click(function(){
                ...
                //var campus = $("#campus").val();
                  ...
                  if(academic_year=="" || report_type==""){
                      alert("Please select All  Options ");
                  }
                  else {
                      $("#loader1").html('<div class="loader"></div>');
                      $.ajax({
                                'url' : base_url + '/Competitive_exam/get_exam_fees_report',
                                'type' : 'POST', //the way you want to send data to your URL
                                'data' : {'academic_year':academic_year,'report_type':report_type,'act':'view'},
                      ...
                      // $("#loader1").html('<div class="loader"></div>');
                       $("#FrmAdm").submit();
                        ...
                        $.ajax({
                                'url' : base_url + '/Competitive_exam/get_exam_fees_report',
                                'type' : 'POST', //the way you want to send data to your URL
                                'data' : {'academic_year':academic_year,'report_type':report_type,'act':'excel'},
                                'success':function (str) {
                                // alert(str);
...
<div id="content-wrapper">
  ...
  <form action="<?=base_url($currentModule.'/get_exam_fees_report');?>" method="POST" id="FrmAdm">
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title form-group"><i class="fa fa-list-alt page-header-icon h3"></i>&nbsp;&nbsp;Competitive Exam Fees Report</span>
                    </div>
                    <div class="panel-body">
					 <div class="row">
						  ...
						  <div class="col-sm-1"><a class="btn btn-primary btn-labeled" id="btnPdf" >PDF</a>
