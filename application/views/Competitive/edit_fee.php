	 ...
	 <script>
	     $(document).ready(function(){
			...
			var DynamicVar = "uploads/Competitive/student_challans/";
	  ...
	  <div class="panel" id="" style="">
                            <div class="panel-heading">
								...
								<form name="editPayment" id="editPayment" method="POST" action="<?=base_url()?>Competitive_exam/update_inst" enctype="multipart/form-data">
								<?php
