...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
			...
			<i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Update All Boarding Fee details </h1>
                ...
                <div class="panel">
					...
					<?php if(!empty($this->session->flashdata('message2'))){ echo $this->session->flashdata('message2'); } ?>
                        ...
                        <div class="table-info">                            
                            <div class="row ">
							<div id="r_div" class="col-sm-12">
								<div class="table-info">    
									<form id="form" name="form" action="<?=base_url($currentModule.'/updateall_fees_details_submit'.'/'.$campus.'/'.$academic)?>" method="POST" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="academic" name="academic" value="<?=$academic?>"/>
                                    </div>                                    
									...
									<div id="list">
										<?php //echo "state".$state;exit();
											if(!empty($all_boarding_fee_details)){
												$j=1;
												echo "<table class=\"table table-bordered\">
														...
														<tbody>";
												foreach($all_boarding_fee_details as $val)
												{
													echo "<tr >";
													echo "<td>".$j."</td>";
													echo "<td>".$val['boarding_point']."<input type=\"hidden\" name=\"b_id[]\" value=\"".$val['sffm_id']."\"/></td>";
													echo "<td> <input type=\"text\" id=\"fees".$j."\" name=\"fees[]\" class=\"only_number form-control \" onkeyup=\"only_number(this.id)\" style=\"width:80px;\" value=\"".$val['fees']."\" required/> </td>";
									...
									<div class="form-group">
										...
										<div class="col-sm-2">
											<button class="btn btn-primary form-control" id="save" type="submit" >Update</button>                                        
										</div>                                    
