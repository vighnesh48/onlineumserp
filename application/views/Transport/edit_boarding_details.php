...
<script>    
    $(document).ready(function()
    {
		...
		var campus='<?=$boarding_details['campus']?>';
	...
	var status='<?=$boarding_details['is_active']?>';
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
			...
			<i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit Boarding Details </h1>
			 ...
			 <?php if(!empty($this->session->flashdata('message2'))){ echo $this->session->flashdata('message2'); } ?>
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/edit_boarding_submit/'.$boarding_details['board_id'])?>" method="POST" onsubmit="return validate_faci_category(event)">     
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" id="bpoint" value="<?=$boarding_details['boarding_point']?>" name="bpoint" onblur="check_boardingpoint_exists()" class="form-control alphaonly" />
                                    </div>                                    
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" id="distance" value="<?=$boarding_details['distance_from_campus']?>" name="distance" class="form-control numbersOnly" />
                                    </div>                                    
								...
								<!--<div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="ptime" name="ptime"  value="<?=$boarding_details['pickup_timing']?>" type="text" class="form-control" autocomplete="off">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                       <input id="dtime" name="dtime" value="<?=$boarding_details['drop_timing']?>" type="text" class="form-control" autocomplete="off">
                                    </div>                                    
...
function check_boardingpoint_exists()
{
	...
	var id='<?=$boarding_details['board_id']?>';
		$.ajax({
				type: 'POST',
				url: '<?= base_url() ?>Transport/check_boardingpoint_exists',
				data: {campus:campus,bpoint:bpoint,id:id},
