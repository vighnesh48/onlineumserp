        ...
        $('#btnView').click(function(){
                ...
                var campus = $("#campus").val();
                  ...
                  if(academic_year=="" ||institute_name==""||report_type==""){
                      ...
                      $.ajax({
                                'url' : base_url + '/Transport_facility/get_transport_fees_report',
...
<div id="content-wrapper">
  ...
  <form action="<?=base_url($currentModule.'/get_transport_fees_report');?>" method="POST" id="FrmAdm">
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title form-group"><i class="fa fa-list-alt page-header-icon h3"></i>&nbsp;&nbsp;Transport Fees Report</span>
                    </div>
  ...
  else
  {
            ...
            if($exp[1]=="nashik")
        {
							...
							<option value="SU-PROV">SU-PROV</option><option value="JrCollege">GLOBAL SCHOOL</option>
        											 	...
        											 	<option value="SIP">SF-SIP</option><option value="MBA">SF-MBA</option>
					  <?php
 }
  elseif($exp[1]=="sijoul")
  {
                						...
                						<div class="col-sm-2">
                                    	        <select id="report_type" name="report_type" class="form-control"  required>
        											<option value=""> Select Report Type</option>
        												...
        												<option value="5">Transport Summary</option>
...
<script>
  $(document).ready(function (){
      ...
      $("#campus").on('change', function (e){
         ...
         {
             dat ='<option value="All">All Transport</option><option value="SRP">SRP</option><option value="SSJPITI">SSJPITI</option><option value="SU-SIJOUL">SU-SIJOUL</option><option value="SNJCOE">SNJCOE</option>';
         }
          if($("#campus").val() =="NASHIK")
         {
    dat =' <option value="All">All Transport</option><option value="SU">Sandip University Nashik</option><option value="SU-PROV">SU-PROV</option><option value="JrCollege">GLOBAL SCHOOL</option><option value="SITRC">SF-SITRC</option><option value="SIEM">SF-SIEM</option><option value="SIPS">SF-SIPS</option><option value="SP">SF-SP</option><option value="SIP">SF-SIP</option><option value="MBA">SF-MBA</option>';
         }
         
                 if($("#campus").val() =="ALL")
         {
    dat ='<option value="All">All Transport</option><option value="SU">Sandip University Nashik</option><option value="SU-PROV">SU-PROV</option><option value="JrCollege">GLOBAL SCHOOL</option><option value="SITRC">SF-SITRC</option><option value="SIEM">SF-SIEM</option><option value="SIPS">SF-SIPS</option><option value="SP">SF-SP</option><option value="SIP">SF-SIP</option><option value="MBA">SF-MBA</option><option value="SRP">SRP</option><option value="SSJPITI">SSJPITI</option><option value="SU-SIJOUL">SU-SIJOUL</option><option value="SNJCOE">SNJCOE</option>';
         }
