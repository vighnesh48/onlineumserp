...
for($i=0;$i<count($ids);$i++)
{
	...
	$form_no = $ids[$i]['driving_license_no'];
...
<tr>
<td valign="top">
	<img src="<?=base_url()?>uploads/Transport/Driver/<?=$ids[$i]['driver_photo']?>" alt="<?=base_url()?>assets/images/nopic.jpg" width="40"/>
</td>
<td valign="top" width="100%">
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
<td valign="top" style="line-height:10px;font-size:10px;" width="100%"><strong><?=$ids[$i]['driver_name']?></strong><br><small><strong><?=$short_stream?></strong></small></td>
<td valign="middle" style="border:1px solid #000;border-radius:5px;text-align:right;margin:0!important;padding:5px!important;" align="right"><strong><?=$ids[$i]['driver_id']?></strong></td>
</tr>
<tr>
<td colspan="2">
<table border="0" cellpadding="0" cellspacing="0" width="100%">
...
<tr>
<td><font size="12">Vendor</font></td>
<td><font size="12"><strong>: <?=$ids[$i]['vendor_name']?></strong></font></td>
</tr>
<!--<tr>
<td><font size="12">Route Name </font></td>
<td><font size="12"><strong>: <?=$ids[$i]['driving_license_no']?></strong></font></td>
</tr>-->
...
VALID FROM<br>VALID TO
</td>
<td align="center" style="border-bottom:1px dotted #000;"><?=$ids[$i]['service_started_date']?><br><strong><?=$ids[$i]['service_end_date']?></strong></td>
</tr>
<tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
<td valign="top" width="100%" align="center" style="border-right:1px dotted #000;border-bottom:1px dotted #000;">Driver Contact No.<br>+91 <?=$ids[$i]['mobile']?></td>
...
1) Your Card remains the property of the Vendor and must be returned when you suspend, withdraw from, or complete your agreement(s) at the Vendor or your agreement is cancelled by the Vendor. 2) Your Card is not transferable. 3) You are responsible for use of your Card at all times. 4) You must keep your Card secure.
</td>
</tr>
</table>
</td></tr>
