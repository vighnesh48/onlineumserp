...
$object->getActiveSheet()->setCellValue('A2', 'Transport Cancelled Student Details for the academic year -'.$student_details[0]['academic_year']);	
...
$object->getActiveSheet()->setCellValue('J3', 'Transport Fee');
