...
<form action="<?php echo base_url()?>Challan_transport_report/download_modefor_today_pdf" id="exportpf" name="exportpf" method="post">
...
function common_call()
{
    ...
    type='POST',url='<?= base_url() ?>Challan_transport_report/challan_list_reportview';
