...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
			...
			<i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit Bus </h1>
                ...
                <div class="panel">
					...
					<?php if(!empty($this->session->flashdata('message2'))){ echo $this->session->flashdata('message2'); } ?>
                        ...
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/edit_bus_submit/'.$bus_details['bus_id'])?>" method="POST" onsubmit="return validate_faci_category(event)">    
							<div class="form-group">
									 ...
									 <?php 
											if(!empty($vendor_details)){
												foreach($vendor_details as $coursename){
													if($bus_details['vendor_id']==$coursename['vendor_id'])
												{
												?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" id="bno"  value="<?=$bus_details['bus_no']?>" name="bno" onblur="check_bus_exists()" class="form-control alphanum" />
                                    </div>                                    
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text"  value="<?=$bus_details['capacity']?>" id="capacity" name="capacity" class="form-control numbersOnly" />
                                    </div>                                    
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input value="<?=$bus_details['bus_company']?>" type="text" id="company" name="company" class="form-control" />
                                    </div>                                    
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input  value="<?=$bus_details['bus_model_no']?>" type="text" id="model" name="model" class="form-control" />
                                    </div>                                    
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                       <!-- <input  value="<?=$bus_details['manufacture_year']?>" type="text" id="myear" name="myear" class="form-control numbersOnly" />-->
								...
								<div class="form-group">
								 <label class="col-sm-2">Is Active:<?=$astrik?></label>
								 <div class="col-sm-3">
...
function validate_faci_category(events)
{
    ...
    $(document).ready(function()
    {
		var inhouse='<?=$bus_details['inhouse']?>';
		$('#inhouse option').each(function()
		{
			if($(this).val()== inhouse)
			{
		...
		var status='<?=$bus_details['is_active']?>';
		...
		var myear='<?=$bus_details['manufacture_year']?>';
		$('#myear option').each(function()
		{
			if($(this).val()== myear)
			{
				$(this).attr('selected','selected');
