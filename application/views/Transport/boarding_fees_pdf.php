...
<div align="center"  class="m" style="padding:20px;">
	...
	<p><h3 align="center"><u>Transport Fees - <?=$boardingfee_details[0]['academic_year']?>  (<?=$boardingfee_details[0]['campus']?> Campus)</u></h3></p>
    </td> 
   </tr>
</table>
</div>
...
<div align="center"  class="m" style="padding:20px;">
	...
	<table class="content-table" border="1">
		...
		for($i=0;$i<count($boardingfee_details);$i++)
		{
			...
			<tr>
			<td><?=$j?></td>
			<td><?=$boardingfee_details[$i]['boarding_point']?></td>
			<td><?=$boardingfee_details[$i]['fees']?></td>
			</tr>
			<?php
			$j++;
		}
