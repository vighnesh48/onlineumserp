	  ...
	  $(document).ready(function(){
         ...
         // alert("hi");
            ...
            $("#loader1").html('<div class="loader"></div>');
                $.ajax({
                    'url' : base_url + 'Transport/search_students_data',
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-5 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Transport Students List</h1>
           <div class="col-xs-12 col-sm-7">
                <div class="row">                    
                    <hr class="visible-xs no-grid-gutter-h">
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule.'/search_transport_students')?>"><span class="btn-label icon fa fa-plus"></span>Add New</a></div>                        
		      ...
		      <option value="SU">Sandip University</option>
			   ...
			   <ul class="nav nav-tabs">
					  ...
					  <div class="tab-content">
						...
						<form name="form" id="form" method="post" action="<?=base_url()?>Transport/export_allocated">	
				...
				<form name="form1" id="form1" method="post" action="<?=base_url()?>Transport/export_cancelled">	
