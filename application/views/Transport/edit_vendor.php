...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-5 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit Vendor</h1>
			 ...
			 <?php if(!empty($this->session->flashdata('message2'))){ echo $this->session->flashdata('message2'); } ?>
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/edit_vendor_submit/'.$vendor_details['vendor_id'])?>" method="POST" onsubmit="return validate_faci_category(event)" enctype="multipart/form-data">   
							...
							<input type="hidden" id="state" name="state"/>
								...
								<label >Select Campus:<?=$astrik?></label>
									...
									<div class="col-sm-3">
									<input type="text" id="vname" name="vname"  onblur="check_vendor_gst_exists()" value="<?=$vendor_details['vendor_name']?>" class="form-control alphaonly" placeholder="Vendor Name" />                                    
								...
								<div class="form-group">
									...
									<input type="text" id="cperson" name="cperson" value="<?=$vendor_details['contact_person']?>"  placeholder="Contact Person" class="form-control alphaonly"  />
									<span style="color:red;"><?php echo form_error('cperson');?></span>
									</div>
									...
									<div class="col-sm-3">
									<input type="text" id="pemail" name="pemail" value="<?=$vendor_details['email']?>"  placeholder="Email" class="form-control"  />
									
									<span style="color:red;"><?php echo form_error('pemail');?></span>
								...
								<label>Enter Mobile:<?=$astrik?></label>
									...
									<div class="col-sm-3">
									<input type="text" id="mobile"  value="<?=$vendor_details['mobile']?>" name="mobile" placeholder="Mobile" class="form-control"  />                                  
                                   <span style="color:red;"><?php echo form_error('mobile');?></span>
									...
									<div class="col-sm-3">
									<input type="text" id="office"  value="<?=$vendor_details['office_no']?>" name="office" placeholder="Office No" class="form-control"  />
									
									<span style="color:red;"><?php echo form_error('office');?></span>
									</div>
								</div>
								...
								<div class="form-group">
								   ...
								   <div class="col-sm-3">
									...
									<textarea class="form-control" id="address" name="address" > <?=$vendor_details['address']?></textarea>                                    
								   ...
								   <div class="col-sm-3">
									...
									<div class="col-sm-3">
									<input type="text" id="pincode"  value="<?=$vendor_details['pincode']?>" name="pincode" placeholder="Pincode" class="form-control"  />
							...
							<div class="form-group">
									...
									<input type="text" id="gst" value="<?=$vendor_details['gst_no']?>"  onblur="check_vendor_gst_exists()"  name="gst" placeholder="GST No" class="form-control"  />
							...
							<div class="col-sm-3">
								...
								<input type="text" class="form-control" value="<?=$vendor_details['service_end_year']?>"  id="doc-sub-datepicker22" placeholder="Start Date" name="sdate" readonly="true"/>
								...
								<input type="text" class="form-control" value="<?=$vendor_details['service_end_year']?>" id="doc-sub-datepicker23" placeholder="End Date" name="edate"  readonly="true"/>
...
{
	var id='<?=$vendor_details['vendor_id']?>';
	...
	$.ajax({
			...
			data: {campus:campus,vname:vname,id:id},
	...
	$.ajax({
		...
		data: {campus:campus,gst:gst,id:id},
		success: function (html) {
			  //alert(html);
			if(html>0)
...
$(document).ready(function(){
   ...
   .on('changeDate', function (e) {
	...
	var hstate_id='<?=$vendor_details['state_id']?>';
	var district_id='<?=$vendor_details['district_id']?>';
	//alert(district_id);
	var taluka_id='<?=$vendor_details['taluka_id']?>';
	$('#state').val('<?=$vendor_details['state']?>');
	$('#district').val('<?=$vendor_details['district']?>');
	$('#taluka').val('<?=$vendor_details['taluka']?>');
	...
	var campus='<?=$vendor_details['campus']?>';
	...
	var status='<?=$vendor_details['is_active']?>';
