    ...
    <div class="page-header">			
        <div class="row">
			...
			<div class="col-xs-12 col-sm-8">
                <div class="row"> 
                  <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/trip_entry_new")?>"><span class="btn-label icon fa fa-plus"></span>Entry </a></div>
        ...
        <div class="row ">
            <div class="col-sm-12">
                       ...
                       <table class="table table-bordered" style="width:100%;max-width:100%;">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr>
								...
								<td><?=$trip_details[$i]['noofstudent']?></td>
				...
				<div class="btn-group col-sm-2  pull-right" id="pdf">
					<form id="form" name="form" action="<?=base_url($currentModule.'/trip_details_pdfReports_new')?>" method="POST" >
					...
					<form id="form" name="form" action="<?=base_url($currentModule.'/trip_details_excelReports_new')?>" method="POST" >
...
function common_call()
{
	...
	$('#fdatepdf').val(fdate);
	$('#tdatepdf').val(tdate);
	type='POST',url='<?= base_url() ?>Transport/get_bus_trip_list_by_creteria_new';
...
function display_content(html_content)
{
	...
	else
	{
		...
		for(i=0;i<len;i++)
		{
			content+='<tr><td>'+j+'</td><td>'+array.trip_list[i].bus_no+'</td><td>'+array.trip_list[i].route_name+'</td><td>'+array.trip_list[i].trip_type+'</td><td>'+array.trip_list[i].noofstudent+'</td>';
