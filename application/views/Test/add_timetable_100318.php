                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-info">                            
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/update_timetable')?>" method="POST">  
							<?php }else{ ?>
							<form id="form" name="form" action="<?=base_url($currentModule.'/insert_timetable')?>" method="POST">  
							<?php }?>							
                              ...
                              <div class="col-sm-3" id="semest" >
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-3"><select id="batch_no" name="batch_no" class="form-control" required/>
										<option value="">Select</option>
