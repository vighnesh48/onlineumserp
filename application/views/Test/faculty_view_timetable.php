...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-calendar page-header-icon"></i>&nbsp;&nbsp;Lecture Time Table <?php
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
					...
					<div class="row">
					<form name="searchTT" id="searchTT" method="POST" action="<?=base_url()?>Test/downloadpdffaculty">
    ...
    <tbody>
       <tr>
            ...
            <th align="center" style="color:#FFF"><?=$listslot['from_time']?>
...
<form action="<?php echo base_url()?>Test/downloadpdffaculty" id="exportpf" name="exportpf" method="post">
