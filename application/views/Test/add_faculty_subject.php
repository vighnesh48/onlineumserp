							...
							<div class="form-group">
                               ...
                               <div class="form-group">                     
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2"><button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url($currentModule)?>/assign_faculty/<?=$sub[0]['stream_id']?>/<?=$sub[0]['semester']?>/<?=$sub[0]['division']?>/<?=$academicyear?>/<?=$sub[0]['course_id']?>'">Cancel</button></div>
