...
<script>    
...

    {
		...
		if(semesterId !=''){
			...
			var batch = '<?php if($courseId !=''){echo $courseId;}else{ echo $ttdet[0]['batch'];} ?>';
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-info">                            
							...
							<div class="col-sm-2">Academic year <?=$astrik?></div>
							  ...
							  <div class="col-sm-2">Batch <?=$astrik?></div>

                              <div class="col-sm-3" >

                                <select name="batch" id="batch" class="form-control" required <?=$disabled?>>
							...
							<div class="col-sm-2">Course <?=$astrik?></div>
                              ...
                              <div class="col-sm-3" >
                                ...
                                <select name="course_id" id="course_id" class="form-control" onchange="load_streams(this.value)" required <?=$disabled?>>
                              ...
                              <div class="col-sm-3" id="semest">
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-3">
                                        ...
                                        <select id="subject" name="subject" class="form-control" onchange="checkOfflecture()" <?=$disabled?>>
                                ...
                                <div class="form-group">
									...
									<label class="col-sm-2">Class Room</label>
