    ...
    <div class="page-header">			
        ...
        <div class="row ">
            <div class="col-sm-12">
				...
				<div class="row">
					<form name="searchTT" method="POST" action="<?=base_url()?>feedback/Factilywise_attendance_report">
                        ...
                        <div class="table-info">  
						    <div class="pull-right" style="margin-right: 15px;margin-bottom: 10px;">
							 ...
							 $stud_details1 = $academic_type.'~'.$academic_year.'~'.$school.'~'.$select_School;
									?>
									<button onclick="exportTableToCSV('Export_excel.csv')">Export To Excel</button><!--a href="<?=base_url()?>Feedback/Factilywise_report_pdf/<?=base64_encode($stud_details1)?>/<?=$fbcycle?>"style="color:red" title="PDF"><button ><i class="fa fa-file-pdf-o" aria-hidden="true"> PDF</i></button></a>&nbsp;&nbsp; &nbsp;-->
							...
							<thead>
							   <tr>
									...
									<th align="center"><b><span>Div</span></b></th>
									<th align="center"><b><span>Sem</span></b></th>
									<!--<th align="center"><span>Status</span></th>-->
									<th align="center"><b><span>#Stud Strength</span></b></th>
									<!--th align="center"><b><span>#Att >= 60%</span></b></th-->
									<th align="center"><b><span>#Submitted</span></b></th>
								...
								?>
									<tr>
										...
										<td><?php if($sb['class_studcnt'][0]['stud_id'] !=''){ echo count($sb['class_studcnt']);}?></td>
										<!--td><?php if(!empty($sb['fdappeared_studcnt'])){ echo count($sb['fdappeared_studcnt']);}?></td-->
...
<script>
	...
	var academic_year ="<?php echo $academicyear;?>";
		var school ="<?php echo $school;?>";
	if(academic_year!='' && school!='' )
	{
		if (academic_year) {
				$.ajax({
					type: 'POST',
					url: '<?= base_url() ?>feedback/load_school_details',
				data: {academic_year:academic_year,school:school},
				...
				$('#select_School').html('<option value="">Select Academic Year first</option>');
			}

	}
	
	
		$('#fbsession').on('change', function () {
			
			//var course_id = $(this).val();
			var academic_year = $("#fbsession").val();
