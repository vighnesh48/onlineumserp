...
<table width="100%" cellpadding="0" cellspacing="0" border="1" class="table time-table table-striped table-bordered" 
align="center" style="font-size:13px;margin:50px 50px">
