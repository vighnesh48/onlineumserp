                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
							  ...
							  <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
									<!--for update-->
									<input type="text" id="test_date" name="test_date" class="form-control" required>	
								...
								<div class="form-group">
								 <label class="col-sm-3">Min Marks<?=$astrik?></label>
									 ...
									 <div class="col-sm-3"><input type="text" id="min_for_pass" name="min_for_pass" class="form-control numbersOnly" value="" maxlength=3 required/></div>
								   	<label class="col-sm-3">Max Marks<?=$astrik?></label>
                                    <div class="col-sm-3">
									<input type="text" id="max_marks" name="max_marks" class="form-control numbersOnly" maxlength=3 required onblur="return checkMarks()">
