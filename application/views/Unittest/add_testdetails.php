...
<div class="container">
  ...
  <a href="<?=base_url($currentModule."/index/".$subj_Id)?>">
	...
	<div class="clearfix">&nbsp;</div>
		<div class="col-md-12">
			<div class="col-md-2">Test:</div><div class="col-md-2" style="align-left"> <?=$ut[0]['test_no']?></div>
  ...
  <div class="row detail-bg">
	...
	<input type="hidden" name="unit_test_id" value="<?=$ut[0]['unit_test_id']?>">
	<input type="hidden" name="subject_id" value="<?=$ut[0]['subject_id']?>">
    <table class="table table-bordered" style="WIDTH:400%">
	  ...
	  <tr>
		...
		<td><?=$stud['first_name']?> <?=$stud['last_name']?></td>
		 <td><input type="text" name="marks_obtained[]" class="numbersOnly" maxlength="3" value="<?=$td[$i]['marks_obtained']?>" required></td>
