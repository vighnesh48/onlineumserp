...
<div id="content-wrapper">
   ...
   ?>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;<?php if(empty($guide_det['acc_no'])){echo 'Add'; }else { echo 'Edit'; } ?> Guide Bank Details </h1>
        ...
        <div class="row ">
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                        <span class="panel-title"><?php if(empty($guide_det['acc_no'])){ echo 'Add'; }else { echo 'Edit'; } ?> Guide Bank Details</span>						
                    ...
                    <div class="panel-body">
                        <div class="table-info">                                                       
                            <form id="form" name="form" action="<?=base_url($currentModule.'/insert_guide_bank_details')?>" method="POST" enctype="multipart/form-data"> 
							 ...
							 <input type="hidden" name="bid" value="<?=$guide_det['bid']?>" />	
							<div class="form-group">  
							   ...
							   <label >Select Bank: <?=$astrik?></label>
                                 ...
                                 <option value="<?php echo $result['bank_id']?>"<?php if($guide_det['bank_id']==$result['bank_id']){echo 'Selected'; }?>><?php echo $result['bank_name'];?></option>
                                 <?php } ?>   
                              </select>
                                ...
                                <div class="col-sm-4">
									...
									<input type="text" id="acc_holder_name" name="acc_holder_name" class="form-control" placeholder="Enter Name" value="<?=isset($guide_det['acc_holder_name'])?$guide_det['acc_holder_name']:''?>" />
                                   <span style="color:red;"><?php echo form_error('acc_holder_name');?></span>								
                                </div>
								 <div class="col-sm-4">
                                   <label>Account No: <?=$astrik?></label>
									<input type="text" id="acc_no" name="acc_no" class="form-control" placeholder="Enter Account No." value="<?=isset($guide_det['acc_no'])?$guide_det['acc_no']:''?>" />
                                ...
                                <div class="col-sm-4">
									...
									<input type="text" id="ifsc_code" name="ifsc_code" class="form-control" placeholder="Enter IFSC Code" value="<?=isset($guide_det['ifsc_code'])?$guide_det['ifsc_code']:''?>" />
                                   <span style="color:red;"><?php echo form_error('ifsc_code');?></span>								
                                </div>
								 <div class="col-sm-4">
                                   <label>Branch : <?=$astrik?></label>
									<input type="text" id="branch" name="branch" class="form-control" placeholder="Enter Branch" value="<?=isset($guide_det['branch'])?$guide_det['branch']:''?>" />
                            ...
                            <div class="col-sm-1">
									 <?php if ($guide_det['cheque_file']): 
										$b_name = "uploads/phd_renumaration_files/";
										$dwnld_url = base_url()."Upload/download_s3file/".$guide_det['cheque_file'].'?b_name='.$b_name; ?>
							...
							<div class="form-group" ></div>
							 <div class="form-group" id="guide">
                                    <div class="col-sm-2">
                                       <button class="btn btn-primary form-control" id="btn_submit" type="submit" ><?php if(empty($guide_det['acc_no'])){ echo 'Submit'; }else { echo 'Update'; } ?></button>
                                    </div>                                    
