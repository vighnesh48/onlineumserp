...
//echo $academic_year;
  ...
  /*  function generateTreeView($items, $currentParent,$unitno,$topicno,$faculty,$subject, $currLevel = 0, $prevLevel = -1) {
        foreach ($items as $itemId => $item) {
            if ($currentParent == $item['parents']) {                       
