            ...
            <div class="col-sm-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
						...
						<form id="form" name="form" action="<?=base_url()?>lessonplan/add" method="POST">
...
/*echo $dayw.'--'.date("Y-m-d",  strtotime('+'.$i.' '.$dayw.''));
echo "<br/>";*/
							$lect_dates[] = date("Y-m-d",  strtotime('+'.$i.' '.$dayw.'',strtotime($new_date))); 
                            ...
                            <div class="form-group">   
	                            ...
	                            <div class="col-sm-2" >
	                                <select name="academic_year" id="academic_year" class="form-control" required>
	                                 ...
	                                 <?php foreach ($academic_year as $yr) {
	                            ...
	                            <div class="col-sm-2">
	                                <select name="topic_no" id="topic_no" class="form-control" required>
	                                  ...
	                                  <?php foreach ($topics as $topc) {
										$topic_val = $topc['unit_no'].'.'.$topc['topic_no'].'.'.$topc['topic_name'];
							...
							<label class="col-sm-2">Type details <?= $astrik ?></label>
	                           <div class="col-sm-2">
	                                <input type="text" name="topic_contents" id="topic_contents" class="form-control"> 
	                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2"><button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url()?>lessonplan'">Cancel</button></div>
