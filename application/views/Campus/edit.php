...
<?php
    ...
    //echo "<pre>"; print_r($campus_details); echo "</pre>";
?>
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit Campus</h1>
                    ...
                    <div class="panel-body">
                        <div class="table-info">
                            ...
                            <form id="form" name="form" action="<?=base_url($currentModule.'/submit')?>" method="POST">                                                               
                                <input type="hidden" value="<?=isset($campus_details['campus_id'])?$campus_details['campus_id']:""?>" id="campus_id" name="campus_id" />
                                <div class="form-group">
                                    <label class="col-sm-3">Campus Code <?=$astrik?></label>                                    
                                    <div class="col-sm-6"><input type="text" id="campus_code" name="campus_code" class="form-control" value="<?=isset($campus_details['campus_code'])?$campus_details['campus_code']:""?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="campus_name" name="campus_name" class="form-control" value="<?=isset($campus_details['campus_name'])?$campus_details['campus_name']:""?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="campus_state" name="campus_state" class="form-control" value="<?=isset($campus_details['campus_state'])?$campus_details['campus_state']:""?>" /></div>                                    
                                    <div class="col-sm-3"><span style="color:red;"><?php echo form_error('campus_state');?></span></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3">Campus City</label>
                                    <div class="col-sm-6"><input type="text" id="campus_city" name="campus_city" class="form-control" value="<?=isset($campus_details['campus_city'])?$campus_details['campus_city']:""?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="campus_address" name="campus_address" class="form-control" value="<?=isset($campus_details['campus_address'])?$campus_details['campus_address']:""?>" /></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" id="campus_pincode" name="campus_pincode" class="form-control" value="<?=isset($campus_details['campus_pincode'])?$campus_details['campus_pincode']:""?>" /></div>                                    
