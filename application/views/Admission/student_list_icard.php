         ...
         // alert("hi");
             var base_url = 'https://erp.sandipuniversity.com/';
                   ...
                   var admissioncourse = $("#admission-course").val();
                    ...
                    var admissionyear = $("#admission-year").val();
                ...
                $.ajax({
                    'url' : base_url + 'Ums_admission/load_studentlist_icard',
                    'type' : 'POST', //the way you want to send data to your URL
                    'data' : {'admission-course':admissioncourse,'admission-stream':admissionstream,'admission-year':admissionyear,'acyear':acyear,'academic_year':'2017'},
                    'success' : function(data){ //probably this request will return anything, it'll be put in var "data"
