...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Bonafied Certificate</h1>
            <div class="col-xs-12 col-sm-8">         <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule.'/bonafied_list/')?>"><span class="btn-label icon fa fa-back"></span> Back to Bonafied list</a></div> 
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title">Bonafied Certificate Form</span>
                    </div>
                        ...
                        <div class="table-info">                            
                            ...
                            <span id="bonafied_div" style="display:none;" >
                                ...
                                <div class="form-group">
                                    ...
                                    <hr>
                        <form id="form1" name="form1" action="<?=base_url($currentModule.'/bonafied_pdf')?>" method="POST">  
                       <input type="hidden" id="prn" name="prn" class="form-control" />
                         <input type="hidden" id="stud_id" name="stud_id" class="form-control" />
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4"><input type="text" class="form-control" name="reg" id="reg" placeholder="Reference No."></div>                                    
                                    <div class="col-sm-4"></div>   
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-2"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2"> <input type="text" class="form-control" name="idate" id="idate" placeholder=""></textarea></div>                                    
                                    <div class="col-sm-4"></div>   
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4"></div>
