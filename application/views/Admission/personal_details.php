      ...
      <div class="col-sm-12">
               ...
               <div class="xtable-info">
                  <div id="dashboard-recent" class="panel panel-warning">
                     ...
                     <div class="tab-content">
                        <form method="post" action="<?=base_url()?>Ums_admission/update_personalDetails/" enctype="multipart/form-data">
                        <div id="personal-details" class="setup-content widget-comments panel-body tab-pane fade active in">
                                    ...
                                    <label class="col-sm-3">Academic Year <?= $astrik ?></label>
                                        <div class="col-sm-3">
                                            <select id="acyear" name="acyear" class="form-control" required>
                                              <?php $selected ='';
                                                $startAcademicYear = getStartSuccessiveAcademicYear();
                                                foreach ($startAcademicYear as $year) {
                                                  $xyear = explode('-', $year);
                                                  /*if($emp_list[0]['academic_year'] == $xyear[0]) {
                                                     $selected = "selected";
                                                  }*/
												  if($xyear[0]==$emp_list[0]['academic_year']){ $selected = "selected='selected'";}else{$selected ='';}
                                                  echo "<option  value='".$xyear[0]."' ".$selected.">".$year."</option>";
                                                }
                                              ?>
                                            </select>
                                        </div>
                         ...
                         <input type="text" id="sgrn" name="sgrn" class="form-control" value="<?= isset($emp_list[0]['general_reg_no']) ? $emp_list[0]['general_reg_no'] : ''; ?>" placeholder="Student GRN Number" />
                              ...
                              <div class="col-sm-3">
                                      ...
                                      <select name="admission_type" id="admission_type" class="form-control" required disabled>
                              ...
                              <div class="col-sm-3">
                                ...
                                <input id="sfnumber" name="sfnumber" class="form-control" value="<?= isset($admission_details[0]['form_number']) ? $admission_details[0]['form_number'] : ''; ?>" placeholder="Admission Form Number " type="text">
                                    ...
                                    <div class="form-group">
                                       <label class="col-sm-3">Mother Name <sup class="redasterik" style="color:red">*</sup></label>
                                       <div class="col-sm-3">
                                          <input data-bv-field="sfname" id="sfname2" name="sfname2" class="form-control" value="<?= isset($emp_list[0]['mother_name']) ? $emp_list[0]['mother_name'] : ''; ?>" placeholder="First Name" type="text" required="required">
									   ...
									   <label class="col-sm-3">Student Name In Marathi <sup class="redasterik" style="color:red">*</sup></label>
                                       <div class="col-sm-3">
                                          <input data-bv-field="sfname" id="marathi_name" name="marathi_name" class="form-control" value="<?= isset($emp_list[0]['marathi_name']) ? $emp_list[0]['marathi_name'] : ''; ?>" placeholder="Marathi Name" type="text" required="required">
                                          <i data-bv-icon-for="sfname" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="sfname" data-bv-validator="notEmpty" class="help-block" style="display: none;">Marathi name should not be empty</small><small data-bv-result="NOT_VALIDATED" data-bv-for="sfname" data-bv-validator="regexp" class="help-block" style="display: none;">Marathi name should be alphabate characters</small><small data-bv-result="NOT_VALIDATED" data-bv-for="sfname" data-bv-validator="stringLength" class="help-block" style="display: none;">Marathi name should be 2-50 characters.</small> 
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="col-sm-3">Date of Birth <sup class="redasterik" style="color:red">*</sup></label>
                                       <div class="col-sm-3 date" id="dob-datepicker"> <div class="input-group">
                                          <input type="text" id="dob" name="dob" class="form-control"  value="<?= isset($emp_list[0]['dob']) ? $emp_list[0]['dob'] : ''; ?>" placeholder="Date of Birth" required="required"/>
                              ...
                              <div class="col-sm-3 ">
        <input type="text" id="pob" name="pob" class="form-control"  value="<?= isset($emp_list[0]['birth_place']) ? $emp_list[0]['birth_place'] : ''; ?>" placeholder="Place of Birth"  />
                                </div>
                                    </div>
                                    <div class="form-group">
                                 ...
                                 Transgender</label>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-3">
                                          <input type="text" id="mobile" name="mobile" value="<?= isset($emp_list[0]['mobile']) ? $emp_list[0]['mobile'] : ''; ?>" 
                                          class="form-control numbersOnly"  placeholder="contact no" maxlength="10" required />
                                       </div>
                                       <label class="col-sm-3">Email</label>
                                       <div class="col-sm-3">
                                          <input type="email" id="email_id" name="email_id" class="form-control"
                                           value="<?= isset($emp_list[0]['email']) ? $emp_list[0]['email'] : ''; ?>" placeholder="Email" />
                                       </div>
                                    </div>
                                    <div class="form-group">
									   ...
									   <select id="nationality" name="nationality" class="form-control">
											<option value="Indian" <?php if($emp_list[0]['nationality']=='Indian'){?> selected="selected"<?php }?>>Indian</option>
											<option value="INTERNATIONAL" <?php if($emp_list[0]['nationality']=='INTERNATIONAL'){?> selected="selected" <?php }?>>INTERNATIONAL</option>
										</select>
        ...
        <input type="text" id="subcaste" name="subcaste" class="form-control"  value="<?= isset($emp_list[0]['sub_caste']) ? $emp_list[0]['sub_caste'] : ''; ?>" placeholder="Sub Caste" />
                              ...
                              <div class="col-sm-3 date" id="doadd-datepicker">
                                ...
                                <input type="text" id="doadd" name="doadd" class="form-control"  value="<?= isset($emp_list[0]['admission_date']) ? $emp_list[0]['admission_date'] : ''; ?>" placeholder="Date of Admission" />
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span> </div></div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-3">
                                          <select id="res_state" name="res_state" class="form-control" >
                                             ...
                                             <?php
                                                ...
                                                elseif ($emp_list[0]['domicile_status'] == "PIO") {
                                                    $val3 = "selected";
                                                }elseif ($emp_list[0]['domicile_status'] == "FOR") {
                                                    $val4 = "selected";
                                                }
                                                ?>
                                             <option <?php
                                          ...
                                          <option  <?php echo $val4; ?>  value="FOR">FOR</option>
                                          </select>
                                       </div>
                                    </div>
          ...
          <input type="text" id="saadhar" value="<?= isset($emp_list[0]['adhar_card_no']) ? $emp_list[0]['adhar_card_no'] : ''; ?>" name="saadhar" class="numbersOnly form-control" >
									   ...
									   if($um_id=='3334'){ $readonly="";}else{ $readonly="disabled";} ?> 
                                       <label class="col-sm-3">Student&nbsp;Belongs&nbsp;To<?= $astrik ?></label>
                                       <div class="col-sm-3">
                                       <select id="belongs_to" name="belongs_to" class="form-control" required <?=$readonly?>>
                                       <option value="">Please select</option>
									   <option value="Package" <?php if($emp_list[0]['belongs_to']=='Package'){?> selected="selected"<?php }?>>Package</option>
									   <option value="Regular" <?php if($emp_list[0]['belongs_to']=='Regular'){?> selected="selected" <?php }?>>Regular</option>
										</select>
                                    </div>
									...
									<div class="form-group">
                                       ...
                                       <div class="col-sm-3"><input type="text" name="passport_no" id="passport" class="form-control"
                                        placeholder="passport No" value="<?= isset($emp_list[0]['passport_no']) ? $emp_list[0]['passport_no'] : ''; ?>"  
                                         title="Enter your Passport No"  /></div>
                                         
									   <label class="col-sm-3">Visa No<?= $astrik ?></label>
                                       
                                       <div class="col-sm-3"><input type="text" name="visa_no" id="visa_no" 
                                       class="form-control" placeholder="Visa No" value="<?= isset($emp_list[0]['visa_no']) ? $emp_list[0]['visa_no'] : ''; ?>"   title="Enter your Passport No"  /></div>
									...
									if($um_id=='3334'){ $readonly="";}else{ $readonly="disabled";}
									?> 
                                       <label class="col-sm-3">Transfer Case</label>
                                       <div class="col-sm-3">
                                          <select id="transefercase" name="transefercase" class="form-control" required <?=$readonly?>>
                                             <option value="">Select</option>
                                             <?php
                                                $val  = "";
                                                $val1 = "";
                                                if ($emp_list[0]['transefercase'] == "Y") {
                                                    $val = "selected";
                                                } elseif ($emp_list[0]['transefercase'] == "N") {
                                                    $val1 = "selected";
                                                }
                                                ?>
									    ...
									    <label class="col-sm-3">ABC No</label>
                                       <div class="col-sm-3">
                                          <input type="text" class="form-control col-md-5 creditCardText" name="abc_no" id="abc_no" minlength=15 maxlength=15 pattern="[0-9-]+" " placeholder="123-567-901-345" value="<?=$emp_list[0]['abc_no']?>" >
                                       </div>
                                    </div>
                                    <div class="form-group">
							  ...
							  <label class="col-sm-3">Knowledge Partner</label>
                              <div class="col-sm-3">
                                <select class="form-control" name="kp" id="kp" required>
                                      <option value="0~~0~~0">Select Knowledge Partner</option>
                                      <?php
                                        if(!empty($kps)){
                                            foreach($kps as $kp){
												$kp['partner_id'];
												if($kp['partner_id']==$emp_list[0]['kp_id']){
													$sel_kp="selected";
												}else{
													$sel_kp="";
												}
                                                ?>
                                              <option value="<?=$kp['partner_id'].'~~'.$kp['partnership_code'].'~~'.$kp['partner_short_name'];?>" <?=$sel_kp?>><?=$kp['partnership_code']?>-<?=$kp['partner_name']?></option>  
                                            <?php 
...
$(document).ready(function(){
	  <?php if($emp_list[0]['marathi_name']==''){ ?>
	$("#sfname").trigger('input');
  <?php } ?>
 ...
 <?php }  } ?>
  ...
  /////////// for perment address
    ...
    $('#dob-datepicker').datepicker( {format: 'dd-mm-yyyy',autoclose: true});
     $('#doadd-datepicker').datepicker( {format: 'yyyy-mm-dd',autoclose: true});
	...
	if(nationality=='Indian'){
	 ...
	 $('#sfname').on('change', function () {
   var fname=$("#sfname").val();
   	if (fname) {
			$.ajax({
				type: 'POST',
				url: '<?= base_url() ?>Ums_admission/fetch_marathi_fullname',
				data: { fname: fname},
				success: function (html) {
					//alert(html);
					if(html !=''){
					$('#marathi_name').val(html);
					}else{
					  $('#marathi_name').val();  
					}
				}
