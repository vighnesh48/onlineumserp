        ...
        <div class="panel">
          <div class="panel-body">
           <?php
              ...
              {
                 ?>
                   <div class="form-group"><span style="color:red"><strong>***Academic Fees for selected academic year and stram not Updated. Hence student can not be Confirmed Please contact finance section</strong></span>
                           </div>
...
?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3 date" id="dob-datepicker">
                                ...
                                <input type="text" id="dob" name="dob" class="form-control"  value="<?= isset($stud_det['dob']) ? date('d-m-Y',strtotime($stud_det['dob'])) : ''; ?>" placeholder="Date of Birth" required />
        ...
        <input type="text" id="pob" name="pob" class="form-control"  value="" placeholder="Place of Birth" />
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <input type="text" id="mobile" name="mobile" class="form-control numbersOnly" value="<?=$stud_det['mobile1']?>" placeholder="contact no" maxlength="10" onblur="return chek_mob_exist(this.value)" required />
                              </div>
...
?>
        ...
        <input type="text" id="subcaste" name="subcaste" class="form-control"  value="" placeholder="Sub Caste" />
                              ...
                              <div class="col-sm-3 date" id="doadd-datepicker">
                                  <div class="input-group">
                                <input type="text" id="doadd" name="doadd" class="form-control"  value="<?= isset($stud_det['doa']) ? date('d-m-Y',strtotime($stud_det['doa'])) : ''; ?>" placeholder="Date of Admission" required />
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span> </div></div>
                        ...
                        <div class="panel-body" style="font-size:12px!important">
                          <table class="table table-new">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                  <textarea id="laddress" class="form-control" NAME="laddress" style="margin: 0px; width: 200px; height: 50px;" required><?=$stud_det['address'] ?></textarea>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                  <INPUT TYPE="TEXT" class="form-control numbersOnly" id="lpincode" maxlength="6" NAME="lpincode" value="<?= $stud_det['pincode']?>" required>
                                </div>
                              </div>
                              </td>
                            <!--Permanent Address-->
                           ...
                           <tr>
                            ...
                            <tr>
                             ...
                             // var_dump($acfees);
                              ...
                              <td><input type="text" id="txt32" name="totalfeepaid" value="<?= isset($fee_det['amtpaid']) ? $fee_det['amtpaid'] : '' ?>" onblur="return cal_balance_left();" style="width:100px" readonly required></td>
