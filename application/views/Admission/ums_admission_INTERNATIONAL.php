...
<div id="content-wrapper">
  ...
  <div class="page-header">
    <div class="row">
      <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Admission Form International</h1>
...
<option value="2024" selected="selected">2024-25</option>
...
?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3 ">
        <input type="text" id="pob" name="pob" class="form-control"  value="<?= isset($personal[0]['dob']) ? $personal[0]['dob'] : ''; ?>" placeholder="Place of Birth" />
                                </div>
                                ...
                                <!--<select  class="form-control" name="nationality" id="nationality">
                                                  <option value="">Select</option>
                                                   <option value="Indian" selected="selected">Indian</option>
                                                    ...
                                                    INTERNATINTERNATIONALION
                                                  </select> -->
                                <input type="text" id="nationality" name="nationality" class="form-control" value="INTERNATIONAL" placeholder="" />
                              </div>
...
?>
                                ...
                                <div class="col-sm-3">Mandatory minimum documents varify</div>
                               <div class="col-sm-2">&nbsp;&nbsp;YES&nbsp;&nbsp;<input type="radio" name="Mandatory" id="Mandatory" value="Y" 
                               <?php if($emp_list[0]['docuemnt_confirm']=="Y"){ ?> checked="checked"<?php } ?>/>&nbsp;&nbsp;No&nbsp;&nbsp;<input type="radio" name="Mandatory" id="Mandatory"  value="N" <?php if(isset($emp_list[0]['docuemnt_confirm'])){ if($emp_list[0]['docuemnt_confirm']=="N"){ ?> checked="checked"<?php }}else{ ?>checked="checked"<?php } ?>   />
                          ...
                          <table class="table table-bordered">
                           ...
                           <tr>
                            ...
                            <tr>
                              ...
                              <td><input type="text" id="txt32" name="totalfeepaid" value="<?= isset($fee[0]['totalfeepaid']) ? $fee[0]['totalfeepaid'] : '' ?>" onblur="return cal_balance_left();" style="width:100px" readonly required></td>
                           <td><input type="text" id="txt33" name="totalfeebal" value="<?= isset($fee[0]['totalfeeappli']) ? $fee[0]['totalfeeappli'] : '' ?>"  readonly></td>
    ...
    //  alert(acyear);
        if (strm_id && acyear && admission_type) {
            $.ajax({
                ...
                data: {'strm_id' : strm_id,'acyear':acyear,'admission_type':admission_type},//'strm_id=' + strm_id + 'acyear=' + acyear,
                success: function (resp) {
                    //alert(resp)
