...
<td valign="top">
    ...
    <?php
                                     ...
                                     //  echo $tep;
                                     /*  if (file_exists('uploads/2017-18/'.$ids[$i]['form_number'].'/'. $ids[$i]['form_number'].'_PHOTO.bmp')) {
                                        //  echo "****************";
                                           $ext = 'bmp';
                                       }
                                       else
   ...
   <!-- <img src="https://erp.sandipuniversity.com/uploads/2017-18/<?=$ids[$i]['form_number']?>/<?=$ids[$i]['form_number']?>_PHOTO.<?=$ext?>" alt="" width="60"/>-->
