  ...
  $object->getActiveSheet()->getStyle('A1:I'.$x)->applyFromArray($styleArray);    
   ...
   exit(); 
                   ...
                   $this->load->library("excel");
	                ...
	                $object->getActiveSheet()->setCellValue('S4', 'Blodd Group');
...
$exm = $row['last_exam']['degree_type']." ".$row['last_exam']['degree_name']." ".$row['last_exam']['passing_year'];
$mrk =$row['last_exam']['total_marks']."-".$row['last_exam']['out_of_marks'];
   $per =$row['last_exam']['percentage'] ;                    
         $board_uni_name= $row['last_exam']['board_uni_name'] ;               
