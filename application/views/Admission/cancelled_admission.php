                                  ...
                                  $("#stream_name").html(jdata.stream_name);
                                    ...
                                    $("#acyear").html(jdata.academic_year);
                                     ...
                                     $("#stud_id").val(jdata.stud_id);
                                       ...
                                       {
                                            var lin ='<div style="color:red">Student is already promoted</div>';
                                       }
                                       ...
                                       {  
                                            ...
                                            {
                                                 var stat='Y';
                                                var lin ='<a href="'+base_url+'ums_admission/reregistration_Cancelled/'+sid+'/'+stat+'"> <button class="btn btn-primary form-control" id="btn_prn" type="button" >Cancelled Admission </button> </a>';
                                            }
                                        }
                                       else
                                       {
                                        var lin ='<a href="'+base_url+'ums_admission/reregistration_details/'+sid+'"> <button class="btn btn-primary form-control" id="btn_prn" type="button" >Cancelled Admission </button> </a>';
                                       }
                                     //$("#rereg").html(lin);
...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Student Cancelled Admission</a></li>
    </ul>
    <div class="page-header">           
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Cancelled Admission</h1>
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title">Cancelled Admission</span>
                            <span class="panel-title" style=" float:right"><a href="https://erp.sandipuniversity.com/ums_admission/cancelled_admission_list" target="_blank">Cancelled Admission List</a></span>
                    </div>
                    <div class="panel-body">
                        <div class="table-info">                            
                                ...
                                <hr>
                                <form action="reregistration_Cancelled" method="post" name="" id="" >
                            <div id="bonafied_div" style="display:none;" >
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4"><textarea name="remark" id="remark"></textarea></div>                                    
                                    <div class="col-sm-3"></div>
                                   
                                </div>
                                <input type="hidden" name="prn" id="prn" value="" />
                                <input type="hidden" name="stud_id" id="stud_id" value="" />
                                 <div class="form-group" >
                                  <div class="col-sm-4"></div>
                                   <div class="col-sm-2" id="rereg"><button class="btn btn-primary form-control" id="btn_prn" type="submit" >Cancelled Admission </button></div>
