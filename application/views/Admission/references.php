               ...
               <div class="xtable-info">
                  <div id="dashboard-recent" class="panel panel-warning">
                     ...
                     <div class="tab-content">
                        <form method="post" action="<?=base_url()?>Ums_admission/update_refDetails" enctype="multipart/form-data">
                        <!--start  of references -->
                           ...
                           <tr class="concernid">
                              ...
                              <select name="cin" id="cin">
                                ...
                                <tr>
								 ...
								 <tr>
								<td><label>Consultant name:</label>
								&nbsp;&nbsp;&nbsp;&nbsp;
								
								<select type="text" name="Consultantname" id="Consultantname">
								 ...
								 <?php if(!empty($consultants)){
									 ...
									 ?>
										 <option value="<?=$con['employee_code']?>"
										 <?php
										 if( !empty($is_reference[0]['Consultantname']) && $is_reference[0]['Consultantname']==$con['employee_code'])
										 {
											echo "selected";
										} 
										?>
										 ...
										 ><?=strtoupper($con['contact_person']);?>-<?=$con['mobile_no']?></option>
								<?php }
