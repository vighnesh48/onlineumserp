               ...
               <div class="xtable-info">
                  <div id="dashboard-recent" class="panel panel-warning">
                     ...
                     <div class="tab-content">
                        <form method="post" id="upload_form" action="<?=base_url()?>phd_admission/updateEducation" enctype="multipart/form-data">
...
?>
                                    ...
                                    <td><input type="text" name="percentage[]" class="form-control" value="<?= isset($var['percentage']) ? $var['percentage'] : '' ?>" placeholder="" required/></td>
                                     <td><input type="file" class="userfile" name="sss_doc[]" id="sss_doc" style="width:80px" onchange="validatefile()" > <br><a href="<?= site_url() ?>Upload/get_document/<?=$var['file_path'];?>?b_name=uploads/student_document/<?php echo $student_year.'/';?>" target="_blank"> <?= isset($var['file_path']) ? $var['file_path'] : '' ?></a></td>
                                   <td></td>
                                  </tr>
								<?php $j++;}
									}
...
?>
                                    ...
                                    <td><input type="text" name="percentage[]" class="form-control" value="<?= isset($_REQUEST['percentage']) ? $_REQUEST['percentage'] : '' ?>" placeholder="" /></td>
                                     <td><input type="file" name="sss_doc[]" class="userfile" id="sss_doc" onchange="validatefile()" style="width:80px"></td>
                         ...
                         <div class="row">
							...
							<div class="col-sm-6">
								 ...
								 <div class="form-group" id="enrol_div" style="display:none">
									 <label class="col-sm-4">Enrollment Number: </label>
									 <div class="col-sm-5">
...
?>
                    ...
                    <div class="form-group">
                     ...
                     <div class="col-sm-2">
                    <button class="btn btn-primary nextBtn form-control" id="" type="submit">Update</button>
                    </div>
