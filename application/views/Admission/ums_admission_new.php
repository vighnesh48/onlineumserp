...
?>
        ...
        <input type="text" id="pob" name="pob" class="form-control"  value="<?= isset($personal[0]['dob']) ? $personal[0]['dob'] : ''; ?>" placeholder="Place of Birth" />
                            ...
                            <div class="form-group">
                              ...
                              <label class="col-sm-3">Category <?php // $astrik ?></label>
                              <div class="col-sm-3">
...
?>
        ...
        <input type="text" id="subcaste" name="subcaste" class="form-control"  value="" placeholder="Sub Caste" />
                              ...
                              <label class="col-sm-3">Date of Admission <?php // $astrik ?></label>
                              <div class="col-sm-3 date" id="doadd-datepicker">
                                  <div class="input-group">
                                <input type="text" id="doadd" name="doadd" class="form-control"  value="" placeholder="Date of Admission"  />
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span> </div></div>
                            ...
                            <div class="form-group">
                              <label class="col-sm-3">Religion <?php // $astrik ?></label>
                              <div class="col-sm-3">
                      ...
                      <div class="panel">
                        ...
                        <div class="panel-body" style="font-size:12px!important">
                          <table class="table table-new">
                            ...
                            <td width="47%">
                            <div class="form-group">
                                <label  class="col-sm-3">Address: <?php //$astrik?></label>
                                <div class="col-sm-6">
                                  <textarea id="laddress" class="form-control" NAME="laddress" style="margin: 0px; width: 200px; height: 50px;" ></textarea>
                                </div>
                              </div>
<div id="ladd">
                              <div class="form-group">
                                <label  class="col-sm-3">State: <?php ///$astrik?></label>
                                <div class="col-sm-6">
                              ...
                              <div class="form-group">
                                <label  class="col-sm-3">District: <?php //$astrik?></label>
                                <div class="col-sm-6">
                              ...
                              <div class="form-group">
                                <label  class="col-sm-3">City: <?php //$astrik?></label>
                                <div class="col-sm-6">
                              ...
                              <div class="form-group">
                                <label  class="col-sm-3">Pin Code: <?php //$astrik?></label>
                                <div class="col-sm-6">
                                  <INPUT TYPE="TEXT" class="form-control numbersOnly" id="lpincode" maxlength="6" NAME="lpincode" value="" >
                                </div>
                              </div></div>
                              </td>
                            <!--Permanent Address-->
