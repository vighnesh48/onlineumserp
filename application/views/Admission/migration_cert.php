...
$(document).ready(function() {
    ...
    $('#example').DataTable( {
        ...
        buttons: [
            {
                extend: 'excel',
                messageTop: '<?="Migration Certificate List"?>.',
				filename: 'Migration Certificate List'
            },
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp; Migration Certificate List</h1>
            <div class="col-xs-12 col-sm-8">
                                 
                    <hr class="visible-xs no-grid-gutter-h">
                                        <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule.'/add_migration_cert/')?>"><span class="btn-label icon fa fa-plus"></span>Add Migration Certificate</a></div>                        
              ...
              <select class="form-control" name="acyear" id="acyear">
                ...
                <div class="col-sm-2"><button class="btn btn-primary form-control" id="search" type="submit">Search</button></div>
                        ...
                        <td><?=$j?></td>
                                 ...
                                 <td><?=$emp_list['tc_no']?></td> 
                                <td><?=$emp_list['cert_date']?></td>  
                              
                                    
                      <td><a href="<?=base_url($currentModule.'/regenerate_migration_cert/'.$emp_list['mgc_id'].'/'.$emp_list['enrollment_no'])?>" target="_blank" class="btn btn-primary btn-sm">view </a></button> </td> 
