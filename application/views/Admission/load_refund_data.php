...
?>
 <table class="table table-bordered" id="table2excel">
                        ...
                        //    }
                            ?>        
                            	<tr><td colspan="5" align="center"><input type="button" name="Make Refund" id="pmnt" value="Make Refund" class="btn btn-primary" /></td></tr>
                        </tbody>
                    </table>  
            <?php
}
                     ...
                     <!-- <input type="submit" value="Apply Fees" class="btn btn-primary btn-labeled">-->
                       ...
                       <div class="panel" id="makepmnt" style="display:none">
                            <div class="panel-heading">
								...
								<form name="makePayment" id="makePayment" onsubmit="" method="POST" action="<?=base_url()?>ums_admission/pay_refund" enctype="multipart/form-data">
								<?php
