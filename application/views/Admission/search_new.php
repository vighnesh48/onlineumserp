             ...
             var base_url = 'https://erp.sandipuniversity.com/';
                   ...
                   var prn = $("#prn").val();
                    ...
                    var fname = $("#fname").val();
                     ...
                     if(prn=='' && mobile==''    && fname==''  && mname=='' && lname=='')
                    {
                ...
                $.ajax({
                    ...
                    'data' : {'prn':prn,'mobile':mobile,'mname':mname,'lname':lname,'hide':'hide'},
                ...
                <div class="panel">
                    <div id="dashboard-recent" class="panel panel-warning">        
                     <div class="panel-heading">
                      ...
                      <div class="col-sm-3"><input type="text" class="form-control" name="prn" id="prn" placeholder="Student PRN No."></div>
