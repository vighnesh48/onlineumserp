...
$(document).ready(function() {
     $('#btn_prn').click(function(){
          ...
          //    var acyear = $("#acyear").val();
                ...
                $.ajax({
                    'url' : base_url + 'Ums_admission/verifyprn_bonafide1',
                        ...
                        if(data){
                            ...
                            //  alert(data); 
                               // container.html("PRN Number Does not exists");
                                 $('#errordiv').html("You can not do Re-registration of this students. kindly contact to student section.");
                                  ...
                                  $("#stream_name").html(jdata.stream_name);
                                    ...
                                    $("#acyear").html(jdata.academic_year);
                                     $("#prn").val(jdata.enrollment_no);
                                       ...
                                       var d = new Date();
                                       var n ='<?=C_RE_REG_YEAR?>';// d.getFullYear();
                                     //alert(n);
                                       ...
                                       {  
                                            ...
                                            {
                                                 var stat='Y';
                                                var lin ='<a href="'+base_url+'ums_admission/reregistration_details/'+sid+'/'+stat+'"> <button class="btn btn-primary form-control" id="btn_prn" type="button" >Reregister Student </button> </a>';
                                            }
                                        }
                                       else
                                       {
                                        var lin ='<a href="'+base_url+'ums_admission/reregistration_details/'+sid+'"> <button class="btn btn-primary form-control" id="btn_prn" type="button" >Reregister Student </button> </a>';
                                       }
                                     $("#rereg").html(lin);
...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Student Re-registration</a></li>
    </ul>
    <div class="page-header">           
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Re-registration</h1>
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title">Re-registration</span>
                    </div>
