...
$(document).ready(function() {
     $('#btn_prn').click(function(){
          ...
          //    var acyear = $("#acyear").val();
                ...
                $.ajax({
                    'url' : base_url + '/Ums_admission/check_deregistration',
                                  ...
                                  $("#stream_name").html(jdata.stream_name);
                                    ...
                                    $("#stud_id").val(jdata.stud_id);
                                      ...
                                      /* if(n==jdata.academic_year)
                                       ...
                                       {
										    if(jdata.academic_year==n){
                                        var lin ='<a href="'+base_url+'ums_admission/De_reregistration_details/'+sid+'"> <button class="btn btn-primary form-control" id="btn_prn" type="button" >De-Reregister</button> </a>';
...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Student De-Reregistration</a></li>
    </ul>
    <div class="page-header">           
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;DeReregistration</h1>
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title">De-Reregistration</span>
                    </div>
