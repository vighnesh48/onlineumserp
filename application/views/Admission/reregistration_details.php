...
<ul class="breadcrumb breadcrumb-page">
   ...
   <li class="active"><a href="#">Re-registration Form</a></li>
</ul>
<div class="page-header">
   <div class="row">
      <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Re-registration Form</h1>
   ...
   <div class="row ">
      <div class="col-sm-12">
               ...
               <div class="xtable-info">
                  <div id="dashboard-recent" class="panel panel-warning">
                     ...
                     <div class="tab-content">
                        <form method="post" action="<?=base_url()?>Ums_admission/reregistration_details/<?=$emp_list[0]['stud_id']?>" enctype="multipart/form-data">
                        <div id="personal-details" class="setup-content widget-comments panel-body tab-pane fade active in">
                          ...
                          <?php
                          if($feedetj[0]['total_fees']=='')
                          {
                          ?>
                           <div class="form-group"><span style="color:red"><strong>***Academic Fees for selected academic year not Updated. Hence student can not be reregistered</strong></span>
                           </div>
                              <?php
                          }
                              ?>
                              ...
                              <div class="col-sm-3">
                                ...
                                <!--  <option value="">Select Academic Year</option>
                                 ...
                                 <!--<option value="<?=$emp_list[0]['academic_year']+1?>"><?=$emp_list[0]['academic_year']+1?>-<?php  echo  substr($emp_list[0]['academic_year'],-2) + 2;  ?></option>-->
								 <!--option value="2018">2018-19</option> <option value="2019">2019-20</option>
                                 <option value="2020">2020-21</option-->
                                 <option value="<?=C_RE_REG_YEAR?>" selected="selected"><?=RE_REG_YEAR?></option>
                                 <!--   <option value="2018">2018-19</option>-->
                                     ...
                                     <label class="col-sm-3">PRN <?= $astrik ?></label>
                          
                               
                                <label class="col-sm-3"> <?= $emp_list[0]['enrollment_no'] ?></label>
                              ...
                              <div class="col-sm-3">
                                   ...
                                   <option value="1" <?php if($emp_list[0]['admission_year']==1){echo "selected";} ?>>First Year</option>
                                    <option value="2" <?php if($emp_list[0]['admission_year']==2){echo "selected";} ?>>Lateral Entry</option>
                                ...
                                <div class="form-group">
                                      <label class="col-sm-3">Admission Form Number <sup class="redasterik" style="color:red">*</sup></label>
                              <div class="col-sm-3">
                               
                                <input id="sfnumber" name="sfnumber" class="form-control" value="" placeholder="Admission Form Number "  type="text" required="">
                                <input type="hidden" id="isdetained" name="isdetained" class="form-control" value="<?php echo $stau; ?>" placeholder=""  type="text" required="">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-3">
                                           ...
                                           <input type="hidden" name="hacyear" value="<?php echo $emp_list[0]['academic_year'];  ?>">
                                           <input type="hidden" name="hcsem" value="<?php echo $emp_list[0]['current_semester'];  ?>">
                                           <input type="hidden" name="hcyear" value="<?php echo $emp_list[0]['current_year'];  ?>">
                                            <input type="hidden" name="henroll" value="<?php echo $emp_list[0]['enrollment_no'];  ?>">
                                             <input type="hidden" name="hstream" value="<?php echo $emp_list[0]['admission_stream'];  ?>">
                                           <input type="hidden" name="hschool" value="<?php echo $emp_list[0]['admission_school'];  ?>">
                                           <input type="hidden" name="admission_cycle" value="<?php echo $emp_list[0]['admission_cycle'];  ?>">
                                          <input data-bv-field="slname" id="slname" name="slname" class="form-control" value="<?= isset($emp_list[0]['last_name']) ? $emp_list[0]['last_name'] : ''; ?>" placeholder="Last Name" type="text" >
                                       </div>
                                       <div class="col-sm-3">
                                          <input data-bv-field="sfname" id="sfname" name="sfname" class="form-control" value="<?= isset($emp_list[0]['first_name']) ? $emp_list[0]['first_name'] : ''; ?>" placeholder="First Name" type="text" >
                                       </div>
                                       <div class="col-sm-3">
                                          <input data-bv-field="smname" id="smname" name="smname" class="form-control" value="<?= isset($emp_list[0]['middle_name']) ? $emp_list[0]['middle_name'] : ''; ?>" placeholder="Middle Name" type="text" >
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label class="col-sm-3">Father's/Husband Name <?= $astrik ?></label>
                                       <div class="col-sm-3">
                                          <input data-bv-field="slname" id="slname1" name="slname1" class="form-control" value="<?= isset($emp_list[0]['father_lname']) ? $emp_list[0]['father_lname'] : ''; ?>" placeholder="Last Name" type="text" >
                                       </div>
                                       <div class="col-sm-3">
                                          <input data-bv-field="sfname" id="sfname1" name="sfname1" class="form-control" value="<?= isset($emp_list[0]['father_fname']) ? $emp_list[0]['father_fname'] : ''; ?>" placeholder="First Name" type="text" >
                                       </div>
                                       <div class="col-sm-3">
                                          <input data-bv-field="smname" id="smname1" name="smname1" class="form-control" value="<?= isset($emp_list[0]['father_mname']) ? $emp_list[0]['father_mname'] : ''; ?>" placeholder="Middle Name" type="text">
                                       </div>
                                    </div>
                                    <div class="form-group">
        ...
        <input type="text" id="pob" name="pob" class="form-control"  value="<?= isset($emp_list[0]['birth_place']) ? $emp_list[0]['birth_place'] : ''; ?>" placeholder="Place of Birth" required />
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-3">
										<select id="nationality" name="nationality" class="form-control">
											<option value="Indian" <?php if($emp_list[0]['nationality']=='Indian'){ echo 'selected';}?>>Indian</option>
											<option value="INTERNATIONAL" <?php if($emp_list[0]['nationality']=='INTERNATIONAL'){ echo 'selected';}?>>INTERNATIONAL</option>
										</select>
									...
									<div id="show_indian_fields" class="hidden">
                                    <div class="form-group">
									...
									<div id="show_non_indian_fields" class="hidden">
									<div class="form-group">
                                       <label class="col-sm-3">Passport No<?= $astrik ?></label>
                                       <div class="col-sm-3"><input type="text" name="passport_no" id="passport" class="form-control" placeholder="passport No" value="<?= isset($emp_list[0]['passport_no']) ? $emp_list[0]['passport_no'] : ''; ?>"   title="Enter your Passport No"  /></div>
									   <label class="col-sm-3">Visa No<?= $astrik ?></label>
                                       <div class="col-sm-3"><input type="text" name="visa_no" id="visa_no" class="form-control" placeholder="Visa No" value<?= isset($emp_list[0]['visa_no']) ? $emp_list[0]['visa_no'] : ''; ?>"   title="Enter your Passport No"  /></div>
                                    ...
                                    <tr>
                                       ...
                                       <td width="47%">
                                          <div class="form-group">
                                             ...
                                             <div class="col-sm-6">
                                                <textarea id="laddress" class="form-control" NAME="laddress" style="margin: 0px; width: 200px; height: 50px;" ><?= isset($local_address[0]['address']) ? $local_address[0]['address'] : ''; ?></textarea>
                                             </div>
                                          </div>
                                          <div class="form-group">
                                                   ...
                                                   <?php
                                                      if(!empty($states)){
                                                          foreach($states as $stat){
                                                              ?>
                                                   <option value="<?=$stat['state_id']?>" <?php if($stat['state_id'] == $local_address[0]['state_id']){echo "selected";} ?> ><?=$stat['state_name']?></option>
                                                   <?php 
                                                      }
                                                      }
                                                      ?>
                                              ...
                                              ?>
                                                <select class="form-control" name="ldistrict_id" id="ldistrict_id" >
                                                      ...
                                                      if(!empty($localdistrict)){
                                                          foreach($localdistrict as $stat){
                                                              ?>
                                                   <option value="<?=$stat['district_id']?>" <?php if($stat['district_id'] == $local_address[0]['district_id']){echo "selected";} ?> ><?=$stat['district_name']?></option>
                                                   <?php 
                                                      }
                                                      }
                                                      ?>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-sm-6">
                                                <select class="form-control" name="lcity" id="lcity">
                                                     <?php
                                                      if(!empty($localcity)){
                                                          foreach($localcity as $stat){
                                                              ?>
                                                   <option value="<?=$stat['taluka_id']?>" <?php if($stat['taluka_id'] == $local_address[0]['city']){echo "selected";} ?> ><?=$stat['taluka_name']?></option>
                                                   <?php 
                                                      }
                                                      }
                                                      ?>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-sm-6">
                                                <INPUT TYPE="TEXT" class="form-control numbersOnly" id="lpincode" NAME="lpincode" value="<?= isset($local_address[0]['pincode']) ? $local_address[0]['pincode'] : ''; ?>">
                                             </div>
                                          </div>
                                       </td>
                                       <!--Permanent Address-->
                                       <td width="50%">
                                          <div class="form-group">
                                             <label  class="col-sm-3">Address: <?=$astrik?></label>
                                             <div class="col-sm-6">
                                                <textarea id="paddress" class="form-control" NAME="paddress" style="margin: 0px; width: 200px; height: 50px;" ><?= isset($perm_address[0]['address']) ? $perm_address[0]['address'] : ''; ?></textarea>
                                             </div>
                                          </div>
                                          <div class="form-group">
                                             <label  class="col-sm-3">State: <?=$astrik?></label>
                                          ...
                                          <div class="form-group">
                                             <label  class="col-sm-3">Pin Code: <?=$astrik?></label>
                                             <div class="col-sm-6">
                                                <INPUT TYPE="TEXT" class="form-control numbersOnly" id="ppincode" NAME="ppincode" value="<?= isset($perm_address[0]['pincode']) ? $perm_address[0]['pincode'] : ''; ?>" >
                                             </div>
                                          </div>
                                       </td>
                                    </tr>
                           ...
                           <div class="panel">
						    ...
						    <div class="panel">
                              <div class="panel-heading">Fees Details
                                 <?= $astrik ?>
                              </div>
                              <div class="panel-body">
                            ...
                            <tr>
                              ...
                              <?php
                              //var_dump($feedetj);
							  if($emp_list[0]['belongs_to']=='Package'){
								$total_fees = $package[0]['total_fees']; 
							  }else{
								$total_fees = $feedetj[0]['total_fees'];   
							  }
							  //echo 'canc='. $canc_charges['canc_amount'];
                              $opbal = $admission_details[0]['applicable_fee']+$canc_charges['canc_amount'] + $admission_details[0]['opening_balance']+$total_fees_refund[0]['fees_refund']- $total_fees_paid[0]['tot_fee_paid'];
							 // echo $opbal;
                              ?>
                              <td><input type="text" id="txt_acd" name="acd_totalfee" value="<?= isset($total_fees) ? $total_fees : ''; ?>" style="width:100px" required class="readonly" ></td>
							<td>
							    <input type="text" id="txt32" name="open_bal" value="<?php /*if($opbal>0){echo $opbal;} else{echo 0;}*/ echo $opbal; ?>"
							    style="width:100px" readonly="" required=""></td>
							 <!-- <td><input type="text" id="txt_exempt" name="exepmted_fee" value="" onkeyup="sub3();" style="width:100px" readonly=""></td>
                              <td><input type="text" id="txt31" name="totalfeeappli" value="<?= isset($admission_details[0]['applicable_fee']) ? $admission_details[0]['applicable_fee'] : ''; ?>" onkeyup="sub3();" style="width:100px" readonly=""></td>
                             <!-- <td><input type="text" id="txt32" name="totalfeepaid" value="" onblur="return cal_balance_left();" style="width:100px" readonly="" required=""></td>
                           <td><input type="text" id="txt33" name="totalfeebal" value="" readonly=""></td>-->
                         
                           
                             <!-- <td><input type="text" id="txt33" name="totalfeebal" value="" onkeyup="sub3();" style="width:100px" readonly></td>
                          -->  </tr>
                          <?php
                          if($feedetj[0]['total_fees']=='')
                          {
                          ?>
                          <tr>
                              <td colspan="3"><span style="color:red"><strong>***Academic Fees for selected academic year not Updated. Hence student can not be reregistered</strong></span></td>
                              </tr>
                              <?php
                          }
                              ?>
...
$(document).ready(function(){
  ...
  /////////// for perment address
	...
	var nationality = "<?=$emp_list[0]['nationality']?>";
	if(nationality=='Indian'){
		$("#show_non_indian_fields").addClass('hidden');
		$("#show_indian_fields").removeClass('hidden');
	}else{
		$('#pstate_id').prop('required',false);
			$('#pdistrict_id').prop('required',false);
			$('#pcity').prop('required',false);
			$("#show_non_indian_fields").removeClass('hidden');
			$("#show_indian_fields").addClass('hidden');
	}
