                    ...
                    <div class="panel-body">
                        <div class="table-info">
                            ...
                            <div class="form-group">
							  ...
							  <div class="form-group">
							<label class="col-sm-2">Change Stream <?= $astrik ?></label>
                              <div class="col-sm-3" >
                               <select name="admission_stream" id="admission_stream" class="form-control" required>
								...
								<?php if($stud_acd_yr >=$curr_year || $curr_year = $stud_acd_yr+1){?>
                                   <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-2"><button class="btn btn-primary form-control" id="btn_cancel" type="button" onclick="window.location='<?=base_url()?>phd_admission/stud_list'">Cancel</button></div>
