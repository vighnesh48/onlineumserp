                  ...
                  <div id="dashboard-recent" class="panel panel-warning">
                    <div id="errors" style="color:red;"></div>
                     ...
                     <div class="tab-content">
                        <form method="post" id="upload_form" action="<?=base_url()?>phd_admission/update_docDetails" enctype="multipart/form-data">
        ...
        ?>
                                  ...
                                  <!-- <td><select name="dapplicable[<?= $doc['document_id'] ?>]">
                                       ...
                                       <!-- <td><div class="form-group">
                                        ...
                                        <td><input type="file"  class="userfile" onchange="validatefile()" name="scandoc[<?= $doc['document_id'] ?>]"> <?php if($doc['doc_path']!=''){echo $doc['doc_path'];}  ?></td>
                                        <td>
										                        <?php
