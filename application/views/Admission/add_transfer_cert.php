     ...
     $('#form1').submit(function(){
                   var prn = $("#prn").val();
                     ...
                     if(prn=='')
                    {
                     ...
                     if(conduct=='')
                    {
                        alert("Please Enter Conduct of Student ");
                        return false;
                    }
...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Transfer Certificate</h1>
            <div class="col-xs-12 col-sm-8">         <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule.'/transfer_certificate/')?>"><span class="btn-label icon fa fa-back"></span> Back to Transfer Certificate list</a></div> 
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title">Transfer Certificate Form</span>
                    </div>
                        ...
                        <div class="table-info">                            
                            ...
                            <span id="bonafied_div" style="display:none;" >
                                ...
                                <div class="form-group">
                                    ...
                                    <hr>
                        <form id="form1" name="form1" action="<?=base_url($currentModule.'/generate_transfer_cert')?>" method="POST">  
                       <input type="hidden" id="prn" name="prn" class="form-control" />
                         <input type="hidden" id="stud_id" name="stud_id" class="form-control" />
                         
                               <div class="form-group">
                                   <div class="col-sm-2"></div>
                                   <label class="col-sm-2">Conduct</label>   
                                    <div class="col-sm-3"><input type="text" class="form-control" name="conduct" id="conduct" placeholder="Conduct of Student"></div>
                                    <label class="col-sm-2">Progress</label>                                    
                                    <div class="col-sm-3"><input type="text" class="form-control" name="progress" id="progress" placeholder="Progress of Student"></div>                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3"><input type="text" class="form-control" name="reg" id="reg" placeholder="Registration No."></div>                                    
                                   
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-2"></div>
                                    <label class="col-sm-2">Reason of Leaving</label>                                    
                                    <div class="col-sm-3"> <textarea class="form-control" name="reason" id="reason" placeholder="Reason of Leaving"></textarea></div>                                    
                                      <label class="col-sm-2">Remark</label>                                    
                                    <div class="col-sm-3"> <textarea class="form-control" name="remark" id="remark" placeholder="Remark"></textarea></div>                                    
                                     
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-2"></div>
                                    <label class="col-sm-2">Issue Date:</label>                                    
                                    <div class="col-sm-3"> <input type="text" class="form-control" name="idate" id="idate" placeholder=""></div>  
                                      <label class="col-sm-2">Leaving Date:</label>                                    
                                    <div class="col-sm-3"> <input type="text" class="form-control" name="ldate" id="ldate" placeholder=""></div>  
                                 
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4"></div>
                                    <div class="col-sm-3"><button class="btn btn-primary form-control" id="" type="submit" >Generate Transfer Certificate</button></div>                                 
