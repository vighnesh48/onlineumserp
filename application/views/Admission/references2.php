...
<div class="container">
  <div class="row main-wrapper">
    ...
    <div class="col-xs-3 pull-right"> <strong>Form No :</strong> 0123456987 <svg id="barcode"></svg> </div>
    <div class="col-xs-12">
    ...
    <div class="col-lg-12">
      <table class="table">
        <tr>
          ...
          <td colspan="3"><strong>Surname :</strong> Saxena &nbsp;&nbsp;&nbsp;<strong>First Name :</strong> Ankur &nbsp;&nbsp;&nbsp; <strong>Middle Name :</strong> Ankur</td>
        </tr>
        <tr>
          <td  align="right">&nbsp;</td>
        ...
        <tr>
          ...
          <td valign="top"  colspan="3"><table width="100%">
              ...
              <tr>
                <td class="pb"><strong> Tehsil :</strong> Dahisar &nbsp; &nbsp; <strong>City :</strong> Mumbai &nbsp; &nbsp;<strong>Dist :</strong> Mumbai<strong> &nbsp; &nbsp;State :</strong> Maharashtra &nbsp; &nbsp; <strong>Pincode :</strong> 400068</td>
              </tr>
              <tr>
                <td class="pb"><strong>Mobile (self) :</strong> 09825587456 &nbsp; &nbsp; <strong>Mobile (parent) :</strong> 09825587456 &nbsp; &nbsp;</td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input name="Male" type="checkbox" value="" checked></td>
        </tr>
        <tr>
          ...
          <td>Original text type here lorem </td>
        </tr>
      </table>
    </div>
  </div>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td><input name="Male" type="checkbox" value="" checked>
            ...
            <input name="Male" type="checkbox" value="" >
            No</td>
          <td>If yes Boarding Station/Point of Bus</td>
        </tr>
      </table>
    </div>
  </div>
    ...
    <div class="col-lg-12 np">
      <table class="table table-bordered">
        <tr>
          ...
          <th scope="col">Level (college/state/national)</th>
          <th scope="col">Achievement with remarks (if any)</th>
        </tr>
        <tr>
          <td>SU-JEE Exam</td>
          <td>AGHT23568</td>
  ...
  <div class="row detail-bg">
    ...
    <div class="col-lg-12 np">
      <table class="table table-bordered">
        <tr>
          <td><strong>Newspaper Advt</strong></td>
        </tr>
      </table>
      <table class="table table-bordered">
        <tr>
        ...
        <tr>
          ...
          <td colspan="2">Prashant Maurya</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <table width="100%">
              <tr>
                <td class="pb"><strong>Mobile :</strong> 91+ 98755236454 &nbsp; &nbsp;<strong>Landline with STD Code :</strong> 022-25587788<br>
                  <br>
                  <strong>E-mail id :</strong> info@gmail.com</td>
              </tr>
              <tr> </tr>
            </table></td>
        </tr>
  ...
  <div class="row detail-bg">
    ...
    <div class="col-lg-12 np">
      ...
      <th>(For office use only)</th>
         ...
         <tr>
          <td>2.</td>
          <td>Attested copy of matriculation or its equivalent  certificate for DOB testimony*</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
         ...
         <tr>
          <td>3.</td>
          <td>Attested copy of mark-sheet of qualifying examination</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>4.</td>
          <td>One recent passport size photograph pasted on main form, enclosures and one extra*</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
         ...
         <tr>
          <td>5.</td>
          <td>Proff of residence(Passport/Voter Id/Ration Card/Driving License/Bank Statement/Telephone or Electricity Bill)*</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
         ...
         <tr>
          <td>6.</td>
          <td>Migration and Transfer Certificate*</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>7.</td>
          <td>Caste/Category Certificate/Caste Validity (if applicable)*</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>8.</td>
          <td>Domicile Certificate/Nationality Certificate (if applicable)*</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <br>
         ...
         <tr>
          <td>9.</td>
          <td>Proof of payment(Demand Draft/Receipt of cash deposited)*</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>10.</td>
          <td>Enterance Test Rank/Score Sheet(if applicable)</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>11.</td>
          <td>Recommendation by Teacher(if any)(in a sealed envelope)</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>13</td>
          <td>Affidavit(on Rs.10/- Non Judicial Stamp Paper) if there is a gap in study after qualifying exam.</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
