    ...
    <div class="row ">
      <div class="col-sm-12">
        <div class="panel">
          ...
          <form id="form1" name="form1" action="<?= base_url($currentModule . '/ums_admission_submit') ?>" method="POST">
                        ...
                        <div class="panel-body"> 
                          ...
                          <div class="panel-padding no-padding-vr">
                            <div class="form-group">
                              <label class="col-sm-3">Admission To (Course)</label>
                              <div class="col-sm-3" >
                                <select name="admission-course" class="form-control" onchange="load_streams(this.value)">
                        ...
                        if(data){
                         //   alert(data);
                            ...
                            container.html(data);
                              ...
                              <label class="col-sm-3">Branch(Stream) </label>
...
?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <input data-bv-field="smname" id="smname" name="smname" class="form-control" value="<?= isset($personal[0]['mname']) ? $personal[0]['mname'] : ''; ?>" placeholder="Middle Name" type="text">
                                <i data-bv-icon-for="smname" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="smname" data-bv-validator="notEmpty" class="help-block" style="display: none;">Middle name should not be empty</small><small data-bv-result="NOT_VALIDATED" data-bv-for="smname" data-bv-validator="regexp" class="help-block" style="display: none;">Middle name should be alphabate characters</small><small data-bv-result="NOT_VALIDATED" data-bv-for="smname" data-bv-validator="stringLength" class="help-block" style="display: none;">Middle name should be 2-50 characters.</small> </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3">Father's/Husband Name</label>
                              <div class="col-sm-3">
                                <input data-bv-field="slname" id="slname1" name="slname1" class="form-control" value="<?= isset($personal[0]['plname']) ? $personal[0]['plname'] : ''; ?>" placeholder="Last Name" type="text">
                                <i data-bv-icon-for="slname" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="slname" data-bv-validator="notEmpty" class="help-block" style="display: none;">Last name should not be empty</small><small data-bv-result="NOT_VALIDATED" data-bv-for="slname" data-bv-validator="regexp" class="help-block" style="display: none;">Last name should be alphabate characters</small><small data-bv-result="NOT_VALIDATED" data-bv-for="slname" data-bv-validator="stringLength" class="help-block" style="display: none;">Last name should be 2-50 characters</small> </div>
                              <div class="col-sm-3">
                                <input data-bv-field="sfname" id="sfname1" name="sfname1" class="form-control" value="<?= isset($personal[0]['pfname']) ? $personal[0]['pfname'] : ''; ?>" placeholder="First Name" type="text">
                                <i data-bv-icon-for="sfname" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="sfname" data-bv-validator="notEmpty" class="help-block" style="display: none;">First name should not be empty</small><small data-bv-result="NOT_VALIDATED" data-bv-for="sfname" data-bv-validator="regexp" class="help-block" style="display: none;">First name should be alphabate characters</small><small data-bv-result="NOT_VALIDATED" data-bv-for="sfname" data-bv-validator="stringLength" class="help-block" style="display: none;">First name should be 2-50 characters.</small> </div>
                              <div class="col-sm-3">
                                <input data-bv-field="smname" id="smname1" name="smname1" class="form-control" value="<?= isset($personal[0]['pmname']) ? $personal[0]['pmname'] : ''; ?>" placeholder="Middle Name" type="text">
                                <i data-bv-icon-for="smname" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="smname" data-bv-validator="notEmpty" class="help-block" style="display: none;">Middle name should not be empty</small><small data-bv-result="NOT_VALIDATED" data-bv-for="smname" data-bv-validator="regexp" class="help-block" style="display: none;">Middle name should be alphabate characters</small><small data-bv-result="NOT_VALIDATED" data-bv-for="smname" data-bv-validator="stringLength" class="help-block" style="display: none;">Middle name should be 2-50 characters.</small> </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3">Mother Name</label>
                              <div class="col-sm-3">
                                <input data-bv-field="sfname" id="sfname2" name="sfname2" class="form-control" value="<?= isset($personal[0]['mothernm']) ? $personal[0]['mothernm'] : ''; ?>" placeholder="First Name" type="text">
                                <i data-bv-icon-for="sfname" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="sfname" data-bv-validator="notEmpty" class="help-block" style="display: none;">First name should not be empty</small><small data-bv-result="NOT_VALIDATED" data-bv-for="sfname" data-bv-validator="regexp" class="help-block" style="display: none;">First name should be alphabate characters</small><small data-bv-result="NOT_VALIDATED" data-bv-for="sfname" data-bv-validator="stringLength" class="help-block" style="display: none;">First name should be 2-50 characters.</small> </div>
                            </div>
                            <div class="form-group">
...
?> value="T" id="gender" name="gender" >
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <input type="text" id="mobile" name="mobile" class="form-control" value="<?= isset($personal[0]['mobile']) ? $personal[0]['mobile'] : ''; ?>" placeholder="contact no" maxlength="10" />
                              </div>
                              <label class="col-sm-3">Email</label>
                              <div class="col-sm-3">
                                <input type="text" id="email_id" name="email_id" class="form-control" value="<?= isset($personal[0]['email_id']) ? $personal[0]['email_id'] : ''; ?>" placeholder="Email" />
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3">Nationality</label>
                              <div class="col-sm-3">
                                <input type="text" id="nationality" name="nationality" class="form-control" value="<?= isset($personal[0]['nationality']) ? $personal[0]['nationality'] : 'Indian'; ?>" placeholder="" />
                              </div>
...
?> value="OMS">OMS</option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <input type="text" id="saadhar" value="<?= isset($personal[0]['aadhar_no']) ? $personal[0]['aadhar_no'] : ''; ?>" name="saadhar" class="form-control" >
                              </div>
                            </div>
                            <div class="form-group">
...
?>value="No">No</option>
                              ...
                              <div class="col-sm-2">
                                <label>
                                  <input type="radio" checked value="reg" id="hosteltype" name="hosteltype">
                                  &nbsp;&nbsp;Regular</label>
                              </div>
                              <div class="col-sm-3">
                                <label>
                                  <input type="radio" value="day" id="hosteltype" name="hosteltype">
                                  &nbsp;&nbsp;Day Boarding</label>
                              </div>
                            </div>
                            <div class="form-group">
                      ...
                      <div class="panel">
                        ...
                        <div class="panel-body" style="font-size:12px!important">
                          <table class="table table-new">
                            ...
                            <!--Local Address-->
                            <td width="47%"><div class="form-group">
                                <label  class="col-sm-3">House no.:</label>
                                <div class="col-sm-3">
                                  <INPUT TYPE="TEXT" data-bv-field="bill_A" id="bill_A" NAME="bill_A" value="<?= isset($personal[0]['lhouseno']) ? $personal[0]['lhouseno'] : ''; ?>" SIZE=30>
                                  <i data-bv-icon-for="bill_A" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="bill_A" data-bv-validator="notEmpty" class="help-block" style="display: none;">House No .should not be empty</small></div>
                              </div>
                              <div class="form-group">
                                <label  class="col-sm-3">Street:</label>
                                <div class="col-sm-3">
                                  <INPUT TYPE="TEXT" id="bill_B" NAME="bill_B" value="<?= isset($personal[0]['lstreet']) ? $personal[0]['lstreet'] : ''; ?>" SIZE=30>
                                </div>
                              </div>
                              <div class="form-group">
                                <label  class="col-sm-3">City:</label>
                                <div class="col-sm-3">
                                  <INPUT TYPE="TEXT" id="bill_C" NAME="bill_C" value="<?= isset($personal[0]['lcity']) ? $personal[0]['lcity'] : ''; ?>" SIZE=30>
                                </div>
                              </div>
                              <div class="form-group">
                                <label  class="col-sm-3">State:</label>
                                <div class="col-sm-3">
                                  <INPUT TYPE="TEXT" id="bill_D" NAME="bill_D" value="<?= isset($personal[0]['lstate']) ? $personal[0]['lstate'] : ''; ?>" SIZE=30>
                                </div>
                              </div>
                              <div class="form-group">
                                <label  class="col-sm-3">Country:</label>
                                <div class="col-sm-3">
                                  <INPUT TYPE="TEXT" id="bill_country" NAME="bill_country" value="<?= isset($personal[0]['lcountry']) ? $personal[0]['lcountry'] : ''; ?>" SIZE=30>
                                </div>
                              </div>
                              <div class="form-group">
                                <label  class="col-sm-3">Post Code:</label>
                                <div class="col-sm-3">
                                  <INPUT TYPE="TEXT" id="bill_pc" NAME="bill_pc" value="<?= isset($personal[0]['lpostal']) ? $personal[0]['lpostal'] : ''; ?>" SIZE=30>
                                </div>
                              </div>
                              </td>
                            <!--Permanent Address-->
                            ...
                            <div class="form-group">
                              <label  class="col-sm-3">House no.:</label>
                              <div class="col-sm-3">
                                <INPUT TYPE="TEXT" id="shipping_A" NAME="shipping_A" value="<?= isset($personal[0]['phouseno']) ? $personal[0]['phouseno'] : ''; ?>" SIZE=30>
                              </div>
                            </div>
                            <div class="form-group">
                              <label  class="col-sm-3">Street:</label>
                              <div class="col-sm-3">
                                <INPUT TYPE="TEXT" NAME="shipping_B" value="<?= isset($personal[0]['pstreet']) ? $personal[0]['pstreet'] : ''; ?>" SIZE=30>
                              </div>
                            </div>
                            <div class="form-group">
                              <label  class="col-sm-3">City:</label>
                              <div class="col-sm-3">
                                <INPUT TYPE="TEXT" id="shipping_C" NAME="shipping_C" value="<?= isset($personal[0]['pcity']) ? $personal[0]['pcity'] : ''; ?>" SIZE=30>
                              </div>
                            </div>
                            <div class="form-group">
                              <label  class="col-sm-3">State:</label>
                              <div class="col-sm-3">
                                <INPUT TYPE="TEXT" id="shipping_D" NAME="shipping_D" value="<?= isset($personal[0]['pstate']) ? $personal[0]['pstate'] : ''; ?>" SIZE=30>
                              </div>
                            </div>
                            <div class="form-group">
                              <label  class="col-sm-3">Country:</label>
                              <div class="col-sm-3">
                                <INPUT TYPE="TEXT" id="shipping_country" NAME="shipping_country" value="<?= isset($personal[0]['pcountry']) ? $personal[0]['pcountry'] : ''; ?>" SIZE=30>
                              </div>
                            </div>
                            <div class="form-group">
                              <label  class="col-sm-3">Post Code:</label>
                              <div class="col-sm-3">
                                <INPUT TYPE="TEXT" id="shipping_pc" NAME="shipping_pc" value="<?= isset($personal[0]['ppostal']) ? $personal[0]['ppostal'] : ''; ?>" SIZE=30>
                              </div>
                            </div>
                              </td>
                              </tr>
...
?> value="Other">Other</option>
                          ...
                          <div class="form-group">
                            <label class="col-sm-3">Mobile</label>
                            <div class="col-sm-3">
                              <input type="text" id="parent_mobile" name="parent_mobile" class="form-control" value="<?= isset($personal[0]['gparent_mobile']) ? $personal[0]['gparent_mobile'] : '' ?>" maxlength="10"/>
                            </div>
                            <label class="col-sm-3">Phone No</label>
                            <div class="col-sm-3">
                              <input type="text" id="parent_phone" name="parent_phone" class="form-control" value="<?= isset($personal[0]['gparent_phone']) ? $personal[0]['gparent_phone'] : '' ?>" />
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-3">Address</label>
                            <div class="col-sm-3">
                              <textarea id="parent_address" name="parent_address" class="form-control" rows="3" cols="50" style="resize: vertical;" ><?= isset($personal[0]['gparent_address']) ? $personal[0]['gparent_address'] : '' ?>
</textarea>
                            </div>
                          </div>
                        </div>
...
?>
                       <div class="col-sm-2"> 
                          ...
                          <a  data-toggle="tab" class="btn-all btnNext btn-primary form-control" id="btnNext" href="#educational-details">Next</a> </div>
                        <div class="col-sm-2"> <a class="btn btn-primary form-control" href="<?= base_url('admission/cancel1') ?>">Cancel</a> </div>
                        <?php
}
?>
                       <?php
...
?>
                  ...
                  <div id="educational-details" class="widget-comments panel-body tab-pane fade ">
                    ...
                    <div class="panel">
                      <div class="panel-heading">Admission & Qualifying exam Details
                        <?= $astrik ?>
                     </div>
                      <div class="panel-body">
                        <div class="form-group">
                          ...
                          <div class="col-sm-3">
                            <input data-bv-field="slname" id="qexam" name="qexam" class="form-control" value="<?= isset($qualiexam[0]['qexam_name']) ? $qualiexam[0]['qexam_name'] : '' ?>" placeholder="Qualifying Exam" type="text">
                          ...
                          <div class="col-sm-3">
                            <input data-bv-field="slname" id="pyexam" name="pyexam" class="form-control" value="<?= isset($qualiexam[0]['qexam_pyear']) ? $qualiexam[0]['qexam_pyear'] : '' ?>" placeholder="Year of Passing" type="text">
                            <i data-bv-icon-for="slname" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="slname" data-bv-validator="notEmpty" class="help-block" style="display: none;">Qualifying Exam name should not be empty</small></div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-3">Name Of College/School/Institute</label>
                          <div class="col-sm-3">
                            <input data-bv-field="slname" id="cexam" name="cexam" class="form-control" value="<?= isset($qualiexam[0]['qexam_colleg']) ? $qualiexam[0]['qexam_colleg'] : '' ?>" placeholder="Name Of College" type="text">
                            <i data-bv-icon-for="slname" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="slname" data-bv-validator="notEmpty" class="help-block" style="display: none;">Name Of College/School/Institute should not be empty </small></div>
                        </div>
                        <div class="form-group">
...
?>
                         <div class="col-sm-2">
                            <label>
                              <input type="radio" <?php
echo $rad;
?> value="EN" id="admission_basis" name="admission_basis">
                              &nbsp;&nbsp;Entrance Exam</label>
                          </div>
                          <div class="col-sm-2">
                            <label>
                              <input type="radio" <?php
echo $rad1;
?> value="GD" id="admission_basis" name="admission_basis">
                              &nbsp;&nbsp;GD/PI</label>
                          </div>
                          <div class="col-sm-2">
                            <label>
                              <input type="radio"<?php
echo $rad2;
?> value="M" id="admission_basis" name="admission_basis">
                              &nbsp;&nbsp;Merit</label>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-sm-3">
                            <input data-bv-field="slname" id="roll_exam" name="roll_exam" class="form-control" value="<?= isset($qualiexam[0]['qexam_roll']) ? $qualiexam[0]['qexam_roll'] : '' ?>" placeholder="Roll Number" type="text">
                            <i data-bv-icon-for="slname" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="slname" data-bv-validator="notEmpty" class="help-block" style="display: none;">Roll Number should not be empty </small></div>
                          <label class="col-sm-3">Entrance Exam Rank</label>
                          <div class="col-sm-3">
                            <input data-bv-field="slname" id="exam_rank" name="exam_rank" class="form-control" value="<?= isset($qualiexam[0]['qexam_rank']) ? $qualiexam[0]['qexam_rank'] : '' ?>" placeholder="Exam rank" type="text">
                            <i data-bv-icon-for="slname" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="slname" data-bv-validator="notEmpty" class="help-block" style="display: none;">Name Of College/School/Institute should not be empty </small></div>
                        </div>
                      </div>
                    </div>
                            ...
                            <div class="table-responsive">
                              <table id="eduDetTable" class="table table-bordered edu-table">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                    <td><select name="exam_id[]" class="form-control">
                                        <option value="">Select</option>
                                    ...
                                    <td><input data-bv-field="college_name" type="text"  id="college_name" name="college_name[]" class="form-control" value="<?= isset($_REQUEST['college_name']) ? $_REQUEST['college_name'] : '' ?>" placeholder="Specialization" />
                                      <i data-bv-icon-for="college_name" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="college_name" data-bv-validator="notEmpty" class="help-block" style="display: none;">College Name should not be empty </small></td>
                                    
                                    <td><input type="text" name="seat_no[]" class="form-control" value="<?= isset($_REQUEST['seat_no']) ? $_REQUEST['seat_no'] : '' ?>" placeholder="Board/University" /></td>
...
?>
                                    ...
                                    <td><input type="button" class="btn btn-xs btn-primary btn-flat" value="Add More" name="addMore" />
                    ...
                    <div class="panel">
                      ...
                      <div class="panel-body">
                        <table class="table table-bordered">
                          ...
                          <tr>
                            <td rowspan="5">12th(Intermediate)or Equivalent</td>
                            <td><label>Physics</label></td>
                            <td><input type="text" id="thsc_phy" value="<?= isset($qualiexam[0]['htotal_phy']) ? $qualiexam[0]['htotal_phy'] : '' ?>" name="thsc_phy"></td>
                            <td><input type="text" id="ohsc_phy" value="<?= isset($qualiexam[0]['hobt_phy']) ? $qualiexam[0]['hobt_phy'] : '' ?>" name="ohsc_phy"></td>
                            <td rowspan="5"><!--<input type="text" id="hscpass_date" value="<? //=isset($qualiexam[0]['hscpass_date'])?$qualiexam[0]['hscpass_date']:''
?>" name="hscpass_date" placeholder="yyyy-mm-dd">-->
                          ...
                          <tr>
                            ...
                            <td><input type="text" id="thsc_chem" value="<?= isset($qualiexam[0]['htotal_chem']) ? $qualiexam[0]['htotal_chem'] : '' ?>" name="thsc_chem"></td>
                            <td><input type="text" id="ohsc_chem" name="ohsc_chem" value="<?= isset($qualiexam[0]['hobt_chem']) ? $qualiexam[0]['hobt_chem'] : '' ?>"></td>
                          </tr>
                          <tr>
                            <td><label>Math</label></td>
                            <td><input type="text" id="thsc_bio" value="<?= isset($qualiexam[0]['htotal_bio']) ? $qualiexam[0]['htotal_bio'] : '' ?>" name="thsc_bio"></td>
                            <td><input type="text" id="ohsc_bio" name="ohsc_bio" value="<?= isset($qualiexam[0]['hobt_bio']) ? $qualiexam[0]['hobt_bio'] : '' ?>" ></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td><input type="text" id="thsc_eng" value="<?= isset($qualiexam[0]['htotal_eng']) ? $qualiexam[0]['htotal_eng'] : '' ?>" name="thsc_eng"></td>
                            <td><input type="text" id="ohsc_eng" name="ohsc_eng" value="<?= isset($qualiexam[0]['hobt_eng']) ? $qualiexam[0]['hobt_eng'] : '' ?>"></td>
                          </tr>
                          <tr>
                            <td><label>10th(Matriculation)Or Equivalent</label></td>
                            <td><label>English</label></td>
                            <td><input data-bv-field="tssc_eng" type="text" id="tssc_eng" name="tssc_eng" value="<?= isset($qualiexam[0]['stotal_eng']) ? $qualiexam[0]['stotal_eng'] : '' ?>" >
                            ...
                            <td><!--<input data-bv-field="slname" type="text" id="sscpass_date" name="sscpass_date" value="<? //=isset($qualiexam[0]['ssc_passing_dt'])?$qualiexam[0]['ssc_passing_dt']:''
?>" placeholder="yyyy-mm-dd">-->
                    ...
                    <div class="panel">
                      ...
                      <div class="panel-body">
                        <table class="table table-bordered edu-table">
                          <tr>
                            <th>Exam Name</th>
...
?>
                          ...
                          <td><input type="text" name="enrolment" class="form-control" placeholder="Enrolment Number" /></td>
                          <td><input type="text" name="marks" class="form-control" placeholder="Marks Obtained" /></td>
                          <td><input type="text" name="total" class="form-control" placeholder="Total Marks" /></td>
                          <td><input type="text" name="total" class="form-control" placeholder="Percentage" /></td>
                          <td><input type="button" class="btn btn-xs btn-primary btn-flat" value="Add More" name="addMore" />
                         <!-- <input type="button" class="btn btn-xs btn-danger btn-flat" id="remove" value="Remove" name="remove" />--></td>
                          </tr>
                        </table>
...
?>
                     <div class="col-sm-2"> 
                        <!--<a class="btn btn-primary form-control" id="next" href="#educational-details">Next</a>  --> 
                        <a  data-toggle="tab" class="btn-all btnNext btn-primary form-control" id="next" href="#documents-certificates">Next</a> </div>
                      <div class="col-sm-2"> <a class="btn btn-primary form-control" href="<?= base_url('admission/cancel2') ?>">Cancel</a> </div>
                      <?php
}
?>
                     <?php
                        ...
                        <div class="panel-body">
                          <table class="table table-bordered">
                            ...
                            <tr>
                              ...
                              <td><input type="text" name="cno[]" value="<?= isset($certificate[0]['certificate_no']) ? $certificate[0]['certificate_no'] : '' ?>"/></td>
                              <td><div class="form-group">
                              ...
                              <td><input type="text" name="cval[]" value="<?= isset($certificate[0]['cvalidity']) ? $certificate[0]['cvalidity'] : '' ?>"></td>
                            </tr>
                            <tr>
                              <td><input type="hidden" name="cert_id[]" value="<?= isset($certificate[1]['cid']) ? $certificate[1]['cid'] : '' ?>">
                                <label>Cast-category</label>
                                <input type="hidden"name="cnm[]" value="Cast-category" readonly></td>
                              <td><input type="text" name="cno[]" value="<?= isset($certificate[1]['certificate_no']) ? $certificate[1]['certificate_no'] : '' ?>"/></td>
                              <td><div class="form-group">
                              ...
                              <td><input type="text" name="cval[]" value="<?= isset($certificate[1]['cvalidity']) ? $certificate[1]['cvalidity'] : '' ?>"></td>
                            </tr>
                            <tr>
                              ...
                              <td><input type="text" name="cno[]" value="<?= isset($certificate[2]['certificate_no']) ? $certificate[2]['certificate_no'] : '' ?>"/></td>
                              <td><div class="form-group">
                              ...
                              <td><input type="text" name="cval[]" value="<?= isset($certificate[2]['cvalidity']) ? $certificate[2]['cvalidity'] : '' ?>"></td>
                            </tr>
                          </table>
                        </div>
                      </div>
...
?>
                       <div class="col-sm-2"> 
                          <!--<a class="btn btn-primary form-control" id="next" href="#educational-details">Next</a>  --> 
                          <a  data-toggle="tab" class="btn-all btnNext btn-primary form-control" id="next" href="#references">Next</a> </div>
                        <div class="col-sm-2"> <a class="btn btn-primary form-control" href="<?= base_url('admission/cancel3') ?>">Cancel</a> </div>
                        <?php
}
?>
                       <?php
                      ...
                      <div class="panel">
                        ...
                        <div class="panel-body">
                          ...
                          <table class="table table-bordered">
                            ...
                            <tr>
                              <td>1</td>
                              <td><input type="text" name="fref1" value="<?= isset($references[0]['for_stud_refer_name1']) ? $references[0]['for_stud_refer_name1'] : '' ?>" required/></td>
                              <td><input type="text" name="frefcont1" maxlength="10" value="<?= isset($references[0]['for_stud_refer_cont1']) ? $references[0]['for_stud_refer_cont1'] : '' ?>" required></td>
                            </tr>
                            <tr>
                              <td>2</td>
                              <td><input type="text" name="fref2" value="<?= isset($references[0]['for_stud_refer_name2']) ? $references[0]['for_stud_refer_name2'] : '' ?>"required/></td>
                              <td><input type="text" name="frefcont2" maxlength="10" value="<?= isset($references[0]['for_stud_refer_cont2']) ? $references[0]['for_stud_refer_cont2'] : '' ?>" required></td>
                            </tr>
                          </table>
                          <table class="table table-bordered">
                            <tr >
...
?> value="otherweb">Other Website</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-3">
                              <input data-bv-field="refcandidateemail" id="refcandidateemail" name="refcandidateemail" class="form-control" value="<?= isset($references[0]['ref_bystud_email']) ? $references[0]['ref_bystud_email'] : '' ?>" placeholder="Candidate Email" type="email">
                            </div>
...
?>
                       <div class="col-sm-2"> 
                          <!--<a class="btn btn-primary form-control" id="next" href="#educational-details">Next</a>  --> 
                          <a  data-toggle="tab" class="btn-all btnNext btn-primary form-control" id="next" href="#payment-photo">Next</a> </div>
                        <div class="col-sm-2"> <a class="btn btn-primary form-control" href="<?= base_url('admission/cancel4') ?>">Cancel</a> </div>
                        <?php
}
?>
                       <?php
                          ...
                          <table class="table table-bordered">
                            ...
                            <tr>
                              ...
                              <td rowspan="4"><p>Payment of Rs.
                                  ...
                                  <i data-bv-icon-for="paidfee" class="form-control-feedback" style="display: none; top: 0px;"></i><small data-bv-result="NOT_VALIDATED" data-bv-for="paidfee" data-bv-validator="notEmpty" class="help-block" style="display: none;">Total Paid Fee should not be empty</small><small data-bv-result="NOT_VALIDATED" data-bv-for="paidfee" data-bv-validator="regexp" class="help-block" style="display: none;">Total Paid Fee should be numeric characters</small><small data-bv-result="NOT_VALIDATED" data-bv-for="slname" data-bv-validator="stringLength" class="help-block" style="display: none;">Last name should be 2-50 characters</small> Made through CashRecipt/DD No.
                                  <input type="text" name="dd_no"  required value="<?= isset($fee[0]['dd_no']) ? $fee[0]['dd_no'] : '' ?>" placeholder="DD No.">
                                  <br>
                                  Dated
                                
                                <div class="input-group date" id="doc-sub-datepicker20">
                                  <input type="text" id="dd_date" name="dd_date" required value="<?= isset($fee[0]['dd_drawn_date']) ? $fee[0]['dd_drawn_date'] : '' ?>" placeholder="DD Date" />
                                  <span class="input-group-addon"><i class="fa fa-calendar"></i></span> </div>
                                Drawn On<br>
                                <input type="text" id="dd_bank" name="dd_bank" required value="<?= isset($fee[0]['dd_drawn_bank_branch']) ? $fee[0]['dd_drawn_bank_branch'] : '' ?>" placeholder="Bank & Branch">
                                <br>
                                (Name of Bank & Branch)
                                </p></td>
                            </tr>
                            ...
                            <tr>
                              <td>Total</td>
                              <td><input type="text" id="txt31" name="totalfeeappli" value="<?= isset($fee[0]['totalfeeappli']) ? $fee[0]['totalfeeappli'] : '' ?>" onkeyup="sub3();" readonly></td>
                              <td><input type="text" id="txt32" name="totalfeepaid" value="<?= isset($fee[0]['totalfeepaid']) ? $fee[0]['totalfeepaid'] : '' ?>" onkeyup="sub3();" readonly ></td>
                              <td><input type="text" id="txt33" name="totalfeebal" value="<?= isset($fee[0]['totalfeebal']) ? $fee[0]['totalfeebal'] : '' ?>" onkeyup="sub3();" readonly></td>
                            </tr>
                          </table>
                          <div class="form-group">
...
?>"width="100" height="100" border="1px solid black" />
                      ...
                      <div class="form-group">
                        <div class="col-sm-4"></div>
                        <?php
if ($this->session->userdata('updatestep5flag') == 'active') {
?>
                       <div class="col-sm-2">
                          <button class="btn btn-primary form-control" id="btn_submit" type="submit" >Update</button>
                        </div>
