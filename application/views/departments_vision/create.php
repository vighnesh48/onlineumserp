...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Add Department Vision</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add Department Vision</h1>
            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                            <span class="panel-title">Department Vision Details</span>
                    </div>
                    <div class="panel-body">
                        <div class="table-info">
                            <?php //if(in_array("Add", $my_privileges)) { ?>
                           <form method="post" action="<?= site_url('departments_vision/store') ?>">
							...
							<div class="col-sm-6">
								...
								<div class="form-group">
									<label class="col-sm-3">Vision<sup class="redasterik" style="color:red">*</sup></label>
									<div class="col-sm-6">
									<textarea name="vision" id="vision" class="form-control " required></textarea>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3">Mission<sup class="redasterik" style="color:red">*</sup></label>
									<div class="col-sm-6">
									<textarea name="mission" id="mission" class="form-control" required></textarea>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3">Admission Year<sup class="redasterik" style="color:red">*</sup></label>
									<div class="col-sm-6">
									...
									<div class="form-group">
									<label class="col-sm-3">Status<sup class="redasterik" style="color:red">*</sup></label>
									<div class="col-sm-6">
