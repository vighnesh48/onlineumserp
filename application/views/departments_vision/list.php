    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm">
                <i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp; Department Vision
            </h1>
            <span id="err_msg" style="color:red;"></span>
			
			<div class="pull-right col-xs-4 col-sm-auto">
				<a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url('departments_vision/create')?>"><span class="btn-label icon fa fa-plus"></span>Add</a>
			</div>
                            ...
                            <table class="table table-bordered" style="width:100%;max-width:100%;">
                                ...
                                <tbody id="itemContainer">
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$row->stream_name?></td> <!-- You can replace with name if needed -->
                                        <td><?=$row->vision?></td>
                                        <td><?=$row->mission?></td>
                                        <td><?=$row->academic_year?></td>
                                        <td><?=$row->status == 1 ? 'Active' : 'Inactive'?></td>
                                        <td>
                                            <a title="Edit Vision" class="btn btn-primary btn-xs" href="<?=base_url('departments_vision/edit/'.$row->id.'/1')?>">Edit</a>
                                            <a title="Delete Vision" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure?')" href="<?=base_url('departments_vision/delete/'.$row->id)?>">Delete</a>
                                        </td>
                                    </tr>
                                    <?php $j++; endforeach; ?>
                                </tbody>
