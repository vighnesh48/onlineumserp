...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Subject Component Master</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-book page-header-icon"></i>&nbsp;&nbsp;Subject List</h1><!-- <span class="blinking pull-left">Last date for adding/updating Course master is 3<sup>rd</sup> July 2019 </span> -->
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                    <hr class="visible-xs no-grid-gutter-h">
                    <?php// if(in_array("Add", $my_privileges)) { ?>
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add_subject_component")?>"><span class="btn-label icon fa fa-plus"></span>Add Subject component</a></div>                        
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                        ...
                        <form name="searchTT" id="forms" method="POST" action="<?=base_url()?>subject/Subject_component_details">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr <?=$subj_details[$i]["status"]=="N"?"style='background-color:#FBEFF2'":""?>>
								...
								<td><?=$subj_details[$i]['semester_id']?></td>								
                                <td><?=$subj_details[$i]['batch']?></td>
                                  <td><?=$subj_details[$i]['total_subject']?></td>
                                <td><?=$subj_details[$i]['theory']?></td>
                                <td><?=$subj_details[$i]['practical']?></td>
                                <td><?=$subj_details[$i]['embadded']?></td>
								<td><?=$subj_details[$i]['academic_year']?></td>
                                <td>
                                   
                                    <a href="<?=base_url($currentModule."/edit_stream_component/".$subj_details[$i]['sub_comid'])?>" class="<?=$dis_cls?>"><i class="fa fa-edit <?=$dis_cls?>" ></i></a> | 
                                    <a href="<?=base_url($currentModule."/removeSubjectcomponent/".$subj_details[$i]['sub_comid'])?>" class="tt <?=$dis_cls?>">
