...
<table cellpadding="0" cellspacing="0" border="0" align="center" width="800" style="margin-bottom:1px;">
 <tr>
	<td align="center" colspan="3"><h3>Subjectwise Student Info.</h3></td>
</tr>
 <tr>
...
<td colspan="2"><b>Course Code/ Name:</b> <?php if(!empty($student_details)){ echo $student_details[0]['subject_name'].' ('.$student_details[0]['subject_code'].').';}?></td>
