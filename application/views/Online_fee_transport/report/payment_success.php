...
<td valign="top" align="left"  style="padding:5px 5px 5px;font-size:8px;">
    <img src="https://erp.sandipuniversity.com/assets/images/sf_logo.png"  width="150"><br>
...
<td align="right" valign="top" style="padding:5px 5px 5px 5px;" height="30" ><img src="'.$site_url.'uploads/online_payment/'.$fileName.'" width="70"></td>
</tr>
...
<tr>
  ...
  <td colspan="2" height="20" style="padding:0" align="center">
   <br>   
  <p style="margin:0px;font-size:12px;" align="center"> <i><strong>Corporate Office:  1st Floor,Manisha Pride, J.N.Road,Mulund West.Mumbai(MH)-400080</strong></i></p>
...
<div style="border:1px solid #000;display:none">
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-size:14px;height:415px;">
<tr>
<td colspan="2">
<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="border-spacing:0px" border-spacing="0">
...
Payment of Rs $amount received for sandip university and tranction no -:$txnid.

Your Provisonal PRN number is $registration_no.
...
";
$subject="Payment Receipt Transport";
 ...
 $path=$_SERVER["DOCUMENT_ROOT"].'/erp/application/third_party/';
	...
	//	$mail->AddAddress('vighnesh.sukum@carrottech.in');
	  // $mail->AddAddress('kamlesh.kasar@sandipuniversity.edu.in');
       ...
       $mail->AddAddress('prashant.joshi@siem.org.in');
	
	 //  $mail->AddAddress('ar@sandipuniversity.edu.in');
     
	   $mail->AddAddress('accounts.transport@sandipfoundation.org');
...
$email->AddAddress('vighnesh.sukum@carrottech.in');
