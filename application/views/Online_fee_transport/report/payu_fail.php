            ...
            <div class="tabbable">
              ...
              <div class="tab-content form-tab">
                <div class="tab-pane active" id="one">
					...
					<div class="col-lg-12">
							<p style="color:green">Transaction Failure.</p>
                            
							<div class="clearfix">&nbsp;</div>
							<p class="text-center">Your payment has been Failed.Please Try again</b></p>
                            <p class="text-center"></p>
                            <p class="text-center"><!--Click To Visit Hostel Admission <a href="https://sandipuniversity.com/Hostelpayment/Home"> Click Here </a>--></p>
