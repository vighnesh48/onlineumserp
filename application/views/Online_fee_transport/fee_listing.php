...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Payment List</h1> <a href="<?=base_url()?>Online_fee/ic_adm_payment"><button class="btn-primary btn pull-right" style="margin-right:10px;">IC Admission Online Payment</button></a>
                         ...
                         //var_dump($emp_list);exit;
                            ...
                            <tr <?=$bg?> <?=$emp_list[$i]["status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                               <td><?=$j?></td>
                                 ...
                                 <td>
                                     ...
                                     ?>
                                     <a href="<?php echo base_url();?>uploads/online_payment/<?=$emp_list[$i]['bank_ref_num']?>.pdf" target="_blank"> <?=$emp_list[$i]['receipt_no']?></a>
                                     <?php
                                     }
                                    else
                                     {
                            ...
                            <td><?=$emp_list[$i]['amount']?></td>
                                ...
                                <td><?=$emp_list[$i]['payment_mode'];?></td>    
								  ...
								  <td><?=$emp_list[$i]['productinfo'];?></td>
                                 <td><?php if($emp_list[$i]['fees_id']!==NULL){echo "Approved";} else{ echo "Pending";}?></td> 
                                       ...
                                       <td>
                                         ...
                                         <?php if($emp_list[$i]['fees_id']!==NULL){?>
                                       <?php echo $emp_list[$i]['college_receiptno']; ?>
                                         <?php }else{ ?>
             <a href="<?php echo base_url();?>Online_fee/Challan/<?=$emp_list[$i]['payment_id']?>/<?=$emp_list[$i]['productinfo']?>" target="_blank">Verify</a>
             <?php } ?>
                                            <?php
                            }
