...
class Phd_master extends CI_Controller 
{
    var $currentModule="";
    var $title="";
    var $table_name="academic_fees";
    var $model_name="Phd_master_model";
    var $model;
    var $view_dir='Phd_master/';
    var $data=array();
	...
	$this->data['academic_details']= $this->Phd_master_model->get_academic_details();		
	...
	{ //exit();
		$academic_fees_details=$this->Phd_master_model->get_academic_fees_detailsnew($_POST);
		//exit();
		$i=1;
		$ban='fa-ban';
		$check='fa-check';
	...
	{
		$p_dts=array_shift($this->Phd_master_model->get_academic_fees_details($_POST));
		echo json_encode(array("fees_details"=>$p_dts));
	}
	
	public function get_school_stream_details()
	{
		$school_stream_details=$this->Phd_master_model->get_school_stream_details($_POST);
		$i=1;
		$ban='fa-ban';
		$check='fa-check';
		$gender='';
	...
	{
		$academic_fees_details=$this->Phd_master_model->get_academic_stream_list($_POST);
	...
	public function academic_fee_details_excelReports()
	{
		...
		$this->data['academic_fees_details']=$this->Phd_master_model->get_academic_fees_details($val);
	...
	{
		//var_dump($_POST);exit();
		$last_inserted_id=$this->Phd_master_model->add_academic_fees_submit($_POST);
		if($last_inserted_id)
	...
	{
		$last_inserted_id=$this->Phd_master_model->add_school_stream_submit($_POST);
		if($last_inserted_id)
	...
	public function edit_academic_fees()
	{
        ...
        $this->data['academic_fee_details']=array_shift($this->Phd_master_model->get_academic_fees_details($val));
		$this->data['academic_details']= $this->Phd_master_model->get_academic_details();
	...
	public function edit_school_stream()
	{
		...
		$this->data['school_details']=$this->Phd_master_model->get_school_details();
		$this->data['course_category_details']=$this->Phd_master_model->get_course_category_details();
        $this->data['school_stream_details']=array_shift($this->Phd_master_model->get_school_stream_details($val));
		//	echo $this->view_dir.'edit_room_details';exit();
	...
	public function edit_academic_fees_submit()
	{
		...
		$flag=$this->Phd_master_model->edit_academic_fees_submit($_POST);
		if($flag)
		{
	...
	public function disable_academic_fees()
	{
		...
		$flag=$this->Phd_master_model->disable_academic_fees($academic_fees_id);
		if($flag)
		{
	...
	{
		$academic_fees_id=$this->uri->segment(3);
		$flag=$this->Phd_master_model->enable_academic_fees($academic_fees_id);
		if($flag)
		{
	...
	{
		echo $status=$this->Phd_master_model->edit_check_academicfee_exists($_POST);
	}
	
	public function academic_session()
	{
		$this->load->view('header',$this->data);   
		$this->data['academic_session_details']=$this->Phd_master_model->get_academic_session_details();
	...
	{
		$this->load->view('header',$this->data);   
		$this->data['academic_year_details']=$this->Phd_master_model->get_academic_year_details();
	...
	{
		$this->load->view('header',$this->data);   
		$this->data['course_details']=$this->Phd_master_model->get_course_details();
	...
	{
		$this->load->view('header',$this->data);   
		$this->data['stream_details']=$this->Phd_master_model->get_stream_details();
		$this->data['partnership_details']=$this->Phd_master_model->get_partnership_details();
	...
	public function stream_mapping()
	{
		$this->load->view('header',$this->data);
		$this->data['school_details']=$this->Phd_master_model->get_school_details();
//$this->data['stream_map_details']=$this->Phd_master_model->get_stream_mapping_details();
	...
	{
		$this->load->view('header',$this->data);   
		$this->data['school_stream_details']=$this->Phd_master_model->get_school_stream_details();
		$this->data['school_details']=$this->Phd_master_model->get_school_details();
	...
	public function get_partnership_details()
	{
		...
		$p_dts=array_shift($this->Phd_master_model->get_partnership_details($id));
	...
	public function get_school_details()
	{
		...
		$p_dts=array_shift($this->Phd_master_model->get_school_details($id));
	...
	{
		$id=$_POST['pid'];//echo "id===".$id;
		$p_dts=$this->Phd_master_model->get_partnership_streams($id);
	...
	{
		$this->load->view('header',$this->data);   
		$this->data['state']= $this->Phd_master_model->getAllState();
	...
	{
		$get_stream_list_notin_school=$this->Phd_master_model->get_stream_list_notin_school($_POST);
		/* echo "<table id='myTable' class='table' >";
        echo "<th></th><th>Stream Name</th><th>Year</th>"; */
	...
	public function add_partnership_submit()
    {
		...
		//echo "calling";exit();
        $last_inserted_id= $this->Phd_master_model->add_partnership_submit($_POST,$payfile );
		if($last_inserted_id)
		{
	...
	public function edit_partnership_submit()
	{
		...
		$flag=$this->Phd_master_model->edit_partnership_submit($_POST,$payfile);
		if($flag)
		{
	...
	{
		$dts=$this->Phd_master_model->get_last_stream_no($_POST);
	...
	{
		echo $dts=$this->Phd_master_model->check_academic_session_exists($_POST);
	}
	
	public function check_academic_year_exists()
	{
		echo $dts=$this->Phd_master_model->check_academic_year_exists($_POST);
	}
	
	public function check_course_exists()
	{
		echo $dts=$this->Phd_master_model->check_course_exists($_POST);
	}
	
	public function check_course_cat_exists()
	{
		echo $dts=$this->Phd_master_model->check_course_cat_exists($_POST);
	}
	
	public function check_school_exists()
	{
		echo $dts=$this->Phd_master_model->check_school_exists($_POST);
	}
	
	public function check_stream_exists()
	{
		echo $dts=$this->Phd_master_model->check_stream_exists($_POST);
	}
	
	public function check_partnership_exists()
	{
		echo $dts=$this->Phd_master_model->check_partnership_exists($_POST);
	}
	
	public function add_academic_session_submit()
	{
		$flag=$this->Phd_master_model->add_academic_session_submit($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->Phd_master_model->edit_academic_session_submit($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->Phd_master_model->add_academic_year_submit($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->Phd_master_model->edit_academic_year_submit($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->Phd_master_model->add_course_submit($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->Phd_master_model->edit_course_submit($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->Phd_master_model->add_course_category_submit($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->Phd_master_model->edit_course_category_submit($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->Phd_master_model->add_school_submit($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->Phd_master_model->edit_school_submit($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->Phd_master_model->add_stream_submit($_POST);
		if($flag)
		{
	...
	public function edit_academic_session()
	{
        ...
        $this->load->view('header',$this->data);
        $this->data['academic_details']= array_shift($this->Phd_master_model->get_academic_session_details($id));
	...
	public function edit_academic_year()
	{
		$id=$this->uri->segment(3);
        $this->load->view('header',$this->data);                   
        $this->data['academic_details']= array_shift($this->Phd_master_model->get_academic_year_details($id));
	...
	public function edit_course()
	{
		$id=$this->uri->segment(3);
        $this->load->view('header',$this->data);                   
        $this->data['course_details']= array_shift($this->Phd_master_model->get_course_details($id));
	...
	public function edit_course_category()
	{
		$id=$this->uri->segment(3);
        $this->load->view('header',$this->data);                   
        $this->data['course_details']= array_shift($this->Phd_master_model->get_course_category_details($id));
	...
	public function edit_school()
	{
		$id=$this->uri->segment(3);
        $this->load->view('header',$this->data);                   
        $this->data['school_details']= array_shift($this->Phd_master_model->get_school_details($id));
	...
	public function edit_partnership()
	{
        ...
        $this->load->view('header',$this->data);                
		$this->data['state']= $this->Phd_master_model->getAllState();
        $this->data['partnership_details']= array_shift($this->Phd_master_model->get_partnership_details($id));
	...
	public function edit_stream()
	{
		...
		$this->data['course_details']=$this->Phd_master_model->get_course_details();
		$this->data['course_category_details']=$this->Phd_master_model->get_course_category_details();
		$this->data['last_stream_no']=array_shift($this->Phd_master_model->get_last_stream_no());
        $this->data['stream_details']= array_shift($this->Phd_master_model->get_stream_details($id));
		$this->data['partnership_details']=$this->Phd_master_model->get_partnership_details();
		$this->data['school_details']=$this->Phd_master_model->get_school_details();
		$this->data['school_id_code']=$this->Phd_master_model->get_school_id($id);
		$arr = $this->Phd_master_model->get_stream_details($id);
		//print_r($arr);exit();
		$this->data['school_stream_details']=array_shift($this->Phd_master_model->get_school_stream_details($arr[0]['stream_id']));
	...
	{
		$flag=$this->Phd_master_model->edit_stream_submit($_POST);
		if($flag)
		{
