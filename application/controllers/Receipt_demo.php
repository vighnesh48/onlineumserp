...
class Receipt_demo extends CI_Controller 
{
    var $currentModule="";
    var $title="";
    var $model_name="Receipt_model_demo";
    var $model_name1="Receipt_model_demo";
    var $model;
    var $view_dir='Receipt_demo/';
    var $data=array();
...
//error_reporting(1);
		...
		$this->data['bank_details']= $this->Receipt_model->getbanks();
		$this->data['academic_details']=$this->Receipt_model->get_academic_details();
		$this->data['challan_details']=$this->Receipt_model->fees_challan_list_byid($this->uri->segment(3));
...
//print_r($artists);
	...
	//	print_r($Check_challan);
		...
		"Balance_Amount"=>$_POST['Balance_Amount'],"remark"=>$_POST['Remark']
		);
	...
	public function edit_fees_challan_submit(){
	   ...
	   $this->Receipt_model->add_into_fees_details($insert_array);
		...
		redirect(base_url($this->view_dir.'Receipt'));
	...
	{
		$std_challan_list=$this->Receipt_model->fees_challan_list($_POST);
