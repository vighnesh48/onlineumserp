...
class Result_reval extends CI_Controller{
	...
	public function __construct(){        
      ...
      public function search_student_verification_byprn()
	  {
		$this->load->view('header',$this->data);
		$this->load->view($this->view_dir.'search_student_verification_byprn',$this->data);
	...
	function load_streams_for_result(){
		...
		if($_POST["course_id"] !=''){
			//Get all streams
			$stream = $this->Result_reval_model->get_streams_for_result($_POST["course_id"],$_POST["school_code"]);
