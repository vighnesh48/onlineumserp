...
public function payment_new()
	{
		...
		$this->load->library('someclass');
		//$this->someclass->some_method();  // Object instances will always be lower case
		$this->load->view('new_payment/header');
		$this->load->view('new_payment/payment');
		$this->load->view('new_payment/footer');
	}
...
//var_dump($data);
	...
	//$encrypted_data=encrypt($merchant_data,$working_key); // Method for encrypting the data. //https://test.ccavenue.com/transaction/transaction.do?command=initiateTransaction
	$this->load->library('someclass');
