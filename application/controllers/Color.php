...
class Color extends CI_Controller 
{
    var $currentModule="";
    var $title="";
    var $table_name="colormaster";
    var $model_name="color_model";
    var $model;
    var $view_dir='Color/';
    var $data=array();
    ...
    public function index()
    {
        ...
        $this->data['color_details']= $this->color_model->get_color_details();                                                
    ...
    public function edit()
    {
        ...
        $this->data['color_details']=array_shift($this->color_model->get_color_details($color_id));                            
    ...
    public function disable()
    {
		...
		//$secondDB ->update($this->table_name, $update_array);
    ...
    {      
        ...
        $config=array(
                        array('field'   => 'colorcode',
			'label'   => 'Color Code',
			'rules'   => 'trim|required|xss_clean'
			),
			array('field'   => 'colorname',
			'label'   => 'Color name',
			'rules'   => 'trim|required|xss_clean'
			)
                 );
        ...
        if($color_id=="")
        {
            ...
            else
            {
                ...
                $insert_array=array("colorcode"=>$colorcode,"colorname"=>$colorname,"created_by"=>'1',"created_at"=>date("Y-m-d H:i:s"));                                                                
                $secondDB->insert("colormaster", $insert_array); 
        ...
        else
        {
            ...
            {        
                ...
                $update_array=array("colorcode"=>$colorcode,"colorname"=>$colorname,"updated_by"=>'1',"updated_at"=>date("Y-m-d H:i:s"));                                                                
    ...
    {        
        ...
        $color_details=  $this->color_model->get_color_details($para);                    
        echo json_encode(array("color_details"=>$color_details));
    } 
}
?>