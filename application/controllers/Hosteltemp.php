...
class Hosteltemp extends CI_Controller 
{
    var $currentModule="";
    var $title="";
    var $table_name="sf_hostel_master";
    var $model_name="hosteltemp_model";
    var $model;
    var $view_dir='Hosteltemp/';
    var $data=array();
...
//ini_set('display_errors', 1);
    ...
    public function index()
    {
        ...
        $this->data['hostel_details']=$this->hosteltemp_model->get_hostel_details();
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();
		$this->data['campus']= $this->hosteltemp_model->getcampusname();             
        $this->data['state']= $this->hosteltemp_model->getAllState(); 
...
/*	 public function add()
	...
	{
		echo $status=$this->hosteltemp_model->check_exists($_POST);
	}

	public function check_hcode_exist()
	{
		echo $status=$this->hosteltemp_model->check_hcode_exist($_POST);
	}
	...
	{
		$this->load->view('header',$this->data);                   
        $this->data['facilities_types']= $this->hosteltemp_model->get_facilities_types();
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();
		$this->data['campus']= $this->hosteltemp_model->getcampusname(); 
	...
	public function edit_facility()
    {
		...
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();
		$this->data['campus']= $this->hosteltemp_model->getcampusname(); 
		$this->data['facilities_details']= array_shift($this->hosteltemp_model->get_facilities_byid($sf_fc_id));
  ...
  /*  public function edit()
    {
        ...
        $this->data['hostel_details']=array_shift($this->hosteltemp_model->get_hostel_details($hostel_id));
		$this->data['state']= $this->hosteltemp_model->getAllState();                          
  ...
  /*  public function submit()
    ...
    {               
		...
		$host_id=$this->uri->segment(3);
		$res=$this->hosteltemp_model->check_hcode_exist($host_id,$hostel_code);
	...
	*/
    ...
    {        
        ...
        $hostel_details=  $this->hosteltemp_model->get_hostel_search_details($para);                    
	...
	public function getallfailities()
	{
		...
		$fc_dts=$this->hosteltemp_model->getallfailities($_POST);
		$i=1;
		$ban='fa-ban';
		$check='fa-check';
	...
	public function getinstutename()
	{
		if($_POST['org']=='SU')
		{
			$school_list=$this->hosteltemp_model->get_su_program_detail($_POST);
		...
		{
			$school_list=$this->hosteltemp_model->get_program_detail();
			if(!empty($school_list)){
				echo"<option value=''>Select institute</option>";
				foreach($school_list as $val){
	...
	public function incharge_list()
	{
        ...
        $this->data['hostel_details']=$this->hosteltemp_model->get_hostel_details();
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();          
		$this->data['academic_year']=$this->hosteltemp_model->get_incharge_byacademic();
        $this->data['state']= $this->hosteltemp_model->getAllState(); 
		//echo "".print_r($this->data['hostel_details']);exit();
	...
	public function fetch_incharge_list()
	{
		...
		$inchrg_dts=$this->hosteltemp_model->fetch_incharge_list($_POST);
		$i=1;
		$ban='fa-ban';
		$check='fa-check';
	...
	public function add_inchrg()
    {
		...
		$this->data['hostel_details']=$this->hosteltemp_model->get_hostel_details(); 
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();
		$this->data['designations']=$this->hosteltemp_model->get_su_designation();
		$this->data['state']= $this->hosteltemp_model->getAllState();		
	...
	public function get_inchrgr_detailsbyhid()
	{
		...
		$rm_dts=$this->hosteltemp_model->get_inchrgr_detailsbyhid($host_id);
	...
	public function edit_inchrg()
	{
		...
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();
		$this->data['designations']=$this->hosteltemp_model->get_su_designation();
        $this->data['inchrgr_details']=array_shift($this->hosteltemp_model->get_inchrgr_details($inchrgr_id));
		$this->data['state']= $this->hosteltemp_model->getAllState();                          
	...
	{
		$fc_dts=$this->hosteltemp_model->get_all_std_details($_POST);
		$i=1;
		$ban='fa-ban';
		$check='fa-check';
		$gender='';
	...
	public function add_student()
    {
		...
		$this->data['campus']= $this->hosteltemp_model->getcampusname();
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();
        $this->data['program_detail']=$this->hosteltemp_model->get_program_detail();
		$this->data['state']= $this->hosteltemp_model->getAllState();		
	...
	{
	    echo $this->hosteltemp_model->get_institutes_by_campus($_POST['campus']);
	}
	...
	public function getprogrambycollegename()
	{
		...
		$college=$this->hosteltemp_model->getprogrambycollegename($college_name);
		//print_r($dist);exit;
		if(!empty($college)){
	...
	{
		return $this->hosteltemp_model->checking_enroll_acyear_exists($enroll,$acyear);
	}
	...
	public function edit_student()
	{
		...
		$sf_std_id=$this->uri->segment(3);
		$this->load->view('header',$this->data); 
		$this->data['student_details']= array_shift($this->hosteltemp_model->get_std_details_byid($sf_std_id));	
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();
		$dat = $this->hosteltemp_model->get_std_details_byid($sf_std_id);
		$this->data['program_detail']=$this->hosteltemp_model->get_program_detail($dat[0]['campus_name']);
...
//ini_set('display_errors', 1);
       ...
       // $this->data['program_detail']=$this->hosteltemp_model->get_program_detail();
		//$this->data['state']= $this->hosteltemp_model->getAllState();
		$this->data['student_details']= array_shift($this->hosteltemp_model->get_hostelfee_details($this->data['stud_details']));
		$this->data['bank_details']= $this->hosteltemp_model->getbanks();
		$this->data['installment']= $this->hosteltemp_model->fetch_hostelfee_details($this->data['stud_details']);
		
		$this->data['canc']= $this->hosteltemp_model->get_student_canc($this->data['stud_details']['enrollment_no']);
		
		$this->data['total_fees']= $this->hosteltemp_model->total_fee_paid($this->data['stud_details']);
			
	//	$this->data['installments'] = $this->hosteltemp_model->student_paid_fees();
		$this->data['stud_faci_details']= $this->hosteltemp_model->get_std_fc_details_byid($this->data['stud_details']);		
	...
	public function getcoursename_by_prgmid()
	{
		...
		//echo $college_name;exit();
		$course=$this->hosteltemp_model->getcoursename_by_prgmid($prgm_id,$academic_year);
		echo $course;
	...
	public function Refund_payment()
    {
		...
		//echo "calling";exit();
        $last_inserted_id= $this->hosteltemp_model->Refund_payment($_POST,$payfile );
		if($last_inserted_id)
		{
	...
	public function pay_Installment()
    {
		...
		//echo "calling";exit();
        $last_inserted_id= $this->hosteltemp_model->pay_Installment($_POST,$payfile );
		if($last_inserted_id)
		{
	...
	public function getamtpaid_by_stdid()
	{
		...
		$paid_amt=$this->hosteltemp_model->getamtpaid_by_stdid($_POST);
		echo $paid_amt;
	}
	...
	{//alert("called"+stdid+orgz+enroll);
		...
		//echo $sf_std_id;exit();
		//$this->data['bank_details']= $this->hosteltemp_model->getbanks();
		//$this->data['indet']= $this->hosteltemp_model->get_inst_details($stud_id);
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();
		$this->data['program_detail']=$this->hosteltemp_model->get_program_detail();
		//$this->data['student_details']= array_shift($this->hosteltemp_model->get_std_details_byid($sf_std_id));
		$this->data['bank_details']= $this->hosteltemp_model->getbanks();
		$this->data['indet']= $this->hosteltemp_model->fetch_hostelfee_details_byfid($feeid);
		//$this->data['student_faci_details']= array_shift($this->hosteltemp_model->get_std_fc_details_byid($sf_std_id));
	...
	//	$no_of_installment =1+$_POST['no_of_installment'];
        ...
        $this->hosteltemp_model->update_fee_det($_POST,$payfile );
	...
	{
	      $this->hosteltemp_model->delete_fees($_POST);  
	}
	...
	{
		//echo "helloooo";exit();
		$rm_dts=$this->hosteltemp_model->get_rooms_detailsbyhid($_POST);
		//echo base_url($currentModule.$this->view_dir);exit();
		$i=1;
		$ban='fa-ban';
		$check='fa-check';
	...
	public function edit_room_details()
    {
        ...
        $this->data['h_room_details']=array_shift($this->hosteltemp_model->get_h_room_details($room_id));
	...
	public function edit_room_submit()
	{
		...
		$r_dts=$this->hosteltemp_model->check_rm_exist_byflrhid($_POST,$sf_room_id);
		//$res=$this->hosteltemp_model->check_hcode_exist($host_id,$hostel_code);
...
INNER JOIN sf_student_facility_allocation AS fm ON fm.allocated_id = hrd.sf_room_id AND fm.sffm_id='1'
 ...
 GROUP BY room_no */
	...
	public function check_rm_exist_byflr_rid()
	{
		...
		//$r_no=$_REQUEST['r_no'];
		$r_dts=$this->hosteltemp_model->check_rm_exist_byflr_rid($_POST);
		//$flr_dts['count_rows'];
		echo $r_dts;
	...
	public function check_flr_exist()
	{
		$host_id=$_REQUEST['host_id'];
		$flr_no=$_REQUEST['flr_no'];
		$flr_dts=$this->hosteltemp_model->check_flr_exist($flr_no,$host_id);
	...
	{
		echo $facifee_dts=$this->hosteltemp_model->check_student_exists($_POST);
	}
	
	public function check_facilityfee_exists()
	{
		echo $facifee_dts=$this->hosteltemp_model->check_facilityfee_exists($_POST);
	}
	
	public function check_facilityfee_exists_byid()
	{
		echo $facifee_dts=$this->hosteltemp_model->check_facilityfee_exists_byid($_POST);
	}
	
	public function room_existsbyflrofhostel()
	{
		$roomsdts=$this->hosteltemp_model->room_existsbyflrofhostel($_POST);
		if(!empty($roomsdts))
			echo "exists";
		else
			echo "notexists";
	...
	public function rooms_allocation_details()
	{
		$host_id=$_REQUEST['host_id'];
		$flr_no=$_REQUEST['flr_no'];
		$r_alloted=array_shift($this->hosteltemp_model->total_rooms($host_id));
		echo $r_alloted['no_of_rooms']."||".$r_alloted['no_of_beds'];
		$r_alloted=$this->hosteltemp_model->rooms_allocated($host_id);
		echo "||".$r_alloted;
		$b_alloted=$this->hosteltemp_model->beds_allocated($host_id);
		echo "||".$b_alloted;
	}
	...
	public function edit_flr_room_details()
	{
		$this->load->view('header',$this->data);                
        $hostel_id=$this->uri->segment(3);
        $this->data['h_flr_rm_details']=$this->hosteltemp_model->get_h_flr_rm_details($hostel_id);
		//	echo $this->view_dir.'edit_room_details';exit();
	...
	public function check_rm_exist_byflrhid()
	{
		...
		$flr_no=$_REQUEST['flr_no'];
		$r_no=$_REQUEST['r_no'];
		$r_dts=$this->hosteltemp_model->check_rm_exist_byflrhid($h_rm_id,$h_id,$flr_no,$r_no);
		//$flr_dts['count_rows'];
		echo $r_dts;
		//echo $flr_dts['count_rows'];exit();
	...
	{
		$h_dts=$this->hosteltemp_model->gethostelbycampus($_POST);
		if(!empty($h_dts)){
	...
	{
		$r_dts=$this->hosteltemp_model->getroomnumsbyfloorno($_POST);
		echo json_encode(array("flr_details"=>$r_dts));
	}
	
	public function fetch_alloted_details()
	{
		$r_dts=$this->hosteltemp_model->fetch_alloted_details($_POST);
		echo json_encode(array("flr_details"=>$r_dts));
	}
	
	public function fetch_alloted_details1()
	{
		$this->data['flr_details'] = $this->hosteltemp_model->fetch_alloted_details($_POST);
	...
	{
		$sf_id=$this->hosteltemp_model->getsfid_byenrollment($_POST);
		//print_r($sf_id);exit();
		echo $sf_id;
	}
	...
	{
		$last_inserted_id=$this->hosteltemp_model->stdnt_faci_submit($_POST);
	...
	public function edit_stdnt_faci_allocation()
	{
		...
		$this->load->view('header',$this->data); 
        $this->data['facilities_types']= $this->hosteltemp_model->get_facilities_types();
		$this->data['facilities_allocation']=array_shift($this->hosteltemp_model->get_facilities_allocation($f_alloc_id));
	...
	public function edit_stdnt_faci_submit()
	{
		...
		$last_inserted_id=$this->hosteltemp_model->edit_stdnt_faci_submit($_POST,$f_alloc_id);
		if($last_inserted_id)
		{
	...
	public function student_allocation_list()
	{
		$this->load->view('header',$this->data); 
       // $this->data['facilities_types']= $this->hosteltemp_model->get_facilities_types();
		//$this->data['facilities_allocation']=$this->hosteltemp_model->student_allocation_list();
		//print_r($this->data['facilities_allocation']);exit();
		$this->data['hostel_details']= $this->hosteltemp_model->get_hostel_details();
	...
	{
		$std_list=$this->hosteltemp_model->get_allocation_listbyhid($_POST);
		//echo base_url($currentModule.$this->view_dir);exit();
	...
	{
		$hostel_details= $this->hosteltemp_model->hostel_details($_POST);
		echo json_encode(array("hostel_details"=>$hostel_details));
	}
	
	public function get_info()
	{
		$get_info= $this->hosteltemp_model->get_info($_POST);
    ...
    {
		$f_alloc_id=$this->uri->segment(3);//echo "f_alloc_id==".$f_alloc_id;exit();
		$last_inserted_id=$this->hosteltemp_model->stdnt_faci_disable($f_alloc_id);
		if($last_inserted_id)
		{
    ...
    {
        $f_alloc_id=$this->uri->segment(3);//echo "f_alloc_id==".$f_alloc_id;exit();
		$last_inserted_id=$this->hosteltemp_model->stdnt_faci_enable($f_alloc_id);
		if($last_inserted_id)
		{
	...
	{
		$dts= $this->hosteltemp_model->fetch_std_hostel_fee_details($_POST);
		if(!empty($dts)){
	...
	{
		  $std_faci_details=array_shift($this->hosteltemp_model->get_details($_POST));
	...
	{
		  $std_faci_details=array_shift($this->hosteltemp_model->get_stddetails($_POST));
	...
	public function facility_allocate_submit()
	{
		...
		{
			$this->session->set_flashdata('message1','Hostel facility allocated Successfully.');
		redirect('Hosteltemp/hostel_allocation_view/'.$_POST['h_id']);
		}
		else
		{
			$this->session->set_flashdata('message2','Hostel facility not allocated Successfully.');
	...
	public function student_list($enrollment_no='', $ac_year='', $org='')
    {
        //global $model;
        $this->load->view('header',$this->data);    
        $this->data['student_list']= $this->hosteltemp_model->get_hstudent_list();
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();		
...
$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();	  
	...
	function facility_fee_details()
	{
		...
		$host = $this->hosteltemp_model->facility_fee_details($_POST['fcid'],$_POST['acyear'],$_POST['org']);
		  echo json_encode($host);
	}
	
	function facility_fee_details_by_prn()
	{
		$host = $this->hosteltemp_model->facility_fee_details_by_prn($_POST);
	}
    ...
    function register_for_facility()
	{
		...
		$host = $this->hosteltemp_model->register_for_facility();
			}else{
		$host = $this->hosteltemp_model->register_for_facility();
		}
		...
		redirect(base_url('Hosteltemp/add_fees_challan/'.$enrollment_no.'/'.$ac_year.'/'.$org));
		}else{
    ...
    function load_hostel_students()
    {
		...
		$this->data['student_list'] = $this->hosteltemp_model->load_hostel_students(); 
		$this->data['stud_faci_details']= $this->hosteltemp_model->get_std_fc_details_byid($this->data['stud_details']);
		$this->data['installment'] = $this->hosteltemp_model->student_paid_fees();
		$this->data['bank_details']= $this->hosteltemp_model->getbanks();
    ...
    public function search_students_data()
	{
		...
		//exit;
		$this->data['student_list'] = $this->hosteltemp_model->search_students_data($_POST);     	
	   $this->load->view($this->view_dir.'hostel_applied_list',$this->data);	
	}
	
	public function get_hstudents_data()
	{
		$student_list= $this->hosteltemp_model->search_students_data($_POST);     	
	...
	{
		$this->data['ids'] = $this->hosteltemp_model->h_students_data($_POST);
	...
	public function export_allocated()
	{
		...
		$this->data['student_details'] = $this->hosteltemp_model->allocated_list_export($this->data['stud_details']);
		
		//$this->data['student_details'] = $this->hosteltemp_model->search_students_data($this->data['stud_details']);
	...
	{	
		...
		$this->data['student_details'] = $this->hosteltemp_model->cancelled_list_export($this->data['stud_details']);
	...
	{
		echo $this->hosteltemp_model->de_allocate_bed($_POST);  
	}
	public function check_allocate()
	{
		echo $chk = $this->hosteltemp_model->check_allocate($_POST); 
		//echo "1";
	}
    public function student_facility_details()
	{
		...
		$this->data['student_list'] = $this->hosteltemp_model->student_hostel_details($val); 
		$this->data['installment'] = $this->hosteltemp_model->student_payment_history($val);
		$this->data['bank_details']= $this->hosteltemp_model->getbanks();
		$this->data['student_details']= array_shift($this->hosteltemp_model->get_hostelfee_details($this->data['stud_details']));
		$this->data['stud_details']['enrollment_no']= str_replace("_","/",$this->uri->segment(3));//$this->uri->segment(3);
	...
	{
	   // exit(0);
		$last_inserted_id=$this->hosteltemp_model->cancel_faci_submit($_POST);
		if($last_inserted_id)
		{
	...
	{
		$last_inserted_id=$this->hosteltemp_model->gatepass_submit($_POST);
    ...
    {
        $this->load->view('header',$this->data);        
		$current_academic= $this->hosteltemp_model->get_current_academic();
		$arr=explode("-",$current_academic);
		$ac_year=$arr[0];
		//echo $ac_year;exit();
        $this->data['hostel_details']=$this->hosteltemp_model->gatepass_list($ac_year);
		//echo "".print_r($this->data['hostel_details']);exit();
    ...
    {
        $this->load->view('header',$this->data);        
        $this->data['hostel_details']=$this->hosteltemp_model->gatepass_list();
		//echo "".print_r($this->data['hostel_details']);exit();
	...
	public function edit_gatepass()
    {
        ...
        $this->data['student_list']=array_shift($this->hosteltemp_model->gatepass_list($ac_year,$hgp_id));
	...
	{
		$hgp_id=$_POST['hgp_id'];
		$flag=$this->hosteltemp_model->edit_gatepass_submit($_POST);
		if($flag)
		{
	...
	{
		$std_gatepass_details=array_shift($this->hosteltemp_model->get_gatepass_details($_POST));
		  echo json_encode(array("std_gatepass_details"=>$std_gatepass_details));
	}
	
	public function getpass_approval_submit()
	{
		$flag=$this->hosteltemp_model->getpass_approval_submit($_POST);
		if($flag=='A')
		{
	...
	{
		$flag=$this->hosteltemp_model->getpass_reject_submit($_POST);
		if($flag)
		{
	...
	public function download_gatepass_pdf($hgp_id,$stud_prn,$stud_org,$academic){
		...
		{
			$std_gatepass_details=array_shift($this->hosteltemp_model->get_gatepass_details($this->data['stud_details']));
		  //echo json_encode(array("std_gatepass_details"=>$std_gatepass_details));
	...
	{
		echo $status=$this->hosteltemp_model->check_gatepass_exists($_POST);
	}
	
	public function edit_check_gatepass_exists()
	{
		echo $status=$this->hosteltemp_model->edit_check_gatepass_exists($_POST);
	}
	
	public function gatepass_listbydate()
	{
		$status=$this->hosteltemp_model->gatepass_listbydate($_POST);
		echo json_encode(array("std_gatepass_details"=>$status));
	}
	
	public function gatepass_students_data()
	{
		$std_gatepass_details = $this->hosteltemp_model->gatepass_students_data($_POST);   
	...
	{
		//$status=$this->hosteltemp_model->gatepass_checkincheckout($_POST);
		//echo $status[0]['approval_status']."||".$status[0]['checkin_status'];
		
		
		$std_gatepass_details=$this->hosteltemp_model->gatepass_checkincheckout($_POST);
		echo json_encode(array("std_gatepass_details"=>$std_gatepass_details));
	}
	
	public function gatepass_trailbalance()
	{
		$status=$this->hosteltemp_model->checkout_listbydate($_POST);
		echo json_encode(array("std_gatepass_details"=>$status));
	}
	
	public function update_checkout()
	{
		$flag=$this->hosteltemp_model->update_checkout($_POST);
		if($flag)
		{
	...
	{
		$flag=$this->hosteltemp_model->update_checkin($_POST);
		if($flag)
		{
	...
	{
$hdata = $this->hosteltemp_model->get_hostel_details($hostel='',$_POST['campus']);    
	...
	{
		$r_dts=$this->hosteltemp_model->emptybeds_count_data($_POST);
		echo json_encode(array("emptybeds_details"=>$r_dts));
	}
	
	public function emptybeddetail()
	{
		$r_dts=$this->hosteltemp_model->emptybeddetail($_POST);
	...
	public function excel_emptybeddetail()
	{
		...
		$this->data['emptybeddetail']=$this->hosteltemp_model->emptybeddetail($this->data['hostel_details']);
    ...
    {
        $this->load->view('header',$this->data);
		$this->data['challan_details']=$this->hosteltemp_model->fees_challan_list();
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();
	...
	{
		$hdata = $this->hosteltemp_model->get_depositedto($_POST);    
	...
	{
		$this->load->view('header',$this->data);
		$this->data['facility_details']=$this->hosteltemp_model->get_facility_types();
		//$this->data['depositedto_details']=$this->hosteltemp_model->get_depositedto();
	...
	{
		$std_challan_list=$this->hosteltemp_model->fees_challan_list($_POST);
	...
	public function edit_challan()
	{
		$this->load->view('header',$this->data);
		$this->data['facility_details']=$this->hosteltemp_model->get_facility_types();
		$this->data['depositedto_details']=$this->hosteltemp_model->depositedto_details();
		$this->data['bank_details']= $this->hosteltemp_model->getbanks();
		$this->data['challan_details']=array_shift($this->hosteltemp_model->fees_challan_list_byid($this->uri->segment(3)));
		//exit();
	...
	{
		$challan_details=array_shift($this->hosteltemp_model->fees_challan_list_byid($_POST['id']));
		echo json_encode(array("challan_details"=>$challan_details));
	}
	
	public function students_data()
	{
		$std_details = $this->hosteltemp_model->students_data($_POST);   
	...
	public function add_fees_challan_submit()
	{
        ...
        $last_inserted_id= $this->hosteltemp_model->add_fees_challan_submit($insert_array);
		if($last_inserted_id)
		{
			...
			$last_inserted= $this->hosteltemp_model->update_challan_no($last_inserted_id,$update_array);
...
//if($this->session->userdata("role_id")==6){
	 $check_exits=$this->hosteltemp_model->check_exits($challan_no);
   //exit;
//}
        if($check_exits==0)
		...
		if($_POST['challan_status']=='VR')
		{
			...
			//var_dump($insert_array);exit();
			$this->hosteltemp_model->add_into_sf_fees_details($insert_array);
		}
        ...
        $last_inserted_id= $this->hosteltemp_model->update_challan_no($id,$update_array);
        ...
        $last_inserted_id= $this->hosteltemp_model->fees_details_update($challan_no,$update_array);
    }    
		}
	...
	{
		$category_details = $this->hosteltemp_model->get_faci_category_details($_POST);
	...
	{
		$fee_details = array_shift($this->hosteltemp_model->get_faci_fee_details($_POST));
	...
	public function download_challan_pdf($fees_id)
	{
		...
		if($fees_id!='')
		{
			$std_challan_details=array_shift($this->hosteltemp_model->fees_challan_list_byid($fees_id));
		  //echo json_encode(array("std_gatepass_details"=>$std_gatepass_details));
	...
	public function challan_approval_submit()
	{
		...
		$flag=$this->hosteltemp_model->update_challan_no($_POST['feesid'],$update_array);
	...
	public function challan_type()
	{
		...
		if(!empty($_POST)){
			...
			if($typ_value=='student'){
				redirect('Hosteltemp/add_fees_challan');
			}else{
				redirect('Hosteltemp/add_guest_challan');
			}
		}
	...
	public function add_guest_challan()
	{
		...
		$this->data['depositedto_details']=$this->hosteltemp_model->get_depositedto($data1);
		$this->data['academic_details']=$this->hosteltemp_model->get_academic_details();
		$this->data['bank_details']= $this->hosteltemp_model->getbanks();
	...
	public function add_guest_challan_submit()
	{
		...
		if($last_inserted_id)
		{
			...
			$challan_no=$ayear.str_pad( $last_inserted_id, $challan_digits, "0", STR_PAD_LEFT );
			$update_array=array("exam_session"=>$challan_no);
			$last_inserted_id= $this->hosteltemp_model->update_challan_no($last_inserted_id,$update_array);
			$this->session->set_flashdata('message1','Fees Challan Generated Successfully.');
		}
		else
			$this->session->set_flashdata('message2','Fees Challan Not Generated Successfully.');
    ...
    {
        $this->load->view('header',$this->data);
		$this->data['challan_details']=$this->hosteltemp_model->guest_challan_list();
		$this->data['academic_details']= $this->hosteltemp_model->get_academic_details();
	...
	public function download_guest_challan_pdf($fees_id)
	{
		...
		if($fees_id!='')
		{
			$std_challan_details=array_shift($this->hosteltemp_model->guest_challan_list($fees_id));
		  //echo json_encode(array("std_gatepass_details"=>$std_gatepass_details));
			$this->data['std_challan_details']= $std_challan_details;
		}
	...
	public function edit_guest_challan()
	{
		...
		$this->data['depositedto_details']=$this->hosteltemp_model->depositedto_details();
		$this->data['bank_details']= $this->hosteltemp_model->getbanks();
		$this->data['challan_details']=array_shift($this->hosteltemp_model->guest_challan_list($this->uri->segment(3)));
		//exit();
	...
	public function Hostel_dashboard(){
		...
		$this->data['ref_data']=$this->hosteltemp_model->Hostel_dashboard();
		//exit();
