...
class State extends CI_Controller 
{
    var $currentModule="";
    var $title="";
    var $table_name="state_master";
    var $model_name="state_model";
    var $model;
    var $view_dir='State/';
    var $data=array();
    ...
    public function index()
    {
        ...
        $this->data['state_details']= $this->state_model->get_state_details();                                        
    ...
    public function edit()
    {
        ...
        $this->data['state_details']=array_shift($this->state_model->get_state_details($state_id));                            
    ...
    {       
        ...
        if($state_id=="")
        {
            ...
            {                 
                ...
                $insert_array=array("state_name"=>$state_name,"inserted_by"=>$this->session->userdata("uid"),"inserted_datetime"=>date("Y-m-d H:i:s"));                                                                
                $this->db->insert("state_master", $insert_array);                 
        ...
        else
        {
            ...
            {        
                ...
                $update_array=array("state_name"=>$state_name,"updated_by"=>$this->session->userdata("uid"),"updated_datetime"=>date("Y-m-d H:i:s"));                                                                
