...
class Online_hostel_fee extends CI_Controller 
{

    var $currentModule="Online_hostel_feemodel";
    var $title="";
    var $table_name="campus_master";
    var $model_name="Online_hostel_feemodel";
    var $model;
    var $view_dir='Online_fee_hostel/';
    ...
    //ini_set('display_errors', 1);
	    ...
	    $this->load->model('Online_hostel_feesmodel');
    ...
    public function indexold() // Renamed by to indexold as new index is down 
    {
        ...
        $this->load->view('header',$this->data);    
         $this->data['emp_list']= $this->Online_hostel_feemodel->getFeesdata();
      //    var_dump($this->Online_hostel_feemodel->getFeesdata());
	...
	public function index()
    {
	    ...
	    $this->data['product_info']= $this->Online_hostel_feesmodel->product_info();                 
   ...
   public function test(){
	   error_reporting(E_ALL);
    $p= $this->Online_hostel_feesmodel->count_all();
print_r($p); exit();
   }
    public function getOnlineFeeDetail()
    {
      ...
      $list = $this->Online_hostel_feesmodel->get_datatables('', $pstatus, $pdate,$Type_status,$Verify_status,$pyear);
    // print_r($list);
 //exit();
      $data = array();
      $no = $_POST['start'];
	   ...
	   /* if($apStatus == NULL) {
        ...
        if($payment_status == 'success') {
        	if($verification_status =='Y') {
				...
				}else if($students->productinfo=="Hostel_Temp_Room"){
					$studentVerify = base_url()."Hostel/add_guest_challan/".$students->payment_id."/".$students->productinfo;
				}else{
        		$studentVerify = base_url()."Online_hostel_fee/Challan/".$students->payment_id."/".$students->productinfo;
				}
...
///print_r($p); exit();
      $output = array(
              "draw" => $_POST['draw'],
              "recordsTotal" => $this->Online_hostel_feesmodel->count_all(),
              "recordsFiltered" => $this->Online_hostel_feesmodel->count_filtered('', $pstatus, $pdate,$Type_status,$Verify_status,$pyear),
              "data" => $data,
          );
      ...
      echo json_encode($output);
		...
		echo	$check=$this->Online_hostel_feesmodel->change_productinfo($_POST);
		}
		...
		public function getOnlineFeeDetail_Registration()
    {
      ...
      $list = $this->Online_hostel_feesmodel->get_datatables_Registration('', $pstatus, $pdate);
      ...
      $output = array(
              "draw" => $_POST['draw'],
              "recordsTotal" => $this->Online_hostel_feesmodel->count_all_Registration(),
              "recordsFiltered" => $this->Online_hostel_feesmodel->count_filtered_Registration(),
              "data" => $data,
          );
	  ...
	  public function student_payment_history()
    {
		...
		$name=$this->session->userdata("aname");
         $this->data['pay_list']= $this->Online_hostel_feemodel->student_payment_history($name);
      //    var_dump($this->Online_hostel_feemodel->getFeesdata());
       // $this->data['campus_details']= $this->campus_model->get_campus_details();                        
	...
	function load_feelist()
	{
	      ...
	      $data['emp_list']= $this->Online_hostel_feemodel->getFeesajax();
	...
	{
	  $this->Online_hostel_feemodel->update_feestatus();  
	 echo "Y";   
	}
	...
	{
	  $this->Online_hostel_feemodel->remove_list();  
	 echo "Y";   
	}
      ...
      //    var_dump($this->Online_hostel_feemodel->getFeesdata());
       // $this->data['campus_details']= $this->campus_model->get_campus_details();                        
        ...
        $this->load->view('footer'); 
	      ...
	      $this->load->view('header',$this->data);    
          $stdata= $this->Online_hostel_feemodel->fetch_studentdata();
		  $this->data['adm']= $this->Online_hostel_feemodel->check_admission_year($stdata['stud_id']);
		  $this->data['ex_list']= $this->Online_hostel_feemodel->get_stud_exams($stdata['stud_id']);
	...
	function pay_fees_old($type='')
	{
      ...
      //  $this->load->view($this->view_dir.'maintenance',$_POST);
        ...
        $this->load->view('footer'); 
          ...
          $stdata= $this->Online_hostel_feemodel->fetch_studentdata();
		  $this->data['adm']= $this->Online_hostel_feemodel->check_admission_year($stdata['stud_id']);
		  //$this->data['payment_status']= $this->Online_hostel_feemodel->check_payment_status($stdata['stud_id'],$acdemic_year='2021');
		  $this->data['stdata']=$stdata;
		  $this->data['productinfo1']=$type;
		  $this->load->view($this->view_dir.'payfeesnew',$this->data);//pay_fees
	...
	function pay_full_fees()
	{
      ...
      //    var_dump($this->Online_hostel_feemodel->getFeesdata());
	   ...
	   else
	   {
	      ...
	      $this->load->view('header',$this->data);    
       $this->data['stdata']= $this->Online_hostel_feemodel->fetch_studentdata();
      //    var_dump($this->Online_hostel_feemodel->getFeesdata());
       // $this->data['campus_details']= $this->campus_model->get_campus_details();                        
        $this->load->view($this->view_dir.'pay_full_fees',$this->data);
        $this->load->view('footer'); 
...
{
    $amount= $this->Online_hostel_feemodel->fetch_ReRegistration();
}
 ...
 //  print_r($_POST);exit();
  ...
  // exit;
   ...
   $trans_id=$this->Online_hostel_feemodel->insert_data_in_trans($_POST,$txnid);
 ...
 //  } else {
  ...
  // }
   ...
   if($posted['productinfo']=="Re-Registration"){
	  $amount= $this->Online_hostel_feemodel->fetch_ReRegistration($_POST);
	  $udf6=$posted['udf6'];
...
|| empty($posted['productinfo'])) {
 ...
 //  } else {
  ...
  // }
   ...
   /*if($posted['productinfo']=="Re-Registration"){
	  $amount= $this->Online_hostel_feemodel->fetch_ReRegistration($_POST['stud_id']);
   ...
   if($posted['productinfo']=="Re-Registration-full"){
	  $amount= $this->Online_hostel_feemodel->fetch_ReRegistration_full($_POST['stud_id']);
	  $posted['amount']=$amount;
	//  $pay=$amount;
   }else{
	  $posted['amount']=$posted['amount'];
...
|| empty($posted['productinfo'])) {
   ...
   $action = $PAYU_BASE_URL . '/_payment';
	...
	function test_student(){
		echo $this->Online_hostel_feemodel->fetch_ReRegistration_full('4389');
	}
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
echo 'Status revert is: ' . $status.'<pre>';
 ...
 $get_data=$this->Online_hostel_feemodel->Update_Manually_Status($recepit_no,$txtid,$email,$productinfo,$amount,$bank_ref_num,$payment_date);
 ////////////////////////////////////////////////////
...
//$ccv['merchant_param3'];
   ...
   // $this->session->set_userdata('cvorder_id', $recepit);
	...
	//	print_r($this->data);
		//exit();
		$this->Online_hostel_feemodel->add_online_feedetails($this->data);
       //var_dump($this->Online_hostel_feemodel->getFeesdata());
       //$data['session_details']= $this->Online_hostel_feemodel->fetch_studentdata(); 
 ...
 //$_POST['amount']='10';
   ...
   if($_POST['productinfo']=="Re-Registration"){
	...
	//  $pay=$amount;
	  ...
	  $amount=$this->Online_hostel_feemodel->fetch_admission($_POST);
	  $udf6=$_POST['udf6'];
  ...
  // $this->Online_hostel_feemodel->Update_recepit($recepit,$txnid);
   
 //  echo	$amount= $this->Online_hostel_feemodel->fetch_admission($_POST);
  // exit();
   $this->session->set_userdata('ctid', $txnid);
...
{
     $this->Online_hostel_feemodel->fetch_feedet();
}
...
{
     $this->Online_hostel_feemodel->fetch_feedet_full();
}
...
public function received_payment_details()
{
    	...
    	$this->load->view('header', $this->data);
   $this->data['payment_data']	=  $this->Online_hostel_feemodel->received_payment_details();
 ...
 public function ic_adm_payment()
    {
        global $model;
        $this->load->view('header',$this->data);    
         $this->data['emp_list']= $this->Online_hostel_feemodel->getFeesdata_ic();
      //    var_dump($this->Online_hostel_feemodel->getFeesdata());
       // $this->data['campus_details']= $this->campus_model->get_campus_details();                        
	...
	public function Challan(){
        ...
        $this->load->view('header',$this->data);    
		 ...
		 $this->data['payment_id']=$this->uri->segment(3);
		...
		// print_r($pay); exit();
		 ...
		 $this->data['pay']=$pay;
		//exit();
		if($productinfo=="Hostel_admission_new"){
		$this->data['user_details']=$this->Online_hostel_feemodel->get_details($recepit);
		//exit();
		$dats=$this->data['user_details'];
		}elseif(($productinfo=="Hostel_Gym_new") || $productinfo=="Gym" ||($productinfo=="Hostel_Gym_Sf")  || ($productinfo=="Hostel_Temp_Room")){	 
		$this->data['user_details']=$this->Online_hostel_feemodel->get_details_gym($recepit,$pay[0]['org_frm']);
		//exit();
		$dats=$this->data['user_details'];	
		}elseif($productinfo=="Hostel_Pending_fees"){	 
		$this->data['user_details']=$this->Online_hostel_feemodel->get_details($recepit);
		//exit();
		$dats=$this->data['user_details'];
		
		}else{
		$this->data['user_details']=$this->Online_hostel_feemodel->get_details_register($recepit);
		$dats=$this->data['user_details'];
		}
		...
		$this->data['depositedto_details']=$this->Online_hostel_feesmodel->hostel_get_depositedto();
		...
		//exit();
		$this->data['examsession']=$this->Challan_model->get_examsession();
		if($productinfo=="Hostel_Temp_Room"){
			$this->load->view($this->view_dir.'add_fees_challan_details_temp_hostel',$this->data);
		}elseif($productinfo=="Gym"){
			$this->load->view($this->view_dir.'add_fees_challan_details_new_gym',$this->data);
		}else{
			//echo 1311;exit;
	...
	public function External_challan_mba(){
        ...
        $this->load->view('header',$this->data);    
		 ...
		 $this->data['productinfo']=$this->uri->segment(4);
		//exit();
		$this->data['user_details']=$this->Online_hostel_feemodel->get_details_mba($recepit);
		$dats=$this->data['user_details'];
		//print_r($this->data['user_details']);
		//exit();
		$this->data['facility_details']=$this->Challan_model->get_facility_types();
...
function provision_add(){
	...
	{
		$std_details = $this->Online_hostel_feemodel->students_data($_POST);   
		//var_dump($std_details);
	   	echo json_encode(array("std_details"=>$std_details));
	}
	
	public function get_fee(){
		  $fee_details_new = $this->Online_hostel_feemodel->fee_details($_POST);
	...
	public function save_slot(){
		...
		$fee_details_new = $this->Online_hostel_feemodel->save_slot($_POST);
		//fee_slot
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
public function check_facility_recepit(){
	
		$receipt_number=$this->input->post('receipt_number');
		$epayment_type=$this->input->post('epayment_type');
		$sql="select count(fees_id) as Total FROM sf_fees_challan WHERE receipt_no='$receipt_number' AND challan_status!='CL'";//fees_paid_type='$epayment_type' AND
