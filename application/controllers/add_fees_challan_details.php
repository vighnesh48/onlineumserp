									   ...
									   <?php 
										if(!empty($depositedto_details)){
											foreach($depositedto_details as $deposit){
												?>
											  <option value="<?=$deposit['bank_id']?>"><?=$deposit['account_name']?> - <?=$deposit['bank_name']?></option>  
											<?php 
						...
						<div class="panel" id="fee_details" style="display:none;">
							...
							<!--	<div class="form-group">
							   ...
							   <div class="form-group">
                                ...
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly"  value="0" readonly name="apaid" id="apaid" readonly/>
                                </div>
                                
                              </div>
                              
                                    <div class="form-group">
                                <label class="col-md-5" style="padding-left:0px;">Amount Pending:</label>
                                <div class="col-md-6">
                                   <input type="text" class="form-control numbersOnly"  value="0" readonly name="apend" id="apend" readonly/>
                                </div>
