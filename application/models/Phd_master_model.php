<?php
class Phd_master_model extends CI_Model 
{
	...
	public function get_academic_fees_details($data)
	{
		...
		$DB1->select("vw_stream_details.stream_short_name,vw_stream_details.stream_code as stream_name,vw_stream_details.course_short_name as course_name,vw_stream_details.school_short_name as school_name,academic_fees.*,");
	...
	public function get_admissionyear_stream_list($data)
	{
		...
		$DB1->where("academic_fees.academic_year = '".$data['academic']."' and academic_fees.admission_year = '".$data['year']."'");
		$arr=explode("-",$data['academic']);
		$ac_year=$arr[0];
	...
	public function get_all_stream_list($data)
	{
		...
		$DB1->from("vw_stream_details");
		$DB1->join("academic_fees", "academic_fees.stream_id = vw_stream_details.stream_id",'left');
		$where=("academic_fees.academic_year ='".$data['academic']."' and academic_fees.admission_year = '".$data['year']."' and academic_fees.year ='".$data['yr']."'");
