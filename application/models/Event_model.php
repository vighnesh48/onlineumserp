...
class Event_model extends CI_Model
{
    ...
    public function get_events($limit, $offset, $search = null)
    {
        ...
        $DB1->select('e.*,ep.file_name,ep.file_path, 
                  ...
                  vw.stream_name');
        $DB1->from('events e');
        $DB1->join('vw_stream_details vw','vw.stream_id = e.stream_id', 'left');
    ...
    public function get_event_detail_by_id($event_id)
    {
        ...
        $DB1->from('events e');
        $DB1->join('vw_stream_details vsd', 'e.stream_id = vsd.stream_id','left');
        $DB1->where('id', $event_id);
        $query = $DB1->get();
    ...
    public function get_event_allocation_list_by_id($event_id, $limit, $offset, $search = '')
    {
        ...
        $DB1->join('vw_stream_details vsd', 'ea.stream_id = vsd.stream_id','left');
    ...
    public function get_event_allocation_list_by_id_old($event_id, $limit, $offset, $search = '')
    {
        $DB1 = $this->load->database('umsdb', TRUE);
