...
<div id="content-wrapper">
    ...
    <div class="page-header">
    	<div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Gradesheet Generation</h1>
        ...
        <div class="row ">
			...
			//if(isset($role_id) && $role_id==1 ){?>
                ...
                <div class="row">
			<div class="col-lg-3"><input type="text" name="current_date" value="" id="datepicker" class="form-control"></div>
                        <div class="col-lg-2">
