...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        ...
        <div class="row">
            ...
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Lessonplan covered Details</h1>
            ...
            <div class="col-sm-12">
				...
				<div class="panel">
                    ...
                    <div class="panel-heading">
							...
							<div><a href="<?=base_url()?>lessonplan/downloadpdf_coverd/<?=base64_encode($subdetails)?>"><button class="btn btn-info">Download pdf</button></a></div>
                    </div>
										...
										foreach ($Syllabus_Covered as $lplan) {	
												...
												?>
													...
													<tr>
														...
														<td><?php
														if($lplan['is_from_lesson_plan']=='Y')
														{
