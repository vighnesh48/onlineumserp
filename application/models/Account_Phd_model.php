<?php
class Account_Phd_model extends CI_Model 
{
...
//	  echo $DB1->last_query();//exit;
 ...
 public function get_studentwise_admission_fees($data){
	 ...
	 ad.academic_year,ad.opening_balance,dt.district_name,tm.taluka_name,st.state_name
	 
	 from admission_details ad 
	 left join vw_stream_details v on v.stream_id=ad.stream_id
	 left join address_details ads on ads.student_id=ad.student_id AND ads.address_type='CORS'
