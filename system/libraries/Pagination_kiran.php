...
class CI_Pagination_kiran {
	...
	function create_links()
	{
		...
		if  ($this->prev_link !== FALSE AND $this->cur_page != 1)
		{
			...
			{
				$output .= $this->prev_tag_open.'<li><a '.$this->anchor_class.'href="1">'.$this->prev_link.'</a></li>'.$this->prev_tag_close;//'.$this->first_url.'
			}
			else
			{
				$i = ($i == 0) ? '' : $this->prefix.$i.$this->suffix;
				$output .= $this->prev_tag_open.'<li><a '.$this->anchor_class.'href="2">'.$this->prev_link.'</a></li>'.$this->prev_tag_close;//'.$this->base_url.$i.'
			}
		}
			...
			for ($loop = $start -1; $loop <= $end; $loop++)
			{
				...
				if ($i >= $base_page)
				{
					...
					else
					{
						...
						if ($n == '' && $this->first_url != '')
						{
							$output .= $this->num_tag_open.'<li><a '.$this->anchor_class.'href="3">'.$loop.'</a></li>'.$this->num_tag_close;//'.$this->first_url.'
						}
						else
						{
							$n = ($n == '') ? '' : $this->prefix.$n.$this->suffix;

		$output .= $this->num_tag_open.'<li><a '.$this->anchor_class.' href="#" onclick=newajx("'.$this->base_url.$n.'");>'.$loop.'</a></li>'.$this->num_tag_close;//'.$this->base_url.$n.'
						}
					}
			}
		}
		...
		if ($this->next_link !== FALSE AND $this->cur_page < $num_pages)
		{
			...
			$output .= $this->next_tag_open.'<li><a '.$this->anchor_class.'href="5" onclick=newajx("'.$this->base_url.$this->prefix.$i.$this->suffix.'");>'.$this->next_link.'</a></li>'.$this->next_tag_close;//'.$this->base_url.$this->prefix.$i.$this->suffix.'
		}
		...
		if ($this->last_link !== FALSE AND ($this->cur_page + $this->num_links) < $num_pages)
		{
			...
			$output .= $this->last_tag_open.'<li><a '.$this->anchor_class.'href="6" onclick=newajx("'.$this->base_url.$this->prefix.$i.$this->suffix.'");>'.$this->last_link.'</a></li>'.$this->last_tag_close;//'.$this->base_url.$this->prefix.$i.$this->suffix.'
		}
